/*
 Basic Primitives Diagrams v5.6.4
...
y.right()+5);G.y<y.y?G.y=y.y+5:G.bottom()>y.bottom()&&(G.y-=G.bottom()-y.bottom()+5);l=G;k=new a.common.Rect(l);k.addRect(e.x,e.y);k.offset(50);e.x-=k.x;e.y-=k.y;l.x-=k.x;l.y-=k.y;x=new a.common.RenderEventArgs;x.context=f.getConfig(b);x.isCursor=m.getCursorTreeItem()==b;x.isSelected=n.isSelected(b);x.templateName=z.templateConfig.name;p.show("calloutplaceholder");p.activate("calloutplaceholder",15);p.position("calloutplaceholder",k.x,k.y,k.width,k.height);p.template(l.x,l.y,l.width,l.height,0,0,
