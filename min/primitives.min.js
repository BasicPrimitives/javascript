/*
 Basic Primitives Diagrams v5.4.15
...
13)}j(f.getAnnotations(),e.getItemPosition);return!1}}};a.orgdiagram.DrawTreeItemsTask=function(g,b,d,c,f,e,h,i,j,k,m,n,l,p){function q(){var b,g=k.getCursorTreeItem(),f,n,l;n=null;if(null!=i){n=c.getOptions().scale;var p=new a.common.Point(i.getPlaceholderOffset()),q=new a.common.Rect(h.getContentSize()),D=new a.common.Size(d.getOptimalPanelSize());p.scale(1/n);D.scale(1/n);n=new a.common.Rect(p.x,p.y,Math.min(D.width,q.width),Math.min(D.height,q.height))}l=n;for(var C in r)r.hasOwnProperty(C)&&
(f=r[C],n=f.actualPosition,1==f.actualVisibility&&t.transformRect(n.x,n.y,n.width,n.height,!0,this,function(c,d,h,i){var n=new a.common.Rect(c,d,h,i);if(null==l||l.overlaps(n)){var k=j.getTemplateParams(C),n=k.template;b=new a.common.RenderEventArgs;b.id=C;b.context=e.getConfig(C);b.isCursor=C==g;b.isSelected=m.isSelected(C);b.templateName=n.templateConfig.name;b.template=k.template;b.isActive=k.isActive;b.hasSelectorCheckbox=k.hasSelectorCheckbox;b.hasButtons=k.hasButtons;b.hasGroupTitle=k.hasGroupTitle;
b.buttons=k.buttons;b.onButtonsRender=k.onButtonsRender;s.activate("placeholder",12);s.template(c,d,h,i,f.contentPosition.x,f.contentPosition.y,f.contentPosition.width,f.contentPosition.height,n.itemTemplate.template(),n.itemTemplate.getHashCode(),n.itemTemplate.render,b,{borderWidth:n.templateConfig.itemBorderWidth});if(k.hasGroupTitle){var p=0;switch(w.groupTitlePlacementType){case 2:case 0:p=2;break;case 3:p=h-(w.groupTitlePanelSize-4)}s.template(c,d,h,i,p,f.contentPosition.y,w.groupTitlePanelSize-
4,f.contentPosition.height+2,x.template(),x.getHashCode(),x.render,b,null)}k.hasSelectorCheckbox&&(s.activate("placeholder",16),s.template(c,d,h,i,f.contentPosition.x,i-(w.checkBoxPanelSize-4),f.contentPosition.width,w.checkBoxPanelSize-4,A.template(),A.getHashCode(),A.render,b,null));if(k.hasButtons){s.activate("placeholder",16);k=0;switch(w.groupTitlePlacementType){case 2:case 0:k=h-(w.buttonsPanelSize-4);break;case 3:k=2}s.template(c,d,h,i,k,f.contentPosition.y,w.buttonsPanelSize-4,Math.max(f.contentPosition.height,
i-f.contentPosition.y),u.template(),n.templateConfig.name+u.getHashCode(),u.render,b,null)}}}))}var r,s,t,w,u,A,x;return{process:function(){s=g();w=f.getOptions();r=h.getItemsPositions();t=b.getTransform();u=p.getTemplate();A=l.getTemplate();x=n.getTemplate();s.reset("placeholder",12);s.reset("placeholder",16);q();return!1}}};a.orgdiagram.ActiveItemsTask=function(g,b){function d(a,c){var d=[],e,f;e=0;for(f=c.length;e<f;e+=1){var g=c[e],l=b.getTemplate(g.templateName,a.defaultTemplateName,b.DefaultWidgetTemplateName).templateConfig;
g.isActive&&l.isActive&&d.push(g.id)}return d}var c=[],f={},e=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:f},b=g.getOptions();c=e.read(c,d(b,b.items),"items",a);return a.isChanged},getActiveItems:function(){return f.items}}};a.orgdiagram.AnnotationLabelTemplateTask=function(a,b){var d=null;return{process:function(){return!1},getTemplate:function(){null==d&&(d=new b.AnnotationLabelTemplate);return d}}};a.orgdiagram.ButtonsTemplateTask=
...
function(g){function b(a){var b=[],c={},d,f,g;d=0;for(f=a.length;d<f;d+=1)g=a[d],g.selectItems&&(null!=g.fromItem&&!c.hasOwnProperty(g.fromItem)&&(b.push(g.fromItem),c[g.fromItem]=!0),null!=g.toItem&&!c.hasOwnProperty(g.toItem)&&(b.push(g.toItem),c[g.toItem]=!0));return b}var d=[],c={},f=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:c},h=g.getAnnotations();d=f.read(d,b(h),"items",a);return a.isChanged},getItems:function(){return d}}};
