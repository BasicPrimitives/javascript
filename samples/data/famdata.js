...
var treesSharingNodes = {
  cursorItem: 2,
  itemsOrderType: primitives.ItemsOrderType.MergedTrees,
  annotations: [
    {
      annotationType: primitives.AnnotationType.Connector,
      fromItem: 1,
  ...
  items: [
    { id: 1, title: "Global Headquarters", label: "HQ", description: "Primary coordination and governance entity.", image: "../images/photos/e.png", itemTitleColor: primitives.Colors.Navy },
    { id: 2, title: "Regional Operations Center", label: "Ops Center", description: "Manages regional execution and oversight.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },

    { id: 3, parents: [1], title: "Northern Division", label: "North Div", description: "Supervises activities across the northern region.", image: "../images/photos/j.png", itemTitleColor: primitives.Colors.Navy },
    { id: 107, parents: [2], title: "Routing Node 107", label: "Node 107", templateName: "dot", description: "Logical connector for downstream entities.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },

    { id: 4, parents: [107], title: "Operations Unit Alpha", label: "Ops Alpha", description: "Executes operational workflows for assigned scope.", image: "../images/photos/a.png", itemTitleColor: primitives.Colors.Red },
    { id: 5, parents: [107], title: "Operations Unit Beta", label: "Ops Beta", description: "Provides specialized operational support.", image: "../images/photos/f.png", itemTitleColor: primitives.Colors.Red },
    { id: 6, parents: [107], title: "Operations Unit Gamma", label: "Ops Gamma", description: "Handles advanced or specialized initiatives.", image: "../images/photos/s.png", itemTitleColor: primitives.Colors.Red },
    { id: 7, parents: [3], title: "Partner Coordination Group", label: "Partners", description: "Coordinates collaboration with external groups.", image: "../images/photos/i.png", itemTitleColor: primitives.Colors.Navy },
    { id: 8, parents: [107], title: "Domestic Services Unit", label: "Domestic", description: "Oversees nationally scoped activities.", image: "../images/photos/a.png", itemTitleColor: primitives.Colors.Red },
    { id: 9, parents: [107], title: "Logistics Division", label: "Logistics", description: "Manages transport, supply, and distribution.", image: "../images/photos/n.png", itemTitleColor: primitives.Colors.Red },
    { id: 10, parents: [107], title: "Infrastructure Division", label: "Infrastructure", description: "Maintains physical and digital infrastructure.", image: "../images/photos/m.png", itemTitleColor: primitives.Colors.Red },
    { id: 11, parents: [107], title: "Special Projects Office", label: "Projects", description: "Runs time-bound and cross-functional projects.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },

    { id: 12, parents: [5], title: "Service Cluster A", label: "Service A", description: "Delivers coordinated service capabilities.", image: "../images/photos/e.png", itemTitleColor: primitives.Colors.Red },
    { id: 13, parents: [7], title: "Connector Node 13", label: "Node 13", templateName: "dot", description: "Structural connector for partner units.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Navy },
    { id: 14, parents: [8], title: "Connector Node 14", label: "Node 14", templateName: "dot", description: "Logical routing element.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 15, parents: [11], title: "Connector Node 15", label: "Node 15", templateName: "dot", description: "Execution routing placeholder.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },

    { id: 16, parents: [12], title: "Connector Node 16", label: "Node 16", templateName: "dot", description: "Service distribution connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 17, parents: [13], title: "Advisory Group", label: "Advisory", description: "Provides expert consultation and guidance.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Navy },
    { id: 18, parents: [14], title: "Health Services Team", label: "Health Team", description: "Supports health and wellbeing initiatives.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 19, parents: [14], title: "Forward Support Team", label: "Support", description: "Provides rapid on-site assistance.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 20, parents: [13], title: "Transition Management Group", label: "Transition", description: "Manages organizational change activities.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 21, parents: [14], title: "Training Office", label: "Training", description: "Delivers training and capability development.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 22, parents: [14], title: "Connector Node 22", label: "Node 22", templateName: "dot", description: "Governance routing placeholder.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Navy },
    { id: 23, parents: [14], title: "Compliance Task Group", label: "Compliance", description: "Ensures policy and regulatory adherence.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 24, parents: [13], title: "Unified Coordination Cell", label: "Unified Cell", description: "Aligns multiple parallel initiatives.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 25, parents: [14], title: "Connector Node 25", label: "Node 25", templateName: "dot", description: "Execution flow connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 26, parents: [14], title: "Process Improvement Team", label: "Process", description: "Optimizes operational processes.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 27, parents: [14], title: "Medical Services Unit", label: "Medical", description: "Provides medical and support services.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 28, parents: [14], title: "Connector Node 28", label: "Node 28", templateName: "dot", description: "Resource distribution connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 29, parents: [14], title: "Digital Enablement Team", label: "Digital", description: "Implements digital initiatives.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 30, parents: [14], title: "Technical Support Group", label: "Tech Support", description: "Provides specialized technical assistance.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 45, parents: [14], title: "Connector Node 45", label: "Node 45", templateName: "dot", description: "Intermediate routing connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 31, parents: [14], title: "Information Services Unit", label: "Info Services", description: "Manages information flow and reporting.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 32, parents: [14], title: "Security Operations Office", label: "Security", description: "Oversees security-related operations.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 33, parents: [15], title: "Connector Node 33", label: "Node 33", templateName: "dot", description: "Program execution connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },

    { id: 34, parents: [16], title: "Service Team Alpha", label: "Team Alpha", description: "Provides core service delivery.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 35, parents: [16], title: "Service Team Beta", label: "Team Beta", description: "Supports extended service functions.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 36, parents: [16], title: "Service Team Gamma", label: "Team Gamma", description: "Handles specialized service tasks.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 37, parents: [16], title: "Service Team Delta", label: "Team Delta", description: "Delivers regional service support.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 38, parents: [16], title: "Service Team Epsilon", label: "Team Epsilon", description: "Focuses on advisory and oversight services.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 39, parents: [22], title: "Transition Cell A", label: "Cell A", description: "Supports localized transition activities.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 40, parents: [23], title: "Operations Extension Unit", label: "Ops Ext", description: "Extends operational reach and capacity.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 41, parents: [24], title: "Connector Node 41", label: "Node 41", templateName: "dot", description: "Coordination routing node.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Navy },
    { id: 42, parents: [25], title: "Connector Node 42", label: "Node 42", templateName: "dot", description: "Execution branching connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 43, parents: [28], title: "Integration Nexus", label: "Nexus", description: "Central integration and coordination hub.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 44, parents: [28], title: "Coordination Group Three", label: "Group 3", description: "Handles regional coordination tasks.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 46, parents: [45], title: "Network Operations Cell", label: "Net Ops", description: "Manages network-level operations.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 47, parents: [32], title: "Joint Operations Team", label: "Joint Ops", description: "Executes joint operational initiatives.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 48, parents: [33], title: "Task Group 3-10", label: "Task 3-10", description: "Performs assigned task-based activities.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },

    { id: 49, parents: [41], title: "Infrastructure Support Cell", label: "Infra Support", description: "Provides infrastructure assistance.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 50, parents: [41], title: "Regional Cell Southwest", label: "Cell SW", description: "Coordinates southwest regional activities.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 51, parents: [42], title: "Western Operations Group", label: "West Ops", description: "Manages western operational scope.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 62, parents: [41], title: "Local Coordination Office", label: "Local Office", description: "Handles local-level coordination.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 63, parents: [41], title: "Connector Node 63", label: "Node 63", templateName: "dot", description: "Subdivision routing connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Navy },
    { id: 64, parents: [41], title: "Regional Cell South", label: "Cell South", description: "Coordinates southern region activities.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 65, parents: [42], title: "Mountain Operations Group", label: "Mountain Ops", description: "Handles high-complexity operational areas.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 66, parents: [41], title: "Regional Cell West", label: "Cell West", description: "Coordinates western region services.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 67, parents: [42], title: "Connector Node 67", label: "Node 67", templateName: "dot", description: "Auxiliary routing connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 68, parents: [41], title: "Regional Cell North", label: "Cell North", description: "Coordinates northern region activities.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 69, parents: [42], title: "Northern Operations Group", label: "North Ops", description: "Manages northern operational scope.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 70, parents: [41], title: "Regional Cell Central", label: "Cell Central", description: "Coordinates central region operations.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 71, parents: [42], title: "Connector Node 71", label: "Node 71", templateName: "dot", description: "Branching logic connector.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 72, parents: [41], title: "Regional Cell East", label: "Cell East", description: "Coordinates eastern region services.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 73, parents: [42], title: "Eastern Operations Group", label: "East Ops", description: "Manages eastern operational scope.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 74, parents: [42], title: "Special Deployment Unit", label: "Deployment", description: "Handles rapid deployment activities.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 75, parents: [42], title: "Connector Node 75", label: "Node 75", templateName: "dot", description: "Structural placeholder node.", image: "../images/photos/u.png", itemTitleColor: primitives.Colors.Red },
    { id: 76, parents: [41], title: "Connector Node 76", label: "Node 76", templateName: "dot", description: "Supplementary routing connector.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 77, parents: [42], title: "Engineering Support Team", label: "Engineering", description: "Provides engineering and technical support.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },
    { id: 78, parents: [42], title: "Construction Services Unit", label: "Construction", description: "Handles construction and maintenance tasks.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red },

    { id: 79, parents: [50], title: "Southwest Cell A", label: "SW A", description: "Operational subgroup A.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 80, parents: [50, 51], title: "Southwest Cell B", label: "SW B", description: "Operational subgroup B.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 81, parents: [63], title: "Local Advisory Cell", label: "Advisory Cell", description: "Provides localized advisory services.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 82, parents: [64, 65], title: "South Cell A", label: "South A", description: "Southern region subgroup A.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 83, parents: [64, 65], title: "South Cell B", label: "South B", description: "Southern region subgroup B.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 84, parents: [64, 65], title: "South Cell C", label: "South C", description: "Southern region subgroup C.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 85, parents: [64, 65], title: "South Cell D", label: "South D", description: "Southern region subgroup D.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 86, parents: [64, 65], title: "South Cell E", label: "South E", description: "Southern region subgroup E.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 87, parents: [64, 65], title: "South Cell F", label: "South F", description: "Southern region subgroup F.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 88, parents: [64, 65], title: "South Cell J", label: "South J", description: "Southern region subgroup J.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 89, parents: [66], title: "West Cell A", label: "West A", description: "Western region subgroup A.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 90, parents: [66], title: "West Cell B", label: "West B", description: "Western region subgroup B.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 91, parents: [66, 67], title: "West Cell C", label: "West C", description: "Western region subgroup C.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 92, parents: [66, 67], title: "West Cell D", label: "West D", description: "Western region subgroup D.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 93, parents: [68], title: "North Cell A", label: "North A", description: "Northern region subgroup A.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 94, parents: [68, 69], title: "North Cell B", label: "North B", description: "Northern region subgroup B.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 95, parents: [68, 69], title: "North Cell C", label: "North C", description: "Northern region subgroup C.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 96, parents: [70], title: "Central Cell A", label: "Central A", description: "Central region subgroup A.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 97, parents: [70, 71], title: "Central Cell B", label: "Central B", description: "Central region subgroup B.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 98, parents: [72], title: "East Cell A", label: "East A", description: "Eastern region subgroup A.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 99, parents: [72], title: "East Cell B", label: "East B", description: "Eastern region subgroup B.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 100, parents: [72, 73], title: "East Cell C", label: "East C", description: "Eastern region subgroup C.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 101, parents: [72, 73], title: "East Cell D", label: "East D", description: "Eastern region subgroup D.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 102, parents: [72, 73], title: "East Cell E", label: "East E", description: "Eastern region subgroup E.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 103, parents: [72, 73], title: "East Cell F", label: "East F", description: "Eastern region subgroup F.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 104, parents: [72, 73], title: "East Cell J", label: "East J", description: "Eastern region subgroup J.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 105, parents: [72, 73], title: "East Cell H", label: "East H", description: "Eastern region subgroup H.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Navy },
    { id: 106, parents: [75, 76], title: "Coordination Group 25", label: "Group 25", description: "Joint coordination across multiple branches.", image: "../images/photos/t.png", itemTitleColor: primitives.Colors.Red }
  ]
...
var dataSetNames = {
  ...
  "Rombus": "rombusShape",
  "Trees Sharing Nodes": "treesSharingNodes",
