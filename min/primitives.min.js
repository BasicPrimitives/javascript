/*
 Basic Primitives Diagrams v5.8.0
...
null;this.tooltip=e;this.size=new a.common.Size(16,16)};a.famdiagram.Config=function(c){this.name=void 0!==c?c:"FamDiagram";this.classPrefix="famdiagram";this.graphicsType=this.navigationMode=0;this.pageFitMode=3;this.minimalVisibility=2;this.orientationType=0;this.verticalAlignment=1;this.loopsLayoutMode=a.common.LoopsLayoutMode.Optimized;this.arrowsDirection=0;this.showExtraArrows=!0;this.extraArrowsMinimumSpace=30;this.groupByType=2;this.alignBylevels=!0;this.enableMatrixLayout=!1;this.minimumMatrixSize=
...
getConnectorsStacksSizes:function(a){return n[a]||r}}};a.famdiagram.RemoveLoopsTask=function(c,b,e){function d(b,c,f,d,e){var h,m=g(c,f);c=[];1<m.length&&b==a.common.LoopsLayoutMode.Optimized&&(m=a.common.getFamilyLoops(f,e));var k=[],q={};b=0;for(e=m.length;b<e;b+=1){var l=m[b];q.hasOwnProperty(l.to)?q[l.to].parents.push(l.from):(q[l.to]={itemid:l.to,parents:[l.from]},k.push(q[l.to]))}m={};if(0<k.length)for(f=f.clone(),b=0,e=k.length;b<e;b+=1){var p=k[b];q=p.parents;var n=[];f.loopParents(this,p.itemid,
function(a,b){n.push(a);return f.SKIP});var B=0;for(h=n.length;B<h;B+=1)f.removeChildRelation(n[B],p.itemid);d+=1;l=n.length<=q.length;l=new a.famdiagram.FamilyItem({id:d,isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:l,hideChildrenConnection:l,levelGravity:2,itemConfig:{title:"fake parent #"+d,description:"This is fake parent item was created by loops reversal."}});f.add([],l.id,l);f.adopt([l.id],p.itemid);B=0;for(h=q.length;B<h;B+=1){var F=q[B];p=m[F];null==p&&(d+=1,p=new a.famdiagram.FamilyItem({id:d,
isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,levelGravity:1,itemConfig:{title:"fake child #"+d,description:"This is fake child item was created by loops reversal."}}),m[F]=p,f.add([F],p.id,p));f.adopt([l.id],p.id);c.push({from:l.id,to:p.id})}p={};B=0;for(h=q.length;B<h;B+=1)p[q[B]]=!0;B=0;for(h=n.length;B<h;B+=1)p.hasOwnProperty(n[B])||f.adopt([n[B]],l.id)}return{maximumId:d,logicalFamily:f,loops:c}}function g(a,b){var c,f,d=[];var e=b.clone();b.loopTopo(this,
function(a,b,c){e.removeNode(a)});if(e.hasNodes())for(b=0,c=a.length;b<c;b+=1){var h=a[b];if(null!=e.node(h.id)){var g=[];e.loopParents(this,h.id,function(a,b,c){g.push(a);d.push({from:a,to:h.id});return e.SKIP});var k=0;for(f=g.length;k<f;k+=1)e.removeRelation(g[k],h.id);var l=[];e.loopTopo(this,function(a,b,c){l.push(a)});k=0;for(f=l.length;k<f;k+=1)e.removeNode(l[k])}}return d}var f=null,h=null,k=[];return{process:function(a){var g=e.getLogicalFamily(),m=e.getMaximumId(),q=c.getItems(),l=b.getOptions().loopsLayoutMode;
m=d(l,q,g,m,a);f=m.logicalFamily;h=m.maximumId;k=m.loops;if(a&&!g.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return f},getMaximumId:function(){return h},getLoops:function(){return k}}};a.famdiagram.UserDefinedNodesOrderTask=function(c){var b=null,e=null,d=new a.famdiagram.UserDefinedNodesOrder;return{process:function(){var a=c.getOptions();a=d.getUserDefinedPositions(a.items);b=a.position;e=a.group;return!0},getPositions:function(){return b},
getGroups:function(){return e}}};a.famdiagram.Control=function(c,b){return a.orgdiagram.BaseControl(c,b,a.famdiagram.TaskManagerFactory,a.famdiagram.EventArgsFactory,{AnnotationLabelTemplate:a.common.AnnotationLabelTemplate,ButtonsTemplate:a.common.ButtonsTemplate,CheckBoxTemplate:a.common.CheckBoxTemplate,CursorTemplate:a.common.CursorTemplate,DotHighlightTemplate:a.common.DotHighlightTemplate,GroupTitleTemplate:a.common.GroupTitleTemplate,HighlightTemplate:a.common.HighlightTemplate,ItemTemplate:a.common.ItemTemplate,
UserTemplate:a.common.UserTemplate,LabelAnnotationTemplate:a.common.LabelAnnotationTemplate})};a.famdiagram.EventArgsFactory=function(c,b,e,d){var g=new a.famdiagram.EventArgs,f=c.tasks.getTask("CombinedContextsTask"),h=c.tasks.getTask("AlignDiagramTask"),k=c.tasks.getTask("LogicalFamilyTask");b=f.getConfig(b);var l=f.getConfig(e),n=k.getLogicalFamily();b&&null!=b.id&&(g.oldContext=b);l&&null!=l.id&&(g.context=l,n.loopParents(this,l.id,function(a,b,c){if(0<c)return n.BREAK;g.parentItems.push(f.getConfig(a))}),
n.loopChildren(this,l.id,function(a,b,c){if(0<c)return n.BREAK;g.childrenItems.push(f.getConfig(a))}),k=a.common.getElementOffset(c.layout.mousePanel),c=a.common.getElementOffset(c.layout.element),e=h.getItemPosition(e),g.position=(new a.common.Rect(e.actualPosition)).translate(k.left,k.top).translate(-c.left,-c.top));null!=d&&(g.name=d);return g};a.famdiagram.getProcessDiagramConfig=function(){var c=function(){};return a.famdiagram.TaskManagerFactory(c,c,c).getProcessDiagramConfig()};a.famdiagram.TaskManagerFactory=
function(c,b,e,d,g){var f=new a.common.TaskManager;f.addDependency("options",c);f.addDependency("graphics",b);f.addDependency("getLayout",e);f.addDependency("setLayout",d);f.addDependency("templates",g);f.addDependency("defaultConfig",new a.famdiagram.Config);f.addDependency("defaultItemConfig",new a.famdiagram.ItemConfig);f.addDependency("defaultTemplateConfig",new a.famdiagram.TemplateConfig);f.addDependency("defaultButtonConfig",new a.famdiagram.ButtonConfig);f.addDependency("defaultPaletteItemConfig",
new a.famdiagram.PaletteItemConfig);f.addDependency("defaultBackgroundAnnotationConfig",new a.famdiagram.BackgroundAnnotationConfig);f.addDependency("defaultConnectorAnnotationConfig",new a.famdiagram.ConnectorAnnotationConfig);f.addDependency("defaultHighlightPathAnnotationConfig",new a.famdiagram.HighlightPathAnnotationConfig);f.addDependency("defaultShapeAnnotationConfig",new a.famdiagram.ShapeAnnotationConfig);f.addDependency("defaultLabelAnnotationConfig",new a.famdiagram.LabelAnnotationConfig);
f.addDependency("isFamilyChartMode",!0);f.addDependency("showElbowDots",!0);f.addDependency("null",null);f.addDependency("foreground",2);f.addDependency("background",1);f.addTask("OptionsTask",["options"],a.famdiagram.OptionsTask,"#000000");f.addTask("LayoutOptionsTask",["getLayout","OptionsTask"],a.orgdiagram.LayoutOptionsTask,"#000000");f.addTask("CurrentControlSizeTask",["LayoutOptionsTask","ItemsSizesOptionTask"],a.orgdiagram.CurrentControlSizeTask,"#000000");f.addTask("CurrentScrollPositionTask",
["LayoutOptionsTask"],a.orgdiagram.CurrentScrollPositionTask,"#000000");f.addTask("CalloutOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.CalloutOptionTask,"#000080");f.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ConnectorsOptionTask,"#000080");f.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.ItemsOptionTask,"#000080");f.addTask("ItemsContentOptionTask",["OptionsTask","defaultItemConfig"],a.orgdiagram.ItemsContentOptionTask,
"#000080");f.addTask("RemoveLoopsOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.RemoveLoopsOptionTask,"#000080");f.addTask("SpousesOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.SpousesOptionTask,"#000080");f.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],a.orgdiagram.ItemsSizesOptionTask,"#000080");f.addTask("LabelsOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.LabelsOptionTask,"#000080");
f.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],a.orgdiagram.TemplatesOptionTask,"#000080");f.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.OrientationOptionTask,"#000080");f.addTask("VisualTreeOptionTask",["OptionsTask"],a.famdiagram.VisualTreeOptionTask,"#000080");f.addTask("MinimizedItemsOptionTask",["OptionsTask"],a.orgdiagram.MinimizedItemsOptionTask,"#000080");f.addTask("HideGrandParentsConnectorsOptionTask",
...
"defaultConfig"],a.orgdiagram.CursorItemOptionTask,"#000080");f.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.HighlightItemOptionTask,"#000080");f.addTask("SelectedItemsOptionTask",["OptionsTask"],a.orgdiagram.SelectedItemsOptionTask,"#000080");f.addTask("CursorSelectionPathModeOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.CursorSelectionPathModeOptionTask,"#000080");f.addTask("NeighboursSelectionModeOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.NeighboursSelectionModeOptionTask,
"#000080");f.addTask("SplitAnnotationsOptionTask",["OptionsTask"],a.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");f.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");f.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");f.addTask("ForegroundHighlightPathAnnotationOptionTask",
...
b,e,d,g){function f(b,c){var f=[];if(0==c.showLabels||1==c.showLabels)for(var d in b.treeItemsPositions)if(b.treeItemsPositions.hasOwnProperty(d)){var e=c.itemsOptions[d],h=b.treeItemsPositions[d],g=h.actualPosition;null!=e&&b.transform.transformRect(g.x,g.y,g.width,g.height,!0,this,function(b,d,g,m){switch(h.actualVisibility){case 1:if(0==c.showLabels){var k=new a.common.Label(b,d,g,m);k.weight=1E4;k.labelType=1;f.push(k)}break;case 2:case 3:k=e;var q=h,l=null;if(!a.common.isNullOrEmpty(k.label)){var n=
3;switch(k.showLabel){case 0:switch(c.showLabels){case 0:switch(q.actualVisibility){case 3:case 2:n=0}break;case 1:n=2}break;case 1:n=2}switch(n){case 0:var p=q.leftPadding+q.rightPadding;break;case 2:p=1E4;break;case 3:p=0}if(3!=n){var r=null!=k.labelSize?k.labelSize:c.labelSize;q=3!=k.labelOrientation?k.labelOrientation:3!=c.labelOrientation?c.labelOrientation:0;l=0!=k.labelPlacement?k.labelPlacement:0!=c.labelPlacement?c.labelPlacement:1;switch(q){case 0:var t=r.width;var u=r.height;break;case 1:case 2:u=
r.width,t=r.height}r=c.labelOffset;switch(l){case 0:case 1:var v=new a.common.Rect(b+g/2-t/2,d-r-u,t,u);switch(q){case 0:var w=0;var y=2;break;case 1:y=w=1;break;case 2:w=2,y=1}break;case 2:case 11:v=new a.common.Rect(b+g+r,d-r-u,t,u);switch(q){case 0:w=1;y=2;break;case 1:w=1;y=0;break;case 2:y=w=2}break;case 3:v=new a.common.Rect(b+g+r,d+m/2-u/2,t,u);switch(q){case 0:y=w=1;break;case 1:y=w=0;break;case 2:w=0,y=2}break;case 4:case 12:v=new a.common.Rect(b+g+r,d+m+r,t,u);switch(q){case 0:w=1;y=0;break;
case 1:w=2;y=0;break;case 2:w=1,y=2}break;case 5:v=new a.common.Rect(b+g/2-t/2,d+m+r,t,u);switch(q){case 0:y=w=0;break;case 1:w=2;y=1;break;case 2:y=w=1}break;case 6:case 10:v=new a.common.Rect(b-t-r,d+m+r,t,u);switch(q){case 0:w=2;y=0;break;case 1:y=w=2;break;case 2:w=1,y=0}break;case 7:v=new a.common.Rect(b-t-r,d+m/2-u/2,t,u);switch(q){case 0:w=2;y=1;break;case 1:w=0;y=2;break;case 2:y=w=0}break;case 8:case 9:switch(v=new a.common.Rect(b-t-r,d-r-u,t,u),q){case 0:y=w=2;break;case 1:w=1;y=2;break;
case 2:w=2,y=0}}b=w;l=new a.common.Label(v);l.labelType=n;l.weight=p;l.text=k.label;l.labelOrientation=q;l.horizontalAlignmentType=b;l.verticalAlignmentType=y}}k=l;null!=k&&f.push(k)}})}0==c.showLabels&&a.common.getCrossingRectangles(this,f,function(a,b){if(a.isActive&&b.isActive)switch(a.labelType){case 1:switch(b.labelType){case 0:b.isActive=!1;break;case 2:b.isActive=!1}break;case 2:switch(b.labelType){case 1:a.isActive=!1;break;case 0:b.isActive=!1}break;case 0:switch(b.labelType){case 1:a.isActive=
...
w.loopChildren(this,a,function(g,k){var q=u.edge(a,g),l=null,t,w;h[g].processed=!0;if(1<q.weight){var v=q.items.join(",");if(d.hasOwnProperty(v))l=d[v];else{var y=c();H[y.id]=y;l=new p;l.id=y.id;l.key=v;v=0;for(t=q.items.length;v<t;v+=1){var x=q.items[v];l.children.push(x);l.childrenHash[x]=!0;r[x]=!0}l.children.sort();d[l.key]=l;e[l.id]=l;n[l.id]=l;r[l.id]=l;var B=l.children.slice(0);f(this,b.replacementItem||a,function(a,b,c){l.childrenHash[a]||null==e[a]||(w=!0,f(this,a,function(a,b,c){if(!l.childrenHash[a])return w=
!1,1;if(!r.hasOwnProperty(a))return 2}),w&&B.push(a));return 2});m(b.replacementItem||a,B,l.id,y,G,J,C,z,!1);1>=(z[a]||0)&&null==b.replacementItem&&(b.replacementItem=l.id)}l.id!=g&&(B=l.children.slice(0),f(this,k.replacementItem||g,function(a,b,c){null==e[a]||l.childrenHash[a]||(w=!0,f(this,a,function(a,b,c){return l.childrenHash[a]?(r.hasOwnProperty(a),2):(w=!1,1)}),w&&B.push(a));return 2}),m(k.replacementItem||g,B,l.id,null,G,J,C,z,!1),1>=(z[g]||0)&&null==k.replacementItem&&(k.replacementItem=
l.id))}})})}h=n}}},eliminateManyToMany:function(a){var c,d;for(c in C)C.hasOwnProperty(c)&&1<(z[c]||0)&&b(this,C,c,function(b){1<(J[b]||0)&&(d=a(),q(c,[b],d.id,d))})},groupBy:function(a,b,c){if(null!=c){var d={};for(g in H){var f=z[g]||0;if(1>=(J[g]||0)&&1>=f){f=B(g);var e=D(g),h=f+" * "+e;d.hasOwnProperty(h)||(d[h]=new F(f,e));d[h].ids.push(g);d[h].nodes.push(H[g])}}for(h in d)if(d.hasOwnProperty(h)){var g=d[h];if(g.ids.length>=b&&c.call(a,g.parentid,g.childid,g.ids,g.nodes))break}}},getPlanarFamily:function(b){var c=
...
return 2});1==w(a)&&(c=D(a),1==y(c)&&(c=new u(a,c),q.push(c.key)))});h=[];for(v in k){var n=k[v];g=n.length;null!=h[g]?h[g].push(v):h[g]=[v]}g={};h.unshift(q);for(var p=0,r=h.length;p<r;p+=1){var t=h[p];if(null!=t)for(d=0,e=t.length;d<e;d+=1){var v=t[d];if(!g.hasOwnProperty(v)){g[v]=!0;n=l[v];null==c.node(n.parentid)&&c.add(null,n.parentid,{});null==c.node(n.childid)?c.add([n.parentid],n.childid,{}):c.adopt([n.parentid],n.childid);n=k[v];v=0;for(var x=n.length;v<x;v+=1)g[n[v].key]=!0}}}});return c},
...
c,d){a.removeNode(b)});return a.hasNodes()},clone:x,BREAK:1,SKIP:2}};a.common.FamilyAlignment=function(c,b,e,d){function g(b,c){var d=b[c];null==d&&(d=new a.common.FamilyMargins,b[c]=d);return d}function f(a,b,c,d,f,e,g,k){var m=e,l=e;c.loopSiblings(this,b,function(a){a=g.getItemPosition(a);m=Math.min(m,a);l=Math.max(l,a)});for(var q=e-1;q>=m;--q){var n=g.getItemAtPosition(d,q);if(!a.hasOwnProperty(n)){var p=g.getItemAtPosition(d,q+1);a[n]=a[p]-(h[n]/2+(k[p]||0)+h[p]/2)}}for(q=e+1;q<=l;q+=1)n=g.getItemAtPosition(d,
q),a.hasOwnProperty(n)||(p=g.getItemAtPosition(d,q-1),a[n]=a[p]+(h[p]/2+(k[n]||0)+h[n]/2));n=g.getItemAtPosition(d,m);p=a[n]-h[n]/2;n=g.getItemAtPosition(d,l);p+=a[n]+h[n]/2;p/=2;l=m=null;c.loopNonSiblings(this,b,function(a){a=g.getItemPosition(a);m=null!=m?Math.min(m,a):a;l=null!=l?Math.max(l,a):a});c=0;for(q=m;q<=l;q+=1)b=g.getItemAtPosition(f,q),c+=h[b],q>m&&(c+=k[b]||0);q=p-c/2;b=g.getItemAtPosition(f,m);a.hasOwnProperty(b)||(a[b]=q+h[b]/2);for(q=m+1;q<=l;q+=1)b=g.getItemAtPosition(f,q),a.hasOwnProperty(b)||
(p=g.getItemAtPosition(f,q-1),a[b]=a[p]+(h[p]/2+(k[b]||0)+h[b]/2))}var h={};null!=d&&e.loopItems(this,function(a,b,f,e,g){h[a]=d.call(c,a,b)});var k=function(b,c){var d={},f={},e=null;c.loopLevelsReversed(this,function(m,k){k=new a.common.FamilyMargins;null!=e&&(e.add(0,Number.MAX_VALUE),k.merge(e,0));var l=e=k;c.loopLevelItems(this,m,function(a,e,m){var k=g(f,a);k.add(h[a],m);switch(b.countParents(a)){case 0:null!=l&&(d[a]=l.attach(k));break;case 1:b.loopParents(this,a,function(c,e,h){c=g(f,c);d[a]=
...
0;for(t=p.length;r<t;r+=1)u=p[r],v=n[u],v.remove(q.index)&&(delete n[u],l.remove(u));f(l,p[0],p[1],q.index,q.rect)}}}};a.common.Edge=function(a,b){this.from=a;this.to=b};a.common.getFamilyLoops=function(c,b){var e=[],d,g=c.clone();c.loopTopo(this,function(a){g.removeNode(a)});c.loopTopoReversed(this,function(a){g.removeNode(a)});var f=g.clone();f.loop(this,function(b){null!=g.node(b)&&f.loopParents(this,b,function(c){e.push(new a.common.Edge(c,b));g.removeChildRelation(c,b);return f.SKIP});var c=
...
f;d+=1){var g=e[d];if(b<=g.maximum||d==f-1){c.context=a;g.quadTree.addPoint(c);break}}},loopArea:function(b,c,d){if(null!=d)for(var f=0,g=e.length;f<g;f+=1){var h=e[f],k=new a.common.Rect(c);k.offset(h.maximum/2);h.quadTree.loopArea(this,k,function(a){a=a.context;if(c.overlaps(a))return d.call(b,a)})}},validate:function(){for(var a=!0,b=0,c=e.length;b<c;b+=1){var d=e[b];a=a&&d.quadTree.validate()}return a},getPositions:function(a){for(var b=[],c=0,d=e.length;c<d;c+=1)b=b.concat(e[c].quadTree.getPositions(a));
return b}}};a.common.tree=function(c){function b(a,b,c){var d;if(null!=f[b]&&(b=k[b],null!=b)){var e=0;for(d=b.length;e<d;e+=1){var g=b[e];if(c.call(a,g,f[g],e,d-1))break}}}function e(a){var b=null;null!=h[a]&&(b=h[a]);return b}function d(a,b){var c,d=a.length;for(c=0;c<d;c+=1)if(a[c]==b)return a.splice(c,1),d-1;return d}function g(a,c,d){if(null!=d&&f.hasOwnProperty(c)){var g=e(c);null!=g&&d.call(a,g,f[g])||(b(a,g,function(b,e){b!=c&&d.call(a,b,e)}),b(a,c,function(b,c){d.call(a,b,c)}))}}var f={},
h={},k={},l={},n={};(function(b){a.common.isObject(b)&&(f=a.common.cloneObject(b.nodes,!0),h=a.common.cloneObject(b.parents,!0),k=a.common.cloneObject(b.children,!1),l=a.common.cloneObject(b.roots,!1),n=a.common.cloneObject(b.rootChildren,!0))})(c);return{loop:function(a,b){var c;if(null!=b)for(c in f)if(f.hasOwnProperty(c)&&b.call(a,c,f[c]))break},loopLevels:function(a,b,c){var d=0,e=[],g;switch(arguments.length){case 2:var h=b;break;case 3:var l=b;h=c}if(null!=h){if(null==l)for(m in n)n.hasOwnProperty(m)&&
(e=e.concat(n[m]));else null!=k[l]&&(e=e.concat(k[l]));for(;0<e.length;){var m=[];var q=0;for(g=e.length;q<g;q+=1)switch(l=e[q],h.call(a,l,f[l],d)){case 1:m=[];break;case 2:break;default:null!=k[l]&&(m=m.concat(k[l]))}e=m;d+=1}}},loopParents:function(a,b,c,d){if(null!=f[b]&&null!=c&&(!0!==d||!c.call(a,b,f[b])))for(;null!=(b=h[b])&&!c.call(a,b,f[b]););},loopChildren:b,loopChildrenRange:function(a,b,c,d,e){var g;if(null!=f[b]&&(b=k[b],null!=b))if(c<d)for(c=Math.max(c,0),d=Math.min(d,b.length-1),g=c;g<=
d&&(c=b[g],!e.call(a,c,f[c],g,NaN));g+=1);else for(c=Math.min(c,b.length-1),d=Math.max(0,d),g=c;g>=d&&(c=b[g],!e.call(a,c,f[c],g,NaN));--g);},loopChildrenReversed:function(a,b,c){var d;if(null!=f[b]){b=k[b];var e=b.length-1;if(null!=b)for(d=e;0<=d;--d){var g=b[d];if(c.call(a,g,f[g],d,e))break}}},loopPostOrder:function(a,b){var c=[],d;if(null!=b){for(e in n)n.hasOwnProperty(e)&&(c=c.concat(n[e]));for(;0<c.length;){var e=c[c.length-1];if(e!=g&&null!=(d=k[e]))for(e=d.length-1;0<=e;--e)c.push(d[e]);else{c.pop();
...
!0),k=a.common.cloneObject(b.maximum,!0))})(c);return{addlevel:function(a,b){d(a).context=b},hasLevel:function(a){return null!=g[a]},hasItem:function(a){return f.hasOwnProperty(a)},addItem:function(a,b,c){if(f.hasOwnProperty(b)){var g=d(a);g.items.push(b);b=f[b];b.positions[a]=g.items.length-1;b.startLevel=Math.min(b.startLevel,a);b.endLevel=Math.max(b.endLevel,a)}else g=d(a),g.items.push(b),f[b]=new e(c,g.items.length-1,a)},getItemContext:function(a){var b=null;f.hasOwnProperty(a)&&(b=f[a].context);
