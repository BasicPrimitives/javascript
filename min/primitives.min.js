/*
 Basic Primitives Diagram v5.2.2
...
c}if("style"===d.toLowerCase()&&K.createStyleSheet)return ia(K.createStyleSheet(),a,b),null;var e=ia(O(d),a,b);aa(e);return e&&Z(b)?b(e):e}catch(g){try{return(Z(M.onerror)?M.onerror:ra)(g,a,b)}catch(h){return K.createTextNode("["+h+"]")}}};M.toHTMLText=function(a,b){var d=ba(a,b);if(d.outerHTML)return d.outerHTML;var c=O("div");c.appendChild(d);var e=c.innerHTML;c.removeChild(d);return e}}a.common.AdviserPlacementType={Auto:0,Left:2,Right:3};a.orgdiagram.AdviserPlacementType=a.common.AdviserPlacementType;
...
f.addSegment(new a.common.LineSegment(e)));f.addSegment(new a.common.LineSegment(k));null!==i?(f.addSegment(new a.common.LineSegment(i)),f.addSegment(new a.common.LineSegment(c))):f.addSegment(new a.common.QuadraticArcSegment(d,c))};a.common.ConnectorOffbeat=function(){};a.common.ConnectorOffbeat.prototype=new a.common.BaseShape;a.common.ConnectorOffbeat.prototype.draw=function(f,b,d,c,e,g,h,i,j,k,l,n,m,p){var q,r,u,s,v,t,z,x,m=g=0,B=null,y,w;y=f.getPolyline(b);v=[];switch(j){case 1:v=[-e/2,e/2];
w=!1;break;case 0:v=[0];w=!1;break;case 2:v=[0],w=!0}q=Math.max(n?h.width:0,5*e);if(d.right()+q<c.left()||d.left()>c.right()+q)if(d.left()>c.right()?(u=new a.common.Point(d.left(),d.verticalCenter()),s=new a.common.Point(c.right(),c.verticalCenter())):(u=new a.common.Point(d.right(),d.verticalCenter()),s=new a.common.Point(c.left(),c.verticalCenter())),n&&(d.left()>c.right()?(g=7,m=3):(g=3,m=7)),r=new a.common.Rect(u,s),x=u.y<=s.y,z=u.x<s.x,r.height<r.width){r.height<2*e&&r.offset(0,x?2*e:0,0,x?0:
2*e);i=0;for(q=v.length;i<q;i+=1)t=v[i],f.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new a.common.MoveSegment(u.x,u.y+t));c.addSegment(new a.common.QuadraticArcSegment(r.horizontalCenter(),(x?r.top():r.bottom())+t,s.x,s.y+t));w&&c.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))});n&&(j=h.width<2*(r.width/5)?a.common.QuadraticArcSegment.prototype.offsetPoint(u.x,u.y,r.horizontalCenter(),
x?r.top():r.bottom(),s.x,s.y,0.5):new a.common.Point(u.x,x?r.top():r.bottom()),B=new a.common.Rect(j.x+(z?e:-h.width-e),x?j.y-h.height-e:j.y+e,h.width,h.height))}else{i=0;for(q=v.length;i<q;i+=1)t=v[i],f.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new a.common.MoveSegment(u.x,u.y+t));c.addSegment(new a.common.QuadraticArcSegment(r.horizontalCenter()+t*(x!=z?1:-1),(x?r.top():r.bottom())+t,r.horizontalCenter()+t*(x!=z?1:-1),r.verticalCenter()+t));c.addSegment(new a.common.QuadraticArcSegment(r.horizontalCenter()+
t*(x!=z?1:-1),(x?r.bottom():r.top())+t,s.x,s.y+t));w&&c.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))});n&&(B=new a.common.Rect(r.horizontalCenter()+(x!=z?e:-(e+h.width)),r.verticalCenter()-h.height/2,h.width,h.height))}else if(d.verticalCenter()<c.top()||d.verticalCenter()>c.bottom()){z=d.x<i.width/2;u=new a.common.Point(z?d.right():d.left(),d.verticalCenter());s=new a.common.Point(z?
c.right():c.left(),c.verticalCenter());r=new a.common.Rect(u,s);r.offset(10*e,0,10*e,0);x=u.y<=s.y;i=0;for(q=v.length;i<q;i+=1)t=v[i],f.addInverted(function(d){d=d.getPolyline(b);d.addSegment(new a.common.MoveSegment(u.x,u.y+t));d.addSegment(new a.common.QuadraticArcSegment(z?r.right()+t*(x?-1:1):r.left()-t*(x?-1:1),r.verticalCenter(),z?c.right():c.left(),c.verticalCenter()-t));w&&d.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))});
n&&(m=g=z?3:7,j=a.common.QuadraticArcSegment.prototype.offsetPoint(u.x,u.y,z?r.right():r.left(),r.verticalCenter(),s.x,s.y,0.5),B=new a.common.Rect(j.x+(z?e/2:-e/2-h.width),j.y-h.height/2,h.width,h.height))}else{u=new a.common.Point(d.horizontalCenter(),d.top());s=new a.common.Point(c.horizontalCenter(),c.top());r=new a.common.Rect(u,s);r.offset(0,7*e,0,0);z=u.x<s.x;i=0;for(q=v.length;i<q;i+=1)t=v[i],f.addInverted(function(d){d=d.getPolyline(b);d.addSegment(new a.common.MoveSegment(u.x+t,u.y));d.addSegment(new a.common.QuadraticArcSegment(r.horizontalCenter(),
r.top()-t*(z?-1:1),c.horizontalCenter()-t,c.top()));w&&d.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))});n&&(m=g=1,j=a.common.QuadraticArcSegment.prototype.offsetPoint(u.x,u.y,r.horizontalCenter(),r.top(),s.x,s.y,0.5),B=new a.common.Rect(j.x-h.width/2,j.y-(k+h.height),h.width,h.height))}if(n)switch(l){case 0:B=this._getLabelPosition(d.x,d.y,d.width,d.height,B.width,B.height,k,g);break;
case 2:B=this._getLabelPosition(c.x,c.y,c.width,c.height,B.width,B.height,k,m)}null!=p&&p(B)};a.common.ConnectorStraight=function(){};a.common.ConnectorStraight.prototype=new a.common.BaseShape;a.common.ConnectorStraight.prototype.draw=function(f,b,d,c,e,g,h,i,j,k,l,n,m,p){var q,r,u,s,v,t=e/2,z=null,x=0,B=0,y=this;s=new a.common.Vector(d.centerPoint(),c.centerPoint());d.loopEdges(function(a,b){q=a.getIntersectionPoint(s,!0,1);x=b;return null!=q});c.loopEdges(function(a,b){r=a.getIntersectionPoint(s,
!0,1);B=b;return null!=r});if(null!=q&&null!=r){var w=new a.common.Vector(q,r);m.getOffset(w,function(c,d,e){w.offset((c*g-(d-1)*g/2)*e);q=w.from;r=w.to;switch(j){case 1:v=new a.common.Vector(r.clone(),q.clone());v.offset(t);y._drawLine(f,b,v.from,v.to,!1);v=new a.common.Vector(q.clone(),r.clone());v.offset(t);y._drawLine(f,b,v.from,v.to,!1);break;case 0:y._drawLine(f,b,q,r,!1);break;case 2:y._drawLine(f,b,q,r,!0)}if(n){switch(l){case 0:z=y._getLabelPositionBySnapPoint(q.x,q.y,h.width,h.height,k,
x);break;case 1:u=y._betweenPoint(q,r);z=y._getLabelPositionBySnapPoint(u.x,u.y,h.width,h.height,k,3);break;case 2:z=y._getLabelPositionBySnapPoint(r.x,r.y,h.width,h.height,k,B)}null!=p&&p.call(this,z)}})}};a.common.ConnectorStraight.prototype._drawLine=function(f,b,d,c,e){var g;f.addInverted(function(e){g=e.getPolyline(b);g.addSegment(new a.common.MoveSegment(d));g.addSegment(new a.common.LineSegment(c));g.addArrow(b.lineWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))})},!1);e&&(g=f.getPolyline(b),
...
d,f));f+=1);}}function d(){return a.common.isNullOrEmpty(i.fillColor)}function c(b,f,c,d,e,i){for(var h=new a.common.Polyline(l),g,j,e=[new a.common.Point(e,-i/2),new a.common.Point(0,0),new a.common.Point(e,i/2),new a.common.Point(3*(e/4),0)],k=Math.atan2(f-d,b-c),b=0,f=e.length;b<f;b+=1)i=e[b],g=i.x*Math.cos(k)-i.y*Math.sin(k),j=i.x*Math.sin(k)+i.y*Math.cos(k),i.x=g+c,i.y=j+d;h.addSegment(new a.common.MoveSegment(e[0].x,e[0].y));h.addSegment(new a.common.LineSegment(e[1].x,e[1].y));h.addSegment(new a.common.LineSegment(e[2].x,
e[2].y));h.addSegment(new a.common.QuadraticArcSegment(e[3].x,e[3].y,e[0].x,e[0].y));return h}function e(a,b){this.segment=a;this.pointIndex=b}function g(b,f,c,d,i){var h=b.relateTo(f),g=i?0:c;2==h?f.offset(g):3==h&&0===f.from.context.pointIndex?(h=new a.common.LineSegment(f.from),d.addSegment(h),f.offset(g),d=f.from.clone(),d.context=new e(h,0),g=new a.common.Vector(b.to.clone(),d),i||(f.from=d.clone()),g.offset(c),g.intersect(b),g.from.context.pushToSegment(g.from),f.intersect(g),i&&g.to.context.pushToSegment(g.to)):
(f.offset(g),f.intersect(b));f.from.context.pushToSegment(f.from)}function h(a,b,f,c){var d,e=a[0],i=e.to.context.segment.getEndPoint().toString();b.hasOwnProperty(i)&&(d=b[i],g(e,d,f,c,!0),delete b[i]);e.to.context.pushToSegment(e.to);a.length=0}var i=new a.common.PaletteItem,j=[],k,l;switch(arguments.length){case 1:i=f}l=new a.common.PaletteItem({lineColor:i.lineColor,lineWidth:0,fillColor:i.lineColor,opacity:i.opacity||1});e.prototype.pushToSegment=function(a){this.segment.setPoint(a,this.pointIndex)};
...
f=!0),c.unshift(b),1<c.length&&(c[1].invert(c[0].getEndPoint()),j.push(c[1]),c.length=1))}):b.mergeTo(k)},addArrow:function(b,f){var d,e,i,h;e=j.length;h=3*b;var g=2*b;switch(b){case 1:h=8;g=6;break;case 2:h=12;g=8;break;case 3:h=16,g=10}null!=f&&1<e&&(d=j[e-2].getEndPoint(),i=j[e-1],null!=i.trim&&(e=new a.common.Point(i.getEndPoint()),d=i.trim(d,g),h=c(d.x,d.y,e.x,e.y,h,g),f(h,d)))},addOffsetArrow:function(b,f,d,e,i){var h,g,l;h=j.length;l=3*f;var k=2*f,z;switch(f){case 1:l=8;k=6;break;case 2:l=
12;k=8;break;case 3:l=16,k=10}null!=i&&1<h&&(f=j[h-2].getEndPoint(),g=j[h-1],null!=g.offsetPoint&&(h=new a.common.Point(g.getEndPoint()),z=f.distanceTo(h),z>e&&(d*=z,b?(b=g.offsetPoint(f,h,d),l=c(f.x,f.y,b.x,b.y,l,k)):(b=g.offsetPoint(h,f,d),l=c(h.x,h.y,b.x,b.y,l,k)),i(l))))},optimizeMoveSegments:function(){var a,b,f,c,d;f={};var e=[],i=[];a=0;for(b=j.length;a<b-1;a+=1)switch(c=j[a],d=j[a+1],c.segmentType){case 0:case 2:case 3:switch(d.segmentType){case 1:case 4:c=c.x+"&"+c.y,f.hasOwnProperty(c)||
(f[c]=a)}break;case 1:c=c.x+"&"+c.y,f.hasOwnProperty(c)&&!e[f[c]]&&(e[f[c]]=a+1,i[a]=!0)}d=[];for(a=0;a<b;a+=1)if(!i[a]&&(c=j[a],d.push(c),i[a]=!0,0<e[a]))for(f=e[a];f<b&&!i[f];)c=j[f],d.push(c),i[f]=!0,f=0<e[f]?e[f]:f+1;j=d},getOffsetPolyine:function(f){var c=new a.common.Polyline(i),d={},l=[],j=[];b(this,function(b){var i=b.clone();switch(i.segmentType){case 4:case 1:0<j.length&&h(j,d,f,c);l.length=0;1==i.segmentType&&(b=new a.common.Point(i),b.context=new e(i,0),l.push(b));break;default:i.loop(this,
function(b,h,k){b=new a.common.Point(b,h);b.context=new e(i,k);l.unshift(b);1<l.length&&(j.unshift(new a.common.Vector(l[1].clone(),l[0].clone())),l.length=1);switch(j.length){case 1:k=j[0];b=k.from.toString();d[b]=k;k.offset(f);k.from.context.pushToSegment(k.from);break;case 2:b=j[1],k=j[0],g(b,k,f,c,!1),j.length=1}})}c.addSegment(i)});0<j.length&&h(j,d,f,c);return c},toString:function(){return i.toString()},getStartPoint:function(){var a=null;0<j.length&&(a=j[0].getEndPoint());return a},getEndPoint:function(){var a=
null;0<j.length&&(a=j[j.length-1].getEndPoint());return a},clone:function(){var b,f,c=new a.common.Polyline(i),d=[],e;b=0;for(f=j.length;b<f;b+=1)e=j[b],d.push(e.clone());c.addSegments(d);return c}}};a.common.PolylinesBuffer=function(){function f(b,f){b[f.toString()]||(b[f.toString()]=new a.common.Polyline(f));return b[f.toString()]}function b(a,b){var f,h;if(null!=b)for(f in d)if(d.hasOwnProperty(f)&&(h=d[f]))if(h.optimizeMoveSegments(),b.call(a,h))break}var d={};return{getPolyline:function(a){return f(d,
a)},loop:b,addInverted:function(a,e){var g,h;g=d;d={};null!=a&&a(this);b(this,function(a){h=f(g,a.paletteItem);e?a.mergeTo(h):h.addInverted(a)});d=g},transform:function(a,f){b(this,function(b){b.transform(a,f)})}}};a.common.QuadraticArcSegment=function(a,b,d,c){this.cpY=this.cpX=this.y=this.x=null;switch(arguments.length){case 2:this.x=b.x;this.y=b.y;this.cpX=a.x;this.cpY=a.y;break;case 4:this.cpX=a,this.cpY=b,this.x=d,this.y=c}this.segmentType=2};a.common.QuadraticArcSegment.prototype.clone=function(){return new a.common.QuadraticArcSegment(this.cpX,
...
b){var d=this;a.transformPoints(d.x,d.y,d.cpX,d.cpY,b,d,function(a,b,f,h){d.x=a;d.y=b;d.cpX=f;d.cpY=h})};a.common.QuadraticArcSegment.prototype.trim=function(a,b){var d=0.5,c=this.offsetPoint(this.x,this.y,this.cpX,this.cpY,a.x,a.y,d),e=this.offsetPoint(this.x,this.y,this.cpX,this.cpY,a.x,a.y,0.1),d=b*(d/c.distanceTo(this.x,this.y)+0.1/e.distanceTo(this.x,this.y))/2,c=this.offsetPoint(this.x,this.y,this.cpX,this.cpY,a.x,a.y,d);this.x=c.x;this.y=c.y;return this};a.common.QuadraticArcSegment.prototype.offsetPoint=
...
a.common.Graphics.prototype._getTextAlign=function(a){var b=null;switch(a){case 0:b="center";break;case 1:b="left";break;case 2:b="right"}return b};a.common.Graphics.prototype._getVerticalAlignment=function(a){var b=null;switch(a){case 1:b="middle";break;case 0:b="top";break;case 2:b="bottom"}return b};a.common.Graphics.prototype.polylinesBuffer=function(a){a.loop(this,function(a){0<a.length()&&this.polyline(a)})};a.common.Graphics.prototype.polyline=function(a){var b=null,d=null,c=a.paletteItem.toAttr();
a.loop(this,function(a){switch(a.segmentType){case 1:b=Math.round(a.x)+0.5;d=Math.round(a.y)+0.5;break;case 0:this.rightAngleLine(b,d,Math.round(a.x)+0.5,Math.round(a.y)+0.5,c);b=Math.round(a.x)+0.5;d=Math.round(a.y)+0.5;break;case 4:this.dot(a.x,a.y,a.width,a.height,a.cornerRadius,c)}})};a.common.Graphics.prototype.dot=function(f,b,d,c,e,g){var h=this.m_activePlaceholder,i=this.m_cache.get(h.name,h.activeLayer.name,"dot"),j=void 0!==g.lineWidth&&void 0!==g.borderColor,f={position:"absolute",width:d-
...
n.x=f+e;n.y=b+g;n.width=h-p;n.height=i-p;null==k?(k=this.getElementByTemplate(j),q=a.common.mergeObjects(q,{position:"absolute",padding:"0px",margin:"0px"},m),a.common.JsonML.applyStyles(k,q),n.element=k,n.renderingMode=0,null!==l&&l(null,n),d.activeLayer.canvas.appendChild(k),this.m_cache.put(d.name,d.activeLayer.name,c,k)):(n.element=k,n.renderingMode=1,a.common.JsonML.applyStyles(k,q),null!==l&&l(null,n));return k};a.common.Graphics.prototype.getElementByTemplate=function(f){var b=null;a.common.isArray(f)?
b=a.common.JsonML.toHTML(f):(b=document.createElement("div"),b.innerHTML=f,b=b.firstChild);return b};a.common.Graphics.prototype.getPxSize=function(a,b){var d=a;"string"===typeof a&&(d=0<a.indexOf("pt")?96*parseInt(a,10)/72:0<a.indexOf("%")?parseFloat(a)/100*b:parseInt(a,10));return d};a.common.Cache=function(){this.threshold=20;this.m_visible={};this.m_invisible={}};a.common.Cache.prototype.begin=function(){var a,b,d,c;for(a in this.m_visible)if(this.m_visible.hasOwnProperty(a))for(b in this.m_visible[a])if(this.m_visible[a].hasOwnProperty(b)){for(d=
this.m_visible[a][b].length-1;0<=d;d-=1)c=this.m_visible[a][b][d],c.style.visibility="hidden",this.m_invisible[a][b].push(c);this.m_visible[a][b].length=0}};a.common.Cache.prototype.end=function(){var a,b,d;for(a in this.m_visible)if(this.m_visible.hasOwnProperty(a))for(b in this.m_visible[a])if(this.m_visible[a].hasOwnProperty(b)&&this.m_invisible[a][b].length>this.threshold)for(;void 0!==(d=this.m_invisible[a][b].pop());)d.parentNode.removeChild(d)};a.common.Cache.prototype.reset=function(a,b){var a=
a+"-"+b,d=null,c,e;for(c in this.m_visible[a])if(this.m_visible[a].hasOwnProperty(c)){for(e=this.m_visible[a][c].length-1;0<=e;e-=1)d=this.m_visible[a][c][e],this.m_invisible[a][c].push(d),d.style.visibility="hidden";this.m_visible[a][c].length=0}};a.common.Cache.prototype.clear=function(){var a,b,d;for(a in this.m_visible)if(this.m_visible.hasOwnProperty(a))for(b in this.m_visible[a])if(this.m_visible[a].hasOwnProperty(b)){for(;void 0!==(d=this.m_visible[a][b].pop());)d.parentNode.removeChild(d);
for(;void 0!==(d=this.m_invisible[a][b].pop());)d.parentNode.removeChild(d)}};a.common.Cache.prototype.get=function(a,b,d){a=a+"-"+b;b=null;void 0===this.m_visible[a]&&(this.m_visible[a]={},this.m_invisible[a]={});void 0===this.m_visible[a][d]&&(this.m_visible[a][d]=[],this.m_invisible[a][d]=[]);b=this.m_invisible[a][d].pop()||null;null!==b&&(this.m_visible[a][d].push(b),b.style.visibility="inherit");return b};a.common.Cache.prototype.put=function(a,b,d,c){this.m_visible[a+"-"+b][d].push(c)};a.common.CanvasGraphics=
...
null));this.parent.clean.apply(this,arguments)};a.common.CanvasGraphics.prototype._activatePlaceholder=function(a){var b,d,c;this.parent._activatePlaceholder.apply(this,arguments);b=this.m_activePlaceholder;d=b.size.width;c=b.size.height;b.hasGraphics=d>this.m_maximum||c>this.m_maximum?!1:!0};a.common.CanvasGraphics.prototype.resizePlaceholder=function(a,b,d){var c,e;this.parent.resizePlaceholder.apply(this,arguments);for(c in a.layers)a.layers.hasOwnProperty(c)&&(e=a.layers[c],null!==e.canvascanvas&&
(e.canvascanvas.width=b,e.canvascanvas.height=d))};a.common.CanvasGraphics.prototype.begin=function(){var a,b,d,c,e,g;this.parent.begin.apply(this);for(a in this.m_placeholders)if(this.m_placeholders.hasOwnProperty(a))for(d in b=this.m_placeholders[a],e=b.size.width,g=b.size.height,b.layers)b.layers.hasOwnProperty(d)&&(c=b.layers[d],null!==c.canvascanvas&&c.canvascontext.clearRect(0,0,e,g))};a.common.Graphics.prototype._getContext=function(a,b){var d=a.size.width,c=a.size.height;null===b.canvascanvas&&
(b.canvascanvas=document.createElement("canvas"),b.canvascanvas.width=d,b.canvascanvas.height=c,this.prepend(a.activeLayer.canvas,b.canvascanvas),b.canvascontext=b.canvascanvas.getContext("2d"));return b.canvascontext};a.common.CanvasGraphics.prototype.reset=function(a,b){var d="none",c=-1,e,g;switch(arguments.length){case 1:"string"===typeof a?d=a:c=a;break;case 2:d=a,c=b}this.parent.reset.apply(this,arguments);e=this.m_placeholders[d];void 0!==e&&(d=e.size.width,g=e.size.height,c=e.layers[c],void 0!==
c&&null!==c.canvascanvas&&c.canvascontext.clearRect(0,0,d,g))};a.common.CanvasGraphics.prototype.polyline=function(a){var b=this.m_activePlaceholder,d,c,e=a.paletteItem.toAttr(),g,h;if(b.hasGraphics){d=b.activeLayer;c=this._getContext(b,d);c.save();void 0!==e.lineWidth&&void 0!==e.borderColor?(c.strokeStyle=e.borderColor,c.lineWidth=e.lineWidth):(c.lineWidth=0,c.strokeStyle="Transparent");if(null!=e.lineType){b=Math.round(e.lineWidth)||1;switch(e.lineType){case 0:g=[];break;case 1:g=[b,b];break;case 2:g=
[5*b,3*b]}void 0!==c.setLineDash?c.setLineDash(g):void 0!==c.webkitLineDash?c.webkitLineDash=g:void 0!==c.mozDash&&(c.mozDash=g)}c.beginPath();a.loop(this,function(a){switch(a.segmentType){case 1:c.moveTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5);break;case 0:c.lineTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5);break;case 4:a.width==a.height&&a.width/2<=a.cornerRadius?(c.moveTo(Math.round(a.x)+a.width+0.5,Math.round(a.y)+a.height/2+0.5),c.arc(Math.round(a.x)+a.width/2+0.5,Math.round(a.y)+a.height/2+0.5,
Math.round(a.width/2),0,2*Math.PI,!1)):0===a.cornerRadius?(c.moveTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5),c.lineTo(Math.round(a.x+a.width)+0.5,Math.round(a.y)+0.5),c.lineTo(Math.round(a.x+a.width)+0.5,Math.round(a.y+a.height)+0.5),c.lineTo(Math.round(a.x)+0.5,Math.round(a.y+a.height)+0.5),c.lineTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5)):(h=Math.min(a.cornerRadius,Math.min(a.width/2,a.height/2)),c.moveTo(Math.round(a.x)+0.5,Math.round(a.y+h)+0.5),c.arc(Math.round(a.x+h)+0.5,Math.round(a.y+h)+
0.5,Math.round(h),Math.PI,-Math.PI/2,!1),c.lineTo(Math.round(a.x+a.width-h)+0.5,Math.round(a.y)+0.5),c.arc(Math.round(a.x+a.width-h)+0.5,Math.round(a.y+h)+0.5,Math.round(h),-Math.PI/2,0,!1),c.lineTo(Math.round(a.x+a.width)+0.5,Math.round(a.y+a.height-h)+0.5),c.arc(Math.round(a.x+a.width-h)+0.5,Math.round(a.y+a.height-h)+0.5,Math.round(h),0,Math.PI/2,!1),c.lineTo(Math.round(a.x+h)+0.5,Math.round(a.y+a.height)+0.5),c.arc(Math.round(a.x+h)+0.5,Math.round(a.y+a.height-h)+0.5,Math.round(h),Math.PI/2,Math.PI,
!1),c.lineTo(Math.round(a.x)+0.5,Math.round(a.y+h)+0.5));break;case 2:c.quadraticCurveTo(Math.round(a.cpX)+0.5,Math.round(a.cpY)+0.5,Math.round(a.x)+0.5,Math.round(a.y)+0.5);break;case 3:c.bezierCurveTo(Math.round(a.cpX1)+0.5,Math.round(a.cpY1)+0.5,Math.round(a.cpX2)+0.5,Math.round(a.cpY2)+0.5,Math.round(a.x)+0.5,Math.round(a.y)+0.5)}});null!=e.opacity&&(c.globalAlpha=e.opacity);void 0!==e.lineWidth&&c.stroke();void 0!==e.fillColor&&(c.fillStyle=e.fillColor,c.fill());c.restore()}else this.parent.polyline.apply(this,
arguments)};a.common.Element=function(a,b){this.name=this.ns=null;this.attr={};this.style={};this.children=[];switch(arguments.length){case 1:this.name=a;break;case 2:this.ns=a,this.name=b}};a.common.Element.prototype.setAttribute=function(a,b){this.attr[a]=b};a.common.Element.prototype.appendChild=function(a){this.children[this.children.length]=a};a.common.Element.prototype.create=function(a){var b=null,d,c,b=null!==this.ns?document.createElementNS(this.ns,this.name):document.createElement(this.name);
for(d in this.attr)this.attr.hasOwnProperty(d)&&(void 0!==a?b[d]=this.attr[d]:b.setAttribute(d,this.attr[d]));for(d in this.style)this.style.hasOwnProperty(d)&&(b.style[d]=this.style[d]);for(c=0;c<this.children.length;c+=1)d=this.children[c],"string"===typeof d?b.appendChild(document.createTextNode(d)):b.appendChild(d.create(a));return b};a.common.Element.prototype.update=function(a,b){var d,c,e;for(d in this.style)this.style.hasOwnProperty(d)&&(c=this.style[d],a.style[d]!==c&&(a.style[d]=c));for(d in this.attr)this.attr.hasOwnProperty(d)&&
(c=this.attr[d],void 0!==b?a[d]!==c&&(a[d]=c):a.getAttribute(d)!==c&&a.setAttribute(d,c));d=this.children.length;for(c=0;c<d;c+=1)e=this.children[c],"string"===typeof e?a.innerHtml!==e&&(a.innerHtml=e):this.children[c].update(a.children[c],b)};a.common.Layer=function(a){this.name=a;this.svgcanvas=this.canvascanvas=this.canvas=null};a.common.Placeholder=function(a){this.name=a;this.layers={};this.div=this.rect=this.size=this.activeLayer=null;this.hasGraphics=!0};a.common.SvgGraphics=function(f){this.parent=
a.common.Graphics.prototype;this.parent.constructor.apply(this,arguments);this._svgxmlns="http://www.w3.org/2000/svg";this.graphicsType=0;this.hasGraphics=!0};a.common.SvgGraphics.prototype=new a.common.Graphics;a.common.SvgGraphics.prototype.clean=function(){var a,b,d,c;for(a in this.m_placeholders)if(this.m_placeholders.hasOwnProperty(a))for(d in b=this.m_placeholders[a],b.layers)b.layers.hasOwnProperty(d)&&(c=b.layers[d],null!==c.svgcanvas&&(c.svgcanvas.parentNode.removeChild(c.svgcanvas),c.svgcanvas=
null));this.parent.clean.apply(this,arguments)};a.common.SvgGraphics.prototype.resizePlaceholder=function(f,b,d){var c,e;this.parent.resizePlaceholder.apply(this,arguments);for(c in f.layers)f.layers.hasOwnProperty(c)&&(e=f.layers[c],null!==e.svgcanvas&&(a.common.JsonML.applyStyles(e.svgcanvas,{position:"absolute",width:b+"px",height:d+"px"}),e.svgcanvas.viewBox="0 0 "+b+" "+d))};a.common.SvgGraphics.prototype._getCanvas=function(){var f=this.m_activePlaceholder,b=f.activeLayer,d=f.rect;null===b.svgcanvas&&
(b.svgcanvas=document.createElementNS(this._svgxmlns,"svg"),b.svgcanvas.viewBox=d.x+" "+d.y+" "+d.width+" "+d.height,a.common.JsonML.applyStyles(b.svgcanvas,{width:d.width+"px",height:d.height+"px"}),this.prepend(f.activeLayer.canvas,b.svgcanvas));return b.svgcanvas};a.common.SvgGraphics.prototype.polyline=function(f){var b=this.m_activePlaceholder,d,c,e=f.paletteItem.toAttr(),g,h,i;d=new a.common.Element(this._svgxmlns,"path");void 0!==e.fillColor?(d.setAttribute("fill",e.fillColor),d.setAttribute("fill-opacity",
e.opacity)):d.setAttribute("fill-opacity",0);void 0!==e.lineWidth&&void 0!==e.borderColor?(d.setAttribute("stroke",e.borderColor),d.setAttribute("stroke-width",e.lineWidth),void 0!==e.opacity?d.setAttribute("stroke-opacity",e.opacity):d.setAttribute("stroke-opacity",1)):(d.setAttribute("stroke","transparent"),d.setAttribute("stroke-width",0));if(null!=e.lineType)switch(g=Math.round(e.lineWidth)||1,e.lineType){case 0:d.setAttribute("stroke-dasharray","");break;case 1:d.setAttribute("stroke-dasharray",
g+","+g);break;case 2:d.setAttribute("stroke-dasharray",5*g+","+3*g)}c="";f.loop(this,function(a){switch(a.segmentType){case 1:c+="M"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+0.5);break;case 0:c+="L"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+0.5);break;case 2:c+="Q"+(Math.round(a.cpX)+0.5)+" "+(Math.round(a.cpY)+0.5)+" "+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+0.5);break;case 4:a.width==a.height&&a.width/2<=a.cornerRadius?(h=a.width/2,c+="M"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+a.height/
2+0.5),c+="A"+h+" "+h+" 0 0 0 "+(Math.round(a.x+a.width)+0.5)+" "+(Math.round(a.y)+a.height/2+0.5),c+="A"+h+" "+h+" 0 0 0 "+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+a.height/2+0.5)):0===a.cornerRadius?(c+="M"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+0.5),c+="L"+(Math.round(a.x+a.width)+0.5)+" "+(Math.round(a.y)+0.5),c+="L"+(Math.round(a.x+a.width)+0.5)+" "+(Math.round(a.y+a.height)+0.5),c+="L"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y+a.height)+0.5),c+="L"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+
0.5)):(i=Math.min(a.cornerRadius,Math.min(a.width/2,a.height/2)),c+="M"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y+i)+0.5),c+="A"+Math.round(i)+" "+Math.round(i)+" 0 0 1 "+(Math.round(a.x+i)+0.5)+" "+(Math.round(a.y)+0.5),c+="L"+(Math.round(a.x+a.width-i)+0.5)+" "+(Math.round(a.y)+0.5),c+="A"+Math.round(i)+" "+Math.round(i)+" 0 0 1 "+(Math.round(a.x+a.width)+0.5)+" "+(Math.round(a.y+i)+0.5),c+="L"+(Math.round(a.x+a.width)+0.5)+" "+(Math.round(a.y+a.height-i)+0.5),c+="A"+Math.round(i)+" "+Math.round(i)+
" 0 0 1 "+(Math.round(a.x+a.width-i)+0.5)+" "+(Math.round(a.y+a.height)+0.5),c+="L"+(Math.round(a.x+i)+0.5)+" "+(Math.round(a.y+a.height)+0.5),c+="A"+Math.round(i)+" "+Math.round(i)+" 0 0 1 "+(Math.round(a.x)+0.5)+" "+(Math.round(a.y+a.height-i)+0.5),c+="L"+(Math.round(a.x)+0.5)+" "+(Math.round(a.y+i)+0.5));break;case 3:c+="C"+(Math.round(a.cpX1)+0.5)+" "+(Math.round(a.cpY1)+0.5)+" "+(Math.round(a.cpX2)+0.5)+" "+(Math.round(a.cpY2)+0.5)+" "+(Math.round(a.x)+0.5)+" "+(Math.round(a.y)+0.5)}});d.setAttribute("d",
c);f=this.m_cache.get(b.name,b.activeLayer.name,"path");null===f?(f=d.create(),d=this._getCanvas(),d.appendChild(f),this.m_cache.put(b.name,b.activeLayer.name,"path",f)):d.update(f)};a.common.Transform=function(){this.invertVertically=this.invertHorizontally=this.invertArea=!1;this.size=null};a.common.Transform.prototype.setOrientation=function(a){switch(a){case 0:this.invertVertically=this.invertHorizontally=this.invertArea=!1;break;case 1:this.invertHorizontally=this.invertArea=!1;this.invertVertically=
...
f[b])}};a.famdiagram.EdgeItem=function(a,b,d,c){this.values=[b,c];this[a]=0;this[d]=1};a.famdiagram.EdgeItem.prototype.getNear=function(a){return this.values[this[a]]};a.famdiagram.EdgeItem.prototype.getFar=function(a){return this.values[Math.abs(this[a]-1)]};a.famdiagram.EdgeItem.prototype.setNear=function(a,b){this.values[this[a]]=b};a.famdiagram.EdgeItem.prototype.setFar=function(a,b){this.values[Math.abs(this[a]-1)]=b};a.famdiagram.EdgeItem.prototype.toString=function(){return this.parent+","+
...
!1,b.minimumMatrixSize),maximumColumnsInMatrix:new a.common.ValueReader(["number"],!1,b.maximumColumnsInMatrix)});return{process:function(){var a={isChanged:!1,hash:c};d=e.read(d,f.getOptions(),"options",a);return a.isChanged},getOptions:function(){return d}}};a.famdiagram.OptionsTask=function(a){return{process:function(){return!0},getOptions:a,description:"Raw options."}};a.famdiagram.SpousesOptionTask=function(f){var b={},d={},c=new a.common.ObjectReader({items:new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["string",
...
!1;t.childIndex=0;h={};d=0;for(c=l.length;d<c;d+=1){p=x[l[d]];k={};u=t;s=0;g=p.links.concat(p.backLinks);for(e=0;e<g.length;e+=1)i=g[e],j=b.orgTree.node(i.toItem),b.orgTree.node(i.fromItem),!0===h[j.familyId]&&(q=p.items[0],r=j,r.level>=q.level&&b.orgTree.loopParents(this,r.id,function(a,b){r=b;if(b.level<q.level)return!0}),k[r.id]=k.hasOwnProperty(r.id)?k[r.id]+1:1,s<k[r.id]&&(u=r,s=k[r.id]));this.attachFamilyToOrgChart(b,f.defaultItemConfig,u,p);h[p.id]=!0}d=this.getExtraGravity(b);c=this.getGrandChildren(b);
this.balanceOrgTree(b.orgTree,d,c)}};a.famdiagram.FamilyBalance.prototype.getGrandChildren=function(a){var b={};a.orgTree.loopPostOrder(this,function(d,c,e){a.minimumLevel=null!=a.minimumLevel?Math.min(a.minimumLevel,c.level):c.level;a.maximumLevel=null!=a.maximumLevel?Math.max(a.maximumLevel,c.level):c.level;if(null!=e&&(b[e]||(b[e]={}),c=c.level-1,b[e][c]=b[e][c]?b[e][c]+1:1,null!=b[d]))for(c in b[d])b[d].hasOwnProperty(c)&&(b[e][c]=b[e][c]?b[e][c]+b[d][c]:b[d][c])});return b};a.famdiagram.FamilyBalance.prototype.balanceOrgTree=
function(f,b,d){var c,e,g,h,i,j,k,l,n,m,p;f.loopLevels(this,function(q,r){var u=a.common.graph(),s={},v=null,t;k=[];f.loopChildren(this,r.id,function(a,d,h){var g;null==v&&(v=d);s[d.id]={};if(b.hasOwnProperty(d.id))for(g in j=b[d.id],j)if(j.hasOwnProperty(g)){m=j[g];s[d.id][g]={};c=0;for(e=m.length;c<e;c+=1)i=m[c],t=i.commonParent==r.id?i.toParent:f.node(i.fromParent).childIndex<f.node(i.toParent).childIndex?"__right__":"__left__",d.id!=t&&(u.addEdge(d.id,t,{weight:0}),u.edge(d.id,t).weight+=1,null==
s[d.id][g][t]&&(s[d.id][g][t]=0),s[d.id][g][t]+=1)}0<h&&u.addEdge(d.id,v.id,{weight:0})});if(null!=v){p=[];u.getTotalWeightGrowthSequence(this,function(a){return a.weight},function(a){p.push(a)});0===p.length&&(p=[v.id]);l=this.balanceItems(p,"__left__","__right__",s,d);g=0;for(h=l.length;g<h;g+=1)n=f.node(l[g]),n.childIndex=g,k.push(n.id)}f.arrangeChildren(r.id,k)})};a.famdiagram.FamilyBalance.prototype.balanceItems=function(f,b,d,c,e){var g=[],h,i,j,k,l,n,m,p,q,r,u,s,v,t,z,x,B,y,w,A;i=new a.famdiagram.Slots;
i.add(new a.famdiagram.Slot(b));i.add(new a.famdiagram.Slot(null));i.add(new a.famdiagram.Slot(d));j=0;i.loop(function(a){j+=1;a.position=j});for(h=0;h<f.length;h+=1)if(k=f[h],k!=b&&k!=d)for(B in q=p=m=n=l=null,i.loop(function(a){var b,d,f,h;if(null==a.itemId){t=e[k];v=s=u=r=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(t&&null!=t[b]&&(r+=a.crossings[b]*t[b]),v+=a.crossings[b]);for(b in c[k])if(c[k].hasOwnProperty(b))for(d in f=c[k][b],f)f.hasOwnProperty(d)&&(h=i.getSlot(d),null!=h&&(h.position<
a.position?(r+=(a.left[b]||0)-(h.left[b]||0),s+=Math.abs(h.balance+1)):(r+=(a.right[b]||0)-(h.right[b]||0),s+=Math.abs(h.balance-1)),u+=Math.abs(h.position-a.position)));if(null==n||n>r||n==r&&(m>u||m==u&&(p>s||p==s&&q>v)))n=r,l=a,m=u,p=s,q=v}}),z=l.clone(),x=l.clone(),x.itemId=k,i.insertBefore(l,z),i.insertBefore(l,x),j=x.position=0,i.loop(function(a){var b,c;if(a.id!=x.id){c=e[k];for(b in c)c.hasOwnProperty(b)&&(a.left[b]=a.left[b]?a.left[b]+c[b]:c[b]);j+=1;a.position=j}},x),j=0,i.backwardLoop(function(a){var b,
c;if(a.id!=x.id){c=e[k];for(b in e[k])e[k].hasOwnProperty(b)&&(a.right[b]=a.right[b]?a.right[b]+c[b]:c[b]);j-=1;a.position=j}},x),c[k])if(c[k].hasOwnProperty(B))for(w in y=c[k][B],y)y.hasOwnProperty(w)&&(A=i.getSlot(w),null!=A&&(0>A.position?(A.balance+=1,x.balance-=1,i.backwardLoop(function(a){if(a.id!=x.id)if(a.id!=A.id)a.crossings[B]=a.crossings[B]?a.crossings[B]+y[w]:y[w];else return!0},x)):(A.balance-=1,x.balance+=1,i.loop(function(a){if(a.id!=x.id)if(a.id!=A.id)a.crossings[B]=a.crossings[B]?
a.crossings[B]+y[w]:y[w];else return!0},x))));i.loop(function(a){a=a.itemId;null!=a&&(a!=b&&a!=d)&&g.push(a)});return g};a.famdiagram.FamilyBalance.prototype.ExtraGravity=function(a){this.toParent=this.fromParent=this.commonParent=null;this.level=a};a.famdiagram.FamilyBalance.prototype.getExtraGravity=function(a){var b,d,c={},e,g,h,i;for(b in a.orgPartners)if(a.orgPartners.hasOwnProperty(b)){d=a.orgTree.node(b);h=a.orgPartners[b];e=0;for(g=h.length;e<g;e+=1)i=a.orgTree.node(h[e]),this.addExtraGravitiesForConnection(a.orgTree,
c,i,d)}return c};a.famdiagram.FamilyBalance.prototype.addExtraGravitiesForConnection=function(a,b,d,c){var e=new this.ExtraGravity(d.level),g=new this.ExtraGravity(c.level);a.zipUp(this,d.id,c.id,function(a,c,d,f){this.addExtraGravityForItem(b,a,e);this.addExtraGravityForItem(b,d,g);if(c==f)return e.commonParent=c,e.fromParent=a,e.toParent=d,g.commonParent=c,g.fromParent=d,g.toParent=a,!0})};a.famdiagram.FamilyBalance.prototype.addExtraGravityForItem=function(a,b,d){a.hasOwnProperty(b)||(a[b]={});
null==a[b][d.level]&&(a[b][d.level]=[]);a[b][d.level].push(d)};a.famdiagram.FamilyBalance.prototype.attachFamilyToOrgChart=function(a,b,d,c){for(var e=c.items[0],g=null,g=d,d=d.level+1;d<e.level;d+=1)a.maximumId+=1,g=this.createOrgItem(a.orgTree,b,a.maximumId,g.id,null,d,null),g.title="shift",g.isVisible=!1,g.isActive=!1,g.hideParentConnection=!0,g.hideChildrenConnection=!0,c.items.push(g);e.hideParentConnection=!0;a.orgTree.adopt(g.id,e.id,e)};a.famdiagram.FamilyBalance.prototype.extractOrgChart=
function(a,b,d,c,e,g,h,i){var j,k=[],l,n,a=b.node(a),k=this.createOrgItem(c,d,a.id,null,i.id,a.level,a.itemConfig);k.hideParentConnection=!0;k.isVisible=a.isVisible;k.isActive=a.isActive;k.hideParentConnection=a.hideParentConnection;k.hideChildrenConnection=a.hideChildrenConnection;i.items.push(k);h[a.id]=!0;a.familyId=i.id;for(k=this.extractChildren(a,b,d,c,e,g,h,i);0<k.length;){l=[];a=0;for(j=k.length;a<j;a+=1)n=k[a],l=l.concat(this.extractChildren(n,b,d,c,e,g,h,i));k=l}};a.famdiagram.FamilyBalance.prototype.extractChildren=
...
function(a,b){return Math.min(a,Math.ceil(Math.sqrt(b)))};a.famdiagram.MatrixLayout.prototype.measure=function(a){var b={treeItemsPositions:{},columns:[],rows:[]};this.measureItems(b,this.params,this.options,a);this.measureColumns(b,this.params,this.options);this.measureRows(b,this.params,this.options);this.data=b;return this.getLayoutSize(b)};a.famdiagram.MatrixLayout.prototype.measureItems=function(f,b,d,c){for(var e=0,g=b.items.length;e<g;e+=1){var h=b.items[e],i=h.id,j=new a.orgdiagram.TreeItemPosition,
k=b.isItemSelected(i)?1:!h.isVisible?4:0,h=b.getTemplateParams(i),k=0===k?c:k,h=this.getItemSize(k,b.cursorItemId==i,h,d);j.actualVisibility=k;j.actualSize=h.actualSize;j.contentPosition=h.contentPosition;f.treeItemsPositions[i]=j}};a.famdiagram.MatrixLayout.prototype.measureColumns=function(a,b,d){var c,e,g,h=this.getMatrixWidth(d.maximumColumnsInMatrix,b.items.length);e=0;for(g=b.items.length;e<g;e+=1){var i=a.treeItemsPositions[b.items[e].id];c=d.intervals[i.actualVisibility]/2;i.leftPadding=c;
i.rightPadding=c;var j=e%h;c=a.columns[j];null==c&&(c=new this.Column,a.columns[j]=c);c.depth=Math.max(c.depth,i.leftPadding+i.actualSize.width+i.rightPadding)}h=8*d.linesWidth;e=i=0;for(g=a.columns.length;e<g;e+=1){c=a.columns[e];if(0==e%2)switch(d.arrowsDirection){case 1:c.leftPadding=b.hideChildrenConnection?0:h;c.rightPadding=0;break;case 2:c.leftPadding=0,c.rightPadding=b.hideParentConnection?0:h}else switch(d.arrowsDirection){case 1:c.leftPadding=0;c.rightPadding=b.hideChildrenConnection?0:
h;break;case 2:c.leftPadding=b.hideParentConnection?0:h,c.rightPadding=0}c.offset=i+c.leftPadding+c.depth/2;i=c.offset+c.depth/2+c.rightPadding}};a.famdiagram.MatrixLayout.prototype.measureRows=function(a,b,d){var c,e,g,h=this.getMatrixWidth(d.maximumColumnsInMatrix,b.items.length);c=0;for(e=b.items.length;c<e;c+=1){var i=a.treeItemsPositions[b.items[c].id],j=Math.floor(c/h),k=d.shifts[i.actualVisibility]/2;g=a.rows[j];null==g&&(g=new this.Row,a.rows[j]=g);g.depth=Math.max(g.depth,k+i.actualSize.height+
k);switch(i.actualVisibility){case 2:case 3:case 4:g.dotsDepth=!g.dotsDepth?i.actualSize.height:Math.min(g.dotsDepth,i.actualSize.height);break;default:g.minimalDepth=!g.minimalDepth?i.actualSize.height:Math.min(g.minimalDepth,i.actualSize.height)}}c=b=0;for(e=a.rows.length;c<e;c+=1)switch(g=a.rows[c],g.offset=b+g.depth/2,b=g.offset+g.depth/2,null==g.minimalDepth&&(g.minimalDepth=g.depth),null!=g.dotsDepth&&g.dotsDepth>g.minimalDepth&&(g.minimalDepth=g.dotsDepth),d.verticalAlignment){case 0:g.horizontalConnectorsDepth=
g.minimalDepth/2;break;case 1:g.horizontalConnectorsDepth=g.depth/2;break;case 2:g.horizontalConnectorsDepth=g.depth-g.minimalDepth/2}};a.famdiagram.MatrixLayout.prototype.getLayoutSize=function(f){return new a.common.Rect(0,0,Math.round(this.getLayoutWidth(f)),Math.round(this.getLayoutHeight(f)))};a.famdiagram.MatrixLayout.prototype.getLayoutWidth=function(a){var b=0,d=a.columns.length;0<d&&(a=a.columns[d-1],b=a.offset+a.depth/2+a.rightPadding);return b};a.famdiagram.MatrixLayout.prototype.getLayoutHeight=
function(a){var b=0,d=a.rows.length;0<d&&(a=a.rows[d-1],b=a.offset+a.depth/2);return b};a.famdiagram.MatrixLayout.prototype.arrange=function(a,b,d){if(null!=d)for(var c=this.getMatrixWidth(this.options.maximumColumnsInMatrix,this.params.items.length),e=0,g=this.params.items.length;e<g;e+=1){var h=this.params.items[e].id,i=this.data.columns[e%c],j=this.data.rows[Math.floor(e/c)],k=this.data.treeItemsPositions[h],l=this.getItemPosition(k.actualVisibility,i,j,k.actualSize,this.options);l.translate(b.x,
b.y);k.actualPosition=l;k.horizontalConnectorsShift=b.y+j.offset-j.depth/2+j.horizontalConnectorsDepth;k.leftMedianOffset=i.depth/2+i.leftPadding;k.rightMedianOffset=i.depth/2+i.rightPadding;k.topConnectorShift=j.depth/2;k.bottomConnectorShift=j.depth/2;d.call(a,h,k)}};a.famdiagram.MatrixLayout.prototype.getItemPosition=function(f,b,d,c,e){var g=0;switch(f){case 1:switch(e.verticalAlignment){case 0:g=0;break;case 1:g=(d.depth-c.height)/2;break;case 2:g=d.depth-c.height}break;case 2:case 3:case 4:g=
d.horizontalConnectorsDepth-c.height/2}return new a.common.Rect(b.offset-c.width/2,d.offset-d.depth/2+g,c.width,c.height)};a.famdiagram.CursorNeighboursTask=function(f,b,d,c){function e(a,b,c,d){var e=[],f={};if(null!==a)switch(b){case 0:c.loopParents(this,a,function(a){f.hasOwnProperty(a)||(f[a]=!0,e.push(a));if(d.hasOwnProperty(a))return c.SKIP});c.loopChildren(this,a,function(a){f.hasOwnProperty(a)||(f[a]=!0,e.push(a));if(d.hasOwnProperty(a))return c.SKIP});break;case 1:c.loopNeighbours(this,a,
function(a){f.hasOwnProperty(a)||(f[a]=!0,e.push(a));if(d.hasOwnProperty(a))return!0})}return e}var g=[],h={},i=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:h},k=f.getCursorTreeItem(),l=d.getNavigationFamily(),n=b.getNeighboursSelectionMode(),m=c.getActiveItems();g=i.read(g,e(k,n,l,m),"items",a);return a.isChanged},getItems:function(){return g}}};a.famdiagram.AddLabelAnnotationsTask=function(f,b){function d(b,c){var d=
a.common.graph(),e={},f,l,n,m;if(0<c.length){m=0;for(f=c.length;m<f;m+=1)l=c[m],e.hasOwnProperty(l.fromItem)?e[l.fromItem].push(l):(e[l.fromItem]=[l],b.loopChildren(this,l.fromItem,function(c){d.addEdge(l.fromItem,c,new a.famdiagram.EdgeItem(l.fromItem,l.fromItem,c,c));return b.SKIP}),b.loopParents(this,l.fromItem,function(c){d.addEdge(c,l.fromItem,new a.famdiagram.EdgeItem(c,c,l.fromItem,l.fromItem));return b.SKIP}));for(n in e)if(e.hasOwnProperty(n)){f=e[n];f.sort(function(a,b){return b.toItems.length-
a.toItems.length});for(m=0;m<f.length;m+=1){l=f[m];for(var p=b,q=d,r=l.fromItem,u=l.toItems,s=void 0,v=!0,t=null,z=void 0,x=void 0,B=void 0,y=void 0,w=[],x=0,B=u.length;x<B;x+=1)if(z=u[x],s=q.edge(r,z),null!=s){if(null==t)t=s.getFar(z);else if(t!=s.getFar(z)){v=!1;break}w.push(s.getNear(z))}else{v=!1;break}if(v&&(y=new a.famdiagram.FamilyItem({id:l.id,isVisible:!0,isLevelNeutral:!0,isActive:!1,itemConfig:l}),p.bundleParents(t,w,y.id,y)?(y.levelGravity=2,v=!0):p.bundleChildren(t,w,y.id,y)?(y.levelGravity=
1,v=!0):p.bundleParents(t,u,y.id,y)?(y.levelGravity=2,v=!0):p.bundleParents(t,u,y.id,y)&&(y.levelGravity=1,v=!0),v)){x=0;for(B=u.length;x<B;x+=1)z=u[x],s=q.edge(r,z),s.setFar(z,y.id)}}}}}var c=null,e=null;return{process:function(a){var h=b.getLogicalFamily(),i=f.getAnnotations(),h=h.clone();d(h,i);c=h;e=f.getMaximumId();if(a&&!h.validate())throw"References are broken in family structure!";return!0},getNavigationFamily:function(){return c},getMaximumId:function(){return e}}};a.famdiagram.AddSpousesTask=
function(f,b){var d=null,c=null;return{process:function(e){var g=b.getLogicalFamily(),h=b.getMaximumId(),i=f.getItems(),j=g=g.clone(),k,l,n,m,p,q,r,u;n=0;for(m=i.length;n<m;n+=1){p=i[n];u=p.spouses.slice(0);q=0;for(r=u.length;q<r;q+=1)k=[p.id,u[q]],j.hasCommonChild(k)||(h+=1,l=new a.famdiagram.FamilyItem({id:h,isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+h,description:"This is fake child keeps spouses together."},levelGravity:1}),
j.add(k,l.id,l))}d=g;c=h;if(e&&!g.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return c}}};a.famdiagram.ItemsPositionsTask=function(f,b,d,c,e,g,h,i,j,k){var l={},n=null;return{process:function(){var m=c.getOptions(),p=e.getOptions(),q=g.getOptions(),r={logicalFamily:h.getLogicalFamily(),treeLevels:h.getTreeLevels(),getConnectorsStacksSizes:h.getConnectorsStacksSizes,isItemSelected:k.isItemSelected,cursorItemId:j.getCursorTreeItem(),
...
getTemplateParams:r.getTemplateParams,hideParentConnection:v.hideParentConnection,hideChildrenConnection:v.hideChildrenConnection},m))}n=q.measure(p);l={};q.arrange(this,function(a,b){l[a]=b});return!0},getItemsPositions:function(){return l},getItemPosition:function(a){return l[a]},getContentSize:function(){return n}}};a.famdiagram.LevelsTask=function(f,b){var d={maximumId:null,treeLevels:null,bundles:null,connectorStacks:null},c=new a.famdiagram.FamilyBalance,e=new a.orgdiagram.TreeLevelConnectorStackSize;
return{process:function(){var a={logicalFamily:f.getLogicalFamily(),maximumId:f.getMaximumId(),defaultItemConfig:b};d=c.balance(a);return!0},getMaximumId:function(){return d.maximumId},getTreeLevels:function(){return d.treeLevels},getBundles:function(){return d.bundles},getConnectorsStacksSizes:function(a){return d.connectorStacks[a]||e}}};a.famdiagram.LogicalFamilyTask=function(f){var b=null,d=null;return{process:function(c){var e,g,h,i,j=f.getItems(),k=a.common.family(),l=0;if(0<j.length){e=0;for(g=
j.length;e<g;e+=1)h=j[e],null!=h&&(i=new a.famdiagram.FamilyItem({id:h.id,itemConfig:h,isActive:h.isActive}),k.add(h.parents,i.id,i),h=parseInt(h.id,10),l=Math.max(isNaN(h)?0:h,l))}b=k;d=l;if(c&&!k.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return b},getMaximumId:function(){return d}}};a.famdiagram.NormalizeLogicalFamilyTask=function(f,b,d){var c=null,e=null,g={},h={},i=null,j=null,k=null,l=new a.famdiagram.FamilyBalance,n=new a.famdiagram.FamilyNormalizer(!1),
...
a.clone(),p=n.normalize(t,a,p),p=m.extract(t,a,u,s,v,p);e=a;g=u;h=s;j=v;a=l.balance({logicalFamily:a,maximumId:p,defaultItemConfig:d});c=a.maximumId;i=a.treeLevels;j=j.concat(a.bundles);k=a.connectorStacks;return!0},getLogicalFamily:function(){return e},getMatrixes:function(){return g},getNestedLayoutBottomConnectorIds:function(){return h},getMaximumId:function(){return c},getTreeLevels:function(){return i},getBundles:function(){return j},getConnectorsStacksSizes:function(a){return k[a]||p}}};a.famdiagram.RemoveLoopsTask=
function(f,b){function d(b,c,d){var e,f,l,n,m,p,q,r,u;e=c.clone();c.loopTopo(this,function(a){e.removeNode(a)});if(e.hasNodes()){n=0;for(m=b.length;n<m;n+=1)if(f=b[n],null!=e.node(f.id)){u=[];e.loopParents(this,f.id,function(a){u.push(a);return e.SKIP});p=0;for(q=u.length;p<q;p+=1)e.removeRelation(u[p],f.id),c.removeRelation(u[p],f.id);d+=1;l=new a.famdiagram.FamilyItem({id:d,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake parent #"+
d,description:"This is fake parent item was created by loops reversal."}});c.add([],l.id,l);c.adopt([l.id],f.id);p=0;for(q=u.length;p<q;p+=1)d+=1,f=new a.famdiagram.FamilyItem({id:d,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+d,description:"This is fake child item was created by loops reversal."}}),c.add([l.id,u[p]],f.id,f);r=[];e.loopTopo(this,function(a){r.push(a)});p=0;for(q=r.length;p<q;p+=1)e.removeNode(r[p])}}return d}
var c=null,e=null;return{process:function(a){var h=b.getNavigationFamily(),i=b.getMaximumId(),j=f.getItems(),h=h.clone(),i=d(j,h,i,a);c=h;e=i;if(a&&!h.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return c},getMaximumId:function(){return e}}};a.common.LabelAnnotationTemplate=function(){var a=["div",{"class":["bp-item","bp-label-annotation"]}];return{template:function(){return a},getHashCode:function(){return"defaultLabelAnnotationTemplate"},render:function(a,
d){d.element.innerHTML=d.context.title}}};a.famdiagram.Control=function(f,b){return a.orgdiagram.BaseControl(f,b,a.famdiagram.TaskManagerFactory,a.famdiagram.EventArgsFactory,{AnnotationLabelTemplate:a.common.AnnotationLabelTemplate,ButtonsTemplate:a.common.ButtonsTemplate,CheckBoxTemplate:a.common.CheckBoxTemplate,CursorTemplate:a.common.CursorTemplate,DotHighlightTemplate:a.common.DotHighlightTemplate,GroupTitleTemplate:a.common.GroupTitleTemplate,HighlightTemplate:a.common.HighlightTemplate,ItemTemplate:a.common.ItemTemplate,
UserTemplate:a.common.UserTemplate,LabelAnnotationTemplate:a.common.LabelAnnotationTemplate})};a.famdiagram.EventArgsFactory=function(f,b,d,c){var e=new a.famdiagram.EventArgs,g=f.tasks.getTask("CombinedContextsTask"),h=f.tasks.getTask("AlignDiagramTask"),i=f.tasks.getTask("LogicalFamilyTask"),b=g.getConfig(b),j=g.getConfig(d),k=i.getLogicalFamily();b&&null!=b.id&&(e.oldContext=b);j&&null!=j.id&&(e.context=j,k.loopParents(this,j.id,function(a,b,c){if(0<c)return k.BREAK;e.parentItems.push(g.getConfig(a))}),
k.loopChildren(this,j.id,function(a,b,c){if(0<c)return k.BREAK;e.childrenItems.push(g.getConfig(a))}),i=a.common.getElementOffset(f.layout.mousePanel),f=a.common.getElementOffset(f.layout.element),d=h.getItemPosition(d),e.position=(new a.common.Rect(d.actualPosition)).translate(i.left,i.top).translate(-f.left,-f.top));null!=c&&(e.name=c);return e};a.famdiagram.getProcessDiagramConfig=function(){var f=function(){};return a.famdiagram.TaskManagerFactory(f,f,f).getProcessDiagramConfig()};a.famdiagram.TaskManagerFactory=
...
function(){return this.currentvisibility};a.orgdiagram.AlignDiagramTask=function(f,b,d,c,e,g,h,i){function j(){var a=[],b={},c;for(c in k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(c)){var d=k.treeItemsPositions[c];switch(d.actualVisibility){case 1:case 2:case 3:d=d.actualPosition,d=Math.max(d.width,d.height),b.hasOwnProperty(d)||(b[d]=!0,a.push(d))}}return a}var k={treeItemsPositions:{},panelSize:null},l,n,m,p,q,r,u,s;return{process:function(){var j=new a.common.Size(h.getContentSize()),
t=new a.common.Size(e.getOptimalPanelSize());s=u=null;l=null!=g?g.getActiveItems():{};n=h.getItemsPositions();m=b.getOptions();p=f.getOptions();q=d.getOptions();r=c.getOptions();switch(p.orientationType){case 2:case 3:t.invert()}t.scale(1/r.scale);k.panelSize=t;k.treeItemsPositions=n;switch(m.pageFitMode){case 5:k.panelSize=new a.common.Size(j);break;default:k.panelSize=new a.common.Size(j);if(j.width<t.width){k.treeItemsPositions={};var z=j.width,x=t.width,B;if(i)B=(x-z)/2;else switch(q.horizontalAlignment){case 1:B=
...
c,d){var e=null,f=null,h=r.scale,i;if(null==u)for(i in u=a.common.SpatialIndex(j()),k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(i)){var g=k.treeItemsPositions[i];if(l.hasOwnProperty(i))switch(g.actualVisibility){case 1:case 2:case 3:g=new a.common.Rect(g.actualPosition),g.context=i,u.addRect(g)}}i=u;var n,b=b/h,c=c/h,h=new a.common.Rect(b,c,0,0);n=new a.common.Point(b,c);h.offset(d,d,d,d);i.loopArea(this,h,function(a){var d=a.context;if(a.contains(b,c))return e=d,!0;switch(k.treeItemsPositions[d].actualVisibility){case 2:case 3:if(a=
n.distanceTo(a.horizontalCenter(),a.verticalCenter()),null==f||a<f)f=a,e=d}});return e},getNextItem:function(b,c){var d;if(null==s)for(d in s=a.common.KeyboardNavigationManager(),k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(d)){var e=k.treeItemsPositions[d];if(l.hasOwnProperty(d))switch(e.actualVisibility){case 1:e=new a.common.Rect(e.actualPosition),s.addRect(e,d)}}d=s;var f;switch(c){case 0:f=d.getItemAbove(b);break;case 1:f=d.getItemBelow(b);break;case 2:f=d.getItemOnLeft(b);break;
...
(f==e.to?e.polyline.clone().mergeTo(h):h.addInverted(e.polyline.clone()),h.addArrow(i.linesWidth,function(a){a.mergeTo(k.getPolyline(a.paletteItem))}))}});n[b]=!0});g.polylinesBuffer(k);return!1}}};a.orgdiagram.DrawCursorTask=function(f,b,d,c,e,g,h,i){function j(b){var d;k.activate("placeholder",11);var f=e.getItemPosition(b),h=f.actualPosition,j=new a.common.Rect(f.contentPosition),u=g.getTemplateParams(b).template,s=u.templateConfig,f=s.cursorPadding;j.offset(f.left,f.top,f.right,f.bottom);d=new a.common.RenderEventArgs;
d.context=c.getConfig(b);d.isCursor=!0;d.isSelected=i.isSelected(b);d.templateName=s.name;l.transformRect(h.x,h.y,h.width,h.height,!0,this,function(a,b,c,e){k.template(a,b,c,e,j.x,j.y,j.width,j.height,u.cursorTemplate.template(),u.cursorTemplate.getHashCode(),u.cursorTemplate.render,d,{borderWidth:s.cursorBorderWidth})})}var k,l;return{process:function(){var a=h.getCursorTreeItem();k=f();k.reset("placeholder",11);null!=a&&(l=b.getTransform(),j(a));return!1}}};a.orgdiagram.DrawHighlightAnnotationTask=
function(f,b,d,c,e,g,h,i,j,k,l,n,m){function p(b){var d,f,l,p,A,E,D=!0,F,C=j.getItemPosition(b),J=C.actualPosition;switch(C.actualVisibility){case 2:case 3:case 1:d=h.getItemOptions(b);switch(d.showCallout){case 2:D=!1;break;case 1:D=!1;break;default:D=v.showCallout}D?(r.activate("placeholder",12),u.transformRect(J.x,J.y,J.width,J.height,!0,this,function(h,u,G,H){var u=new a.common.Rect(h,u,G,H),h=new a.common.Point(u.horizontalCenter(),u.verticalCenter()),G=e.getOptions().scale,H=new a.common.Point(k.getPlaceholderOffset()),
J=new a.common.Rect(j.getContentSize()),N=c.getOptimalPanelSize();H.scale(1/G);N.scale(1/G);J.scale(1/G);G=new a.common.Rect(H.x,H.y,Math.min(N.width,J.width),Math.min(N.height,J.height));if(C.actualVisibility>=v.calloutMaximumVisibility&&4!=C.actualVisibility||!G.overlaps(u)){A=!a.common.isNullOrEmpty(d.calloutTemplateName)?d.calloutTemplateName:!a.common.isNullOrEmpty(d.templateName)?d.templateName:!a.common.isNullOrEmpty(v.defaultCalloutTemplateName)?v.defaultCalloutTemplateName:v.defaultTemplateName;
...
if(n.hasGroupTitle){var p=0;switch(v.groupTitlePlacementType){case 2:case 0:p=2;break;case 3:p=h-(v.groupTitlePanelSize-4)}u.template(c,d,h,i,p,f.contentPosition.y,v.groupTitlePanelSize-4,f.contentPosition.height+2,x.template(),x.getHashCode(),x.render,b,null)}n.hasSelectorCheckbox&&(u.activate("placeholder",16),u.template(c,d,h,i,f.contentPosition.x,i-(v.checkBoxPanelSize-4),f.contentPosition.width,v.checkBoxPanelSize-4,z.template(),z.getHashCode(),z.render,b,null));if(n.hasButtons){u.activate("placeholder",
16);p=0;switch(v.groupTitlePlacementType){case 2:case 0:p=h-(v.buttonsPanelSize-4);break;case 3:p=2}u.template(c,d,h,i,p,f.contentPosition.y,v.buttonsPanelSize-4,Math.max(f.contentPosition.height,i-f.contentPosition.y),t.template(),k.templateConfig.name+t.getHashCode(),t.render,n,null)}}}))}var r,u,s,v,t,z,x;return{process:function(){u=f();v=e.getOptions();r=h.getItemsPositions();s=b.getTransform();t=p.getTemplate();z=m.getTemplate();x=n.getTemplate();u.reset("placeholder",12);u.reset("placeholder",
...
f.getOptions(),h=0<g.buttons.length,i=b.getCursorItem(),j=g.items,k,l;e={};k=0;for(l=j.length;k<l;k+=1){var n=j[k],m=new a.orgdiagram.TemplateParams,p=i==n.id,q=d.getTemplate(n.templateName,g.defaultTemplateName,d.DefaultWidgetTemplateName),r=q.templateConfig,u=null!=r.buttons&&0<r.buttons.length;m.template=q;m.isActive=n.isActive&&r.isActive;m.isActive&&(m.hasSelectorCheckbox=c(p,n.hasSelectorCheckbox,g.hasSelectorCheckbox),m.hasButtons=(h||u)&&c(p,n.hasButtons,g.hasButtons),m.hasButtons&&(m.buttons=
...
for(d=0;d<=c;d+=1)e=b[d],D[e.level].currentvisibility=e.currentvisibility;v();x();t();d=H.lineLevelShift;var f,h,g,l,n=e=0;f=8*I.linesWidth;switch(I.arrowsDirection){case 1:e=f;n=0;break;case 2:e=0,n=f}f=0;for(h=D.length;f<h;f+=1)g=D[f],l=i.getConnectorsStacksSizes(f),d+=g.setShift(d,z(g.actualVisibility),n,e,l.parentsStackSize);return new a.common.Rect(0,0,Math.round(s()),Math.round(u()))}function r(a,b){var c=!1;switch(H.pageFitMode){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&
(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function u(){var a=D[D.length-1];return a.shift+a.nextLevelShift}function s(){var a=0,b,c;b=0;for(c=D.length;b<c;b+=1)a=Math.max(a,D[b].currentOffset);return a+=H.normalItemsInterval}function v(){var b=k.getCursorTreeItem();n={};E.loopLevels(this,function(c){var d=D[c];E.loopLevelItems(this,c,function(c,e){var f=new a.orgdiagram.TreeItemPosition,h=l.isItemSelected(c)?1:e.visibility,g=j.getTemplateParams(c),h=0===h?d.currentvisibility:
...
k.groupTitlePanelSize,k.groupTitlePlacementType){case 3:break;default:r.x+=k.groupTitlePanelSize}break;case 2:p=g.template.templateConfig;q=new a.common.Size(p.minimizedItemSize);break;case 3:case 4:q=new a.common.Size}switch(m){case 2:case 3:q.invert()}f.actualVisibility=h;f.actualSize=q;f.contentPosition=r;n[c]=f})})}function t(){var a,b;E.loopLevels(this,function(c){var d=D[c];d.shift=0;d.depth=0;d.actualVisibility=4;b=a=null;E.loopLevelItems(this,c,function(c){c=n[c];d.depth=Math.max(d.depth,
c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:b=!b?c.actualSize.height:Math.min(b,c.actualSize.height);break;default:a=!a?c.actualSize.height:Math.min(a,c.actualSize.height)}d.actualVisibility=Math.min(d.actualVisibility,c.actualVisibility)});null==a&&(a=d.depth);null!=b&&b>a&&(a=b);switch(H.verticalAlignment){case 0:d.horizontalConnectorsDepth=a/2;break;case 1:d.horizontalConnectorsDepth=d.depth/2;break;case 2:d.horizontalConnectorsDepth=d.depth-a/2}})}function z(a){var b=
0;switch(a){case 1:b=H.normalLevelShift;break;case 2:b=H.dotLevelShift;break;case 3:case 4:b=H.lineLevelShift}return b}function x(){var a,b;a=0;for(b=D.length;a<b;a+=1)D[a].currentOffset=0;F.loopPostOrder(this,function(a,b){var c=n[a],d=c.actualVisibility,e=E.getLevelIndex(a),e=D[e],d=N[0===d?e.currentvisibility:d]/2,f,h,g,i,l,k,j,m;f=8*I.linesWidth;c.leftPadding=d+(0<e.currentOffset?d*b.relationDegree*H.cousinsIntervalMultiplier:0);c.rightPadding=d;0!=I.arrowsDirection&&(b.connectorPlacement&8&&
(c.leftPadding+=f),b.connectorPlacement&2&&(c.rightPadding+=f));c.offset=e.currentOffset+c.leftPadding;e.currentOffset=c.offset+c.actualSize.width+c.rightPadding;if(F.hasChildren(a))if(c=B(b),0<c)w(b,c);else if(0>c&&(c=-c,y(b,c),h=null,g={},l=null,e=F.parent(b.id),null!==e&&(F.loopChildrenReversed(this,e.id,function(a,c){if(c===b)h=[];else if(null!==h){var d=null,e=[],f,k,j,m;f=J[c.id];void 0===f&&(f=[]);f=f.slice();f.splice(0,0,c.id);k=0;for(j=f.length;k<j;k+=1)m=n[f[k]],e[k]=m.offset+m.actualSize.width+
m.rightPadding;f=[];var p;k=C[b.id];void 0===k&&(k=[]);k=k.slice();k.splice(0,0,b.id);j=0;for(m=k.length;j<m;j+=1)p=n[k[j]],f[j]=p.offset-p.leftPadding;k=Math.min(e.length,f.length);for(j=0;j<k&&!(m=f[j]-e[j],d=null!==d?Math.min(d,m):m,0>=m);j+=1);i=Math.floor(d);g[c.id]=i;if(0<i)h.splice(0,0,c);else return l=c,!0}}),0<h.length))){d=null;if(null!==l){k=[l];k=k.concat(h);k.push(b);d=[[l]];e=1;for(f=k.length;e<f;e+=1)j=k[e-1],m=k[e],2==j.gravity||1==m.gravity?d[d.length-1].push(m):d.push([m])}else d=
[h.slice(0)],d[d.length-1].push(b);if(0<d.length){h=d[d.length-1];for(e=h.length-2;0<=e;e-=1)m=h[e],i=g[m.id],c=Math.min(i,c),y(m,c),w(m,c)}k=c/(d.length-1);for(f=d.length-2;0<f;f-=1){j=d[f];for(e=j.length-1;0<=e;e-=1)m=j[e],i=g[m.id],c=Math.min(f*k,Math.min(i,c)),y(m,c),w(m,c)}}})}function B(a){var b=n[a.id],b=b.offset+b.actualSize.width/2,c=null,d,e,f;if(null===a.visualAggregatorId)switch(d=null,F.loopChildren(this,a.id,function(a,b){d=b;if(d.connectorPlacement&1)return!0}),e=n[d.id],f=null,F.loopChildrenReversed(this,
...
c);return!0},getPaletteManager:function(){return d}}};a.orgdiagram.VisualTreeLevelsTask=function(f){function b(b,c,d,e){var f,g,m,p,q,r,u,s={},v,t,z;d.loopLevels(this,function(x){var B=new a.orgdiagram.TreeLevelConnectorStackSize;c[x]=B;u=[];d.loopLevelItems(this,x,function(c,f){var g=[];if(!s.hasOwnProperty(c)&&(f.connectorPlacement&4&&g.push(c),g=g.concat(f.partners),0<g.length)){r=new a.common.VerticalConnectorBundle(g,[]);for(var i=0,l=g.length;i<l;i+=1)s[g[i]]=r;e.loopChildren(this,c,function(a,
b){b.connectorPlacement&1&&r.toItems.push(a)});1<g.length&&u.push(r);(1<r.fromItems.length||0<r.toItems.length)&&b.push(r)}f.connectorPlacement&8&&(r=new a.common.HorizontalConnectorBundle(c,d.getPrevItem(c)),b.push(r));f.connectorPlacement&2&&(r=new a.common.HorizontalConnectorBundle(c,d.getNextItem(c)),b.push(r))});if(0<u.length){z=a.common.pile();f=0;for(g=u.length;f<g;f+=1){r=u[f];t=v=null;m=0;for(p=r.fromItems.length;m<p;m+=1)q=d.getItemPosition(r.fromItems[m]),v=null!=v?Math.min(v,q):q,t=null!=
t?Math.max(t,q):q;z.add(v,t,r)}B.parentsStackSize=z.resolve(this,function(a,b,c,d,e){c.fromOffset=d+1;c.fromStackSize=e})}})}var d=null,c=null,e=null,g=new a.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var h=f.getVisualTree();d=a.common.TreeLevels();h.loopLevels(this,function(a,b,c){d.addItem(c,a,b)});c=[];e=[];b(c,e,d,h);return!0},getTreeLevels:function(){return d},getBundles:function(){return c},getConnectorsStacksSizes:function(a){return e[a]||g},getNestedLayoutBottomConnectorIds:function(){return{}}}};
a.orgdiagram.VisualTreeTask=function(f,b,d,c){function e(a,b,d){var e,f,h,u,v,t,C,J,L,I,G,H,Q={},N,ca={},P,T,U,da={},V;a.loopPostOrder(this,function(a,b,d,c){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=c&&(c.hasVisibleChildren=c.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(h,g){var i,j,H;if(!c&&!g.hasVisibleChildren)return a.SKIP;i=d.node(h);i||(i=q({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},g),d.add(null,h,i));U=T=0;if(null!=(t=d.indexOf(h)))T=
t,U=d.countSiblings(h)-t-1;j=[];a.loopChildren(this,h,function(a,b){if(c||b.hasVisibleChildren){e=q({parentId:h,actualItemType:b.itemType},b);switch(i.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:r(i,e),e.connectorPlacement=5,H=q({visibility:4}),d.add(H.id,e.id,e),e=H;case 8:case 2:f=d.parent(h);if(i.connectorPlacement&2)u=n(d,s.navigationFamily,i),d.add(f.id,e.id,e,u+1),e.connectorPlacement=
6,e.gravity=2;else if(i.connectorPlacement&8)v=m(d,s.navigationFamily,i),d.add(f.id,e.id,e,v),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:u=n(d,s.navigationFamily,i);d.add(f.id,e.id,e,u+1);e.connectorPlacement=6;e.gravity=2;break;default:v=m(d,s.navigationFamily,i),d.add(f.id,e.id,e,v),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=i.parentId?r(d.node(i.parentId),e):r(i,e,!0);break;case 2:r(i,e)}break;case 4:r(i,e),e.connectorPlacement=
5,H=q({visibility:4}),d.add(H.id,e.id,e),e=H;case 1:null===i.visualAggregatorId&&p(d,i,!1);switch(b.adviserPlacementType){case 2:d.add(h,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:d.add(h,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&r(i,e);break;case 0:j.push(e);r(i,e);break;case 7:case 6:f=d.parent(h);if(i.connectorPlacement&2)d.add(f.id,e.id,e,T),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)d.add(f.id,e.id,e,d.countChildren(f.id)-U),e.connectorPlacement=
...
h&&V.push(c)}}),1<V.length&&(da[h]=V)}Q[h]=[];ca[h]=[];var I=i,G=g.childrenPlacementType,J=Q[h],L=ca[h],A,N,C,P,ja,ka,M,K,O=4==I.visibility&&0===I.connectorPlacement;switch(b.horizontalAlignment){case 0:case 1:N=3;break;case 2:N=2}0===G&&(G=l(a,I)?0===b.leavesPlacementType?3:b.leavesPlacementType:0===b.childrenPlacementType?2:b.childrenPlacementType);A=I;null!==I.visualAggregatorId&&(A=d.node(I.visualAggregatorId));3==G&&3>j.length&&(G=2);switch(G){case 2:G=0;for(P=j.length;G<P;G+=1)I=j[G],J=a.node(I.id),
d.add(A.id,I.id,I),I.connectorPlacement=(J.hideParentConnection?0:1)|(J.hideChildrenConnection?0:4),0===G&&(I.relationDegree=1);break;case 3:P=Math.min(b.maximumColumnsInMatrix,Math.ceil(Math.sqrt(j.length)));ja=Math.ceil(j.length/P);ka=Math.ceil(P/2);for(M=0;M<ka;M+=1){N=A;for(K=0;K<ja;K+=1){I=k(j,2*M,K,P);G=k(j,2*M+1,K,P);void 0===J[K]&&(J[K]=[],L[K]=[]);null!==I&&(0===M&&(I.relationDegree=1),d.add(N.id,I.id,I),I.connectorPlacement=(O?0:2)|4,I.gravity=2,L[K].push(I));if(null!==I||null!==G)C=q({visibility:4,
connectorPlacement:O?0:5}),d.add(N.id,C.id,C),J[K].push(C);null!==G&&(d.add(N.id,G.id,G),G.connectorPlacement=(O?0:8)|4,G.gravity=1,L[K].push(G));N=C}}2<P&&(A.visualAggregatorId=null);break;case 1:G=0;for(P=j.length;G<P;G+=1){I=j[G];C=q({visibility:4,connectorPlacement:O?0:5});switch(N){case 2:d.add(A.id,I.id,I);d.add(A.id,C.id,C);I.connectorPlacement=(O?0:2)|4;I.gravity=2;break;case 3:d.add(A.id,C.id,C),d.add(A.id,I.id,I),I.connectorPlacement=(O?0:8)|4,I.gravity=1}J[G]=[C];L[G]=[I];A=C}break;default:throw"Children placement is undefined!";
}});a.loopPostOrder(this,function(a){var b=d.node(a),c,e,f;if(null!=b){c=ca[a];e=Q[a];I=i(d,b);if(0<I&&(b.visualDepth=I+1,null!==b.visualAggregatorId)){h=d.node(b.visualAggregatorId);f=d.hasChildren(h.id);for(t=0;t<I-1;t+=1)h=p(d,h,!f)}f=0;var l=d.parent(b.id),k,n,m;if(null!==l){k=d.indexOf(b.id);for(n=1;null!=(m=d.getChild(l.id,k+n));)if(m.connectorPlacement&8)f=Math.max(f,j(d,m)),n+=1;else break;for(n=1;null!=(m=d.getChild(l.id,k-n));)if(m.connectorPlacement&2)f=Math.max(f,j(d,m)),n+=1;else break}I=
f;if(1<I){b.visualDepth+=I-1;f=d.hasChildren(a);h=b;for(t=0;t<I-1;t+=1)h=p(d,h,!f)}G=[];t=0;for(C=c.length;t<C;t+=1){P=c[t];J=G[t]=0;for(L=P.length;J<L;J+=1)G[t]=Math.max(G[t],j(d,P[J]))}t=0;for(C=G.length;t<C;t+=1)if(H=G[t],1<H){J=0;for(L=e[t].length;J<L;J+=1)if(N=e[t][J],d.hasChildren(N.id))for(I=H;1<I;)N=p(d,N,!1),I-=1}null!=da[a]&&g(d,b,da[a])}})}function g(a,b,c){var d,e,f,g,i=0,l=[],k,j;e=0;for(f=c.length;e<f;e+=1)d=c[e],i=Math.max(i,d.visualDepth);e=0;for(f=c.length;e<f;e+=1){d=c[e];k=h(a,
...
v,t;return{process:function(){var c=f.getOrgTree(),h=d.getOptions();t=null!=b?b.getActiveItems():{};s.visualTree=a.common.tree();s.navigationFamily=a.common.family();v=f.getMaximumId();c.hasNodes()&&e(c,h,s.visualTree);s.leftMargins={};s.rightMargins={};u(s.visualTree,s.leftMargins,s.rightMargins);return!0},getVisualTree:function(){return s.visualTree},getNavigationFamily:function(){return s.navigationFamily},getConnectionsFamily:function(){return s.connectionsFamily},getLeftMargins:function(){return s.leftMargins},
...
c.element,"title",function(b){a.common.JsonML.applyStyles(b,{color:j});b.textContent=h.title});a.common.getElementsByName(this,c.element,"description",function(a){a.textContent=h.description})}}}};a.orgdiagram.BaseControl=function(f,b,d,c,e){function g(b,c){null==c&&(c=!0);switch(b){case 1:h(c,J);break;case 2:var g=J;w.layout.forceCenterOnCursor=!1;w.tasks.process("HighlightItemOptionTask",null,g);w.graphics.end();break;default:m(w.layout);n(w.layout);var L=w.layout,g=w.name,x=a.common.getInnerSize(L.element),
...
c.scrollTop);F=F||new Image;b.dataTransfer.setDragImage(F,0,0)}function t(a){a.preventDefault();a.dataTransfer.dropEffect="move"}function z(b){D=new a.common.Point(E.x-(b.clientX-A.x),E.y-(b.clientY-A.y));null==C&&(C=window.setTimeout(function(){var a=w.layout.scrollPanel;a.scrollLeft=D.x;a.scrollTop=D.y;window.clearTimeout(C);C=null},50))}function x(a,b){var d=!0,e;null!==b?b!==w.options.highlightItem&&(e=c(w,w.options.highlightItem,b,void 0),w.options.highlightItem=b,y("onHighlightChanging",a,e),
...
b,function(a){a=h.getItemPosition(a);j=null!=j?Math.min(j,a):a;v=null!=v?Math.max(v,a):a});c=0;for(t=j;t<=v;t+=1)b=h.getItemAtPosition(e,t),c+=i[b],t>j&&(c+=g[b]||0);t=x-c/2;b=h.getItemAtPosition(e,j);a.hasOwnProperty(b)||(a[b]=t+i[b]/2);for(t=j+1;t<=v;t+=1)b=h.getItemAtPosition(e,t),a.hasOwnProperty(b)||(x=h.getItemAtPosition(e,t-1),a[b]=a[x]+(i[x]/2+(g[b]||0)+i[b]/2))}var h,i={},j;null!=c&&d.loopItems(this,function(a,b){i[a]=c.call(f,a,b)});j=function(b,c){var d={},f={},h=null;c.loopLevelsReversed(this,
...
var s=[],v=null,t=null;k=0;for(l=r.length;k<l;k+=1){var z=r[k];null==v?(v=z.y,t=z.bottom()):t<z.y?(s.push(new c(v,t)),v=z.y,t=z.bottom()):t=Math.max(t,z.bottom())}null!=v&&s.push(new c(v,t));p.push(new e(n.x,s))}var x=[],B={},y=1;i=1;for(j=p.length;i<j;i+=1){b=p[i-1];n=p[i];for(k=u=0;u<b.ranges.length||k<n.ranges.length;)if(l=u<b.ranges.length?b.ranges[u]:null,q=k<n.ranges.length?n.ranges[k]:null,null==q){m=[new a.common.Point(b.x,l.end),new a.common.Point(n.x,l.end),new a.common.Point(n.x,l.start),
...
1],m[s]));l.endHead.attach(l.startHead);u+=1}else q.endHead=h(!0),q.endHead.add(new a.common.Vector(new a.common.Point(n.x,q.start),new a.common.Point(n.x,q.end))),q.startHead=q.endHead.getTail(),k+=1}if(null!=d)for(i=0;i<x.length;i+=1)B.hasOwnProperty(i)&&(j=x[i],m=[],j.iterate(function(a){0==m.length&&m.push(a.from);m.push(a.to)}),d.call(f,m))};a.common.getMinimumCrossingRows=function(a,b,d){var c=a=null;if(null!=d){b.sort(function(a,b){return a.y-b.y});for(var e=0;e<b.length;e+=1){var g=b[e],h=
...
b.call(a,f[g],e,g));if(m>p||null==p)d=e,p=m}return d}function d(a,d,f,k,l){var n={},m,p=[],q={},r=0,u,s,v,t,z,x;if(null!=f&&null!=k&&(null==d&&(d=b(a,f)),null!=d)){k.call(a,d);n[d]=!0;r+=1;for(q[d]=null;0<r;){p=[];s=u=null;v={};for(m in n)if(n.hasOwnProperty(m)){t=c[m];d=!1;for(z in t)if(t.hasOwnProperty(z)&&!q.hasOwnProperty(z))switch(x=f.call(a,t[z],m,z),d=!0,l){case e:null==v[z]&&(v[z]=0);v[z]+=x;if(!s||v[z]>s)u=z,s=v[z];break;case g:if(v[z]=null==v[z]?x:Math.min(v[z],x),!s||v[z]<s)u=z,s=v[z]}d||
p.push(m)}if(null==u)break;else n[u]=!0,r+=1,q[u]=!0,k.call(a,u);d=0;for(u=p.length;d<u;d+=1)delete n[p[d]],r-=1}}}var c={},e=1,g=2;return{addEdge:function(a,b,d){if((null==c[a]||null==c[a][b])&&null!=d)null==c[a]&&(c[a]={}),c[a][b]=d,null==c[b]&&(c[b]={}),c[b][a]=d},edge:function(a,b){var d=null;null!=c[a]&&c[a][b]&&(d=c[a][b]);return d},hasNode:function(a){return c.hasOwnProperty(a)},loopNodes:function(a,b,d){a={};if(null==b)for(b in c)c.hasOwnProperty(b)&&(a.hasOwnProperty[b]||f(this,b,a,d));else f(this,
...
{})}return e},getTotalWeightGrowthSequence:function(a,c,f){var g=b(a,c);d(a,g,c,f,e)},getMinimumWeightGrowthSequence:function(a,b,c,e){d(a,b,c,e,g)},getShortestPath:function(b,d,e,f,g){var n=a.common.FibonacciHeap(!1),m={},p={},q,r,u={},s=0,v=0,m=0;for(r=e.length;m<r;m+=1)q=e[m],u.hasOwnProperty(q)||(s+=1,u[q]=!0);n.add(d,0,null);for(p[d]=null;null!=(d=n.extractRoot());){e=c[d.key];for(q in e)e.hasOwnProperty(q)&&(r=d.priority+(null!=f?f.call(b,e[q],d,q):1),m=n.getPriority(q),null!=m?m>r&&(n.setPriority(q,
r),p[q]=d.key):p.hasOwnProperty(q)||(n.add(q,r,null),p[q]=d.key));if(u.hasOwnProperty(d.key)){m=[];for(e=d.key;null!=e;)m.push(e),e=p[e];g.call(b,m,d.key);v+=1;if(v>=s)break}}}}};a.common.LCA=function(f){var b=[],d=[],c={},e;(function(){var g=0;f.loopEulerWalk(this,function(a,e,f){b.push(a);d.push(f);c.hasOwnProperty(a)||(c[a]=g);g+=1});e=a.common.RMQ(d)})();return{getLowestCommonAncestor:function(a,d){var f=c[a],j=c[d],f=f<j?e.getRangeMinimumIndex(f,j):e.getRangeMinimumIndex(j,f);return b[f]}}};
a.common.LinkedHashItems=function(){function a(b,c){if(e.hasOwnProperty(b))throw"Duplicate segments are not supported!";e[b]=c;g[b]=null;null==j?(i=b,h[b]=null):(g[j]=b,h[b]=j);j=b}function b(a,b){if(e.hasOwnProperty(a))throw"Duplicate segments are not supported!";e[a]=b;h[a]=null;null==i?(j=a,g[a]=null):(h[i]=a,g[a]=i);i=a}function d(a,b,c,d){var f;null==c&&(c=a?i:j);if(null!=b)for(;null!=c;){f=e[c];if(null!=f&&b(f,c))break;c=c==d?null:a?g[c]:h[c]}}function c(a,b,c){d(!0,a,b,c)}var e={},g={},h={},
...
i},attach:function(b){b.iterate(function(b,c){a(c,b)})},iterate:c,iterateBack:function(a,b,c){d(!1,a,b,c)},empty:function(){e={};g={};h={};j=i=null},toArray:function(){var a=[];c(function(b){a.push(b)});return a},validate:function(a){var b,c;for(b in e)if(e.hasOwnProperty(b)&&(!g.hasOwnProperty(b)||!h.hasOwnProperty(b)))return null!=a&&(a.message="Orphant key found!"),!1;if(!e.hasOwnProperty(i)||!e.hasOwnProperty(j))return null!=a&&(a.message="Start or end values are missing!"),!1;for(b in g)if(g.hasOwnProperty(b)){if(!e.hasOwnProperty(b)||
!h.hasOwnProperty(b))return null!=a&&(a.message="Orphant key found!"),!1;if((c=g[b])&&!g.hasOwnProperty(c))return null!=a&&(a.message="Next key not found!"),!1}for(b in h)if(h.hasOwnProperty(b)){if(!e.hasOwnProperty(b)||!g.hasOwnProperty(b))return null!=a&&(a.message="Orphant key found!"),!1;if((c=h[b])&&!h.hasOwnProperty(c))return null!=a&&(a.message="Prev key not found!"),!1}return!0}}};a.common.mergeSort=function(a,b,d){var c=null,e,g,h,i,j,k,l,n,m,p,q,r;switch(a.length){case 0:c=[];break;default:c=
[];for(h=0;h<a.length;h+=1){e=a[h];g=[];k=c.length;l=e.length;j=i=0;q=m=p=n=null;0<k&&(n=c[i],p=!b?n:b(n));0<l&&(m=e[j],q=!b?m:b(m));for(r=null;i<k||j<l;)if(i>=k){if(!d||r!=m)g.push(m),r=m;j+=1;j<l&&(m=e[j],q=!b?m:b(m))}else if(j>=l){if(!d||r!=n)g.push(n),r=n;i+=1;i<k&&(n=c[i],p=!b?n:b(n))}else if(p<q){if(!d||r!=n)g.push(n),r=n;i+=1;i<k&&(n=c[i],p=!b?n:b(n))}else{if(!d||r!=m)g.push(m),r=m;j+=1;j<l&&(m=e[j],q=!b?m:b(m))}c=g}}return c};a.common.pile=function(){function a(b,d,f,h){this.context=f;this.from=
b;this.to=d;this.offset=null;this.direction=h}function b(a,d,f,h,i){if(a>=d.length)return 0;if(f.hasOwnProperty(a))return f[a];for(var j=d[a],k=b(a+1,d,f,h,i),l=a+1;l<d.length&&!(d[l].from>=j.to);)l+=1;d=1+b(l,d,f,h,i);d>k?(f[a]=d,h[a]=l,i[a]=!0):(f[a]=k,h[a]=a+1,i[a]=!1);return f[a]}var d=[];return{add:function(b,e,g){b<e?d.push(new a(b,e,g,1)):d.push(new a(e,b,g,-1))},resolve:function(a,e){var f,h,i,j,k,l,n=0;if(null!=e){j=d.slice(0);j.sort(function(a,b){return a.from-b.from});for(k=[];0<j.length;){f=
{};h={};i={};b(0,j,f,h,i);f=[];k[n]=[];for(l=0;h.hasOwnProperty(l);)i[l]&&(f.push(l),k[n].push(j[l])),l=h[l];for(l=f.length-1;0<=l;l-=1)j.splice(f[l],1);n+=1}for(i=0;i<n;i+=1){f=k[i];for(l=0;l<f.length;l+=1)if(h=f[l],e.call(a,h.from,h.to,h.context,i,n,h.direction))return n}}return n}}};a.common.QuadTree=function(f){function b(a,b,c,d){this.x=a;this.y=b;this.scale=c;this.size=d;this.quadrants=[];this.points=[]}function d(a){var c=a.size/2;a.quadrants=[new b(a.x,a.y,a.scale-1,c),new b(a.x+c,a.y,a.scale-
1,c),new b(a.x,a.y+c,a.scale-1,c),new b(a.x+c,a.y+c,a.scale-1,c)];for(var c=0,d=a.points.length;c<d;c+=1){var e=a.points[c];a.quadrants[a.getQuadrantIndex(Math.floor(e.x),Math.floor(e.y))].points.push(e)}a.points=null}var c=Math.max(1,Math.floor(Math.log(f)/Math.log(2))),e=8,g=256,h=null,h=new b(0,0,e,g);b.prototype.notEnclosed=function(a){return this.x<a.x||this.x+this.size>a.x+a.width||this.y<a.y||this.y+this.size>a.y+a.height?!0:!1};b.prototype.overlaps=function(a){return this.x+this.size<a.x||
a.x+a.width<this.x||this.y+this.size<a.y||a.y+a.height<this.y?!1:!0};b.prototype.getQuadrantIndex=function(a,b){var c=this.scale-1;return a>>c&1|(b>>c&1)<<1};return{addPoint:function(a){for(var f=Math.max(Math.floor(a.x),Math.floor(a.y));g<=f;){e+=1;g*=2;var k=new b(0,0,e,g);d(k);k.quadrants[0]=h;h=k}var f=Math.floor(a.x),k=Math.floor(a.y),l=h;if(0>f||0>k)throw"Negative values are not supported in the quad tree.";for(;(null==l.points||0<l.points.length)&&!(l.scale==c&&null!=l.points);)null!=l.points&&
0<l.points.length&&d(l),l=l.quadrants[l.getQuadrantIndex(f,k)];l.points.push(a)},loopArea:function(a,b,c){var d,e,f;if(null!=c)for(var g=[h],q=[];0<g.length||0<q.length;){var r=[],u=[];e=0;for(f=g.length;e<f;e+=1)if(d=g[e],d.overlaps(b))if(d.notEnclosed(b))if(null==d.points)for(var s=0;4>s;s+=1)r.push(d.quadrants[s]);else for(var s=0,v=d.points.length;s<v;s+=1){var t=d.points[s];if(b.contains(t)&&c.call(a,t))return}else q.push(d);e=0;for(f=q.length;e<f;e+=1)if(d=q[e],null==d.points)for(s=0;4>s;s+=
...
[],f=0,g=d.length;f<g;f+=1){var p=d[f],q=new a.common.Rect(p.x,p.y,p.size,p.size);q.context={isHighlighted:!1};null!=b&&(b.overlaps(q)&&null!=p.points&&0<p.points.length)&&(q.context.isHighlighted=!0);c.push(q);for(q=0;4>q;q+=1){var r=p.quadrants[q];null!=r&&e.push(r)}}d=e}return c}}};a.common.RMQ=function(a){function b(b,e){var h=Math.floor(Math.log(e-b+1)/c);return a[d[b][h]]<=a[d[e-(1<<h)+1][h]]?d[b][h]:d[e-(1<<h)+1][h]}for(var d=[],c=Math.log(2),e,g=0,h=a.length;g<h;g+=1)d[g]=[g];e=1;for(h=a.length;1<<
e<h;e+=1)for(g=0;g+(1<<e)-1<h;g+=1)d[g][e]=a[d[g][e-1]]<a[d[g+(1<<e-1)][e-1]]?d[g][e-1]:d[g+(1<<e-1)][e-1];return{getRangeMinimumIndex:b,getRangeMinimum:function(c,d){return a[b(c,d)]}}};a.common.SortedList=function(){function a(b,c){this.value=b;this.context=c;this.right=this.left=null;this.balance=0}function b(a){var b;if(2==a.balance){var e=a.right;b=e.balance;if(0<=b)d(e,a),1==e.balance?(a.balance=0,e.balance=0):(a.balance=-1,e.balance=1);else{var f=e.left;c(f,e);d(e,a);a.balance=0;switch(f.balance){case 1:e.balance=
-1;f.balance=0;break;case 0:f.balance=0;e.balance=0;break;default:f.balance=1,e.balance=0}}}else if(-2==a.balance)if(b=a.left.balance,0>=b)e=a.left,c(e,a),-1==e.balance?(a.balance=0,e.balance=0):(a.balance=1,e.balance=-1);else switch(e=a.left,f=e.right,d(f,e),c(e,a),a.balance=0,f.balance){case -1:f.balance=0;e.balance=1;break;case 0:f.balance=0;e.balance=0;break;default:f.balance=-1,e.balance=0}return b}function d(a,b){g(a,b);b.right=a.right;a.right=a.left;a.left=b.left;b.left=a}function c(a,b){g(a,
...
j<c&&e(this,t,function(a){f.hasOwnProperty(a)||(i.push(a),f[a]=!0)})}h=i;j+=1}},zipUp:function(a,b,c,d){var e,f;if(null!=d)for(;null!=b&&null!=c&&b!=c;){e=h[b];f=h[c];if(d.call(a,b,e,c,f))break;b=e;c=f}},parentid:d,parent:function(a){var b=null;null!=h[a]&&(b=g[h[a]]);return b},adopt:function(a,b){if(null!=g[a]&&null!=g[b])if(a!=b)j.hasOwnProperty(b)&&(c(k[j[b]],b)||delete k[j[b]],delete j[b]),h.hasOwnProperty(b)&&(c(i[h[b]],b)||delete i[h[b]]),h[b]=a,null!=i[a]?i[a].push(b):i[a]=[b];else throw"Item cannot be parent of itself!";
...
c?a.common.indexOf(i[c],b):null},getChild:function(a,b){var c=null,d;if(null!=(d=i[a]))c=g[d[b]];return c},arrangeChildren:function(a,b){var c,d,e,b=b.slice(0);if(null!=g[a])if(null!=i[a])if(i[a].length==b.length){d=0;for(e=b.length;d<e;d+=1)if(c=b[d],h[c]!=a)throw"Child "+c+" does not belong to given node!";i[a]=b}else throw"Collections of children don't match each other!";else if(0<b.length)throw"Collections of children don't match each other!";},validate:function(){var a=!0,b;for(b in j)if(j.hasOwnProperty(b)&&
null!=j[b]){a=!1;break}return a},clone:function(){return a.common.family({nodes:g,parents:h,children:i,roots:j,rootChildren:k})},BREAK:1,SKIP:2}};a.common.TreeLevels=function(f){function b(a){this.context=a;this.items=[]}function d(a,b,c){this.context=a;this.positions={};this.positions[c]=b;this.endLevel=this.startLevel=c}function c(a){null==e[a]&&(e[a]=new b(null),h=null===h?a:Math.min(h,a),i=null===i?a:Math.max(i,a));return e[a]}var e=[],g={},h=null,i=null;a.common.isObject(f)&&(e=a.common.cloneObject(f.levels,
!0),g=a.common.cloneObject(f.items,!0),h=a.common.cloneObject(f.minimum,!0),i=a.common.cloneObject(f.maximum,!0));return{addlevel:function(a,b){c(a).context=b},hasLevel:function(a){return null!=e[a]},hasItem:function(a){return g.hasOwnProperty(a)},addItem:function(a,b,e){var f;g.hasOwnProperty(b)?(f=c(a),f.items.push(b),b=g[b],b.positions[a]=f.items.length-1,b.startLevel=Math.min(b.startLevel,a),b.endLevel=Math.max(b.endLevel,a)):(f=c(a),f.items.push(b),g[b]=new d(e,f.items.length-1,a))},getItemContext:function(a){var b=
...
b=b||c.startLevel,c=e[b].items[c.positions[b]-1]);return c},getNextItem:function(a,b){var c=null;g.hasOwnProperty(a)&&(c=g[a],b=b||c.startLevel,c=e[b].items[c.positions[b]+1]);return c},length:function(){return e.length},isEmpty:function(){return!e.length},clone:function(){return a.common.TreeLevels({levels:e,items:g,minimum:h,maximum:i})}}};a.common.DependencyManager=function(){var a={};return{register:function(b,d){return a[b]=d},resolve:function(b,d,c){var e=[],g=c||{};return function(){for(var c=
Array.prototype.slice.call(arguments,0),i=0;i<b.length;i+=1){var j=b[i];e.push(a.hasOwnProperty(j)&&""!==j?a[j]:c.shift())}e=e.concat(c);return d.apply(g||{},e)}}}};a.common.KeyboardNavigationManager=function(){function f(a,b){this.itemid=a;this.row=b}function b(){if(null==h){var b=0;g=a.common.SortedList();a.common.getMinimumCrossingRows(this,e,function(a){g.add(a,b);b+=1});h=a.common.TreeLevels();e.sort(function(a,b){return a.horizontalCenter()-b.horizontalCenter()});for(var c=0,d=e.length;c<d;c+=
...
b,function(a){c.push(a)});a.push(c)});return a}}};a.common.TaskManager=function(){function f(a,b,c,d){this.name=a;this.dependencies=b;this.factory=c;this.task=null;this.color=d}var b=new a.common.family,d=new a.common.DependencyManager,c=[];return{addTask:function(a,d,h,i){if(0<c.length)throw"Task Manager is already initialized";b.add(d,a,new f(a,d,h,i))},addDependency:function(a,b){if(0<c.length)throw"Task Manager is already initialized";d.register(a,b)},getTask:function(a){return(a=b.node(a))&&
a.task},process:function(a,f,h){var i=!1;0===c.length&&b.loopTopo(this,function(a,b){b.task=d.register(a,d.resolve(b.dependencies,b.factory)());c.push(b)});h&&console.log("-- process --");for(var j={},k=0,l=c.length;k<l;k+=1){var n=c[k],m=[];if(n.name==a||j.hasOwnProperty(n.name)){if(h)var p=performance.now();(i=n.task.process(h))&&b.loopChildren(this,n.name,function(a){j[a]=!0;h&&m.push(a);return b.SKIP});if(h)var q=performance.now();if(h){var r=Math.round(q-p,2);console.log(k+". "+n.name+(", "+
r+" ms. ")+(i?" - forces: "+m.toString():""))}}if(n.name==f)break}},getProcessDiagramConfig:function(){var e=new a.famdiagram.Config;0===c.length&&b.loopTopo(this,function(a,b){b.task=d.register(a,d.resolve(b.dependencies,b.factory)());c.push(b)});for(var f=0,h=c.length;f<h;f+=1){var i=c[f],j=new a.famdiagram.ItemConfig;j.id=i.name;j.title=a.common.splitCamelCaseName(i.name).join(" ");j.description=i.task.description||"";j.itemTitleColor=i.color;j.parents=[];b.loopParents(this,i.name,function(a){j.parents.push(a);
...
function(a){a.loop(this,function(a){0<a.length()&&this.polyline(a)})};a.pdf.graphics.prototype.polyline=function(a){var b=a.paletteItem.toAttr(),d,c=this._doc;c.save();a.loop(this,function(a){switch(a.segmentType){case 1:c.moveTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5);break;case 0:c.lineTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5);break;case 4:a.width==a.height&&a.width/2<=a.cornerRadius?c.roundedRect(Math.round(a.x)+0.5,Math.round(a.y)+0.5,a.width,a.height,Math.min(a.width,a.height)/2):0===a.cornerRadius?
(c.moveTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5),c.lineTo(Math.round(a.x+a.width)+0.5,Math.round(a.y)+0.5),c.lineTo(Math.round(a.x+a.width)+0.5,Math.round(a.y+a.height)+0.5),c.lineTo(Math.round(a.x)+0.5,Math.round(a.y+a.height)+0.5),c.lineTo(Math.round(a.x)+0.5,Math.round(a.y)+0.5)):(d=Math.min(a.cornerRadius,Math.min(a.width/2,a.height/2)),c.roundedRect(Math.round(a.x)+0.5,Math.round(a.y)+0.5,a.width,a.height,d));break;case 2:c.quadraticCurveTo(Math.round(a.cpX)+0.5,Math.round(a.cpY)+0.5,Math.round(a.x)+
0.5,Math.round(a.y)+0.5);break;case 3:c.bezierCurveTo(Math.round(a.cpX1)+0.5,Math.round(a.cpY1)+0.5,Math.round(a.cpX2)+0.5,Math.round(a.cpY2)+0.5,Math.round(a.x)+0.5,Math.round(a.y)+0.5)}});c.lineJoin("round");if(null!=b.lineType)switch(a=Math.round(b.lineWidth)||1,b.lineType){case 1:c.dash(a,2*a);break;case 2:c.dash(5*a,3*a)}void 0!==b.lineWidth&&void 0!==b.fillColor?c.lineWidth(b.lineWidth).fillOpacity(b.opacity).fillAndStroke(b.fillColor,b.borderColor):void 0!==b.lineWidth?c.lineWidth(b.lineWidth).stroke(b.borderColor):
void 0!==b.fillColor&&c.fillOpacity(b.opacity).fillColor(b.fillColor);c.restore()};a.pdf.graphics.prototype.rightAngleLine=function(){};a.pdf.graphics.prototype.template=function(f,b,d,c,e,g,h,i,j,k,l,n,m){d=0;null!==m&&void 0!==m.borderWidth&&(d=this.getPxSize(m.borderWidth));f=new a.common.Rect(f+e,b+g,h-d,i-d);null==n&&(n=new a.common.RenderEventArgs);null!==l&&l(this._doc,f,n)};a.pdf.graphics.prototype.getPxSize=function(a,b){var d=a;"string"===typeof a&&(d=0<a.indexOf("pt")?96*parseInt(a,10)/
72:0<a.indexOf("%")?parseFloat(a)/100*b:parseInt(a,10));return d};a.pdf.famdiagram.Plugin=function(f){function b(){return g.options}function d(){return g.graphics}function c(){var c=new a.common.TaskManager;c.addDependency("options",b);c.addDependency("graphics",d);c.addDependency("defaultConfig",new a.famdiagram.Config);c.addDependency("defaultItemConfig",new a.famdiagram.ItemConfig);c.addDependency("defaultTemplateConfig",new a.famdiagram.TemplateConfig);c.addDependency("defaultButtonConfig",new a.famdiagram.ButtonConfig);
c.addDependency("defaultPaletteItemConfig",new a.famdiagram.PaletteItemConfig);c.addDependency("defaultBackgroundAnnotationConfig",new a.famdiagram.BackgroundAnnotationConfig);c.addDependency("defaultConnectorAnnotationConfig",new a.famdiagram.ConnectorAnnotationConfig);c.addDependency("defaultHighlightPathAnnotationConfig",new a.famdiagram.HighlightPathAnnotationConfig);c.addDependency("defaultShapeAnnotationConfig",new a.famdiagram.ShapeAnnotationConfig);c.addDependency("defaultLabelAnnotationConfig",
new a.famdiagram.LabelAnnotationConfig);c.addDependency("isFamilyChartMode",!0);c.addDependency("showElbowDots",!0);c.addDependency("null",null);c.addDependency("foreground",2);c.addDependency("background",1);c.addTask("OptionsTask",["options"],a.famdiagram.OptionsTask,"#000000");c.addTask("CalloutOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.CalloutOptionTask,"#000080");c.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ConnectorsOptionTask,
"#000080");c.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.ItemsOptionTask,"#000080");c.addTask("SpousesOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.SpousesOptionTask,"#000080");c.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],a.orgdiagram.ItemsSizesOptionTask,"#000080");c.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],a.orgdiagram.TemplatesOptionTask,
"#000080");c.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.OrientationOptionTask,"#000080");c.addTask("VisualTreeOptionTask",["OptionsTask"],a.famdiagram.VisualTreeOptionTask,"#000080");c.addTask("NormalizeOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.NormalizeOptionTask,"#000080");c.addTask("LinePaletteOptionTask",["OptionsTask","defaultPaletteItemConfig"],a.famdiagram.LinePaletteOptionTask,"#000080");c.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],
a.orgdiagram.CursorItemOptionTask,"#000080");c.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.HighlightItemOptionTask,"#000080");c.addTask("SelectedItemsOptionTask",["OptionsTask"],a.orgdiagram.SelectedItemsOptionTask,"#000080");c.addTask("SplitAnnotationsOptionTask",["OptionsTask"],a.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");c.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],a.orgdiagram.ShapeAnnotationOptionTask,
"#000080");c.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");c.addTask("ForegroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");c.addTask("BackgroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig",
"background"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");c.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");c.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");c.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask",
"defaultBackgroundAnnotationConfig"],a.orgdiagram.BackgroundAnnotationOptionTask,"#000080");c.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ScaleOptionTask,"#000080");c.addTask("LogicalFamilyTask",["ItemsOptionTask"],a.famdiagram.LogicalFamilyTask,"#00ffff");c.addTask("LabelAnnotationOptionTask",["SplitAnnotationsOptionTask","LogicalFamilyTask","defaultLabelAnnotationConfig"],a.famdiagram.LabelAnnotationOptionTask,"#000080");c.addTask("LabelAnnotationTemplateOptionTask",["LabelAnnotationOptionTask",
"defaultLabelAnnotationConfig"],a.famdiagram.LabelAnnotationTemplateOptionTask,"#000080");c.addTask("LabelAnnotationPlacementOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],a.famdiagram.LabelAnnotationPlacementOptionTask,"#000080");c.addTask("CombinedContextsTask",["ItemsOptionTask","LabelAnnotationOptionTask"],a.orgdiagram.CombinedContextsTask,"#00ffff");c.addTask("AddLabelAnnotationsTask",["LabelAnnotationPlacementOptionTask","LogicalFamilyTask"],a.famdiagram.AddLabelAnnotationsTask,
"#ff0000");c.addTask("RemoveLoopsTask",["ItemsOptionTask","AddLabelAnnotationsTask"],a.famdiagram.RemoveLoopsTask,"#ff0000");c.addTask("AddSpousesTask",["SpousesOptionTask","RemoveLoopsTask"],a.famdiagram.AddSpousesTask,"#ff0000");c.addTask("NormalizeLogicalFamilyTask",["NormalizeOptionTask","AddSpousesTask","defaultItemConfig"],a.famdiagram.NormalizeLogicalFamilyTask,"#ff0000");c.addTask("ReadTemplatesTask",["TemplatesOptionTask"],a.pdf.orgdiagram.ReadTemplatesTask,"#00ffff");c.addTask("ItemTemplateParamsTask",
