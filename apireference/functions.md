...
## <a name="primitives.common.beforeOpacity">beforeOpacity</a>
...
## <a name="primitives.common.binarySearch">binarySearch</a>
...
## <a name="primitives.common.compareArrays">compareArrays</a>
...
## <a name="primitives.common.getBlue">getBlue</a>
...
## <a name="primitives.common.getColorHexValue">getColorHexValue</a>
...
## <a name="primitives.common.getColorName">getColorName</a>
...
## <a name="primitives.common.getCrossingRectangles">getCrossingRectangles</a>
...
## <a name="primitives.common.getGreen">getGreen</a>
...
## <a name="primitives.common.getLiniarBreaks">getLiniarBreaks</a>
...
## <a name="primitives.common.getMergedRectangles">getMergedRectangles</a>
...
## <a name="primitives.common.getMinimumCrossingRows">getMinimumCrossingRows</a>
...
## <a name="primitives.common.getRed">getRed</a>
...
## <a name="primitives.common.highestContrast">highestContrast</a>
...
## <a name="primitives.common.indexOf">indexOf</a>
...
## <a name="primitives.common.luminosity">luminosity</a>
...
## <a name="primitives.common.mergeSort">mergeSort</a>
