primitives.orgdiagram.DrawHighlightPathAnnotationTask = function (getGraphics, connectorsOptionTask, highlightPathAnnotationOptionTask, connectionsGraphTask, zOrderType) {
  function process() {
    ...
    switch (zOrderType) {
      case primitives.common.ZOrderType.Background://ignore jslint
        graphics.reset("placeholder", primitives.common.Layers.BackgroundHighlightPathAnnotations);
        break;
      case primitives.common.ZOrderType.Foreground://ignore jslint
        graphics.reset("placeholder", primitives.common.Layers.ForegroundHighlightPathAnnotations);
        break;
    }
  ...
  function drawAnnotations(graphics, highlightOptions, annotations, graph) {
    ...
    if (annotations.length > 0) {
      ...
      switch (zOrderType) {
        case primitives.common.ZOrderType.Background://ignore jslint
          panel = graphics.activate("placeholder", primitives.common.Layers.BackgroundHighlightPathAnnotations);
          break;
        case primitives.common.ZOrderType.Foreground://ignore jslint
          panel = graphics.activate("placeholder", primitives.common.Layers.ForegroundHighlightPathAnnotations);
          break;
      }
