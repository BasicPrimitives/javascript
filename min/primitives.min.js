/*
 Basic Primitives Diagrams v5.6.2
...
typeof document){var M=a.common.JsonML,N=document,ea=function(a){this.value=a},fa=function(a){return"function"===typeof a},W=function(a){switch(typeof a){case "object":return!a?0:ba(a)?2:ga(a)?5:a instanceof Date?4:3;case "function":return 1;case "undefined":return 0;default:return 4}},oa={accesskey:"accessKey",bgcolor:"bgColor",cellpadding:"cellPadding",cellspacing:"cellSpacing",checked:"defaultChecked","class":"className",colspan:"colSpan",contenteditable:"contentEditable",defaultchecked:"defaultChecked",
"for":"htmlFor",formnovalidate:"formNoValidate",hidefocus:"hideFocus",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",readonly:"readOnly",rowspan:"rowSpan",spellcheck:"spellCheck",tabindex:"tabIndex",usemap:"useMap",willvalidate:"willValidate"},X={enctype:"encoding",onscroll:"DOMMouseScroll"},pa={autocapitalize:1,autocomplete:1,autocorrect:1},qa={async:1,autofocus:1,checked:1,defaultchecked:1,defer:1,disabled:1,formnovalidate:1,hidden:1,indeterminate:1,ismap:1,multiple:1,novalidate:1,
readonly:1,required:1,spellcheck:1,willvalidate:1},ra=/^[\r\n]+/,sa=/[\r\n]+$/;ea.prototype.toString=function(){return this.value};M.raw=function(a){return new ea(a)};var ga=M.isRaw=function(a){return a instanceof ea},ba=Array.isArray||function(a){return a instanceof Array},O=function(a){if(a){if("!"===a.charAt(0))return N.createComment("!"===a?"":a.substr(1)+" ")}else{if(N.createDocumentFragment)return N.createDocumentFragment();a=""}return"style"===a.toLowerCase()&&N.createStyleSheet?N.createStyleSheet():
N.createElement(a)},ja=function(a,b,d){"on"===b.substr(0,2)&&(b=b.substr(2));switch(typeof d){case "function":if(a.addEventListener)a.addEventListener(b,d,!1);else if(a.attachEvent&&0!==W(a[b]))a.attachEvent("on"+b,d);else{var c=a["on"+b]||a[b];a["on"+b]=a[b]=!fa(c)?d:function(a){return!1!==c.call(this,a)&&!1!==d.call(this,a)}}break;case "string":a["on"+b]=new Function("event",d)}},ta=M.applyStyles=function(a,b){for(var d in b)b.hasOwnProperty(d)&&(a.style[d]=b[d]);return a},ca=M.appendDOM=function(a,
b){if(b){var d=(a.tagName||"").toLowerCase();if(8===a.nodeType)3===b.nodeType&&(a.nodeValue+=b.nodeValue);else if("table"===d&&a.tBodies)if(b.tagName)if((d=b.tagName.toLowerCase())&&"tbody"!==d&&"thead"!==d){var c=0<a.tBodies.length?a.tBodies[a.tBodies.length-1]:null;c||(c=O("th"===d?"thead":"tbody"),a.appendChild(c));c.appendChild(b)}else!1!==a.canHaveChildren&&a.appendChild(b);else{if(11===b.nodeType)for(;b.firstChild;)ca(a,b.removeChild(b.firstChild))}else if("style"===d&&N.createStyleSheet)a.cssText=
b;else if(!1!==a.canHaveChildren)a.appendChild(b);else if("object"===d&&b.tagName&&"param"===b.tagName.toLowerCase()){try{a.appendChild(b)}catch(f){}try{a.object&&(a.object[b.name]=b.value)}catch(e){}}}},ka=function(a){return!!a&&3===a.nodeType&&(!a.nodeValue||!/\S/.exec(a.nodeValue))},la=function(a,b){a&&(3===a.nodeType&&b.exec(a.nodeValue))&&(a.nodeValue=a.nodeValue.replace(b,""))},ha=function(a){if(a){for(;ka(a.firstChild);)a.removeChild(a.firstChild);for(la(a.firstChild,ra);ka(a.lastChild);)a.removeChild(a.lastChild);
la(a.lastChild,sa)}},ma=function(a){var b=O("div");b.innerHTML=""+a;ha(b);if(1===b.childNodes.length)return b.firstChild;for(a=O("");b.firstChild;)a.appendChild(b.firstChild);return a},ua=function(a){return N.createTextNode("["+a+"]")};M.onerror=null;var na=M.patch=function(a,b,d){for(var c=1;c<b.length;c+=1)if(ba(b[c])||"string"===typeof b[c])ca(a,ia(b[c],d));else if(ga(b[c]))ca(a,ma(b[c].value));else if("object"===typeof b[c]&&null!==b[c]&&1===a.nodeType){var f=b[c];if(f.name&&N.attachEvent&&!a.parentNode)try{var e=
O("<"+a.tagName+' name="'+f.name+'">');a.tagName===e.tagName&&(a=e)}catch(h){}var i=void 0;for(i in f)if(f.hasOwnProperty(i)){var j=f[i],k=W(j);if(i)if(0===k&&(j="",k=4),i=oa[i.toLowerCase()]||i,"$"===i)j(a);else if("className"==i)if(ba(j))for(k=0;k<j.length;k+=1)a.className+=" "+j[k];else a.className+=" "+j;else"style"===i?0!==W(a.style.cssText)?"string"==typeof j?a.style.cssText=j:ta(a,j):a.style=j:"on"===i.substr(0,2)?(ja(a,i,j),(i=X[i])&&ja(a,i,j)):!pa[i.toLowerCase()]&&(4!==k||"$"===i.charAt(0)||
0!==W(a[i])||0!==W(a[X[i]]))?(a[i]=j,(i=X[i])&&(a[i]=j)):qa[i.toLowerCase()]?j&&(a.setAttribute(i,i),(i=X[i])&&a.setAttribute(i,i)):(a.setAttribute(i,j),(i=X[i])&&a.setAttribute(i,j))}}return a},ia=M.toHTML=function(a,b){try{if(!a)return null;if("string"===typeof a)return N.createTextNode(a);if(ga(a))return ma(a.value);if(!ba(a)||"string"!==typeof a[0])throw new SyntaxError("invalid JsonML");var d=a[0];if(!d){for(var c=O(""),d=1;d<a.length;d+=1)ca(c,ia(a[d],b));ha(c);return 1===c.childNodes.length?
c.firstChild:c}if("style"===d.toLowerCase()&&N.createStyleSheet)return na(N.createStyleSheet(),a,b),null;var f=na(O(d),a,b);ha(f);return f&&fa(b)?b(f):f}catch(e){try{return(fa(M.onerror)?M.onerror:ua)(e,a,b)}catch(h){return N.createTextNode("["+h+"]")}}};M.toHTMLText=function(a,b){var d=ia(a,b);if(d.outerHTML)return d.outerHTML;var c=O("div");c.appendChild(d);var f=c.innerHTML;c.removeChild(d);return f}}a.common.AdviserPlacementType={Auto:0,Left:2,Right:3};a.orgdiagram.AdviserPlacementType=a.common.AdviserPlacementType;
...
g.addSegment(new a.common.LineSegment(k));null!==i?(g.addSegment(new a.common.LineSegment(i)),g.addSegment(new a.common.LineSegment(c))):g.addSegment(new a.common.QuadraticArcSegment(d,c))};a.common.ConnectorOffbeat=function(){};a.common.ConnectorOffbeat.prototype=new a.common.BaseShape;a.common.ConnectorOffbeat.prototype.draw=function(g,b,d,c,f,e,h,i,j,k,m,n,l,p,q){var r,s,t,w,v,A,x,B,l=e=0,z=null,y,u;y=g.getPolyline(b);v=[];switch(j){case 1:v=[-f/2,f/2];u=!1;break;case 0:v=[0];u=!1;break;case 2:v=
[0],u=!0}r=Math.max(n?h.width:0,5*f);if(d.right()+r<c.left()||d.left()>c.right()+r)if(d.left()>c.right()?(t=new a.common.Point(d.left(),d.verticalCenter()),w=new a.common.Point(c.right(),c.verticalCenter())):(t=new a.common.Point(d.right(),d.verticalCenter()),w=new a.common.Point(c.left(),c.verticalCenter())),n&&(d.left()>c.right()?(e=7,l=3):(e=3,l=7)),s=new a.common.Rect(t,w),B=t.y<=w.y,x=t.x<w.x,s.height<s.width){s.height<2*f&&s.offset(0,B?2*f:0,0,B?0:2*f);i=0;for(r=v.length;i<r;i+=1)A=v[i],g.addInverted(function(c){c=
c.getPolyline(b);c.addSegment(new a.common.MoveSegment(t.x,t.y+A));c.addSegment(new a.common.QuadraticArcSegment(s.horizontalCenter(),(B?s.top():s.bottom())+A,w.x,w.y+A));u&&c.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))});n&&(j=h.width<2*(s.width/5)?a.common.QuadraticArcSegment.prototype.offsetPoint(t.x,t.y,s.horizontalCenter(),B?s.top():s.bottom(),w.x,w.y,0.5):new a.common.Point(t.x,
B?s.top():s.bottom()),z=new a.common.Rect(j.x+(x?f:-h.width-f),B?j.y-h.height-f:j.y+f,h.width,h.height))}else{i=0;for(r=v.length;i<r;i+=1)A=v[i],g.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new a.common.MoveSegment(t.x,t.y+A));c.addSegment(new a.common.QuadraticArcSegment(s.horizontalCenter()+A*(B!=x?1:-1),(B?s.top():s.bottom())+A,s.horizontalCenter()+A*(B!=x?1:-1),s.verticalCenter()+A));c.addSegment(new a.common.QuadraticArcSegment(s.horizontalCenter()+A*(B!=x?1:-1),(B?s.bottom():s.top())+
A,w.x,w.y+A));u&&c.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))});n&&(z=new a.common.Rect(s.horizontalCenter()+(B!=x?f:-(f+h.width)),s.verticalCenter()-h.height/2,h.width,h.height))}else if(d.verticalCenter()<c.top()||d.verticalCenter()>c.bottom()){x=d.x<i.width/2;t=new a.common.Point(x?d.right():d.left(),d.verticalCenter());w=new a.common.Point(x?c.right():c.left(),c.verticalCenter());
s=new a.common.Rect(t,w);s.offset(10*f,0,10*f,0);B=t.y<=w.y;i=0;for(r=v.length;i<r;i+=1)A=v[i],g.addInverted(function(d){d=d.getPolyline(b);d.addSegment(new a.common.MoveSegment(t.x,t.y+A));d.addSegment(new a.common.QuadraticArcSegment(x?s.right()+A*(B?-1:1):s.left()-A*(B?-1:1),s.verticalCenter(),x?c.right():c.left(),c.verticalCenter()-A));u&&d.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))});
n&&(l=e=x?3:7,j=a.common.QuadraticArcSegment.prototype.offsetPoint(t.x,t.y,x?s.right():s.left(),s.verticalCenter(),w.x,w.y,0.5),z=new a.common.Rect(j.x+(x?f/2:-f/2-h.width),j.y-h.height/2,h.width,h.height))}else{t=new a.common.Point(d.horizontalCenter(),d.top());w=new a.common.Point(c.horizontalCenter(),c.top());s=new a.common.Rect(t,w);s.offset(0,7*f,0,0);x=t.x<w.x;i=0;for(r=v.length;i<r;i+=1)A=v[i],g.addInverted(function(d){d=d.getPolyline(b);d.addSegment(new a.common.MoveSegment(t.x+A,t.y));d.addSegment(new a.common.QuadraticArcSegment(s.horizontalCenter(),
s.top()-A*(x?-1:1),c.horizontalCenter()-A,c.top()));u&&d.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))});n&&(l=e=1,j=a.common.QuadraticArcSegment.prototype.offsetPoint(t.x,t.y,s.horizontalCenter(),s.top(),w.x,w.y,0.5),z=new a.common.Rect(j.x-h.width/2,j.y-(k+h.height),h.width,h.height))}if(n)switch(m){case 0:z=this._getLabelPosition(d.x,d.y,d.width,d.height,z.width,z.height,k,e);break;
case 2:z=this._getLabelPosition(c.x,c.y,c.width,c.height,z.width,z.height,k,l)}null!=p&&p(z,q)};a.common.ConnectorStraight=function(){};a.common.ConnectorStraight.prototype=new a.common.BaseShape;a.common.ConnectorStraight.prototype.draw=function(g,b,d,c,f,e,h,i,j,k,m,n,l,p,q){var r,s,t,w,v,A=f/2,x=null,B=0,z=0,y=this;w=new a.common.Vector(d.centerPoint(),c.centerPoint());d.loopEdges(function(a,b){r=a.getIntersectionPoint(w,!0,1);B=b;return null!=r});c.loopEdges(function(a,b){s=a.getIntersectionPoint(w,
!0,1);z=b;return null!=s});if(null!=r&&null!=s){var u=new a.common.Vector(r,s);l.getOffset(u,function(c,d,f){u.offset((c*e-(d-1)*e/2)*f);r=u.from;s=u.to;switch(j){case 1:v=new a.common.Vector(s.clone(),r.clone());v.offset(A);y._drawLine(g,b,v.from,v.to,!1);v=new a.common.Vector(r.clone(),s.clone());v.offset(A);y._drawLine(g,b,v.from,v.to,!1);break;case 0:y._drawLine(g,b,r,s,!1);break;case 2:y._drawLine(g,b,r,s,!0)}if(n){switch(m){case 0:x=y._getLabelPositionBySnapPoint(r.x,r.y,h.width,h.height,k,
...
b){return"function"==typeof b?b:null};a.common.ObjectReader=function(a,b,d){this.dataTemplate=a;this.isNullable=b;this.defaultValue=d};a.common.ObjectReader.prototype.read=function(g,b,d,c){var f=null,e=a.common.isObject(g),h,i;b||(b=this.isNullable?null:this.defaultValue);if(a.common.isObject(b))for(h in f={},this.dataTemplate)this.dataTemplate.hasOwnProperty(h)&&(i=this.dataTemplate[h],f[h]=i.read(e?g[h]:null,b[h],d+"-"+h,c));else f=b,g!==b&&(c.isChanged=!0);return f};a.common.ValueReader=function(a,
b,d){this.acceptedTypes=a;this.isNullable=b;this.defaultValue=d;this.hash={};for(b=0;b<a.length;b+=1)this.hash[a[b]]=!0};a.common.ValueReader.prototype.stringify=function(a){if(!0==this.hash.object){var b=[];return JSON.stringify(a,function(a,c){return"_"===a[0]?null:null!==c&&"object"==typeof c?-1==b.indexOf(c)?(b.push(c),c):null:c})}return a};a.common.ValueReader.prototype.read=function(a,b,d,c){d=null;if(null===b||"undefined"==typeof b||!this.hash.hasOwnProperty(typeof b))b=this.isNullable?null:
this.defaultValue;d=b;this.stringify(a)!==this.stringify(b)&&(c.isChanged=!0);return d};a.famdiagram.EventArgs=function(){this.context=this.oldContext=null;this.parentItems=[];this.childrenItems=[];this.name=this.position=null;this.cancel=!1};a.famdiagram.TemplateConfig=function(){this.name=null;this.isActive=!0;this.itemSize=new a.common.Size(120,100);this.itemBorderWidth=1;this.minimizedItemShapeType=this.itemTemplate=null;this.minimizedItemSize=new a.common.Size(4,4);this.minimizedItemCornerRadius=
null;this.minimizedItemLineWidth=1;this.minimizedItemBorderColor=null;this.minimizedItemLineType=0;this.minimizedItemFillColor=null;this.minimizedItemOpacity=1;this.highlightPadding=new a.common.Thickness(2,2,2,2);this.highlightBorderWidth=1;this.highlightTemplate=null;this.cursorPadding=new a.common.Thickness(3,3,3,3);this.cursorBorderWidth=2;this.onButtonsRender=this.buttons=this.cursorTemplate=null};a.famdiagram.BackgroundAnnotationConfig=function(g){var b;this.annotationType=4;this.items=[];this.zOrderType=
0;this.offset=new a.common.Thickness(18,18,18,18);this.lineWidth=2;this.opacity=1;this.fillColor=this.borderColor=null;this.lineType=0;this.selectItems=!1;switch(arguments.length){case 1:if(null!==g)if(g instanceof Array)this.items=g;else if("object"==typeof g)for(b in g)g.hasOwnProperty(b)&&(this[b]=g[b])}};a.famdiagram.ButtonConfig=function(g,b,d){this.name=g;this.icon=b;this.text=!1;this.label=null;this.tooltip=d;this.size=new a.common.Size(16,16)};a.famdiagram.Config=function(g){this.name=void 0!==
g?g:"FamDiagram";this.classPrefix="famdiagram";this.graphicsType=this.navigationMode=0;this.pageFitMode=3;this.minimalVisibility=2;this.orientationType=0;this.verticalAlignment=1;this.arrowsDirection=0;this.showExtraArrows=!0;this.extraArrowsMinimumSpace=30;this.groupByType=2;this.alignBylevels=!0;this.enableMatrixLayout=!1;this.minimumMatrixSize=4;this.maximumColumnsInMatrix=6;this.hideGrandParentsConnectors=!1;this.elbowType=3;this.elbowDotSize=this.bevelSize=4;this.emptyDiagramMessage="Diagram is empty.";
this.items=[];this.annotations=[];this.highlightItem=this.cursorItem=null;this.highlightGravityRadius=40;this.selectedItems=[];this.hasSelectorCheckbox=0;this.selectCheckBoxLabel="Selected";this.neighboursSelectionMode=this.selectionPathMode=0;this.templates=[];this.defaultLabelAnnotationTemplate=this.defaultTemplateName=null;this.hasButtons=0;this.buttons=[];this.onCursorRender=this.onHighlightRender=this.onItemRender=this.onMouseDblClick=this.onMouseClick=this.onButtonClick=this.onSelectionChanged=
this.onSelectionChanging=this.onCursorChanged=this.onCursorChanging=this.onHighlightChanged=this.onHighlightChanging=this.onButtonsRender=null;this.dotLevelShift=this.normalLevelShift=20;this.normalItemsInterval=this.lineLevelShift=10;this.dotItemsInterval=1;this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#000080";this.minimizedItemShapeType=6;this.linesColor="#c0c0c0";this.linesWidth=1;this.linesType=0;this.showNeigboursConnectorsHighlighted=
!1;this.highlightLinesColor="#ff0000";this.highlightLinesWidth=1;this.highlightLinesType=0;this.linesPalette=[];this.showCallout=!0;this.calloutMaximumVisibility=2;this.calloutPlacementOffset=100;this.defaultCalloutTemplateName=null;this.calloutfillColor="#000000";this.calloutBorderColor=null;this.calloutCornerRadius=this.calloutOffset=4;this.calloutPointerWidth="10%";this.calloutLineWidth=1;this.calloutOpacity=0.2;this.buttonsPanelSize=28;this.checkBoxPanelSize=this.groupTitlePanelSize=24;this.groupTitleOrientation=
this.groupTitlePlacementType=2;this.groupTitleVerticalAlignment=1;this.groupTitleHorizontalAlignment=0;this.groupTitleFontSize="12px";this.groupTitleFontFamily="Arial";this.groupTitleColor="#4169e1";this.groupTitleFontStyle=this.groupTitleFontWeight="normal";this.distance=3;this.scale=1;this.minimumScale=0.5;this.maximumScale=1;this.showLabels=0;this.labelSize=new a.common.Size(80,24);this.labelOffset=1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";
this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight="normal";this.enablePanning=!0;this.autoSizeMinimum=new a.common.Size(800,600);this.autoSizeMaximum=new a.common.Size(1024,768)};a.famdiagram.ConnectorAnnotationConfig=function(g,b){var d;this.annotationType=0;this.zOrderType=2;this.toItem=this.fromItem=null;this.connectorPlacementType=this.connectorShapeType=0;this.labelPlacementType=1;this.offset=new a.common.Thickness(0,0,0,0);this.lineWidth=2;this.color="#000000";this.lineType=
0;this.selectItems=!0;this.label=null;this.labelSize=new a.common.Size(60,30);switch(arguments.length){case 1:for(d in g)g.hasOwnProperty(d)&&(this[d]=g[d]);break;case 2:this.fromItem=g,this.toItem=b}};a.famdiagram.HighlightPathAnnotationConfig=function(a){var b;this.zOrderType=this.annotationType=2;this.items=[];this.lineWidth=2;this.color="#ff0000";this.lineType=0;this.opacity=1;this.showArrows=!0;this.selectItems=!1;switch(arguments.length){case 1:if(null!==a)if(a instanceof Array)this.items=a;
else if("object"==typeof a)for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};a.famdiagram.ItemConfig=function(a,b,d,c,f){var e;this.id=null;this.parents=[];this.spouses=[];this.relativeItem=null;this.placementType=3;this.context=this.image=this.description=this.title=this.position=null;this.itemTitleColor="#4169e1";this.groupTitle=this.minimizedItemShapeType=null;this.groupTitleColor="#4169e1";this.isActive=!0;this.hasButtons=this.hasSelectorCheckbox=0;this.templateName=null;this.showCallout=0;this.label=
this.calloutTemplateName=null;this.showLabel=0;this.labelSize=null;this.labelOrientation=3;this.labelPlacement=0;switch(arguments.length){case 1:for(e in a)a.hasOwnProperty(e)&&(this[e]=a[e]);break;case 5:this.id=a,this.parents=b,this.title=d,this.description=c,this.image=f}};a.famdiagram.LabelAnnotationConfig=function(a,b){var d;this.annotationType=3;this.fromItem=null;this.toItems=[];this.title=null;this.itemTitleColor="#4169e1";this.templateName=null;switch(arguments.length){case 1:for(d in a)a.hasOwnProperty(d)&&
(this[d]=a[d]);break;case 2:this.fromItem=a,this.toItem=b}};a.famdiagram.PaletteItemConfig=function(a,b,d){var c;this.lineColor="#c0c0c0";this.lineWidth=1;this.lineType=0;switch(arguments.length){case 1:for(c in a)a.hasOwnProperty(c)&&(this[c]=a[c]);break;case 3:this.lineColor=a,this.lineWidth=b,this.lineType=d}};a.famdiagram.ShapeAnnotationConfig=function(g){var b;this.annotationType=1;this.zOrderType=0;this.items=[];this.shapeType=0;this.offset=new a.common.Thickness(0,0,0,0);this.lineWidth=2;this.cornerRadius=
"10%";this.opacity=1;this.fillColor=this.borderColor=null;this.lineType=0;this.selectItems=!1;this.label=null;this.labelSize=new a.common.Size(60,30);this.labelPlacement=0;this.labelOffset=4;switch(arguments.length){case 1:if(null!==g)if(g instanceof Array)this.items=g;else if("object"==typeof g)for(b in g)g.hasOwnProperty(b)&&(this[b]=g[b])}};a.famdiagram.EdgeItem=function(a,b,d,c){this.values=[b,c];this[a]=0;this[d]=1};a.famdiagram.EdgeItem.prototype.getNear=function(a){return this.values[this[a]]};
a.famdiagram.EdgeItem.prototype.getFar=function(a){return this.values[Math.abs(this[a]-1)]};a.famdiagram.EdgeItem.prototype.setNear=function(a,b){this.values[this[a]]=b};a.famdiagram.EdgeItem.prototype.setFar=function(a,b){this.values[Math.abs(this[a]-1)]=b};a.famdiagram.EdgeItem.prototype.toString=function(){return this.parent+","+this.child};a.famdiagram.FamilyItem=function(a){var b;this.itemConfig=this.familyId=this.id=null;this.isActive=this.isVisible=!0;this.isLevelNeutral=!1;this.level=null;
this.levelGravity=0;this.hideChildrenConnection=this.hideParentConnection=!1;switch(arguments.length){case 1:for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};a.famdiagram.Slot=function(a){this.itemId=a;this.position=null;this.balance=0;this.left={};this.right={};this.crossings={}};a.famdiagram.Slot.prototype.clone=function(g){var b=new a.famdiagram.Slot(g),d;for(d in this.left)this.left.hasOwnProperty(d)&&(b.left[d]=this.left[d]);for(d in this.right)this.right.hasOwnProperty(d)&&(b.right[d]=this.right[d]);
for(d in this.crossings)this.crossings.hasOwnProperty(d)&&(b.crossings[d]=this.crossings[d]);b.itemid=g;return b};a.famdiagram.LabelAnnotationOptionTask=function(g,b,d){var c=[],f={},e=null,h={},i=new a.common.ArrayReader(new a.common.ObjectReader({zOrderType:new a.common.EnumerationReader(a.common.ZOrderType,!1,d.zOrderType),fromItem:new a.common.ValueReader(["string","number"],!0),toItems:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0),title:new a.common.ValueReader(["string"],
!0),itemTitleColor:new a.common.ValueReader(["string"],!1,d.itemTitleColor),templateName:new a.common.ValueReader(["string"],!0)},!1),!1,null,!0);return{process:function(){var a={isChanged:!1,hash:h,sourceHash:{}},d=b.getMaximumId(),m,n,l;c=i.read(c,g.getAnnotations(3),"annotations",a);f={};var p=a.sourceHash.annotations;m=0;for(n=c.length;m<n;m+=1)l=c[m],d+=1,l.id=d,f[l.id]=p[m];e=d;return a.isChanged},getAnnotations:function(){return c},getMaximumId:function(){return e},getConfig:function(a){return f[a]}}};
a.famdiagram.LabelAnnotationPlacementOptionTask=function(g){var b=[],d={},c=new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["number"],!0),fromItem:new a.common.ValueReader(["string","number"],!0),toItems:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0)}),!0,"id");return{process:function(){var a={isChanged:!1,hash:d};b=c.read(b,g.getAnnotations(),"annotations",a);return a.isChanged},getAnnotations:function(){return b},getMaximumId:function(){return g.getMaximumId()}}};
a.famdiagram.LabelAnnotationTemplateOptionTask=function(g,b){var d=[],c={},f=new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["number"],!0),title:new a.common.ValueReader(["string"],!0),itemTitleColor:new a.common.ValueReader(["string"],!1,b.itemTitleColor),templateName:new a.common.ValueReader(["string"],!0)}),!0,"id");return{process:function(){var a={isChanged:!1,hash:c};d=f.read(d,g.getAnnotations(),"annotations",a);return a.isChanged},getAnnotations:function(){return d}}};
a.famdiagram.NeighboursSelectionModeOptionTask=function(g,b){var d={},c=new a.common.ObjectReader({neighboursSelectionMode:new a.common.EnumerationReader(a.common.NeighboursSelectionMode,!1,b.neighboursSelectionMode)});return{process:function(){var a={isChanged:!1};d=c.read(d,g.getOptions(),"options",a);return a.isChanged},getNeighboursSelectionMode:function(){return d.neighboursSelectionMode}}};a.famdiagram.HideGrandParentsConnectorsOptionTask=function(g,b){var d={},c={},f=new a.common.ObjectReader({hideGrandParentsConnectors:new a.common.ValueReader(["boolean"],
!1,b.hideGrandParentsConnectors)});return{process:function(){var a={isChanged:!1,hash:c};d=f.read(d,g.getOptions(),"options",a);return a.isChanged},getOptions:function(){return d}}};a.famdiagram.ItemsOptionTask=function(g,b){var d={},c={},f={},e=new a.common.ObjectReader({items:new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["string","number"],!0),parents:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0),isActive:new a.common.ValueReader(["boolean"],
!1,b.isActive)}),!0,"id",!0)});return{process:function(){var a={isChanged:!1,hash:c,sourceHash:f};d=e.read(d,g.getOptions(),"options",a);return a.isChanged},getItems:function(){return d.items},getConfig:function(a){return f["options-items"][a]}}};a.famdiagram.LinePaletteOptionTask=function(g,b){var d={},c={},f=new a.common.ObjectReader({linesPalette:new a.common.ArrayReader(new a.common.ObjectReader({lineColor:new a.common.ValueReader(["string"],!1,b.lineColor),lineWidth:new a.common.ValueReader(["number"],
!1,b.lineWidth),lineType:new a.common.EnumerationReader(a.common.LineType,!1,b.lineType)}),!1)});return{process:function(){var a={isChanged:!1,hash:c};d=f.read(d,g.getOptions(),"options",a);return a.isChanged},getOptions:function(){return d}}};a.famdiagram.NormalizeOptionTask=function(g,b){var d={},c={},f=new a.common.ObjectReader({groupByType:new a.common.EnumerationReader(a.common.GroupByType,!1,b.groupByType),alignBylevels:new a.common.ValueReader(["boolean"],!1,b.alignBylevels)});return{process:function(){var a=
...
!1,b.maximumColumnsInMatrix),items:new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["string","number"],!0),position:new a.common.ValueReader(["number"],!0),relativeItem:new a.common.ValueReader(["string","number"],!0),placementType:new a.common.EnumerationReader(a.common.AdviserPlacementType,!1,d.placementType)}),!0,"id")});return{process:function(){var a={isChanged:!1,hash:f};c=e.read(c,g.getOptions(),"options",a);return a.isChanged},getOptions:function(){return c}}};
a.famdiagram.SpousesOptionTask=function(g){var b={},d={},c=new a.common.ObjectReader({items:new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["string","number"],!0),spouses:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0)}),!0,"id")});return{process:function(){var a={isChanged:!1,hash:d};b=c.read(b,g.getOptions(),"options",a);return a.isChanged},getItems:function(){return b.items}}};a.famdiagram.VisualTreeOptionTask=function(){var a={leavesPlacementType:2,
childrenPlacementType:2,maximumColumnsInMatrix:6,horizontalAlignment:0};return{process:function(){return!1},getOptions:function(){return a}}};a.famdiagram.CombinedTemplateParamsTask=function(a,b){return{process:function(){return!0},getTemplateParams:function(d){return a.getTemplateParams(d)||b.getTemplateParams(d)}}};a.famdiagram.LabelAnnotationTemplateParamsTask=function(g,b,d){var c={};return{process:function(){var f=g.getOptions(),e=b.getAnnotations(),h,i;c={};h=0;for(i=e.length;h<i;h+=1){var j=
e[h],k=new a.orgdiagram.TemplateParams,m=d.getTemplate(j.templateName,f.defaultLabelAnnotationTemplate,d.DefaultWidgetLabelAnnotationTemplateName);k.template=m;c[j.id]=k}return!0},getTemplateParams:function(a){return c[a]}}};a.famdiagram.BaseTransformer=function(a){this.debug=a};a.famdiagram.BaseTransformer.prototype.validate=function(a,b){if(!a.validate())throw"Family structure failed to pass validation!";a.loop(this,function(d,c){a.loopChildren(this,d,function(d,e){if(null===e.level||null===c.level||
(b?e.level!=c.level+1:e.level<=c.level))throw"Family tree is broken. Children/Parents or levels mismatch!";return a.SKIP})})};a.famdiagram.FamilyBalance=function(){this.properties="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement minimizedItemShapeType".split(" ")};a.famdiagram.FamilyBalance.prototype.balance=function(g){var b={maximumId:null,
treeLevels:a.common.TreeLevels(),bundles:[],connectorStacks:[]},d={orgTree:a.common.tree(),maximumId:g.maximumId,orgPartners:{},itemByChildrenKey:{},minimumLevel:null,maximumLevel:null};this.createOrgTree(g,d);d.orgTree.loopLevels(this,function(a,d,g){b.treeLevels.addItem(g,a,d)});this.recalcLevelsDepth(b.bundles,b.connectorStacks,b.treeLevels,d.orgTree,d.orgPartners);b.maximumId=d.maximumId;return b};a.famdiagram.FamilyBalance.prototype.Family=function(a){this.id=null;this.familyPriority=1;this.childFamilies=
[];this.items=[];this.links=[];this.backLinks=[];1==arguments.length&&(this.id=a)};a.famdiagram.FamilyBalance.prototype.FamLink=function(a,b){this.fromItem=a;this.toItem=b};a.famdiagram.FamilyBalance.prototype.createOrgTree=function(g,b){var d,c,f,e,h,i,j,k,m=[],n,l,p,q,r,s,t,w,v,A,x=[],B;if(0<g.logicalFamily.hasNodes()){A={};l=0;B=[];g.logicalFamily.loopRoots(this,function(a){p=new this.Family(l);this.extractOrgChart(a,g.logicalFamily,g.defaultItemConfig,b.orgTree,b.orgPartners,b.itemByChildrenKey,
A,p);x.push(p);B.push(p);l+=1});B.sort(function(a,b){var c=a.items[0].level,d=b.items[0].level;return c!=d?c-d:b.items.length-a.items.length});m=[];n={};if(0<x.length){h=a.common.graph();d=0;for(c=x.length;d<c;d+=1){p=x[d];f=0;for(e=p.links.length;f<e;f+=1)i=p.links[f],j=g.logicalFamily.node(i.fromItem).familyId,k=g.logicalFamily.node(i.toItem).familyId,j!=k&&(h.addEdge(j,k,{weight:0}),h.edge(j,k).weight+=1),x[k].backLinks.push(new this.FamLink(i.toItem,i.fromItem))}for(;m.length<x.length;){d=0;for(c=
B.length;d<c;d+=1)p=B[d],n.hasOwnProperty(p.id)||(w=h.getSpanningTree(p.id,function(a){return-a.weight}),null!=w.node(p.id)?(w.loopPostOrder(this,function(a,b,c){var b=x[a],d=x[c],g=[];null!=c&&(d.familyPriority+=b.familyPriority);g=[];w.loopChildren(this,a,function(a){g.push(a)});g.sort(function(a,b){return x[a].familyPriority-x[b].familyPriority});w.arrangeChildren(a,g)}),w.loopPreOrder(this,function(a){m.push(a);n[a]=!0})):(m.push(p.id),n[p.id]=!0))}}b.maximumId+=1;v=this.createOrgItem(b.orgTree,
g.defaultItemConfig,b.maximumId,null,null,b.minimumLevel-1,null);v.hideParentConnection=!0;v.hideChildrenConnection=!0;v.title="internal root";v.isVisible=!1;v.isActive=!1;v.childIndex=0;h={};d=0;for(c=m.length;d<c;d+=1){p=x[m[d]];k={};s=v;t=0;e=p.links.concat(p.backLinks);for(f=0;f<e.length;f+=1)i=e[f],j=b.orgTree.node(i.toItem),b.orgTree.node(i.fromItem),!0===h[j.familyId]&&(q=p.items[0],r=j,r.level>=q.level&&b.orgTree.loopParents(this,r.id,function(a,b){r=b;if(b.level<q.level)return!0}),k[r.id]=
k.hasOwnProperty(r.id)?k[r.id]+1:1,t<k[r.id]&&(s=r,t=k[r.id]));this.attachFamilyToOrgChart(b,g.defaultItemConfig,s,p);h[p.id]=!0}d=this.getExtraGravity(b);c=this.getGrandChildren(b);this.balanceOrgTree(b.orgTree,d,c,g.itemsPositions,g.itemsGroups)}};a.famdiagram.FamilyBalance.prototype.getGrandChildren=function(a){var b={};a.orgTree.loopPostOrder(this,function(d,c,f){a.minimumLevel=null!=a.minimumLevel?Math.min(a.minimumLevel,c.level):c.level;a.maximumLevel=null!=a.maximumLevel?Math.max(a.maximumLevel,
c.level):c.level;if(null!=f&&(b[f]||(b[f]={}),c=c.level-1,b[f][c]=b[f][c]?b[f][c]+1:1,null!=b[d]))for(c in b[d])b[d].hasOwnProperty(c)&&(b[f][c]=b[f][c]?b[f][c]+b[d][c]:b[d][c])});return b};a.famdiagram.FamilyBalance.prototype.balanceOrgTree=function(g,b,d,c,f){var e,h,i,j,k,m,n,l,p,q,r;g.loopLevels(this,function(s,t){var w=a.common.graph(),v={},A=null,x;n=[];g.loopChildren(this,t.id,function(a,c,d){var f;null==A&&(A=c);v[c.id]={};if(b.hasOwnProperty(c.id))for(f in m=b[c.id],m)if(m.hasOwnProperty(f)){q=
m[f];v[c.id][f]={};e=0;for(h=q.length;e<h;e+=1)k=q[e],x=k.commonParent==t.id?k.toParent:g.node(k.fromParent).childIndex<g.node(k.toParent).childIndex?"__right__":"__left__",c.id!=x&&(w.addEdge(c.id,x,{weight:0}),w.edge(c.id,x).weight+=1,null==v[c.id][f][x]&&(v[c.id][f][x]=0),v[c.id][f][x]+=1)}0<d&&w.addEdge(c.id,A.id,{weight:0})});if(null!=A){r=[];w.getTotalWeightGrowthSequence(this,function(a){return a.weight},function(a){r.push(a)});0===r.length&&(r=[A.id]);l=this.balanceItems(r,"__left__","__right__",
v,d,c,f);i=0;for(j=l.length;i<j;i+=1)p=g.node(l[i]),p.childIndex=i,n.push(p.id)}g.arrangeChildren(t.id,n)})};a.famdiagram.FamilyBalance.prototype.balanceItems=function(g,b,d,c,f,e,h){var i=[],j,k=a.common.LinkedHashItems(),m=0,n={},l,p,q,r={},s,t,w,v,A,x,B,z,y,u,F,E,D,C,G,I,H,K;p=[b,null,d];for(j=0;j<p.length;j+=1)s=p[j],l=m++,q=new a.famdiagram.Slot(s),q.position=j,k.add(l,q),null!==s&&(r[s]=l);for(j=0;j<g.length;j+=1)if(s=g[j],s!=b&&s!=d)for(C in p=l=B=x=A=v=w=t=null,h.hasOwnProperty(s)&&(q=h[s],
n.hasOwnProperty(q)&&(p=e[s],q=n[q],l=q.previousContext(p),p=q.nextContext(p))),k.iterate(function(a,b){var d,g,e,h;if(null==a.itemId){E=f[s];F=u=y=z=0;for(d in a.crossings)a.crossings.hasOwnProperty(d)&&(E&&null!=E[d]&&(z+=a.crossings[d]*E[d]),F+=a.crossings[d]);for(d in c[s])if(c[s].hasOwnProperty(d))for(g in e=c[s][d],e)e.hasOwnProperty(g)&&r.hasOwnProperty(g)&&(h=k.item(r[g]),null!=h&&(h.position<a.position?(z+=(a.left[d]||0)-(h.left[d]||0),u+=Math.abs(h.balance+1)):(z+=(a.right[d]||0)-(h.right[d]||
0),u+=Math.abs(h.balance-1)),y+=Math.abs(h.position-a.position)));if(null==v||v>z||v==z&&(A>y||A==y&&(x>u||x==u&&B>F)))t=b,v=z,w=a,A=y,x=u,B=F}},l,p),k.insertBefore(t,m++,w.clone(null)),D=r[s]=m,l=w.clone(s),e.hasOwnProperty(s)&&(q=h[s],n.hasOwnProperty(q)||(n[q]=a.common.SortedList()),q=n[q],q.add(e[s],m)),k.insertBefore(t,m++,l),H=l.position=0,k.iterate(function(a,b){var c,d;if(b!=D){d=f[s];for(c in d)d.hasOwnProperty(c)&&(a.left[c]=a.left[c]?a.left[c]+d[c]:d[c]);H+=1;a.position=H}},D),H=0,k.iterateBack(function(a,
b){var c,d;if(b!=D){d=f[s];for(c in f[s])f[s].hasOwnProperty(c)&&(a.right[c]=a.right[c]?a.right[c]+d[c]:d[c]);H-=1;a.position=H}},D),c[s])if(c[s].hasOwnProperty(C))for(I in G=c[s][C],G)G.hasOwnProperty(I)&&r.hasOwnProperty(I)&&(K=r[I],q=k.item(K),null!=q&&(0>q.position?(q.balance+=1,l.balance-=1,k.iterateBack(function(a,b){b!=D&&b!=K&&(a.crossings[C]=a.crossings[C]?a.crossings[C]+G[I]:G[I])},D,K)):(q.balance-=1,l.balance+=1,k.iterate(function(a,b){b!=D&&b!=K&&(a.crossings[C]=a.crossings[C]?a.crossings[C]+
G[I]:G[I])},D,K))));k.iterate(function(a){a=a.itemId;null!=a&&(a!=b&&a!=d)&&i.push(a)});return i};a.famdiagram.FamilyBalance.prototype.ExtraGravity=function(a){this.toParent=this.fromParent=this.commonParent=null;this.level=a};a.famdiagram.FamilyBalance.prototype.getExtraGravity=function(a){var b,d,c={},f,e,h,i;for(b in a.orgPartners)if(a.orgPartners.hasOwnProperty(b)){d=a.orgTree.node(b);h=a.orgPartners[b];f=0;for(e=h.length;f<e;f+=1)i=a.orgTree.node(h[f]),this.addExtraGravitiesForConnection(a.orgTree,
c,i,d)}return c};a.famdiagram.FamilyBalance.prototype.addExtraGravitiesForConnection=function(a,b,d,c){var f=new this.ExtraGravity(d.level),e=new this.ExtraGravity(c.level);a.zipUp(this,d.id,c.id,function(a,c,d,g){this.addExtraGravityForItem(b,a,f);this.addExtraGravityForItem(b,d,e);if(c==g)return f.commonParent=c,f.fromParent=a,f.toParent=d,e.commonParent=c,e.fromParent=d,e.toParent=a,!0})};a.famdiagram.FamilyBalance.prototype.addExtraGravityForItem=function(a,b,d){a.hasOwnProperty(b)||(a[b]={});
null==a[b][d.level]&&(a[b][d.level]=[]);a[b][d.level].push(d)};a.famdiagram.FamilyBalance.prototype.attachFamilyToOrgChart=function(a,b,d,c){for(var f=c.items[0],e=null,e=d,d=d.level+1;d<f.level;d+=1)a.maximumId+=1,e=this.createOrgItem(a.orgTree,b,a.maximumId,e.id,null,d,null),e.title="shift",e.isVisible=!1,e.isActive=!1,e.hideParentConnection=!0,e.hideChildrenConnection=!0,c.items.push(e);f.hideParentConnection=!0;a.orgTree.adopt(e.id,f.id,f)};a.famdiagram.FamilyBalance.prototype.extractOrgChart=
function(a,b,d,c,f,e,h,i){var j,k=[],m,n,a=b.node(a),k=this.createOrgItem(c,d,a.id,null,i.id,a.level,a.itemConfig);k.hideParentConnection=!0;k.isVisible=a.isVisible;k.isActive=a.isActive;k.hideParentConnection=a.hideParentConnection;k.hideChildrenConnection=a.hideChildrenConnection;i.items.push(k);h[a.id]=!0;a.familyId=i.id;for(k=this.extractChildren(a,b,d,c,f,e,h,i);0<k.length;){m=[];a=0;for(j=k.length;a<j;a+=1)n=k[a],m=m.concat(this.extractChildren(n,b,d,c,f,e,h,i));k=m}};a.famdiagram.FamilyBalance.prototype.extractChildren=
function(a,b,d,c,f,e,h,i){var j=[],k=null,m=null,n;1==b.countChildren(a.id)&&(k=b.firstChild(a.id));null!=e[k]?(m=e[k],null==f[m.id]&&(f[m.id]=[]),f[m.id].push(a.id),i.links.push(new this.FamLink(a.id,k))):(null!=k&&(e[k]=a),b.loopChildren(this,a.id,function(e,f){if(h[f.id])throw"Many to many relations should not exist at this stage";j.push(f);n=this.createOrgItem(c,d,f.id,a.id,i.id,f.level,f.itemConfig);n.hideParentConnection=f.hideParentConnection;n.hideChildrenConnection=f.hideChildrenConnection;
n.isVisible=f.isVisible;n.isActive=f.isActive;i.items.push(n);h[f.id]=!0;f.familyId=i.id;return b.SKIP}));return j};a.famdiagram.FamilyBalance.prototype.createOrgItem=function(g,b,d,c,f,e,h){var i=new a.orgdiagram.OrgItem({});i.id=d;i.familyId=f;i.level=e;d=0;for(f=this.properties.length;d<f;d+=1)e=this.properties[d],i[e]=null!=h&&void 0!==h[e]?h[e]:b[e];g.add(c,i.id,i);return i};a.famdiagram.FamilyBalance.prototype.recalcLevelsDepth=function(g,b,d,c,f){var e,h,i,j,k,m,n,l,p,q={},r,s,t;d.loopLevels(this,
function(w){var v=new a.orgdiagram.TreeLevelConnectorStackSize;b[w]=v;p=[];d.loopLevelItems(this,w,function(b,d){var i=[],m=[],n;if(!q.hasOwnProperty(b)){q[b]=!0;d.hideChildrenConnection||i.push(b);n=f[b];if(null!=n){e=0;for(h=n.length;e<h;e+=1){var j=n[e];q[j]=!0;i.push(j)}}c.loopChildren(this,b,function(a,b){b.hideParentConnection||m.push(a)});if(1<i.length||0<m.length)l=new a.common.VerticalConnectorBundle(i,m),g.push(l),1<i.length&&p.push(l)}});if(0<p.length){t=a.common.pile();i=0;for(j=p.length;i<
j;i+=1){l=p[i];s=r=null;k=0;for(m=l.fromItems.length;k<m;k+=1)n=d.getItemPosition(l.fromItems[k]),r=null!=r?Math.min(r,n):n,s=null!=s?Math.max(s,n):n;t.add(r,s,l)}v.parentsStackSize=t.resolve(this,function(a,b,c,d,e){c.fromOffset=d+1;c.fromStackSize=e})}})};a.famdiagram.FamilyMatrixesExtractor=function(g){this.parent=a.famdiagram.BaseTransformer.prototype;this.parent.constructor.apply(this,arguments)};a.famdiagram.FamilyMatrixesExtractor.prototype=new a.famdiagram.BaseTransformer;a.famdiagram.FamilyMatrixesExtractor.prototype.extract=
function(g,b,d,c,f,e){0<b.hasNodes()&&g.enableMatrixLayout&&b.groupBy(this,Math.max(2,g.minimumMatrixSize),function(h,i,j,k){var m=e+=1,n=e+=1,l=b.node(j[0]),l=new a.famdiagram.FamilyItem({id:m,level:l.level,isVisible:!1,isActive:!1,itemConfig:{title:"dummy #"+m,description:"This is item used as aggregator of matrixed nodes."},levelGravity:1,hideParentConnection:!0,hideChildrenConnection:!0});c[m]=n;for(var p=0,q=j.length;p<q;p+=1)b.removeNode(j[p]);null!=h?(b.add([h],m,l),l.hideParentConnection=
!1,f.push(new a.common.MatrixConnectorBundle(!0,j,m,m,this.getMatrixWidth(g.maximumColumnsInMatrix,j.length)))):b.add(null,m,l);null!=i&&(b.adopt([m],i),l.hideChildrenConnection=!1,f.push(new a.common.MatrixConnectorBundle(!1,j,m,n,this.getMatrixWidth(g.maximumColumnsInMatrix,j.length))));d[m]=k});return e};a.famdiagram.FamilyMatrixesExtractor.prototype.getMatrixWidth=function(a,b){return Math.min(a,Math.ceil(Math.sqrt(b)))};a.famdiagram.FamilyNormalizer=function(g){this.parent=a.famdiagram.BaseTransformer.prototype;
...
k);switch(i.actualVisibility){case 2:case 3:case 4:e.dotsDepth=!e.dotsDepth?i.actualSize.height:Math.min(e.dotsDepth,i.actualSize.height);break;default:e.minimalDepth=!e.minimalDepth?i.actualSize.height:Math.min(e.minimalDepth,i.actualSize.height)}}c=b=0;for(f=a.rows.length;c<f;c+=1)switch(e=a.rows[c],e.offset=b+e.depth/2,b=e.offset+e.depth/2,null==e.minimalDepth&&(e.minimalDepth=e.depth),null!=e.dotsDepth&&e.dotsDepth>e.minimalDepth&&(e.minimalDepth=e.dotsDepth),d.verticalAlignment){case 0:e.horizontalConnectorsDepth=
e.minimalDepth/2;break;case 1:e.horizontalConnectorsDepth=e.depth/2;break;case 2:e.horizontalConnectorsDepth=e.depth-e.minimalDepth/2}};a.famdiagram.MatrixLayout.prototype.getLayoutSize=function(g){return new a.common.Rect(0,0,Math.round(this.getLayoutWidth(g)),Math.round(this.getLayoutHeight(g)))};a.famdiagram.MatrixLayout.prototype.getLayoutWidth=function(a){var b=0,d=a.columns.length;0<d&&(a=a.columns[d-1],b=a.offset+a.depth/2+a.rightPadding);return b};a.famdiagram.MatrixLayout.prototype.getLayoutHeight=
function(a){var b=0,d=a.rows.length;0<d&&(a=a.rows[d-1],b=a.offset+a.depth/2);return b};a.famdiagram.MatrixLayout.prototype.arrange=function(a,b,d){if(null!=d)for(var c=this.getMatrixWidth(this.options.maximumColumnsInMatrix,this.params.items.length),f=0,e=this.params.items.length;f<e;f+=1){var h=this.params.items[f].id,i=this.data.columns[f%c],j=this.data.rows[Math.floor(f/c)],k=this.data.treeItemsPositions[h],m=this.getItemPosition(k.actualVisibility,i,j,k.actualSize,this.options);m.translate(b.x,
b.y);k.actualPosition=m;k.horizontalConnectorsShift=b.y+j.offset-j.depth/2+j.horizontalConnectorsDepth;k.leftMedianOffset=i.depth/2+i.leftPadding;k.rightMedianOffset=i.depth/2+i.rightPadding;k.topConnectorShift=j.depth/2;k.bottomConnectorShift=j.depth/2;d.call(a,h,k)}};a.famdiagram.MatrixLayout.prototype.getItemPosition=function(g,b,d,c,f){var e=0;switch(g){case 1:switch(f.verticalAlignment){case 0:e=0;break;case 1:e=(d.depth-c.height)/2;break;case 2:e=d.depth-c.height}break;case 2:case 3:case 4:e=
d.horizontalConnectorsDepth-c.height/2}return new a.common.Rect(b.offset-c.width/2,d.offset-d.depth/2+e,c.width,c.height)};a.famdiagram.CursorNeighboursTask=function(g,b,d,c){function f(a,b,c,d){var e=[],g={};if(null!==a)switch(b){case 0:c.loopParents(this,a,function(a){g.hasOwnProperty(a)||(g[a]=!0,e.push(a));if(d.hasOwnProperty(a))return c.SKIP});c.loopChildren(this,a,function(a){g.hasOwnProperty(a)||(g[a]=!0,e.push(a));if(d.hasOwnProperty(a))return c.SKIP});break;case 1:c.loopNeighbours(this,a,
function(a){g.hasOwnProperty(a)||(g[a]=!0,e.push(a));if(d.hasOwnProperty(a))return!0})}return e}var e=[],h={},i=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:h},k=g.getCursorTreeItem(),m=d.getNavigationFamily(),n=b.getNeighboursSelectionMode(),l=c.getActiveItems();e=i.read(e,f(k,n,m,l),"items",a);return a.isChanged},getItems:function(){return e}}};a.famdiagram.AddLabelAnnotationsTask=function(g,b){function d(b,c){var d=
a.common.graph(),g={},f,m,n,l;if(0<c.length){l=0;for(f=c.length;l<f;l+=1)m=c[l],g.hasOwnProperty(m.fromItem)?g[m.fromItem].push(m):(g[m.fromItem]=[m],b.loopChildren(this,m.fromItem,function(c){d.addEdge(m.fromItem,c,new a.famdiagram.EdgeItem(m.fromItem,m.fromItem,c,c));return b.SKIP}),b.loopParents(this,m.fromItem,function(c){d.addEdge(c,m.fromItem,new a.famdiagram.EdgeItem(c,c,m.fromItem,m.fromItem));return b.SKIP}));for(n in g)if(g.hasOwnProperty(n)){f=g[n];f.sort(function(a,b){return b.toItems.length-
a.toItems.length});for(l=0;l<f.length;l+=1){m=f[l];for(var p=b,q=d,r=m.fromItem,s=m.toItems,t=void 0,w=!0,v=null,A=void 0,x=void 0,B=void 0,z=void 0,y=[],x=0,B=s.length;x<B;x+=1)if(A=s[x],t=q.edge(r,A),null!=t){if(null==v)v=t.getFar(A);else if(v!=t.getFar(A)){w=!1;break}y.push(t.getNear(A))}else{w=!1;break}if(w&&(z=new a.famdiagram.FamilyItem({id:m.id,isVisible:!0,isLevelNeutral:!0,isActive:!1,itemConfig:m}),p.bundleParents(v,y,z.id,z)?(z.levelGravity=2,w=!0):p.bundleChildren(v,y,z.id,z)?(z.levelGravity=
1,w=!0):p.bundleParents(v,s,z.id,z)?(z.levelGravity=2,w=!0):p.bundleParents(v,s,z.id,z)&&(z.levelGravity=1,w=!0),w)){x=0;for(B=s.length;x<B;x+=1)A=s[x],t=q.edge(r,A),t.setFar(A,z.id)}}}}}var c=null,f=null;return{process:function(a){var h=b.getLogicalFamily(),i=g.getAnnotations(),h=h.clone();d(h,i);c=h;f=g.getMaximumId();if(a&&!h.validate())throw"References are broken in family structure!";return!0},getNavigationFamily:function(){return c},getMaximumId:function(){return f}}};a.famdiagram.AddSpousesTask=
function(g,b){var d=null,c=null;return{process:function(f){var e=b.getLogicalFamily(),h=b.getMaximumId(),i=g.getItems(),j=e=e.clone(),k,m,n,l,p,q,r,s;n=0;for(l=i.length;n<l;n+=1){p=i[n];s=p.spouses.slice(0);q=0;for(r=s.length;q<r;q+=1)k=[p.id,s[q]],j.hasCommonChild(k)||(h+=1,m=new a.famdiagram.FamilyItem({id:h,isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+h,description:"This is fake child keeps spouses together."},levelGravity:1}),
j.add(k,m.id,m))}d=e;c=h;if(f&&!e.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return c}}};a.famdiagram.HideGrandParentsConnectorsTask=function(a,b){var d=null,c=null;return{process:function(){var f=b.getLogicalFamily(),e=b.getMaximumId();c=f=!0==a.getOptions().hideGrandParentsConnectors?f.getFamilyWithoutGrandParentsRelations():f.clone();d=e;return!0},getLogicalFamily:function(){return c},getMaximumId:function(){return d}}};
a.famdiagram.ItemsPositionsTask=function(g,b,d,c,f,e,h,i,j,k){var m={},n=null;return{process:function(){var l=c.getOptions(),p=f.getOptions(),q=e.getOptions(),r={logicalFamily:h.getLogicalFamily(),treeLevels:h.getTreeLevels(),getConnectorsStacksSizes:h.getConnectorsStacksSizes,isItemSelected:k.isItemSelected,cursorItemId:j.getCursorTreeItem(),getTemplateParams:i.getTemplateParams},l={verticalAlignment:l.verticalAlignment,pageFitMode:l.pageFitMode,minimalVisibility:l.minimalVisibility,normalLevelShift:l.normalLevelShift,
dotLevelShift:l.dotLevelShift,lineLevelShift:l.lineLevelShift,normalItemsInterval:l.normalItemsInterval,dotItemsInterval:l.dotItemsInterval,lineItemsInterval:l.lineItemsInterval,orientationType:d.getOptions().orientationType,arrowsDirection:p.arrowsDirection,linesWidth:p.linesWidth,checkBoxPanelSize:l.checkBoxPanelSize,buttonsPanelSize:l.buttonsPanelSize,groupTitlePanelSize:l.groupTitlePanelSize,groupTitlePlacementType:l.groupTitlePlacementType,maximumColumnsInMatrix:q.maximumColumnsInMatrix},p=g.getOptimalPanelSize(),
q=b.getOptions().scale;p.scale(1/q);var p=new a.common.Rect(0,0,p.width,p.height),q=new a.famdiagram.FamilyLayout(r,l),s=h.getMatrixes(),t;for(t in s)if(s.hasOwnProperty(t)){var w=r.logicalFamily.node(t);q.add(t,new a.famdiagram.MatrixLayout({items:s[t],isItemSelected:r.isItemSelected,cursorItemId:r.cursorItemId,getTemplateParams:r.getTemplateParams,hideParentConnection:w.hideParentConnection,hideChildrenConnection:w.hideChildrenConnection},l))}n=q.measure(p);m={};q.arrange(this,function(a,b){m[a]=
b});return!0},getItemsPositions:function(){return m},getItemPosition:function(a){return m[a]},getContentSize:function(){return n}}};a.famdiagram.LogicalFamilyTask=function(g){var b=null,d=null;return{process:function(c){var f,e,h,i,j=g.getItems(),k=a.common.family(),m=0;if(0<j.length){f=0;for(e=j.length;f<e;f+=1)h=j[f],null!=h&&(i=new a.famdiagram.FamilyItem({id:h.id,itemConfig:h,isActive:h.isActive}),k.add(h.parents,i.id,i),h=parseInt(h.id,10),m=Math.max(isNaN(h)?0:h,m))}b=k;d=m;if(c&&!k.validate())throw"References are broken in family structure!";
return!0},getLogicalFamily:function(){return b},getMaximumId:function(){return d}}};a.famdiagram.NormalizeLogicalFamilyTask=function(g,b){var d=null,c=null,f=new a.famdiagram.FamilyNormalizer(!1);return{process:function(){var a=b.getLogicalFamily(),h=b.getMaximumId(),i=g.getOptions(),i={groupByType:i.groupByType,alignBylevels:i.alignBylevels},a=a.clone(),h=f.normalize(i,a,h);c=a;d=h;return!0},getLogicalFamily:function(){return c},getMaximumId:function(){return d}}};a.famdiagram.OrderFamilyNodesTask=
function(g,b,d,c){var f=null,e=null,h={},i={},j=null,k=null,m=null,n=new a.famdiagram.FamilyBalance,l=new a.famdiagram.FamilyMatrixesExtractor(!1),p=new a.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var a=d.getLogicalFamily(),p=d.getMaximumId(),s={},t={},w=[],v=g.getOptions(),v={enableMatrixLayout:v.enableMatrixLayout,minimumMatrixSize:v.minimumMatrixSize,maximumColumnsInMatrix:v.maximumColumnsInMatrix},a=a.clone(),p=l.extract(v,a,s,t,w,p);e=a;h=s;i=t;k=w;a={logicalFamily:a,maximumId:p,
defaultItemConfig:c,itemsPositions:b.getPositions(),itemsGroups:b.getGroups()};a=n.balance(a);f=a.maximumId;j=a.treeLevels;k=k.concat(a.bundles);m=a.connectorStacks;return!0},getLogicalFamily:function(){return e},getMatrixes:function(){return h},getNestedLayoutBottomConnectorIds:function(){return i},getMaximumId:function(){return f},getTreeLevels:function(){return j},getBundles:function(){return k},getConnectorsStacksSizes:function(a){return m[a]||p}}};a.famdiagram.RemoveLoopsTask=function(g,b){function d(b,
c,d){var g,f,m,n,l,p,q,r,s;g=c.clone();c.loopTopo(this,function(a){g.removeNode(a)});if(g.hasNodes()){n=0;for(l=b.length;n<l;n+=1)if(f=b[n],null!=g.node(f.id)){s=[];g.loopParents(this,f.id,function(a){s.push(a);return g.SKIP});p=0;for(q=s.length;p<q;p+=1)g.removeRelation(s[p],f.id),c.removeRelation(s[p],f.id);d+=1;m=new a.famdiagram.FamilyItem({id:d,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake parent #"+d,description:"This is fake parent item was created by loops reversal."}});
c.add([],m.id,m);c.adopt([m.id],f.id);p=0;for(q=s.length;p<q;p+=1)d+=1,f=new a.famdiagram.FamilyItem({id:d,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+d,description:"This is fake child item was created by loops reversal."}}),c.add([m.id,s[p]],f.id,f);r=[];g.loopTopo(this,function(a){r.push(a)});p=0;for(q=r.length;p<q;p+=1)g.removeNode(r[p])}}return d}var c=null,f=null;return{process:function(a){var h=b.getNavigationFamily(),
i=b.getMaximumId(),j=g.getItems(),h=h.clone(),i=d(j,h,i,a);c=h;f=i;if(a&&!h.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return c},getMaximumId:function(){return f}}};a.famdiagram.UserDefinedNodesOrderTask=function(g){var b=null,d=null,c=new a.famdiagram.UserDefinedNodesOrder;return{process:function(){var a=g.getOptions(),a=c.getUserDefinedPositions(a.items);b=a.position;d=a.group;return!0},getPositions:function(){return b},getGroups:function(){return d}}};
a.famdiagram.Control=function(g,b){return a.orgdiagram.BaseControl(g,b,a.famdiagram.TaskManagerFactory,a.famdiagram.EventArgsFactory,{AnnotationLabelTemplate:a.common.AnnotationLabelTemplate,ButtonsTemplate:a.common.ButtonsTemplate,CheckBoxTemplate:a.common.CheckBoxTemplate,CursorTemplate:a.common.CursorTemplate,DotHighlightTemplate:a.common.DotHighlightTemplate,GroupTitleTemplate:a.common.GroupTitleTemplate,HighlightTemplate:a.common.HighlightTemplate,ItemTemplate:a.common.ItemTemplate,UserTemplate:a.common.UserTemplate,
LabelAnnotationTemplate:a.common.LabelAnnotationTemplate})};a.famdiagram.EventArgsFactory=function(g,b,d,c){var f=new a.famdiagram.EventArgs,e=g.tasks.getTask("CombinedContextsTask"),h=g.tasks.getTask("AlignDiagramTask"),i=g.tasks.getTask("LogicalFamilyTask"),b=e.getConfig(b),j=e.getConfig(d),k=i.getLogicalFamily();b&&null!=b.id&&(f.oldContext=b);j&&null!=j.id&&(f.context=j,k.loopParents(this,j.id,function(a,b,c){if(0<c)return k.BREAK;f.parentItems.push(e.getConfig(a))}),k.loopChildren(this,j.id,
function(a,b,c){if(0<c)return k.BREAK;f.childrenItems.push(e.getConfig(a))}),i=a.common.getElementOffset(g.layout.mousePanel),g=a.common.getElementOffset(g.layout.element),d=h.getItemPosition(d),f.position=(new a.common.Rect(d.actualPosition)).translate(i.left,i.top).translate(-g.left,-g.top));null!=c&&(f.name=c);return f};a.famdiagram.getProcessDiagramConfig=function(){var g=function(){};return a.famdiagram.TaskManagerFactory(g,g,g).getProcessDiagramConfig()};a.famdiagram.TaskManagerFactory=function(g,
b,d,c,f){var e=new a.common.TaskManager;e.addDependency("options",g);e.addDependency("graphics",b);e.addDependency("getLayout",d);e.addDependency("setLayout",c);e.addDependency("templates",f);e.addDependency("defaultConfig",new a.famdiagram.Config);e.addDependency("defaultItemConfig",new a.famdiagram.ItemConfig);e.addDependency("defaultTemplateConfig",new a.famdiagram.TemplateConfig);e.addDependency("defaultButtonConfig",new a.famdiagram.ButtonConfig);e.addDependency("defaultPaletteItemConfig",new a.famdiagram.PaletteItemConfig);
...
e.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],a.orgdiagram.BackgroundAnnotationOptionTask,"#000080");e.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ScaleOptionTask,"#000080");e.addTask("UserDefinedNodesOrderTask",["OrderFamilyNodesOptionTask","defaultItemConfig"],a.famdiagram.UserDefinedNodesOrderTask,"#ff0000");e.addTask("LogicalFamilyTask",["ItemsOptionTask"],a.famdiagram.LogicalFamilyTask,"#00ffff");e.addTask("LabelAnnotationOptionTask",
...
"AddSpousesTask"],a.famdiagram.HideGrandParentsConnectorsTask,"#ff0000");e.addTask("NormalizeLogicalFamilyTask",["NormalizeOptionTask","HideGrandParentsConnectorsTask"],a.famdiagram.NormalizeLogicalFamilyTask,"#ff0000");e.addTask("OrderFamilyNodesTask",["OrderFamilyNodesOptionTask","UserDefinedNodesOrderTask","NormalizeLogicalFamilyTask","defaultItemConfig"],a.famdiagram.OrderFamilyNodesTask,"#ff0000");e.addTask("ReadTemplatesTask",["TemplatesOptionTask","templates"],a.orgdiagram.ReadTemplatesTask,
"#00ffff");e.addTask("ActiveItemsTask",["ItemsSizesOptionTask","ReadTemplatesTask"],a.orgdiagram.ActiveItemsTask,"#00ffff");e.addTask("ItemTemplateParamsTask",["ItemsSizesOptionTask","CursorItemOptionTask","ReadTemplatesTask"],a.orgdiagram.ItemTemplateParamsTask,"#00ffff");e.addTask("LabelAnnotationTemplateParamsTask",["ItemsSizesOptionTask","LabelAnnotationTemplateOptionTask","ReadTemplatesTask"],a.famdiagram.LabelAnnotationTemplateParamsTask,"#00ffff");e.addTask("CombinedTemplateParamsTask",["ItemTemplateParamsTask",
"LabelAnnotationTemplateParamsTask"],a.famdiagram.CombinedTemplateParamsTask,"#00ffff");e.addTask("GroupTitleTemplateTask",["TemplatesOptionTask","templates"],a.orgdiagram.GroupTitleTemplateTask,"#00ffff");e.addTask("CheckBoxTemplateTask",["ItemsSizesOptionTask","templates"],a.orgdiagram.CheckBoxTemplateTask,"#00ffff");e.addTask("ButtonsTemplateTask",["ItemsSizesOptionTask","templates"],a.orgdiagram.ButtonsTemplateTask,"#00ffff");e.addTask("AnnotationLabelTemplateTask",["ItemsOptionTask","templates"],
a.orgdiagram.AnnotationLabelTemplateTask,"#00ffff");e.addTask("ConnectionsGraphTask",["graphics","CreateTransformTask","ConnectorsOptionTask","OrderFamilyNodesTask","AlignDiagramTask"],a.orgdiagram.ConnectionsGraphTask,"#00ffff");e.addTask("HighlightItemTask",["HighlightItemOptionTask","ActiveItemsTask"],a.orgdiagram.HighlightItemTask,"#00ffff");e.addTask("CursorItemTask",["CursorItemOptionTask","ActiveItemsTask"],a.orgdiagram.CursorItemTask,"#00ffff");e.addTask("CursorNeighboursTask",["CursorItemTask",
...
!0;this.maximumColumnsInMatrix=6;this.buttonsPanelSize=28;this.checkBoxPanelSize=this.groupTitlePanelSize=24;this.groupTitleOrientation=this.groupTitlePlacementType=2;this.groupTitleVerticalAlignment=1;this.groupTitleHorizontalAlignment=0;this.groupTitleFontSize="12px";this.groupTitleFontFamily="Arial";this.groupTitleColor="#4169e1";this.groupTitleFontStyle=this.groupTitleFontWeight="normal";this.distance=3;this.scale=1;this.minimumScale=0.5;this.maximumScale=2;this.showLabels=0;this.labelSize=new a.common.Size(80,
24);this.labelOffset=1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight="normal";this.enablePanning=!0;this.autoSizeMinimum=new a.common.Size(800,600);this.autoSizeMaximum=new a.common.Size(1024,768)};a.orgdiagram.ConnectorAnnotationConfig=function(g,b){var d;this.annotationType=0;this.zOrderType=2;this.toItem=this.fromItem=null;this.connectorPlacementType=this.connectorShapeType=
0;this.labelPlacementType=1;this.offset=new a.common.Thickness(0,0,0,0);this.lineWidth=2;this.color="#000000";this.lineType=0;this.selectItems=!0;this.label=null;this.labelSize=new a.common.Size(60,30);switch(arguments.length){case 1:for(d in g)g.hasOwnProperty(d)&&(this[d]=g[d]);break;case 2:this.fromItem=g,this.toItem=b}};a.orgdiagram.HighlightPathAnnotationConfig=function(a){var b;this.zOrderType=this.annotationType=2;this.items=[];this.lineWidth=2;this.color="#ff0000";this.lineType=0;this.opacity=
...
0;this.levelOffset=null;this.placeAdvisersAboveChildren=this.placeAssistantsAboveChildren=this.childrenPlacementType=this.adviserPlacementType=0;this.templateName=null;this.showCallout=0;this.label=this.calloutTemplateName=null;this.showLabel=0;this.labelSize=null;this.labelOrientation=3;this.labelPlacement=0;switch(arguments.length){case 1:for(e in a)a.hasOwnProperty(e)&&(this[e]=a[e]);break;case 5:this.id=a,this.parent=b,this.title=d,this.description=c,this.image=f}};a.orgdiagram.ShapeAnnotationConfig=
function(g){var b;this.annotationType=1;this.zOrderType=0;this.items=[];this.shapeType=0;this.offset=new a.common.Thickness(0,0,0,0);this.lineWidth=2;this.cornerRadius="10%";this.opacity=1;this.fillColor=this.borderColor=null;this.lineType=0;this.selectItems=!1;this.label=null;this.labelSize=new a.common.Size(60,30);this.labelPlacement=0;this.labelOffset=4;switch(arguments.length){case 1:if(null!==g)if(g instanceof Array)this.items=g;else if("object"==typeof g)for(b in g)g.hasOwnProperty(b)&&(this[b]=
g[b])}};a.orgdiagram.EventArgs=function(){this.name=this.position=this.parentItem=this.context=this.oldContext=null;this.cancel=!1};a.common.BaseConnectorBundle=function(){this.NORMAL_ITEM_WEIGHT=10010;this.LINE_ITEM_WEIGHT=1E4};a.common.BaseConnectorBundle.prototype.trace=function(){};a.common.BaseConnectorBundle.prototype.getId=function(a){var b="_"+a.nodeid;a.nodeid+=1;return b};a.common.BaseConnectorBundle.prototype.ConnectorEdge=function(a,b,d,c,f,e,h,i,j,k){this.polyline=d;this.from=a;this.to=
b;this.weight=h||0;this.fromOffset=i||0;this.parentsArrowId=c;this.childrenArrowId=f;this.dotId=e;this.hasMiddle=j;this.middleParent=k};a.common.BaseConnectorBundle.prototype.ConnectorDestination=function(a){this.bundleid=this.y=this.x=this.id=null;this.hasElbow=!1;this.visibility=this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])};a.common.BaseConnectorBundle.prototype.traceFork=function(g,b,d,c,f,e,h,i,j){var k,m,n,l=[],p,q,r;if(e){l=[];e=
0;for(m=f.length;e<m;e+=1)if(n=f[e],n.x<c.x&&!n.isSquared)l.push(n);else break;m=l.length;0<m&&(n=l[m-1],n=n.x==c.x?c:new this.ConnectorDestination({id:n.bundleid,x:n.x,y:c.y}),this.traceAngularSegments(g,b,d,n,l,!1));l=[];for(k=f.length-1;k>=e;k-=1)if(n=f[k],n.x>c.x&&!n.isSquared)l.push(n);else break;m=l.length;0<m&&(n=l[m-1],n=n.x==c.x?c:new this.ConnectorDestination({id:n.bundleid,x:n.x,y:c.y}),this.traceAngularSegments(g,b,d,n,l,!1));for(l=e;l<=k;l+=1){n=f[l];m=d.bevelSize;2>m&&(m=0);if(b.hasGraphics)switch(d.elbowType){case 2:case 3:0<
m&&(Math.abs(c.x-n.x)>m&&Math.abs(c.y-n.y)>m)&&(n.hasElbow=!0,n.elbowPoint1=new a.common.Point(n.x,c.y+(c.y>n.y?-m:m)),n.elbowPoint2=new a.common.Point(n.x+(c.x>n.x?m:-m),c.y))}p=new a.common.Polyline;n.hasElbow?(b.transform.transform3Points(n.elbowPoint2.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint1.y,!0,this,function(b,c,e,g,f,h){switch(d.elbowType){case 2:p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(f,h));break;case 3:p.addSegment(new a.common.MoveSegment(b,
c)),p.addSegment(new a.common.CubicArcSegment(b,c,e,g,f,h))}}),b.transform.transformPoints(n.elbowPoint1.x,n.elbowPoint1.y,n.x,n.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.LineSegment(d,e))})):b.transform.transformPoints(n.x,c.y,n.x,n.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(d,e))});m=n.x==c.x?c.id:n.bundleid;q=4!==n.visibility;g.graph.addEdge(m,n.id,new this.ConnectorEdge(m,n.id,p,h&&q?n.id:null,!h&&q?n.id:null,null,
q?this.NORMAL_ITEM_WEIGHT:this.LINE_ITEM_WEIGHT,i))}e=Math.max(e-1,0);k=Math.min(k+1,f.length-1);n=c;m=c.id;for(l=e;l<=k;l+=1)q=f[l],r=q.bundleid,q.x>n.x&&(p=new a.common.Polyline,b.transform.transformPoints(n.x,c.y,null!=q.elbowPoint2?q.elbowPoint2.x:q.x,c.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(d,e))}),g.graph.addEdge(m,r,new this.ConnectorEdge(m,r,p,null,null,m,Math.abs(q.x-n.x)/1E4,i,j,h?r:m)),n=q.elbowPoint2||q,m=r);n=c;m=
c.id;for(l=k;l>=e;l-=1)q=f[l],r=q.bundleid,q.x<n.x&&(p=new a.common.Polyline,b.transform.transformPoints(n.x,c.y,null!=q.elbowPoint2?q.elbowPoint2.x:q.x,c.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(d,e))}),g.graph.addEdge(m,r,new this.ConnectorEdge(m,r,p,null,null,m,Math.abs(q.x-n.x)/1E4,i,j,h?r:m)),n=q.elbowPoint2||q,m=r)}else this.traceAngularSegments(g,b,d,c,f,!0)};a.common.BaseConnectorBundle.prototype.traceAngularSegments=function(g,
b,d,c,f,e){var h,i,j,k,m;h=0;for(i=f.length;h<i;h+=1){k=f[h];m=new a.common.Polyline;b.transform.transformPoint(c.x,c.y,!0,this,function(b,c){m.addSegment(new a.common.MoveSegment(b,c))});switch(d.connectorType){case 1:b.transform.transformPoint(k.x,k.y,!0,this,function(b,c){m.addSegment(new a.common.LineSegment(b,c))});break;case 2:j=new a.common.Rect(c,k),e?c.x>j.x?b.transform.transform3Points(j.right(),j.verticalCenter(),j.x,j.verticalCenter(),j.x,j.bottom(),!0,this,function(b,c,d,e,g,f){m.addSegment(new a.common.CubicArcSegment(b,
c,d,e,g,f))}):b.transform.transform3Points(j.x,j.verticalCenter(),j.right(),j.verticalCenter(),j.right(),j.bottom(),!0,this,function(b,c,d,e,g,f){m.addSegment(new a.common.CubicArcSegment(b,c,d,e,g,f))}):c.x>j.x?b.transform.transformPoints(j.x,j.y,j.x,j.bottom(),!0,this,function(b,c,d,e){m.addSegment(new a.common.QuadraticArcSegment(b,c,d,e))}):b.transform.transformPoints(j.right(),j.y,j.right(),j.bottom(),!0,this,function(b,c,d,e){m.addSegment(new a.common.QuadraticArcSegment(b,c,d,e))})}j=4!==k.visibility;
g.graph.addEdge(c.id,k.id,new this.ConnectorEdge(c.id,k.id,m,null,j?k.id:null,j?this.NORMAL_ITEM_WEIGHT:this.LINE_ITEM_WEIGHT))}};a.common.HorizontalConnectorBundle=function(a,b){this.fromItem=a;this.toItem=b};a.common.HorizontalConnectorBundle.prototype=new a.common.BaseConnectorBundle;a.common.HorizontalConnectorBundle.prototype.trace=function(g,b){var d=this.fromItem,c=this.toItem,f=b.treeItemsPositions[d],e=b.treeItemsPositions[c],h=new a.common.Polyline;f.actualPosition.x<e.actualPosition.x?
b.transform.transformPoints(f.actualPosition.right(),f.horizontalConnectorsShift,e.actualPosition.x,e.horizontalConnectorsShift,!0,this,function(b,c,d,e){h.addSegment(new a.common.MoveSegment(b,c));h.addSegment(new a.common.LineSegment(d,e))}):b.transform.transformPoints(f.actualPosition.x,f.horizontalConnectorsShift,e.actualPosition.right(),f.horizontalConnectorsShift,!0,this,function(b,c,d,e){h.addSegment(new a.common.MoveSegment(b,c));h.addSegment(new a.common.LineSegment(d,e))});e=4!==e.actualVisibility;
f=4!==f.actualVisibility;g.graph.addEdge(d,c,new this.ConnectorEdge(d,c,h,e?c:null,f?d:null,e||f?this.NORMAL_ITEM_WEIGHT:this.LINE_ITEM_WEIGHT))};a.common.MatrixConnectorBundle=function(a,b,d,c,f){this.isChildren=a;this.items=b;this.len=b.length;this.matrixNodeId=d;this.connectionId=c;this.matrixWidth=f;this.blocksCount=Math.ceil(this.matrixWidth/2);this.rowsCount=Math.ceil(this.len/this.matrixWidth)};a.common.MatrixConnectorBundle.prototype=new a.common.BaseConnectorBundle;a.common.MatrixConnectorBundle.prototype.trace=
function(a,b,d){this.isChildren?this.traceChildrenLayout(a,b,d):this.traceParentsLayout(a,b,d)};a.common.MatrixConnectorBundle.prototype.traceChildrenLayout=function(g,b,d){for(var c,f=[],e=0;e<this.blocksCount;e+=1){for(var h=null,i=this.rowsCount-1;0<=i;i-=1){var j=this.getNodeIndex(e,i,!0,!0),k=null;c=null;j<this.len&&(k=this.items[j],c=b.treeItemsPositions[k]);var m=this.getNodeIndex(e,i,!1,!0),n=null,j=null;m<this.len&&(n=this.items[m],j=b.treeItemsPositions[n]);var l=null;null==l&&null!=c&&
(l=new this.ConnectorDestination({id:this.getId(g),x:c.actualPosition.horizontalCenter()+c.rightMedianOffset,y:c.horizontalConnectorsShift}));null==l&&null!=j&&(l=new this.ConnectorDestination({id:this.getId(g),x:j.actualPosition.horizontalCenter()-j.leftMedianOffset,y:j.horizontalConnectorsShift}));null!=c&&(c=c.actualPosition,b.transform.transformPoints(c.right(),c.verticalCenter(),l.x,l.y,!0,this,function(b,c,d,e){var f=new a.common.Polyline;f.addSegment(new a.common.MoveSegment(b,c));f.addSegment(new a.common.LineSegment(d,
e));g.graph.addEdge(k,l.id,new this.ConnectorEdge(k,l.id,f,null,k,null,10))}));null!=j&&(c=j.actualPosition,b.transform.transformPoints(c.left(),c.verticalCenter(),l.x,l.y,!0,this,function(b,c,d,e){var f=new a.common.Polyline;f.addSegment(new a.common.MoveSegment(b,c));f.addSegment(new a.common.LineSegment(d,e));g.graph.addEdge(n,l.id,new this.ConnectorEdge(n,l.id,f,null,n,null,10))}));null!=h&&null!=l&&b.transform.transformPoints(h.x,h.y,l.x,l.y,!0,this,function(b,c,d,e){var f=new a.common.Polyline;
f.addSegment(new a.common.MoveSegment(b,c));f.addSegment(new a.common.LineSegment(d,e));g.graph.addEdge(h.id,l.id,new this.ConnectorEdge(h.id,l.id,f,null,null,null,0))});null!=l&&(h=l)}null!=h&&f.push(new this.ConnectorDestination({id:h.id,bundleid:this.getId(g),x:h.x,y:h.y,isSquared:!0,visibility:4}))}c=b.treeItemsPositions[this.matrixNodeId].actualPosition;e=new this.ConnectorDestination({id:this.matrixNodeId,x:c.horizontalCenter(),y:c.top()});this.traceFork(g,b,d,e,f,!0,!1,0,d.showExtraArrows)};
a.common.MatrixConnectorBundle.prototype.traceParentsLayout=function(g,b,d){for(var c,f=[],e=0;e<=this.blocksCount;e+=1){for(var h=null,i=0;i<this.rowsCount;i+=1){var j=this.getNodeIndex(e,i,!0,!1),k=null;c=null;j<this.len&&(k=this.items[j],c=b.treeItemsPositions[k]);var m=this.getNodeIndex(e,i,!1,!1),n=null,j=null;m<this.len&&(n=this.items[m],j=b.treeItemsPositions[n]);var l=null;null==l&&null!=c&&(l=new this.ConnectorDestination({id:this.getId(g),x:c.actualPosition.horizontalCenter()+c.rightMedianOffset,
y:c.horizontalConnectorsShift}));null==l&&null!=j&&(l=new this.ConnectorDestination({id:this.getId(g),x:j.actualPosition.horizontalCenter()-j.leftMedianOffset,y:j.horizontalConnectorsShift}));null!=c&&(c=c.actualPosition,b.transform.transformPoints(c.right(),c.verticalCenter(),l.x,l.y,!0,this,function(b,c,d,e){var f=new a.common.Polyline;f.addSegment(new a.common.MoveSegment(b,c));f.addSegment(new a.common.LineSegment(d,e));g.graph.addEdge(k,l.id,new this.ConnectorEdge(k,l.id,f,k,null,null,10))}));
...
c?(a=2*a+(d?0:1),this.matrixWidth>a&&(f=b*this.matrixWidth+a)):(a=2*a+(d?-1:0),0<=a&&a<this.matrixWidth&&(f=b*this.matrixWidth+a));return f};a.common.VerticalConnectorBundle=function(a,b){this.fromItems=a;this.toItems=b;this.childConnectorId={};this.fromStackSize=this.fromOffset=0};a.common.VerticalConnectorBundle.prototype=new a.common.BaseConnectorBundle;a.common.VerticalConnectorBundle.prototype.trace=function(g,b,d){var c,f,e,h,i,j,k,m,n,l=0===d.connectorType;c=[];if(0<this.fromItems.length){e=
this.fromItems;j=0;for(f=e.length;j<f;j+=1)h=e[j],i=b.treeItemsPositions[h],h=new this.ConnectorDestination({id:b.nestedLayoutBottomConnectorIds.hasOwnProperty(h)?b.nestedLayoutBottomConnectorIds[h]:h,bundleid:this.getId(g),x:i.actualPosition.horizontalCenter(),y:i.actualPosition.bottom(),isSquared:!0,visibility:i.actualVisibility}),c.push(h);c.sort(function(a,b){return a.x-b.x});n=i.bottomConnectorShift-i.bottomConnectorInterval*(this.fromStackSize-this.fromOffset+1)}f=[];if(0<this.toItems.length){m=
!1;e=this.toItems;for(j=0;j<e.length;j+=1){h=e[j];i=b.treeItemsPositions[h];k=!0;if(b.hasGraphics)switch(i.actualVisibility){case 2:case 3:k=l}h=new this.ConnectorDestination({id:h,bundleid:this.getId(g),x:i.actualPosition.horizontalCenter()+0,y:i.actualPosition.top(),isSquared:k,visibility:i.actualVisibility});f.push(h);m=m||h.isSquared}f.sort(function(a,b){return a.x-b.x});k=i.topConnectorShift}e=1==f.length?f[0].x:1==c.length?c[0].x:0<f.length&&0<c.length?(c[0].x+c[c.length-1].x+f[0].x+f[f.length-
1].x)/4:0<f.length?(f[0].x+f[f.length-1].x)/2:(c[0].x+c[c.length-1].x)/2;var p=null;0<c.length&&(p=new this.ConnectorDestination({id:this.getId(g),x:e,y:n}),this.traceFork(g,b,d,p,c,!0,!0,this.fromOffset,d.showExtraArrows&&0<f.length));var q=null;0<f.length&&(q=new this.ConnectorDestination({id:this.getId(g),x:e,y:k}),null!=p&&q.y==p.y&&(q=p),this.traceFork(g,b,d,q,f,m,!1,0,d.showExtraArrows&&0<c.length));null!=p&&(null!=q&&p.id!=q.id)&&b.transform.transformPoints(p.x,p.y,q.x,q.y,!0,this,function(b,
c,d,e){var f=new a.common.Polyline;f.addSegment(new a.common.MoveSegment(b,c));f.addSegment(new a.common.LineSegment(d,e));g.graph.addEdge(p.id,q.id,new this.ConnectorEdge(p.id,q.id,f,null,null,null,0))})};a.orgdiagram.LevelVisibility=function(a,b){this.level=a;this.currentvisibility=b};a.orgdiagram.OrgItem=function(a){var b,d,c;this.id=null;this.isActive=this.isVisible=!0;this.hasVisibleChildren=!1;this.placeAssistantsAboveChildren=this.placeAdvisersAboveChildren=this.childrenPlacementType=this.adviserPlacementType=
this.itemType=0;this.level=this.levelOffset=null;this.hideChildrenConnection=this.hideParentConnection=!1;this.childIndex=null;var f="id parent isVisible isActive itemType adviserPlacementType childrenPlacementType placeAdvisersAboveChildren placeAssistantsAboveChildren levelOffset".split(" ");b=0;for(d=f.length;b<d;b+=1)c=f[b],a.hasOwnProperty(c)&&(this[c]=a[c])};a.orgdiagram.Template=function(a,b,d,c,f){this.templateConfig=a;this.itemTemplate=b;this.highlightTemplate=d;this.dotHighlightTemplate=
c;this.cursorTemplate=f};a.orgdiagram.TemplateParams=function(){this.template=null;this.hasGroupTitle=this.hasButtons=this.hasSelectorCheckbox=this.isActive=!1;this.buttons=[];this.onButtonsRender=null};a.orgdiagram.TreeItem=function(){this.visualAggregatorId=this.id=null;this.visualDepth=1;this.partners=[];this.visibility=1;this.actualItemType=null;this.relationDegree=this.gravity=this.connectorPlacement=0};a.orgdiagram.TreeItemPosition=function(g){this.partnerConnectorOffset=0;this.levelPosition=
this.level=null;this.rightPadding=this.leftPadding=this.offset=0;this.actualVisibility=1;this.topConnectorShift=this.horizontalConnectorsShift=this.contentPosition=this.actualPosition=this.actualSize=null;this.topConnectorInterval=0;this.bottomConnectorShift=null;this.bottomConnectorInterval=0;this.rightMedianOffset=this.leftMedianOffset=null;if(null!=g)for(var b in g)if(g.hasOwnProperty(b))switch(b){case "actualPosition":this.actualPosition=new a.common.Rect(g.actualPosition);break;default:this[b]=
g[b]}};a.orgdiagram.TreeLevelConnectorStackSize=function(){this.parentsStackSize=0};a.orgdiagram.TreeLevelPosition=function(a){this.actualVisibility=this.currentvisibility=1;this.currentOffset=this.levelSpace=this.connectorShift=this.topConnectorShift=this.horizontalConnectorsDepth=this.nextLevelShift=this.depth=this.shift=0;this.labels=[];this.labelsRect=null;this.showLabels=!0;this.hasFixedLabels=!1;if(null!=a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])};a.orgdiagram.TreeLevelPosition.prototype.setShift=
function(a,b,d,c,f){this.shift=a;this.levelSpace=b;this.topConnectorShift=-b/2-d;this.connectorShift=this.depth+c+(f+1)*(b/2);return this.nextLevelShift=d+this.depth+c+b+f*b/2};a.orgdiagram.TreeLevelPosition.prototype.shiftDown=function(a){this.shift+=a};a.orgdiagram.TreeLevelPosition.prototype.toString=function(){return this.currentvisibility};a.orgdiagram.AlignDiagramTask=function(g,b,d,c,f,e,h,i){function j(){var a=[],b={},c;for(c in k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(c)){var d=
k.treeItemsPositions[c];switch(d.actualVisibility){case 1:case 2:case 3:d=d.actualPosition,d=Math.max(d.width,d.height),b.hasOwnProperty(d)||(b[d]=!0,a.push(d))}}return a}var k={treeItemsPositions:{},panelSize:null},m,n,l,p,q,r,s,t;return{process:function(){var j=new a.common.Size(h.getContentSize()),v=new a.common.Size(f.getOptimalPanelSize());t=s=null;m=null!=e?e.getActiveItems():{};n=h.getItemsPositions();l=b.getOptions();p=g.getOptions();q=d.getOptions();r=c.getOptions();switch(p.orientationType){case 2:case 3:v.invert()}v.scale(1/
r.scale);k.panelSize=v;k.treeItemsPositions=n;switch(l.pageFitMode){case 5:k.panelSize=new a.common.Size(j);break;default:k.panelSize=new a.common.Size(j);if(j.width<v.width){k.treeItemsPositions={};var A=j.width,x=v.width,B;if(i)B=(x-A)/2;else switch(q.horizontalAlignment){case 1:B=0;break;case 2:B=x-A;break;case 0:B=(x-A)/2}var A=k.treeItemsPositions,z;for(z in n)n.hasOwnProperty(z)&&(x=new a.orgdiagram.TreeItemPosition(n[z]),x.actualPosition.translate(B,0),A[z]=x);k.panelSize.width=v.width}j.height<
v.height&&(k.panelSize.height=v.height)}switch(p.orientationType){case 2:case 3:k.panelSize.invert()}return!0},getItemPosition:function(a){return k.treeItemsPositions[a]},getItemsPositions:function(){return k.treeItemsPositions},getContentSize:function(){return k.panelSize},getTreeItemForMousePosition:function(b,c,d){var e=null,f=null,g=r.scale,h;if(null==s)for(h in s=a.common.SpatialIndex(j()),k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(h)){var i=k.treeItemsPositions[h];if(m.hasOwnProperty(h))switch(i.actualVisibility){case 1:case 2:case 3:i=
new a.common.Rect(i.actualPosition),i.context=h,s.addRect(i)}}h=s;var n,b=b/g,c=c/g,g=new a.common.Rect(b,c,0,0);n=new a.common.Point(b,c);g.offset(d,d,d,d);h.loopArea(this,g,function(a){var d=a.context;if(a.contains(b,c))return e=d,!0;switch(k.treeItemsPositions[d].actualVisibility){case 2:case 3:if(a=n.distanceTo(a.horizontalCenter(),a.verticalCenter()),null==f||a<f)f=a,e=d}});return e},getNextItem:function(b,c){var d;if(null==t)for(d in t=a.common.KeyboardNavigationManager(),k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(d)){var e=
k.treeItemsPositions[d];if(m.hasOwnProperty(d))switch(e.actualVisibility){case 1:e=new a.common.Rect(e.actualPosition),t.addRect(e,d)}}d=t;var f;switch(c){case 0:f=d.getItemAbove(b);break;case 1:f=d.getItemBelow(b);break;case 2:f=d.getItemOnLeft(b);break;case 3:f=d.getItemOnRight(b)}return f}}};a.orgdiagram.ApplyLayoutChangesTask=function(g,b,d,c,f,e){var h=null;return{process:function(){var a=g(),j=f.getOptions(),k=d.getOptions(),m=e.getContentSize(),n=c.getScrollPanelSize();a.resize("placeholder",
m.width,m.height);h=b({scale:j.scale,contentSize:m,scrollPanelSize:n,autoSize:5==k.pageFitMode,autoSizeMaximum:k.autoSizeMaximum,autoSizeMinimum:k.autoSizeMinimum});return!0},getOptimalPanelSize:function(){return new a.common.Size(h.width-25,h.height-25)}}};a.orgdiagram.CenterOnCursorTask=function(g,b,d,c,f,e,h){function i(b){var c=!1;k.transformRect(b.x,b.y,b.width,b.height,!0,this,function(b,d,e,f){c=new a.common.Rect(b,d,e,f)});return c}var j=null,k;return{process:function(){var m;m=g.getOptions();
var n=c.getCursorTreeItem(),l=f.getItemPosition(n),n=new a.common.Size(f.getContentSize()),p;p=h.getOptions().scale;j=d.getPlaceholderOffset();m.forceCenterOnCursor&&(k=e.getTransform(),null!=l&&(m=i(l.actualPosition),m.scale(p),n.scale(p),p=b.getScrollPanelSize(),j=new a.common.Point(Math.max(Math.min(m.horizontalCenter()-p.width/2,n.width-p.width),0),Math.max(Math.min(m.verticalCenter()-p.height/2,n.height-p.height),0))));return!0},getPlaceholderOffset:function(){return j}}};a.orgdiagram.CreateTransformTask=
function(g,b){var d=null;return{process:function(){var c=g.getOptions(),f=new a.common.Size(b.getContentSize());d=new a.common.Transform;d.setOrientation(c.orientationType);d.size=new a.common.Size(f);return!0},getTransform:function(){return d},getTreeItemForMousePosition:function(a,f,e){var g=null;d.transformPoint(a,f,!1,this,function(a,c){g=b.getTreeItemForMousePosition(a,c,e)});return g},description:"Create oordiante system tranfromation object."}};a.orgdiagram.CurrentControlSizeTask=function(g,
b){var d={scrollPanelSize:null},c={},f=new a.common.ObjectReader({scrollPanelSize:new a.common.ObjectReader({width:new a.common.ValueReader(["number"],!0),height:new a.common.ValueReader(["number"],!0)},!0)});return{process:function(){var a={isChanged:!1,hash:c},h=g.getOptions(),i=!1,j=b.getOptions();d=f.read(d,h,"layout",a);switch(j.pageFitMode){case 1:case 2:case 3:case 0:i=a.isChanged}return i},getScrollPanelSize:function(){return d.scrollPanelSize},getOptimalPanelSize:function(){return new a.common.Size(d.scrollPanelSize.width-
25,d.scrollPanelSize.height-25)}}};a.orgdiagram.CurrentScrollPositionTask=function(g){var b={placeholderOffset:null},d={},c=new a.common.ObjectReader({placeholderOffset:new a.common.ObjectReader({x:new a.common.ValueReader(["number"],!0),y:new a.common.ValueReader(["number"],!0)},!0)});return{process:function(){var a={isChanged:!1,hash:d},e=g.getOptions();b=c.read(b,e,"layout",a);return a.isChanged},getPlaceholderOffset:function(){return b.placeholderOffset}}};a.orgdiagram.BackgroundAnnotationOptionTask=
function(g,b){var d=[],c={},f=new a.common.ArrayReader(new a.common.ObjectReader({items:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0),includeChildren:new a.common.ValueReader(["boolean"],!1,b.includeChildren),zOrderType:new a.common.EnumerationReader(a.common.ZOrderType,!1,b.zOrderType),offset:new a.common.ObjectReader({left:new a.common.ValueReader(["number"],!1,b.offset.left),top:new a.common.ValueReader(["number"],!1,b.offset.top),right:new a.common.ValueReader(["number"],
...
getGravityRadius:function(){return d.highlightGravityRadius},description:"Checks highlight item option."}};a.orgdiagram.SelectedItemsOptionTask=function(g){var b={},d={},c=new a.common.ObjectReader({selectedItems:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0)});return{process:function(){var a={isChanged:!1,hash:d},e=g.getOptions();b=c.read(b,e,"options",a);return a.isChanged},getSelectedItems:function(){return b.selectedItems},description:"Checks user selected items option."}};
a.orgdiagram.CalloutOptionTask=function(g,b){var d={},c={},f=new a.common.ObjectReader({calloutMaximumVisibility:new a.common.EnumerationReader(a.common.Visibility,!1,b.calloutMaximumVisibility),showCallout:new a.common.ValueReader(["boolean"],!1,b.showCallout),calloutPlacementOffset:new a.common.ValueReader(["number"],!1,b.calloutPlacementOffset),orientationType:new a.common.EnumerationReader(a.common.OrientationType,!1,b.orientationType),defaultTemplateName:new a.common.ValueReader(["string"],!0),
...
!1,b.selectCheckBoxLabel),buttons:new a.common.ArrayReader(new a.common.ObjectReader({name:new a.common.ValueReader(["string"],!0),icon:new a.common.ValueReader(["string"],!0),text:new a.common.ValueReader(["boolean"],!1,!1),tooltip:new a.common.ValueReader(["string"],!0),size:new a.common.ObjectReader({width:new a.common.ValueReader(["number"],!1,c.size.width),height:new a.common.ValueReader(["number"],!1,c.size.height)},!1,c.size)}),!0,"name"),onButtonsRender:new a.common.FunctionReader,pageFitMode:new a.common.EnumerationReader(a.common.PageFitMode,
...
"number"],!0),groupTitle:new a.common.ValueReader(["string","number"],!0),isVisible:new a.common.ValueReader(["boolean","number"],!1,d.isVisible),isActive:new a.common.ValueReader(["boolean","number"],!1,d.isActive),hasSelectorCheckbox:new a.common.EnumerationReader(a.common.Enabled,!1,d.hasSelectorCheckbox),hasButtons:new a.common.EnumerationReader(a.common.Enabled,!1,d.hasButtons),templateName:new a.common.ValueReader(["string"],!0)}),!0,"id")});return{process:function(){var a={isChanged:!1,hash:e};
f=h.read(f,g.getOptions(),"options",a);return a.isChanged},getItemOptions:function(a){return e["options-items"][a]},getOptions:function(){return f},description:"Checks items size options."}};a.orgdiagram.LabelsOptionTask=function(g,b,d){var c={},f={},e=new a.common.ObjectReader({showLabels:new a.common.EnumerationReader(a.common.Enabled,!1,b.showLabels),labelOffset:new a.common.ValueReader(["number"],!1,b.labelOffset),labelFontSize:new a.common.ValueReader(["string"],!1,b.labelFontSize),labelFontFamily:new a.common.ValueReader(["string"],
...
c={},f=new a.common.ObjectReader({orientationType:new a.common.EnumerationReader(a.common.OrientationType,!1,b.orientationType)});return{process:function(){var a={isChanged:!1,hash:c};d=f.read(d,g.getOptions(),"options",a);return a.isChanged},getOptions:function(){return d},description:"Checks diagram orientation options."}};a.orgdiagram.ScaleOptionTask=function(g,b){var d={},c={},f=new a.common.ObjectReader({scale:new a.common.ValueReader(["number"],!1,b.scale),minimumScale:new a.common.ValueReader(["number"],
!1,b.minimumScale),maximumScale:new a.common.ValueReader(["number"],!1,b.maximumScale)});return{process:function(){var a={isChanged:!1,hash:c};d=f.read(d,g.getOptions(),"options",a);return a.isChanged},getOptions:function(){return d},description:"Checks control scale options."}};a.orgdiagram.TemplatesOptionTask=function(g,b,d,c){var f={},e={},h=new a.common.ObjectReader({groupTitleVerticalAlignment:new a.common.EnumerationReader(a.common.VerticalAlignmentType,!1,b.groupTitleVerticalAlignment),groupTitleHorizontalAlignment:new a.common.EnumerationReader(a.common.HorizontalAlignmentType,
...
!0),isActive:new a.common.ValueReader(["boolean"],!1,c.isActive),itemSize:new a.common.ObjectReader({width:new a.common.ValueReader(["number"],!1,c.itemSize.width),height:new a.common.ValueReader(["number"],!1,c.itemSize.height)},!1,c.itemSize),itemBorderWidth:new a.common.ValueReader(["number"],!1,c.itemBorderWidth),itemTemplate:new a.common.ValueReader(["string","object"],!0),minimizedItemShapeType:new a.common.EnumerationReader(a.common.ShapeType,!0),minimizedItemSize:new a.common.ObjectReader({width:new a.common.ValueReader(["number"],
!1,c.minimizedItemSize.width),height:new a.common.ValueReader(["number"],!1,c.minimizedItemSize.height)},!1,c.minimizedItemSize),minimizedItemCornerRadius:new a.common.ValueReader(["number"],!0),minimizedItemLineWidth:new a.common.ValueReader(["number"],!1,c.minimizedItemLineWidth),minimizedItemBorderColor:new a.common.ValueReader(["string"],!0),minimizedItemLineType:new a.common.EnumerationReader(a.common.LineType,!1,c.minimizedItemLineType),minimizedItemFillColor:new a.common.ValueReader(["string"],
!0),minimizedItemOpacity:new a.common.ValueReader(["number"],!1,c.minimizedItemOpacity),highlightPadding:new a.common.ObjectReader({left:new a.common.ValueReader(["number"],!1,c.highlightPadding.left),top:new a.common.ValueReader(["number"],!1,c.highlightPadding.top),right:new a.common.ValueReader(["number"],!1,c.highlightPadding.right),bottom:new a.common.ValueReader(["number"],!1,c.highlightPadding.bottom)},!1,c.highlightPadding),highlightBorderWidth:new a.common.ValueReader(["number"],!1,c.highlightBorderWidth),
highlightTemplate:new a.common.ValueReader(["string","object"],!0),cursorPadding:new a.common.ObjectReader({left:new a.common.ValueReader(["number"],!1,c.cursorPadding.left),top:new a.common.ValueReader(["number"],!1,c.cursorPadding.top),right:new a.common.ValueReader(["number"],!1,c.cursorPadding.right),bottom:new a.common.ValueReader(["number"],!1,c.cursorPadding.bottom)},!1,c.cursorPadding),cursorBorderWidth:new a.common.ValueReader(["number"],!1,c.cursorBorderWidth),cursorTemplate:new a.common.ValueReader(["string",
"object"],!0),buttons:new a.common.ArrayReader(new a.common.ObjectReader({name:new a.common.ValueReader(["string"],!0),icon:new a.common.ValueReader(["string"],!0),text:new a.common.ValueReader(["boolean"],!1,!1),tooltip:new a.common.ValueReader(["string"],!0),size:new a.common.ObjectReader({width:new a.common.ValueReader(["number"],!1,d.size.width),height:new a.common.ValueReader(["number"],!1,d.size.height)},!1,d.size)}),!0,"name"),onButtonsRender:new a.common.FunctionReader}),!0,"name")});return{process:function(){var a=
{isChanged:!1,hash:e};f=h.read(f,g.getOptions(),"options",a);return a.isChanged},getOptions:function(){return f},description:"Checks items template options."}};a.orgdiagram.VisualTreeOptionTask=function(g,b){var d={},c={},f=new a.common.ObjectReader({leavesPlacementType:new a.common.EnumerationReader(a.common.ChildrenPlacementType,!1,b.leavesPlacementType),childrenPlacementType:new a.common.EnumerationReader(a.common.ChildrenPlacementType,!1,b.childrenPlacementType),placeAdvisersAboveChildren:new a.common.ValueReader(["boolean"],
!1,b.placeAdvisersAboveChildren),placeAssistantsAboveChildren:new a.common.ValueReader(["boolean"],!1,b.placeAssistantsAboveChildren),maximumColumnsInMatrix:new a.common.ValueReader(["number"],!1,b.maximumColumnsInMatrix),horizontalAlignment:new a.common.EnumerationReader(a.common.HorizontalAlignmentType,!1,b.horizontalAlignment)});return{process:function(){var a={isChanged:!1,hash:c};d=f.read(d,g.getOptions(),"options",a);return a.isChanged},getOptions:function(){return d},description:"Checks items layout options."}};
...
function(){var g={};return{getOffset:function(b,d){var c=b.getLineKey();g.hasOwnProperty(c)||(g[c]=new a.orgdiagram.CollinearVectorBundle);g[c].addVector(b,d)},resolve:function(){for(var a in g)g.hasOwnProperty(a)&&g[a].resolve()}}};a.orgdiagram.DrawBackgroundAnnotationTask=function(g,b,d,c,f,e){function h(b,c,d){var f,g,h,j,t,w,v,A,x,B,z,y,c=0;for(f=b.length;c<f;c+=1)if(z=b[c],null!=z.items&&0<z.items.length){j=new a.common.MergedRectangles(i);j.transform=k;t=new a.orgdiagram.BackgroundAnnotationConfig;
x=["opacity","lineWidth","borderColor","fillColor","lineType"];g=0;for(h=x.length;g<h;g+=1)B=x[g],j[B]=z.hasOwnProperty(B)?z[B]:t[B];i.activate("placeholder",2);w=[];A={};g=0;for(h=z.items.length;g<h;g+=1)t=z.items[g],y=e.getItemPosition(t),null!=y&&(A[t]=!0,v=new a.common.Rect(y.actualPosition),v.offset(z.offset),w.push(v),z.includeChildren&&d.loopChildren(this,t,function(b){A[b]||(A[b]=!0,y=e.getItemPosition(b),v=new a.common.Rect(y.actualPosition),v.offset(z.offset),w.push(v))}));j.draw(w)}}var i,
j,k;return{process:function(){var a=c.getAnnotations(),d;i=g();i.reset("placeholder",2);0<a.length&&(j=e.getItemsPositions(),k=b.getTransform(),d=f.getNavigationFamily(),h(a,j,d));return!1}}};a.orgdiagram.DrawConnectorAnnotationTask=function(g,b,d,c,f,e,h,i){function j(b,c){var d,e,f,g,h,j,x,B,z,y=new a.common.PolylinesBuffer,u=a.orgdiagram.ConnectorAnnotationOffsetResolver(),F=0;switch(i){case 1:k.activate("placeholder",4);break;case 2:k.activate("placeholder",14)}d=0;for(e=b.length;d<e;d+=1)B=b[d],
F=Math.max(F,B.lineWidth);d=0;for(e=b.length;d<e;d+=1)if(B=b[d],null!=B.fromItem&&null!=B.toItem&&(f=c(B.fromItem),h=c(B.toItem),null!=f&&null!=h)){g=f.actualPosition;j=h.actualPosition;switch(B.connectorPlacementType){case 0:x=new a.common.ConnectorOffbeat;break;case 1:x=new a.common.ConnectorStraight}var E;m.transformRect(0,0,B.labelSize.width,B.labelSize.height,!1,this,function(b,c,d,e){E=new a.common.Size(d,e)});var D=null;m.transformRect(0,0,l.width,l.height,!1,this,function(b,c,d,e){D=new a.common.Size(d,
e)});h=new a.common.PaletteItem({lineColor:B.color,lineWidth:B.lineWidth,lineType:B.lineType});f=!a.common.isNullOrEmpty(B.label);g=(new a.common.Rect(g)).offset(B.offset);j=(new a.common.Rect(j)).offset(B.offset);x.draw(y,h,g,j,3*B.lineWidth,6*F,E,D,B.connectorShapeType,4,B.labelPlacementType,f,u,function(b,c){!a.common.isNullOrEmpty(c.label)&&null!=b&&(m.transformRect(b.x,b.y,b.width,b.height,!0,this,function(c,d,e,f){b=new a.common.Rect(c,d,e,f)}),z=new a.common.RenderEventArgs,z.context=c,k.template(b.x,
b.y,0,0,0,0,b.width,b.height,n.template(),n.getHashCode(),n.render,z,null))},B)}u.resolve();y.transform(m,!0);k.polylinesBuffer(y)}var k,m,n,l;return{process:function(){k=g();m=b.getTransform();c.getOptions();n=h.getTemplate();l=new a.common.Size(e.getContentSize());switch(i){case 1:k.reset("placeholder",4);break;case 2:k.reset("placeholder",14)}j(f.getAnnotations(),e.getItemPosition);return!1}}};a.orgdiagram.DrawConnectorsTask=function(g,b,d,c,f){return{process:function(){var e=g(),h=b.getGraph(),
...
b.getTransform(),j(a));return!1}}};a.orgdiagram.DrawHighlightAnnotationTask=function(g,b,d,c,f,e,h,i,j,k,m,n){function l(b){var g,k,l,x,B,z,y=!0,u=i.getItemPosition(b),F=u.actualPosition;switch(u.actualVisibility){case 2:case 3:case 1:g=e.getItemOptions(b);switch(g.showCallout){case 2:y=!1;break;case 1:y=!1;break;default:y=s.showCallout}y?(p.activate("placeholder",12),q.transformRect(F.x,F.y,F.width,F.height,!0,this,function(e,q,y,G){var q=new a.common.Rect(e,q,y,G),e=new a.common.Point(q.horizontalCenter(),
q.verticalCenter()),y=c.getOptions().scale,G=new a.common.Point(j.getPlaceholderOffset()),I=new a.common.Rect(i.getContentSize()),H=new a.common.Size(d.getOptimalPanelSize());G.scale(1/y);H.scale(1/y);y=new a.common.Rect(G.x,G.y,Math.min(H.width,I.width),Math.min(H.height,I.height));if(u.actualVisibility>=s.calloutMaximumVisibility&&4!=u.actualVisibility||!y.overlaps(q)){B=!a.common.isNullOrEmpty(g.calloutTemplateName)?g.calloutTemplateName:!a.common.isNullOrEmpty(g.templateName)?g.templateName:!a.common.isNullOrEmpty(s.defaultCalloutTemplateName)?
s.defaultCalloutTemplateName:s.defaultTemplateName;z=h.getTemplate(B,h.DefaultWidgetTemplateName);q=z.templateConfig.itemSize;G=new a.common.Rect(e.x,e.y,q.width,q.height);switch(s.orientationType){case 0:case 1:G.y-=q.height/4;G.x=e.x<y.horizontalCenter()?G.x+s.calloutPlacementOffset:G.x-(s.calloutPlacementOffset+q.width);break;default:G.x-=q.width/4,G.y=e.y<y.verticalCenter()?G.y+s.calloutPlacementOffset:G.y-(s.calloutPlacementOffset+q.height)}G.x<y.x?G.x=y.x+5:G.right()>y.right()&&(G.x-=G.right()-
y.right()+5);G.y<y.y?G.y=y.y+5:G.bottom()>y.bottom()&&(G.y-=G.bottom()-y.bottom()+5);l=G;k=new a.common.Rect(l);k.addRect(e.x,e.y);k.offset(50);e.x-=k.x;e.y-=k.y;l.x-=k.x;l.y-=k.y;x=new a.common.RenderEventArgs;x.context=f.getConfig(b);x.isCursor=m.getCursorTreeItem()==b;x.isSelected=n.isSelected(b);x.templateName=z.templateConfig.name;p.position("calloutplaceholder",k.x,k.y,k.width,k.height);p.show("calloutplaceholder");p.activate("calloutplaceholder",15);p.template(l.x,l.y,l.width,l.height,0,0,
...
s;return{process:function(){var a=k.getHighlightTreeItem();p=g();p.reset("calloutplaceholder",15);null!==a&&(q=b.getTransform(),s=e.getOptions(),l(a));return!1}}};a.orgdiagram.DrawHighlightPathAnnotationTask=function(g,b,d,c,f){function e(b,c,d,e){var g,n,l,p,q,r,s,t,w,v,A,x,B;if(0<d.length){A=new a.common.PolylinesBuffer;switch(f){case 1:b.activate("placeholder",5);break;case 2:b.activate("placeholder",7)}var z={};g=0;for(n=d.length;g<n;g+=1)if(v=d[g],null!=v.items&&0<v.items.length&&(t=v.items.slice(0),
q=t[0],e.hasNode(q))){l=1;for(p=t.length;l<p;l+=1)r=t[l],e.hasNode(r)&&(z.hasOwnProperty(q)?z[q].push(r):z[q]=[r],q=r)}var y={};for(x in z)y[x]={},z.hasOwnProperty(x)&&e.getShortestPath(this,x,z[x],function(a){return a.weight},function(a,b){y[x][b]=a});g=0;for(n=d.length;g<n;g+=1)if(v=d[g],l=new a.common.PaletteItem({lineColor:null!=v.color?v.color:c.highlightLinesColor,lineWidth:null!=v.lineWidth?v.lineWidth:c.highlightLinesWidth,lineType:null!=v.lineType?v.lineType:c.highlightLinesType,fillColor:null,
opacity:v.opacity}),z=A.getPolyline(l),null!=v.items&&0<v.items.length&&(t=v.items.slice(0),q=t[0],e.hasNode(q))){l=1;for(p=t.length;l<p;l+=1)if(r=t[l],e.hasNode(r)){s=y[q][r]||[];for(q=s.length-2;0<=q;q-=1)x=s[q+1],B=s[q],w=e.edge(x,B),w.from==x?w.polyline.clone().mergeTo(z):z.addInverted(w.polyline.clone()),v.showArrows&&(B==w.parentsArrowId||B==w.childrenArrowId)&&z.addArrow(v.lineWidth,function(a){a.mergeTo(A.getPolyline(a.paletteItem))});q=r}}b.polylinesBuffer(A)}}return{process:function(){var a=
...
c.itemsOptions[e],g=b.treeItemsPositions[e],l=g.actualPosition;null!=f&&b.transform.transformRect(l.x,l.y,l.width,l.height,!0,this,function(b,e,h,k){var l;switch(g.actualVisibility){case 1:0==c.showLabels&&(p=new a.common.Label(b,e,h,k),p.weight=1E4,p.labelType=1,d.push(p));break;case 2:case 3:var p;p=f;var q=g,B=null,z,y,u,F;if(!a.common.isNullOrEmpty(p.label)){var E;E=3;switch(p.showLabel){case 0:switch(c.showLabels){case 0:switch(q.actualVisibility){case 3:case 2:E=0}break;case 1:E=2}break;case 1:E=
2}switch(E){case 0:F=q.leftPadding+q.rightPadding;break;case 2:F=1E4;break;case 3:F=0}if(3!=E){u=null!=p.labelSize?p.labelSize:c.labelSize;q=3!=p.labelOrientation?p.labelOrientation:3!=c.labelOrientation?c.labelOrientation:0;B=0!=p.labelPlacement?p.labelPlacement:0!=c.labelPlacement?c.labelPlacement:1;switch(q){case 0:z=u.width;y=u.height;break;case 1:case 2:y=u.width,z=u.height}u=c.labelOffset;var D,C;switch(B){case 0:case 1:D=new a.common.Rect(b+h/2-z/2,e-u-y,z,y);switch(q){case 0:C=0;l=2;break;
case 1:l=C=1;break;case 2:C=2,l=1}break;case 2:case 11:D=new a.common.Rect(b+h+u,e-u-y,z,y);switch(q){case 0:C=1;l=2;break;case 1:C=1;l=0;break;case 2:l=C=2}break;case 3:D=new a.common.Rect(b+h+u,e+k/2-y/2,z,y);switch(q){case 0:l=C=1;break;case 1:l=C=0;break;case 2:C=0,l=2}break;case 4:case 12:D=new a.common.Rect(b+h+u,e+k+u,z,y);switch(q){case 0:C=1;l=0;break;case 1:C=2;l=0;break;case 2:C=1,l=2}break;case 5:D=new a.common.Rect(b+h/2-z/2,e+k+u,z,y);switch(q){case 0:l=C=0;break;case 1:C=2;l=1;break;
case 2:l=C=1}break;case 6:case 10:D=new a.common.Rect(b-z-u,e+k+u,z,y);switch(q){case 0:C=2;l=0;break;case 1:l=C=2;break;case 2:C=1,l=0}break;case 7:D=new a.common.Rect(b-z-u,e+k/2-y/2,z,y);switch(q){case 0:C=2;l=1;break;case 1:C=0;l=2;break;case 2:l=C=0}break;case 8:case 9:switch(D=new a.common.Rect(b-z-u,e-u-y,z,y),q){case 0:l=C=2;break;case 1:C=1;l=2;break;case 2:C=2,l=0}}b=C;B=new a.common.Label(D);B.labelType=E;B.weight=F;B.text=p.label;B.labelOrientation=q;B.horizontalAlignmentType=b;B.verticalAlignmentType=
...
labelFontFamily:a.labelFontFamily,labelFontStyle:a.labelFontStyle,labelFontWeight:a.labelFontWeight,labelColor:a.labelColor,itemsOptions:c.getItemsOptions(),labelSize:a.labelSize,labelOrientation:a.labelOrientation,labelPlacement:a.labelPlacement,labelOffset:a.labelOffset};d.graphics.reset("placeholder",10);e(d,a);return!1}}};a.orgdiagram.DrawMinimizedItemsTask=function(g,b,d,c,f,e){function h(){var b=new a.common.PolylinesBuffer,d={},e,g=new a.common.Marker,h,t,w,v,A,x,B,z,y,u;for(u in n)n.hasOwnProperty(u)&&
(A=n[u],x=A.actualPosition,B=c.getItemOptions(u),j.transformRect(x.x,x.y,x.width,x.height,!0,this,function(c,i,n,j){switch(A.actualVisibility){case 2:z=f.getTemplateParams(u);y=z.template.templateConfig;w=t=h=null;v=0;null!=B&&(t=h=B.itemTitleColor,w=B.minimizedItemShapeType);h=h||y.minimizedItemBorderColor||"#000080";t=t||y.minimizedItemFillColor||"#000080";null==w&&(w=null!==y.minimizedItemShapeType?y.minimizedItemShapeType:m.minimizedItemShapeType);v=null===y.minimizedItemCornerRadius?y.minimizedItemSize.width:
y.minimizedItemCornerRadius;null==w||6==w?(e=b.getPolyline(new a.common.PaletteItem({lineColor:h,lineWidth:y.minimizedItemLineWidth,lineType:y.minimizedItemLineType,fillColor:t,opacity:y.minimizedItemOpacity})),e.addSegment(new a.common.DotSegment(c,i,n,j,v))):g.draw(b,w,new a.common.Rect(c,i,n,j),new a.common.PaletteItem({lineColor:h,lineWidth:y.minimizedItemLineWidth,lineType:y.minimizedItemLineType,fillColor:t,opacity:y.minimizedItemOpacity}));break;default:k&&(h="#ff0000",d.hasOwnProperty(h)||
(d[h]=new a.common.PaletteItem({lineColor:h,lineWidth:1,lineType:0,fillColor:h,opacity:1})),e=b.getPolyline(d[h]),e.addSegment(new a.common.DotSegment(c-1,i-1,2,2,1)))}}));i.activate("placeholder",9);i.polylinesBuffer(b)}var i,j,k=!1,m,n;return{process:function(){i=g();j=b.getTransform();m=c.getOptions();n=e.getItemsPositions();i.reset("placeholder",9);h();return!1}}};a.orgdiagram.DrawShapeAnnotationTask=function(g,b,d,c,f,e,h,i){function j(b,c){var d,e,f,g,h,j,x,B,z,y,u,F;switch(i){case 1:d=k.activate("placeholder",
3);break;case 2:d=k.activate("placeholder",13)}e=0;for(f=b.length;e<f;e+=1)if(u=b[e],null!=u.items&&0<u.items.length){B=new a.common.Rect;g=0;for(h=u.items.length;g<h;g+=1)x=c(u.items[g]),null!=x&&B.addRect(x.actualPosition);if(!B.isEmpty()){j=new a.common.Shape(k);x=new a.orgdiagram.ShapeAnnotationConfig;z="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");g=0;for(h=z.length;g<h;g+=1)y=z[g],j[y]=u.hasOwnProperty(y)?
u[y]:x[y];j.position=B;j.orientationType=n.orientationType;j.panelSize=d.size;j.labelTemplate=l;j.hasLabel=null!=u.templateName||null!=u.label;F=new a.common.RenderEventArgs;F.context=u;F.templateName=j.labelTemplate;m.transformRect(B.x,B.y,B.width,B.height,!0,this,function(b,c,d,e){b=new a.common.Rect(b,c,d,e);j.draw(b,F)})}}}var k,m,n,l;return{process:function(){k=g();m=b.getTransform();n=c.getOptions();l=h.getTemplate();switch(i){case 1:k.reset("placeholder",3);break;case 2:k.reset("placeholder",
13)}j(f.getAnnotations(),e.getItemPosition);return!1}}};a.orgdiagram.DrawTreeItemsTask=function(g,b,d,c,f,e,h,i,j,k,m,n,l,p){function q(){var b,f=k.getCursorTreeItem(),g,n,l;n=null;if(null!=i){n=c.getOptions().scale;var p=new a.common.Point(i.getPlaceholderOffset()),q=new a.common.Rect(h.getContentSize()),C=new a.common.Size(d.getOptimalPanelSize());p.scale(1/n);C.scale(1/n);n=new a.common.Rect(p.x,p.y,Math.min(C.width,q.width),Math.min(C.height,q.height))}l=n;for(var G in r)r.hasOwnProperty(G)&&
(g=r[G],n=g.actualPosition,1==g.actualVisibility&&t.transformRect(n.x,n.y,n.width,n.height,!0,this,function(c,d,h,i){var n=new a.common.Rect(c,d,h,i);if(null==l||l.overlaps(n)){var k=j.getTemplateParams(G),n=k.template;b=new a.common.RenderEventArgs;b.id=G;b.context=e.getConfig(G);b.isCursor=G==f;b.isSelected=m.isSelected(G);b.templateName=n.templateConfig.name;b.template=k.template;b.isActive=k.isActive;b.hasSelectorCheckbox=k.hasSelectorCheckbox;b.hasButtons=k.hasButtons;b.hasGroupTitle=k.hasGroupTitle;
...
i-g.contentPosition.y),v.template(),n.templateConfig.name+v.getHashCode(),v.render,b,null)}}}))}var r,s,t,w,v,A,x;return{process:function(){s=g();w=f.getOptions();r=h.getItemsPositions();t=b.getTransform();v=p.getTemplate();A=l.getTemplate();x=n.getTemplate();s.reset("placeholder",12);s.reset("placeholder",16);q();return!1}}};a.orgdiagram.ActiveItemsTask=function(g,b){function d(a,c){var d=[],e,g;e=0;for(g=c.length;e<g;e+=1){var f=c[e],l=b.getTemplate(f.templateName,a.defaultTemplateName,b.DefaultWidgetTemplateName).templateConfig;
...
bevelSize:k.bevelSize,elbowType:k.elbowType},j=0,n=i.length;j<n;j+=1)i[j].trace(m,h,k);e=m;return!0},getGraph:function(){return e.graph}}};a.orgdiagram.ItemsPositionsTask=function(g,b,d,c,f,e,h,i,j,k,m){var n,l;function p(b){var c=new a.common.Rect(0,0,0,0),d,e,f,g,h;switch(I.orientationType){case 2:case 3:b.invert()}if(!F.isEmpty())switch(J.pageFitMode){case 0:case 5:d=[new a.orgdiagram.LevelVisibility(0,1)];c=q(d,0);break;default:d=[new a.orgdiagram.LevelVisibility(0,1)];e=[];switch(J.minimalVisibility){case 2:e.push(2);
...
c);return!0},getPaletteManager:function(){return d}}};a.orgdiagram.VisualTreeLevelsTask=function(g){function b(b,c,d,e){var f,g,l,p,q,r,s,t={},w,v,A;d.loopLevels(this,function(x){var B=new a.orgdiagram.TreeLevelConnectorStackSize;c[x]=B;s=[];d.loopLevelItems(this,x,function(c,f){var g=[];if(!t.hasOwnProperty(c)&&(f.connectorPlacement&4&&g.push(c),g=g.concat(f.partners),0<g.length)){r=new a.common.VerticalConnectorBundle(g,[]);for(var i=0,m=g.length;i<m;i+=1)t[g[i]]=r;e.loopChildren(this,c,function(a,
b){b.connectorPlacement&1&&r.toItems.push(a)});1<g.length&&s.push(r);(1<r.fromItems.length||0<r.toItems.length)&&b.push(r)}f.connectorPlacement&8&&(r=new a.common.HorizontalConnectorBundle(c,d.getPrevItem(c)),b.push(r));f.connectorPlacement&2&&(r=new a.common.HorizontalConnectorBundle(c,d.getNextItem(c)),b.push(r))});if(0<s.length){A=a.common.pile();f=0;for(g=s.length;f<g;f+=1){r=s[f];v=w=null;l=0;for(p=r.fromItems.length;l<p;l+=1)q=d.getItemPosition(r.fromItems[l]),w=null!=w?Math.min(w,q):q,v=null!=
v?Math.max(v,q):q;A.add(w,v,r)}B.parentsStackSize=A.resolve(this,function(a,b,c,d,e){c.fromOffset=d+1;c.fromStackSize=e})}})}var d=null,c=null,f=null,e=new a.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var e=g.getVisualTree();d=a.common.TreeLevels();e.loopLevels(this,function(a,b,c){d.addItem(c,a,b)});c=[];f=[];b(c,f,d,e);return!0},getTreeLevels:function(){return d},getBundles:function(){return c},getConnectorsStacksSizes:function(a){return f[a]||e},getNestedLayoutBottomConnectorIds:function(){return{}}}};
a.orgdiagram.VisualTreeTask=function(g,b,d,c){function f(a,b,d){var f,g,s,w,v,D,C,G,I,H,K,J,Q,U={},R,Y={},L,Z,$,da={},aa;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(e,i){var j,s,u;if(!c&&!i.hasVisibleChildren)return a.SKIP;j=d.node(e);j||(j=q({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},i),d.add(null,e,j));$=Z=0;if(null!=(D=
d.indexOf(e)))Z=D,$=d.countSiblings(e)-D-1;s=[];a.loopChildren(this,e,function(a,b){if(c||b.hasVisibleChildren){f=q({parentId:e,actualItemType:b.itemType},b);switch(j.actualItemType){case 7:case 8:case 6:switch(f.actualItemType){case 7:case 8:case 6:f.actualItemType=2;break;case 0:f.actualItemType=1}}switch(f.actualItemType){case 5:r(j,f),f.connectorPlacement=5,u=q({visibility:4}),d.add(u.id,f.id,f),f=u;case 8:case 2:g=d.parent(e);if(j.connectorPlacement&2)w=n(d,t.navigationFamily,j),d.add(g.id,f.id,
f,w+1),f.connectorPlacement=6,f.gravity=2;else if(j.connectorPlacement&8)v=l(d,t.navigationFamily,j),d.add(g.id,f.id,f,v),f.connectorPlacement=12,f.gravity=1;else switch(b.adviserPlacementType){case 2:w=n(d,t.navigationFamily,j);d.add(g.id,f.id,f,w+1);f.connectorPlacement=6;f.gravity=2;break;default:v=l(d,t.navigationFamily,j),d.add(g.id,f.id,f,v),f.connectorPlacement=12,f.gravity=1}switch(f.actualItemType){case 8:null!=j.parentId?r(d.node(j.parentId),f):r(j,f,!0);break;case 2:r(j,f)}break;case 4:r(j,
f),f.connectorPlacement=5,u=q({visibility:4}),d.add(u.id,f.id,f),f=u;case 1:var h;h=j;var i,m=b.levelOffset||0,k=null,p;i=!1;for(var J=0;J<=m;)k=null==k?h:d.node(k.visualAggregatorId),null==k.visualAggregatorId&&(p=q({visibility:4,visualAggregatorId:null,connectorPlacement:i?0:5}),d.insert(k.id,p.id,p),k.visualAggregatorId=p.id),J+=1;h=k;switch(b.adviserPlacementType){case 2:d.add(h.id,f.id,f,0);f.connectorPlacement=6;f.gravity=2;break;default:d.add(h.id,f.id,f),f.connectorPlacement=12,f.gravity=
1}1==f.actualItemType&&r(j,f);break;case 0:h=b.levelOffset||0;null==s[h]?s[h]=[f]:s[h].push(f);r(j,f);break;case 7:case 6:g=d.parent(e);if(j.connectorPlacement&2)d.add(g.id,f.id,f,Z),f.connectorPlacement=6,f.gravity=2;else if(j.connectorPlacement&8)d.add(g.id,f.id,f,d.countChildren(g.id)-$),f.connectorPlacement=12,f.gravity=1;else{switch(b.adviserPlacementType){case 2:d.add(g.id,f.id,f,Z);f.gravity=2;break;default:d.add(g.id,f.id,f,d.countChildren(g.id)-$),f.gravity=1}switch(f.actualItemType){case 6:f.connectorPlacement=
5;break;case 7:f.connectorPlacement=4}}null!=j.parentId?r(d.node(j.parentId),f):r(j,f,!0)}}});switch(j.actualItemType){case 7:case 8:case 6:break;default:aa=[],null!=(g=d.parent(e))&&d.loopChildrenRange(this,g.id,Z,d.countChildren(g.id)-$,function(b,c){if(c.id==e)aa.push(c);else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==e&&aa.push(c)}}),1<aa.length&&(da[e]=aa)}U[e]=[];Y[e]=[];var K=[];if(0<s.length){g=h(d,j);for(var J=0;J<s.length-1;J+=1){var I=s[J];if(null!=I){var Q=p(d,g,4==
j.visibility&&0===j.connectorPlacement);K.push([Q]);var H=0;switch(b.horizontalAlignment){case 0:H=Math.ceil(I.length/2)-1;break;case 1:H=-1;break;case 2:H=I.length-1}for(D=H;0<=D;D-=1)G=I[D],d.add(g.id,G.id,G,0),G.connectorPlacement=5,G.gravity=2;for(D=H+1;D<I.length;D+=1)G=I[D],d.add(g.id,G.id,G),G.connectorPlacement=5,G.gravity=1;g=Q}}var H=j,J=s[s.length-1],C=i.childrenPlacementType,I=U[e],Q=Y[e],R,L,P,T,M,N,O,S,V=4==H.visibility&&0===H.connectorPlacement;switch(b.horizontalAlignment){case 0:case 1:R=
3;break;case 2:R=2}0===C&&(C=m(a,H)?0===b.leavesPlacementType?3:b.leavesPlacementType:0===b.childrenPlacementType?2:b.childrenPlacementType);H=h(d,H);3==C&&3>J.length&&(C=2);switch(C){case 2:L=0;for(T=J.length;L<T;L+=1)C=J[L],P=a.node(C.id),d.add(H.id,C.id,C),C.connectorPlacement=(P.hideParentConnection?0:1)|(P.hideChildrenConnection?0:4),0===L&&(C.relationDegree=1);break;case 3:T=Math.min(b.maximumColumnsInMatrix,Math.ceil(Math.sqrt(J.length)));M=Math.ceil(J.length/T);N=Math.ceil(T/2);for(O=0;O<
N;O+=1){R=H;for(S=0;S<M;S+=1){C=k(J,2*O,S,T);L=k(J,2*O+1,S,T);void 0===I[S]&&(I[S]=[],Q[S]=[]);null!==C&&(0===O&&(C.relationDegree=1),d.add(R.id,C.id,C),C.connectorPlacement=(V?0:2)|4,C.gravity=2,Q[S].push(C));if(null!==C||null!==L)P=q({visibility:4,connectorPlacement:V?0:5}),d.add(R.id,P.id,P),I[S].push(P);null!==L&&(d.add(R.id,L.id,L),L.connectorPlacement=(V?0:8)|4,L.gravity=1,Q[S].push(L));R=P}}2<T&&(H.visualAggregatorId=null);break;case 1:L=0;for(T=J.length;L<T;L+=1){C=J[L];P=q({visibility:4,
connectorPlacement:V?0:5});switch(R){case 2:d.add(H.id,C.id,C);d.add(H.id,P.id,P);C.connectorPlacement=(V?0:2)|4;C.gravity=2;break;case 3:d.add(H.id,P.id,P),d.add(H.id,C.id,C),C.connectorPlacement=(V?0:8)|4,C.gravity=1}I[L]=[P];Q[L]=[C];H=P}break;default:throw"Children placement is undefined!";}U[e]=U[e].concat(K);Y[e]=Y[e].concat(s.slice(0,s.length-1))}});a.loopPostOrder(this,function(a,c,f,g){var c=d.node(a),h,m,n=null!=da[f];if(null!=c){f=Y[a];h=U[a];if(null!=g){m=n;switch(g.placeAssistantsAboveChildren){case 0:b.placeAssistantsAboveChildren&&
(m=!0);break;case 1:m=!0}if(m&&(K=i(d,c),0<K&&(c.visualDepth=K+1,null!==c.visualAggregatorId))){s=d.node(c.visualAggregatorId);m=d.hasChildren(s.id);for(D=0;D<K-1;D+=1)s=p(d,s,!m)}}if(null!=g){m=n;switch(g.placeAdvisersAboveChildren){case 0:b.placeAdvisersAboveChildren&&(m=!0);break;case 1:m=!0}if(m){var g=0,n=d.parent(c.id),k,l;if(null!==n){m=d.indexOf(c.id);for(k=1;null!=(l=d.getChild(n.id,m+k));)if(l.connectorPlacement&8)g=Math.max(g,j(d,l)),k+=1;else break;for(k=1;null!=(l=d.getChild(n.id,m-k));)if(l.connectorPlacement&
2)g=Math.max(g,j(d,l)),k+=1;else break}K=g;if(1<K){c.visualDepth+=K-1;m=d.hasChildren(a);s=c;for(D=0;D<K-1;D+=1)s=p(d,s,!m)}}}J=[];D=0;for(C=f.length;D<C;D+=1){L=f[D];I=J[D]=0;for(H=L.length;I<H;I+=1)J[D]=Math.max(J[D],j(d,L[I]))}D=0;for(C=J.length;D<C;D+=1)if(Q=J[D],1<Q){I=0;for(H=h[D].length;I<H;I+=1)if(R=h[D][I],d.hasChildren(R.id))for(K=Q;1<K;)R=p(d,R,!1),K-=1}null!=da[a]&&e(d,c,da[a])}})}function e(a,b,c){var d,e,f,g,i=0,m=[],j,k;e=0;for(f=c.length;e<f;e+=1)d=c[e],i=Math.max(i,d.visualDepth);
e=0;for(f=c.length;e<f;e+=1){d=c[e];j=h(a,d);g=1;for(k=d;null!=k.visualAggregatorId;)k=a.node(k.visualAggregatorId),k.connectorPlacement=5,g+=1;for(;g<i;)j=p(a,j,!1),g+=1;m.push(h(a,j).id)}k=h(a,b);if(a.hasChildren(k.id)){j=c[Math.floor(c.length/2)];if(1<c.length&&0===c.length%2){e=a.parent(j.id);f=n(a,t.navigationFamily,j);g=a.getChild(e.id,f).gravity||a.getChild(e.id,f+1).gravity;j=q({visibility:4,connectorPlacement:j.connectorPlacement&10,gravity:g});a.add(e.id,j.id,j,f+1);for(g=1;g<i;)j=p(a,j,
!1),j.connectorPlacement=0,g+=1}e=0;for(f=c.length;e<f;e+=1)d=c[e],t.navigationFamily.loopChildren(this,b.id,function(a,c){switch(c.actualItemType){case 5:case 2:case 4:case 1:break;default:b.id!=d.id&&r(d,c)}return t.navigationFamily.SKIP});j=h(a,j);a.moveChildren(k.id,j.id)}j.partners=m}function h(a,b){for(var c=b;null!=c.visualAggregatorId;)c=a.node(c.visualAggregatorId);return c}function i(a,b){var c=0;null!=b.visualAggregatorId&&a.loopLevels(this,b.id,function(d,e,f){if(b.visualAggregatorId==
d)return a.SKIP;c=f+1});return c}function j(a,b){var c=0;a.loopLevels(this,b.id,function(a,b,d){c=d+1});return c+1}function k(a,b,c,d){0<d%2&&(b===d-1?b=a.length:b===d&&(b=d-1));b=c*d+b;return b>a.length-1?null:a[b]}function m(a,b){var c=!1,d=!0;a.loopChildren(this,b.id,function(b,e){c=!0;if(0===e.itemType&&a.hasChildren(b))return d=!1,!0});return c&&d}function n(a,b,c){var d=null,e={},f=a.parent(c.id);a.loopChildrenReversed(this,f.id,function(a,f,g){if(null===d)a==c.id&&(d=-1,e[c.id]=!0,b.loopChildren(this,
...
g,!0});return d}function p(a,b,c){c=q({visibility:4,visualAggregatorId:b.visualAggregatorId,connectorPlacement:4==b.visibility&&0===b.connectorPlacement||c?0:5});a.insert(b.id,c.id,c);b.visualAggregatorId=c.id;return c}function q(b,c){var d=new a.orgdiagram.TreeItem,e;for(e in b)b.hasOwnProperty(e)&&(d[e]=b[e]);null!=c?(d.id=c.id,d.visibility=c.isVisible?0:4):(w+=1,d.id=w);return d}function r(a,b,c){var d=[];c||4==a.visibility||!v.hasOwnProperty(a.id)?(c||d.push(a.id),t.navigationFamily.loopParents(this,
a.id,function(a,b){if(4!=b.visibility&&(d.push(a),v.hasOwnProperty(a)))return t.navigationFamily.SKIP})):d.push(a.id);null!=t.navigationFamily.node(b.id)?t.navigationFamily.adopt(d,b.id):t.navigationFamily.add(d,b.id,b)}function s(a,b,c){a.loop(this,function(a){b[a]=[];c[a]=[]});a.loopPostOrder(this,function(a,d,e){var d=b[e],f=c[e],g=b[a],h=c[a],i;if(null!=e){d[0]||(d[0]=a);e=0;for(i=g.length;e<i;e+=1)d[e+1]||(d[e+1]=g[e]);f[0]=a;e=0;for(i=h.length;e<i;e+=1)f[e+1]=h[e]}})}var t={visualTree:null,
leftMargins:{},rightMargins:{},navigationFamily:null},w,v;return{process:function(){var c=g.getOrgTree(),e=d.getOptions();v=null!=b?b.getActiveItems():{};t.visualTree=a.common.tree();t.navigationFamily=a.common.family();w=g.getMaximumId();c.hasNodes()&&f(c,e,t.visualTree);t.leftMargins={};t.rightMargins={};s(t.visualTree,t.leftMargins,t.rightMargins);return!0},getVisualTree:function(){return t.visualTree},getNavigationFamily:function(){return t.navigationFamily},getConnectionsFamily:function(){return t.connectionsFamily},
getLeftMargins:function(){return t.leftMargins},getRightMargins:function(){return t.rightMargins}}};a.common.AnnotationLabelTemplate=function(){var g=["div",{type:"checkbox",name:"checkbox","class":["bp-item","bp-corner-all","bp-connector-label"]}];return{template:function(){return g},getHashCode:function(){return"defaultAnnotationLabelTemplate"},render:function(b,d){var c=d.context;a.common.isArray(c.label)?(d.element.innerHTML="",d.element.appendChild(a.common.JsonML.toHTML(c.label))):d.element.innerHTML=
c.label}}};a.common.ButtonsTemplate=function(){var g=["div",{style:{position:"absolute"}}];return{template:function(){return g},getHashCode:function(){return"defaultButtonsTemplate"},render:function(b,d){var c=0,f,e=d.buttons,g,i;switch(d.renderingMode){case 0:for(i=0;i<e.length;i+=1)f=e[i],g=["button",{style:{position:"absolute",top:c+"px",left:"0px"},"class":["orgdiagrambutton","bp-button"],"data-buttonname":f.name},["span",{style:{width:f.size.width+"px",height:f.size.height+"px"},"class":["bp-icon",
f.icon]}]],d.element.appendChild(a.common.JsonML.toHTML(g)),c+=10+f.size.height}}}};a.common.CheckBoxTemplate=function(a){var b=["div",["label",["nobr",["input",{type:"checkbox",name:"checkbox","class":"bp-selectioncheckbox"}],"\u00a0",["span",{name:"selectiontext","class":"bp-selectiontext"},a]]]];return{template:function(){return b},getHashCode:function(){return"defaultCheckBoxTemplate"},render:function(a,b){var f=b.element.firstChild.firstChild.firstChild;f.checked=b.isSelected;f.setAttribute("data-id",
b.id);b.element.firstChild.firstChild.childNodes[2].setAttribute("data-id",b.id)}}};a.common.CursorTemplate=function(a,b){var d=["div",{style:{width:b.itemSize.width+b.cursorPadding.left+b.cursorPadding.right+"px",height:b.itemSize.height+b.cursorPadding.top+b.cursorPadding.bottom+"px",borderWidth:b.cursorBorderWidth+"px"},"class":["bp-item","bp-corner-all","bp-cursor-frame"]}];return{template:function(){return d},getHashCode:function(){return"defaultCursorTemplate"},render:function(){}}};a.common.DotHighlightTemplate=
function(a,b){var d,c=b.minimizedItemCornerRadius;null==c&&(c=Math.max(b.highlightPadding.left+b.minimizedItemSize.width+b.highlightPadding.right,b.highlightPadding.top+b.minimizedItemSize.height+b.highlightPadding.bottom)+b.highlightBorderWidth);d=["div",{style:{borderWidth:b.highlightBorderWidth+"px",MozBorderRadius:c+"px",WebkitBorderRadius:c+"px","-khtml-border-radius":c+"px",borderRadius:c+"px"},"class":["bp-item","bp-highlight-dot-frame"]}];return{template:function(){return d},getHashCode:function(){return"defaultDotHighlightTemplate"},
render:function(){}}};a.common.GroupTitleTemplate=function(g){var b={style:{fontSize:g.groupTitleFontSize,fontFamily:g.groupTitleFontFamily,fontWeight:g.groupTitleFontWeight,fontStyle:g.groupTitleFontStyle},"class":["bp-item","bp-corner-all","bp-grouptitle-frame"]},d=g.groupTitleVerticalAlignment,c="";switch(g.groupTitleOrientation){case 1:c="rotate(-90deg)";break;case 2:c="rotate(90deg)"}var f=g.groupTitleFontSize,e=g.groupTitleFontFamily,h=g.groupTitleFontWeight,i=g.groupTitleFontStyle,j=null;switch(g.groupTitleHorizontalAlignment){case 0:j=
...
"photo",function(a){a.src=h.image;a.alt=h.title});a.common.getElementsByName(this,c.element,"titleBackground",function(b){a.common.JsonML.applyStyles(b,{background:i})});a.common.getElementsByName(this,c.element,"title",function(b){a.common.JsonML.applyStyles(b,{color:j});b.textContent=h.title});a.common.getElementsByName(this,c.element,"description",function(a){a.textContent=h.description})}}}};a.orgdiagram.BaseControl=function(g,b,d,c,f){function e(b,c){null==c&&(c=!0);switch(b){case 1:h(c,I);break;
case 2:var e=I;u.layout.forceCenterOnCursor=!1;u.tasks.process("HighlightItemOptionTask",null,e);u.graphics.end();break;default:p(u.layout);l(u.layout);var G=u.layout,e=u.name,H=a.common.getInnerSize(G.element),H=new a.common.Rect(0,0,H.width,H.height),y=new a.common.Rect(H),z=a.common.getFixOfPixelALignment(g);a.common.JsonML.appendDOM(G.element,a.common.JsonML.toHTML(["div",{tabindex:0,style:{position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:H.width+
"px",height:H.height+"px",padding:"0px",marginBottom:"0px",marginRight:"0px",marginLeft:z.width+"px",marginTop:z.height+"px"},"class":e,$:function(a){G.scrollPanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"hidden"},y.getCSS()),"class":e,$:function(a){G.mousePanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"hidden"},y.getCSS()),"class":["placeholder",e],$:function(a){G.placeholder=a}},["div",{style:{position:"absolute",overflow:"visible",top:"0px",
left:"0px",width:"0px",height:"0px"},"class":["calloutplaceholder",e],$:function(a){G.calloutPlaceholder=a}}]]]]));e=u.layout;e.mousePanel.addEventListener("mousemove",q);e.mousePanel.addEventListener("click",s);e.mousePanel.addEventListener("dblclick",t);e.mousePanel.addEventListener("change",r);e.scrollPanel.addEventListener("keydown",w);e.scrollPanel.addEventListener("scroll",i);u.options.enablePanning&&a.common.isChrome()&&(e.scrollPanel.draggable=!0,e.scrollPanel.addEventListener("dragstart",
v),e.scrollPanel.addEventListener("drag",x),e.scrollPanel.addEventListener("dragend",x),e.scrollPanel.addEventListener("dragover",A));u.tasks=d(j,k,m,n,f);u.graphics=a.common.createGraphics(u.options.graphicsType,u.layout.element);u.graphics.debug=I;h(!0,I)}}function h(b,c){var d;u.layout.forceCenterOnCursor=b;u.tasks.process("OptionsTask",null,c);u.graphics.end();b&&(d=u.tasks.getTask("CenterOnCursorTask"),d=d.getPlaceholderOffset(),u.layout.scrollPanel.scrollLeft=d.x,u.layout.scrollPanel.scrollTop=
d.y);d=a.common.getFixOfPixelALignment(u.layout.element);a.common.JsonML.applyStyles(u.layout.scrollPanel,{top:"0px",left:"0px",marginBottom:"0px",marginRight:"0px",marginLeft:d.width+"px",marginTop:d.height+"px"})}function i(){null==H&&(H=window.setTimeout(function(){var a=I;u.layout.forceCenterOnCursor=!1;u.tasks.process("LayoutOptionsTask",null,a);u.graphics.end();window.clearTimeout(H);H=null},200))}function j(){return u.options}function k(){return u.graphics}function m(){var b=u.layout,c=a.common.getInnerSize(b.element),
d=new a.common.Point(b.scrollPanel.scrollLeft,b.scrollPanel.scrollTop);return{forceCenterOnCursor:b.forceCenterOnCursor,scrollPanelSize:c,placeholderOffset:d}}function n(b){var c=u.layout,d=new a.common.Size(b.contentSize);d.scale(1*b.scale);a.common.JsonML.applyStyles(c.mousePanel,d.getCSS());a.common.JsonML.applyStyles(c.placeholder,b.contentSize.getCSS());var e="scale("+b.scale+","+b.scale+")";a.common.JsonML.applyStyles(c.placeholder,{"transform-origin":"0 0",transform:e,"-ms-transform":e,"-webkit-transform":e,
"-o-transform":e,"-moz-transform":e});e=new a.common.Size(b.scrollPanelSize);b.autoSize&&(e=new a.common.Size(d.width+25,d.height+25),e.cropBySize(b.autoSizeMaximum),e.addSize(b.autoSizeMinimum),a.common.JsonML.applyStyles(c.element,e.getCSS()));a.common.JsonML.applyStyles(c.scrollPanel,e.getCSS());return e}function l(){if(null!=u.layout.scrollPanel){var a=u.layout.scrollPanel.parentNode;null!=a&&a.removeChild(u.layout.scrollPanel)}}function p(a){null!=a.mousePanel&&(a.mousePanel.removeEventListener("mousemove",
q),a.mousePanel.removeEventListener("click",s),a.mousePanel.removeEventListener("dblclick",t),a.mousePanel.removeEventListener("change",r));null!=a.scrollPanel&&(a.scrollPanel.removeEventListener("keydown",w),a.scrollPanel.removeEventListener("scroll",i),a.scrollPanel.removeEventListener("dragstart",v),a.scrollPanel.removeEventListener("drag",x),a.scrollPanel.removeEventListener("dragend",x),a.scrollPanel.removeEventListener("dragover",A))}function q(b){var c=a.common.getElementOffset(u.layout.mousePanel),
d=b.pageX-c.left,c=b.pageY-c.top,e=u.tasks.getTask("CreateTransformTask"),f=u.tasks.getTask("HighlightItemOptionTask");f.hasHighlightEnabled()&&(d=e.getTreeItemForMousePosition(d,c,f.getGravityRadius()),B(b,d))}function r(b){var d=b.target,e=d.getAttribute("data-id");if(null!=e){var f=(u.options.selectedItems||[]).slice(),g=c(u,null,e,void 0),h=a.common.indexOf(f,e);y("onSelectionChanging",b,g);g.cancel||(0<=h?f.splice(h,1):f.push(e),u.options.selectedItems=f,0>h?d.setAttribute("checked","checked"):
d.removeAttribute("checked"),y("onSelectionChanged",b,g))}}function s(b){var d=a.common.getElementOffset(u.layout.mousePanel),e=b.pageX-d.left,f=b.pageY-d.top,g=u.tasks.getTask("CreateTransformTask"),d=u.tasks.getTask("CursorItemOptionTask"),h=u.tasks.getTask("HighlightItemOptionTask"),e=g.getTreeItemForMousePosition(e,f,h.getGravityRadius()),f=b.target;null!==e&&(a.common.hasClass(f,u.name+"button")||a.common.hasClass(f.parentNode,u.name+"button")?(d=a.common.hasClass(f,u.name+"button")?f:f.parentNode,
d=d.getAttribute("data-buttonname"),f=c(u,null,e,d),y("onButtonClick",b,f)):"checkbox"===f.getAttribute("name")||"selectiontext"===f.getAttribute("name")||(f=c(u,null,e,void 0),y("onMouseClick",b,f),!f.cancel&&d.hasCursorEnabled()&&(z(b,e),u.layout.scrollPanel.focus())))}function t(a){var b;b=u.tasks.getTask("HighlightItemTask").getHighlightTreeItem();null!==b&&(b=c(u,null,b,void 0),y("onMouseDblClick",a,b))}function w(a){var b=u.tasks.getTask("HighlightItemTask"),c=u.tasks.getTask("HighlightItemOptionTask"),
d=u.tasks.getTask("CursorItemTask"),e=u.tasks.getTask("CursorItemOptionTask"),f=u.tasks.getTask("AlignDiagramTask"),g=u.tasks.getTask("CreateTransformTask").getTransform(),h=null,i=null,m=u.layout;c.hasHighlightEnabled()&&e.hasCursorEnabled()?(h=b.getHighlightTreeItem(),null===h&&(h=d.getCursorTreeItem())):c.hasHighlightEnabled()?h=b.getHighlightTreeItem():e.hasCursorEnabled()&&(h=d.getCursorTreeItem());if(null!=h){switch(a.which){case 13:e.hasCursorEnabled()&&(z(a,h),a.preventDefault(),m.scrollPanel.focus());
break;case 40:i=1;break;case 38:i=0;break;case 37:i=2;break;case 39:i=3}if(null!=i){for(d=!1;!d;)d=!0,i=g.getOrientation(i),b=f.getNextItem(h,i),null!=b&&(a.preventDefault(),c.hasHighlightEnabled()?B(a,b):e.hasCursorEnabled()&&z(a,b));m.scrollPanel.focus()}}}function v(b){var c=u.layout.scrollPanel;F=new a.common.Point(b.clientX,b.clientY);E=new a.common.Point(c.scrollLeft,c.scrollTop);C=C||new Image;b.dataTransfer.setDragImage(C,0,0)}function A(a){a.preventDefault();a.dataTransfer.dropEffect="move"}
function x(b){D=new a.common.Point(E.x-(b.clientX-F.x),E.y-(b.clientY-F.y));null==G&&(G=window.setTimeout(function(){var a=u.layout.scrollPanel;a.scrollLeft=D.x;a.scrollTop=D.y;window.clearTimeout(G);G=null},50))}function B(a,b){var d=!0,e;null!==b?b!==u.options.highlightItem&&(e=c(u,u.options.highlightItem,b,void 0),u.options.highlightItem=b,y("onHighlightChanging",a,e),e.cancel?d=!1:(h(!1,!1),y("onHighlightChanged",a,e))):null!==u.options.highlightItem&&(e=c(u,u.options.highlightItem,null,void 0),
u.options.highlightItem=null,y("onHighlightChanging",a,e),e.cancel?d=!1:(h(!1,!1),y("onHighlightChanged",a,e)));return d}function z(a,b){var d;b!==u.options.cursorItem&&(d=c(u,u.options.cursorItem,b,void 0),u.options.cursorItem=b,y("onCursorChanging",a,d),d.cancel||(h(!0,I),y("onCursorChanged",a,d)))}function y(a,b,c){a=u.options[a];null!=a&&a(b,c)}var u={name:"orgdiagram",options:b,tasks:null,graphics:null,mouse:null,layout:{element:g,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,
forceCenterOnCursor:!0}},F,E,D,C,G,I=!1,H=null;e();return{destroy:function(){p(u.layout);l(u.layout);u.tasks=null;u.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(u.options[b]=a[b])},getOptions:j,setOption:function(a,b){return u.options[a]=b},getOption:function(a){return u.options[a]},update:e}};a.orgdiagram.Control=function(g,b){return a.orgdiagram.BaseControl(g,b,a.orgdiagram.TaskManagerFactory,a.orgdiagram.EventArgsFactory,{AnnotationLabelTemplate:a.common.AnnotationLabelTemplate,
...
f={index:d,item:j},c=b(j,d),0<c))if(e=Math.abs(c),j=a[h],c=b(j,h),0<=c)f={index:h,item:j};else{c=Math.abs(c);e>c&&(e=c,f={index:h,item:j});for(;d+1<h;)if(i=Math.round((d+h)/2),j=a[i],c=b(j,i),0===c){f={index:i,item:j};break}else 0<c?d=i:h=i,c=Math.abs(c),e>c&&(e=c,f={index:i,item:j})}return f};a.common.family=function(g){function b(a,b,c,d){var e;if(null!=d&&(b=b[c],null!=b))for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e,b[e]))break}function d(a,b){var c=!1;null!=u[a]&&null!=u[a][b]&&(delete u[a][b],
F[a]-=1,delete E[b][a],D[b]-=1,F[a]||(delete u[a],delete F[a]),E[b]||(delete E[b],delete D[b],null==z[null]&&(z[null]={},y[null]=0),z[null][b]=!0,y[null]+=1),c=!0);return c}function c(a,b){var c;if(null!=b)for(c in C)if(C.hasOwnProperty(c)&&b.call(a,c,C[c]))break}function f(a,c,d,e){for(var f,g,h={},i=0,m=!0;m;){f={};m=!1;for(g in d)if(d.hasOwnProperty(g)&&!h[g])switch(h[g]=!0,e.call(a,g,C[g],i)){case 1:f={};m=!1;break;case 2:break;default:b(this,c,g,function(a){h[a]||(m=f[a]=!0)})}d=f;i+=1}}function e(a,
b,c){null!=c&&null!=b&&(null!=C[b]&&null!=u[b])&&f(a,u,u[b],c)}function h(a,b,c){null!=c&&null!=b&&(null!=C[b]&&null!=E[b])&&f(a,E,E[b],c)}function i(a,c,d,e,f,g){var h,i,m,j;if(null!=g){c=[];i={};for(h in C)C.hasOwnProperty(h)&&(i[h]=d[h]||0,i[h]||c.push(h));for(j=0;0<c.length;){m=[];d=0;for(f=c.length;d<f;d+=1){h=c[d];if(g.call(a,h,C[h],j)){m=[];break}j+=1;b(this,e,h,function(a){i[a]-=1;0===i[a]&&m.push(a)})}c=m}}}function j(a,b){i(a,E,D,u,F,b)}function k(a,b){i(a,u,F,E,D,b)}function m(a,b,c,d,
e,f,g,h,i){var m=!1,j,n;if(null!=C[a]&&null!=g[a]){m=!0;if(i){i=0;for(j=b.length;i<j;i+=1)if(n=b[i],null==C[n]||null==g[a][n])m=!1}if(m&&(null!=d&&(C[c]=d),null!=C[c])){e[c]||(e[c]={},f[c]=0);g[c]||(g[c]={},h[c]=0);e[c][a]||(e[c][a]=!0,f[c]+=1);g[a][c]||(g[a][c]=!0,h[a]+=1);i=0;for(j=b.length;i<j;i+=1)n=b[i],c!=n&&(null!=g[a][n]&&(delete g[a][n],h[a]-=1),null!=e[n][a]&&(delete e[n][a],f[n]-=1),e[n][c]||(e[n][c]=!0,f[n]+=1),g[c][n]||(g[c][n]=!0,h[c]+=1))}}return m}function n(a,b,c,d){return m(a,b,
c,d,E,D,u,F,!0)}function l(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function p(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function q(c){var d=a.common.graph(),e,f,g,h,i,m,j,n,k={};for(e in c)c.hasOwnProperty(e)&&b(this,u,e,function(a){if(!k.hasOwnProperty(a)){k[a]=!0;f=[];b(this,E,a,function(a){f.push(a)});g=0;for(i=f.length;g<i-1;g+=1)if(m=f[g],c.hasOwnProperty(m))for(h=g+1;h<i;h+=1)if(j=f[h],c.hasOwnProperty(j)){n=
Math.abs(c[m].children.length-c[j].children.length);var e=d.edge(m,j);null==e&&(e=new p(n),d.addEdge(m,j,e));e.items.push(a);e.weight+=1}}});return d}function r(a,b){this.parentid=a;this.childid=b;this.key=a+","+b}function s(a,b){this.from=a;this.to=b;this.distance=0}function t(a){return F[a]||0}function w(a){return D[a]||0}function v(a){var b=null,a=u[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null}function A(a){var b=null,a=E[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null}
function x(a,b){this.parentid=a;this.childid=b;this.ids=[];this.nodes=[]}function B(){return a.common.family({roots:z,rootsCount:y,children:u,childrenCount:F,parents:E,parentsCount:D,nodes:C})}var z={},y={},u={},F={},E={},D={},C={};a.common.isObject(g)&&(z=a.common.cloneObject(g.roots,!1),y=a.common.cloneObject(g.rootsCount,!0),u=a.common.cloneObject(g.children,!1),F=a.common.cloneObject(g.childrenCount,!0),E=a.common.cloneObject(g.parents,!1),D=a.common.cloneObject(g.parentsCount,!0),C=a.common.cloneObject(g.nodes,
!0));return{add:function(a,c,d){var e,f,g={};if(!a||0===a.length)a=[null];if(null==C[c]&&null!=d){C[c]=d;d=0;for(e=a.length;d<e;d+=1)f=a[d],null==g[f]&&f!=c&&(g[f]=!0,null!=C[f]?(null==E[c]&&(E[c]={},D[c]=0),E[c][f]||(E[c][f]=!0,D[c]+=1),null==u[f]&&(u[f]={},F[f]=0),u[f][c]||(u[f][c]=!0,F[f]+=1)):(null==z[f]&&(z[f]={},y[f]=0),z[f][c]||(z[f][c]=!0,y[f]+=1)));null!=z[c]&&(u[c]=z[c],F[c]=y[c],delete z[c],delete y[c],b(this,u,c,function(a){null==E[a]&&(E[a]={},D[a]=0);E[a][c]||(E[a][c]=!0,D[a]+=1)}))}},
adopt:function(a,b){var c,d,e;if(null!=C[b]){c=0;for(d=a.length;c<d;c+=1)if(e=a[c],null==E[b]&&(E[b]={},D[b]=0),e!=b&&null!=C[e])E[b][e]||(E[b][e]=!0,D[b]+=1),null==u[e]&&(u[e]={},F[e]=0),u[e][b]||(u[e][b]=!0,F[e]+=1);else throw"Item cannot be parent of itself and parent should exist in the structure!";}else throw"Child should be in hierarchy!";},bundleChildren:n,bundleParents:function(a,b,c,d){return m(a,b,c,d,u,F,E,D,!0)},optimizeReferences:function(c){var d={},f={},g={},h,i,j,n,k,p;k=0;var r=10,
s;if(null!=c){for(h in C)k+=1,C.hasOwnProperty(h)&&(i=new l,b(this,u,h,function(a){i.children.push(a);i.childrenHash[a]=!0}),i.children.sort(),i.id=h,i.key=i.children.join(","),g[i.id]=i);for(r=Math.pow(10,k.toString().length);!a.common.isEmptyObject(g);){j={};s={};n=q(g);for(h in g)g.hasOwnProperty(h)&&(k=g[h],k.processed||(p=n.getSpanningTree(h,function(a){return a.weight*r+r-a.difference}),p.loopLevels(this,function(a,b){g[a].processed=!0;p.loopChildren(this,a,function(h,i){var k=n.edge(a,h),p=
null,q,r,t,w,v,y;g[h].processed=!0;if(1<k.weight){r=k.items.join(",");if(d.hasOwnProperty(r))p=d[r];else{q=c();C[q.id]=q;p=new l;p.id=q.id;p.key=r;r=0;for(t=k.items.length;r<t;r+=1)y=k.items[r],p.children.push(y),p.childrenHash[y]=!0,s[y]=!0;p.children.sort();d[p.key]=p;f[p.id]=p;j[p.id]=p;s[p.id]=p;w=p.children.slice(0);e(this,b.replacementItem||a,function(a){!p.childrenHash[a]&&null!=f[a]&&(v=!0,e(this,a,function(a){if(!p.childrenHash[a])return v=!1,1;if(!s.hasOwnProperty(a))return 2}),v&&w.push(a));
return 2});m(b.replacementItem||a,w,p.id,q,E,D,u,F,!1);if(1>=(F[a]||0)&&null==b.replacementItem)b.replacementItem=p.id}if(p.id!=h&&(w=p.children.slice(0),e(this,i.replacementItem||h,function(a){null!=f[a]&&!p.childrenHash[a]&&(v=!0,e(this,a,function(a){return!p.childrenHash[a]?(v=!1,1):(s.hasOwnProperty(a),2)}),v&&w.push(a));return 2}),m(i.replacementItem||h,w,p.id,null,E,D,u,F,!1),1>=(F[h]||0)&&null==i.replacementItem))i.replacementItem=p.id}})})));g=j}}},eliminateManyToMany:function(a){var c,d;
for(c in u)u.hasOwnProperty(c)&&1<(F[c]||0)&&b(this,u,c,function(b){if(1<(D[b]||0))d=a(),n(c,[b],d.id,d)})},groupBy:function(a,b,c){if(null!=c){var d={},e;for(e in C){var f=F[e]||0;if(1>=(D[e]||0)&&1>=f){var f=A(e),g=v(e),h=f+" * "+g;d.hasOwnProperty(h)||(d[h]=new x(f,g));d[h].ids.push(e);d[h].nodes.push(C[e])}}for(h in d)if(d.hasOwnProperty(h)&&(e=d[h],e.ids.length>=b&&c.call(a,e.parentid,e.childid,e.ids,e.nodes)))break}},getPlanarFamily:function(b){var c=new a.common.family,d,f;b.loopLevels(this,
function(g){var h=new a.common.LinkedHashItems,i={},m={},j=[];b.loopLevelItems(this,g,function(a){e(this,a,function(c){var d=b.getItemPosition(c),e=new r(a,c);m[e.key]=e;var f=[];h.isEmpty()?h.add(d,[e]):(h.iterateBack(function(b,c){if(c<d)return h.insertAfter(c,d,[e]),!0;if(c==d)return b.push(e),!0;for(var g=0,i=b.length;g<i;g+=1){var m=b[g];m.parentid!=a&&f.push(m)}}),h.startKey()>d&&h.unshift(d,[e]));i[e.key]=f;for(var c=0,g=f.length;c<g;c+=1)i[f[c].key].push(e);return 2});if(1==t(a)){var c=v(a);
1==w(c)&&(c=new r(a,c),j.push(c.key))}});var g=[],n,k;for(k in i){n=i[k];var l=n.length;null!=g[l]?g[l].push(k):g[l]=[k]}l={};g.unshift(j);for(var p=0,q=g.length;p<q;p+=1){var s=g[p];if(null!=s){d=0;for(f=s.length;d<f;d+=1)if(k=s[d],!l.hasOwnProperty(k)){l[k]=!0;n=m[k];null==c.node(n.parentid)&&c.add(null,n.parentid,{});null==c.node(n.childid)?c.add([n.parentid],n.childid,{}):c.adopt([n.parentid],n.childid);n=i[k];k=0;for(var u=n.length;k<u;k+=1)l[n[k].key]=!0}}}});return c},getFamilyWithoutGrandParentsRelations:function(){var d=
...
f.push(b)});d.add(f,a,c)});return d},getGraph:function(){var c=a.common.graph(),d;for(d in u)u.hasOwnProperty(d)&&b(this,u,d,function(a){var b=c.edge(d,a);null==b&&(b=new p({}),c.addEdge(d,a,b))});return c},removeNode:function(a){null!=C[a]&&(b(this,u,a,function(b){delete E[b][a];D[b]-=1;D[b]||(delete E[b],delete D[b],null==z[null]&&(z[null]={},y[null]=0),z[null][b]||(z[null][b]=!0,y[null]+=1))}),b(this,E,a,function(b){delete u[b][a];F[b]-=1;F[b]||(delete u[b],delete F[b])}),null!=z[null]&&null!=
z[null][a]&&(delete z[null][a],y[null]-=1,y[null]||(delete z[null],delete y[null])),delete u[a],delete F[a],delete E[a],delete D[a],delete C[a])},removeRelation:function(a,b){var c=!1;null!=C[a]&&null!=C[b]&&(c=d(a,b)||d(b,a));return c},node:function(a){return C[a]},loop:c,loopLevels:function(a,c,d){function e(){this.items={};this.minimumLevel=null}function f(a,b,c){var d=l[b];d||(d=new e,l[b]=d);d.addItemToLevel(a,c);w=null==w?c:Math.min(w,c);n[a]=c;i[a]=!0}var g=[],h={},i={},m=[],n={},l={},p,q,
r,s,t,w=null;r=c?j:k;var v,y,x,A,z,B,D,F;e.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){r(this,function(a,b,c){g.push(a);h[a]=c});r=0;for(v=g.length;r<v;r+=1)if(p=g[r],null==i[p]){m.push(p);for(f(p,r,0);0<m.length;){z=A=x=null;B=!c;D=[];p=0;for(s=m.length;p<s;p+=1)t=m[p],y=n[t],F=!1,c?(b(this,E,t,function(a){var b;if(!i[a]&&(F=!0,b=h[a],null==x||!B||x<b||x==b&&z>
y-1))x=b,A=a,z=y-1,B=!0}),b(this,u,t,function(a){var b;if(!i[a]&&(F=!0,b=h[a],null==x||!B&&(x>b||x==b&&z<y+1)))x=b,A=a,z=y+1,B=!1})):(b(this,u,t,function(a){var b;if(!i[a]&&(F=!0,b=h[a],null==x||B||x<b||x==b&&z<y+1))x=b,A=a,z=y+1,B=!1}),b(this,E,t,function(a){var b;if(!i[a]&&(F=!0,b=h[a],null==x||B&&(x>b||x==b&&z>y-1)))x=b,A=a,z=y-1,B=!0})),F&&D.push(t);null!=A&&(D.push(A),f(A,r,z));m=D}}m=!0;for(c=w;m;){p={};m=!1;for(q in l)if(l.hasOwnProperty(q)&&(r=l[q],s=r.items[r.minimumLevel-w+c],null!=s)){p[q]=
r;m=!0;r=0;for(v=s.length;r<v;r+=1)if(t=s[r],d.call(a,t,C[t],c-w))return m=!1,!0}l=p;c+=1}}},loopTopo:j,loopTopoReversed:k,loopChildren:e,loopParents:h,findLargestRoot:function(){var a=null,b,c={},d={},e;b=null;k(this,function(f,g){c.hasOwnProperty(f)||(c[f]={},d[f]=0);c[f][f]=!0;d[f]+=1;e=!0;h(this,g.id,function(a){var b,g;e=!1;c.hasOwnProperty(a)||(c[a]={},d[a]=0);if(!d[a]&&1==D[f])c[a]=c[f],d[a]=d[f];else for(g in b=c[f],b)b.hasOwnProperty(g)&&(c[a][g]=!0,d[a]+=1);return 2});if(e&&(!b||d[f]>b))b=
d[f],a=f});return a},loopRoots:function(a,b){var c=null,d,e=0,f={},g={},i,m={},n={},j,l,p,q,r,s,t;k(this,function(a,b){f.hasOwnProperty(a)||(f[a]={},g[a]=0);f[a][a]=!0;g[a]+=1;i=!0;h(this,b.id,function(b){var c,d;i=!1;f.hasOwnProperty(b)||(f[b]={},g[b]=0);if(!g[b]&&1==D[a])f[b]=f[a],g[b]=g[a];else for(d in c=f[a],c)c.hasOwnProperty(d)&&!f[b][d]&&(f[b][d]=!0,g[b]+=1);return 2});i&&(m[a]=!0,e+=1)});q={};for(p in m)if(m.hasOwnProperty(p))for(l in d=f[p],d)d.hasOwnProperty(l)&&(q[l]||(q[l]=[]),q[l].push(p.toString()));
for(;0<e;){d=null;for(j in m)if(m.hasOwnProperty(j)&&(!d||g[j]<d))d=g[j],c=j;if(null!=c){null!=b&&b.call(a,c,C[c]);d=f[c];for(l in d)if(d.hasOwnProperty(l)&&!n[l]){p=q[l];s=0;for(t=p.length;s<t;s+=1)r=p[s],g[r]-=1;n[l]=!0}delete m[c];e-=1}}},hasNodes:function(){return!a.common.isEmptyObject(C)},hasCommonChild:function(a){var c=!1,d,e,f,g,h,i,m;d={};g=f=0;for(h=a.length;g<h;g+=1)i=a[g],null!=C[i]&&!d[i]&&(d[i]=!0,f+=1);e={};for(i in d)d.hasOwnProperty(i)&&b(this,u,i,function(a){e[a]=e[a]?e[a]+1:1});
for(m in e)if(e.hasOwnProperty(m)&&null!=E[m]&&(D[m]||0)==e[m]&&e[m]==f){c=!0;break}return c},loopNeighbours:function(a,b,c){var d={};null!=c&&(e(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,1)&&(d[b]=2,h(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,2)&&(d[b]=2));return d[b]})));return d[b]}),h(this,b,function(b,f){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,f,1)&&(d[b]=2,e(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=!0,c.call(a,b,e,2)&&(d[b]=2));return d[b]})));
return d[b]}))},countChildren:t,countParents:w,firstParent:A,firstChild:v,validate:function(a){function d(a){var b=0,c;if(null!=a)for(c in a)a.hasOwnProperty(c)&&(b+=1);return b}var e,f;c(this,function(c){b(this,u,c,function(b){if(!E.hasOwnProperty(b)||!E[b].hasOwnProperty(c))return null!=a&&(a.message="Child #"+b+" does not reference parent #"+c),!1});b(this,E,c,function(b){if(!u.hasOwnProperty(b)||!u[b].hasOwnProperty(c))return null!=a&&(a.message="Parent #"+b+" does not reference child #"+c),!1})});
for(e in E)if(E.hasOwnProperty(e)){if((D[e]||0)!=d(E[e]))return null!=a&&(a.message="Parents count for item #"+e+" missmatch."),!1;if(E.hasOwnProperty(e)&&!C.hasOwnProperty(e))return null!=a&&(a.message="Orphant parents for item #"+e),!1}for(f in u)if(u.hasOwnProperty(f)){if((F[f]||0)!=d(u[f]))return null!=a&&(a.message="Children count for item "+f+" missmatch."),!1;if(u.hasOwnProperty(f)&&!C.hasOwnProperty(f))return null!=a&&(a.message="Orphant children of item "+f),!1}for(f in z)if(z.hasOwnProperty(f)){if((y[f]||
0)!=d(z[f]))return null!=a&&(a.message="Root children count for item @"+f+" missmatch."),!1;b(this,z,f,function(b){if(!C.hasOwnProperty(b))return null!=a&&(a.message="Child #"+b+"of root #"+f+" does not exists."),!1})}return!0},hasLoops:function(){var a=B();j(this,function(b){a.removeNode(b)});return a.hasNodes()},clone:B,BREAK:1,SKIP:2}};a.common.FamilyAlignment=function(g,b,d,c){function f(b,c){var d=b[c];null==d&&(d=new a.common.FamilyMargins,b[c]=d);return d}function e(a,b,c,d,e,f,g,h){var j=
f,w=f;c.loopSiblings(this,b,function(a){a=g.getItemPosition(a);j=Math.min(j,a);w=Math.max(w,a)});for(var v=f-1;v>=j;v-=1){var A=g.getItemAtPosition(d,v);if(!a.hasOwnProperty(A)){var x=g.getItemAtPosition(d,v+1);a[A]=a[x]-(i[A]/2+(h[x]||0)+i[x]/2)}}for(v=f+1;v<=w;v+=1)A=g.getItemAtPosition(d,v),a.hasOwnProperty(A)||(x=g.getItemAtPosition(d,v-1),a[A]=a[x]+(i[x]/2+(h[A]||0)+i[A]/2));A=g.getItemAtPosition(d,j);x=a[A]-i[A]/2;A=g.getItemAtPosition(d,w);x+=a[A]+i[A]/2;x/=2;w=j=null;c.loopNonSiblings(this,
b,function(a){a=g.getItemPosition(a);j=null!=j?Math.min(j,a):a;w=null!=w?Math.max(w,a):a});c=0;for(v=j;v<=w;v+=1)b=g.getItemAtPosition(e,v),c+=i[b],v>j&&(c+=h[b]||0);v=x-c/2;b=g.getItemAtPosition(e,j);a.hasOwnProperty(b)||(a[b]=v+i[b]/2);for(v=j+1;v<=w;v+=1)b=g.getItemAtPosition(e,v),a.hasOwnProperty(b)||(x=g.getItemAtPosition(e,v-1),a[b]=a[x]+(i[x]/2+(h[b]||0)+i[b]/2))}var h,i={},j;null!=c&&d.loopItems(this,function(a,b){i[a]=c.call(g,a,b)});j=function(b,c){var d={},e={},g=null;c.loopLevelsReversed(this,
...
d);y[d]=a});g=-p/2;for(h=q;h<=r;h+=1){var u=y[h],g=g+i[u]/2,F=f(e,u);F.attach(j,-g);s=F;g+=i[u]/2}}})});return d}(b,d);h=function(b,c,d){var f={},g=a.common.getFamilyUnits(b),h={};c.loopLevels(this,function(a){c.loopLevelItems(this,a,function(b,j,k){if(!f.hasOwnProperty(b)){j=0;if(0===k)null!=d[b]&&(j+=d[b]+i[b]/2);else var v=c.getItemAtPosition(a,k-1),j=j+(f[v]+i[v]/2+(d[b]||0)+i[b]/2);f[b]=j}j=g[b];if(null!=j)for(v=0;v<j.length;v+=1){var A=j[v];h.hasOwnProperty(A.id)||(h[A.id]=!0,e(f,b,A,a,a+1,
...
var t=[],w=null,v=null;k=0;for(m=r.length;k<m;k+=1){var A=r[k];null==w?(w=A.y,v=A.bottom()):v<A.y?(t.push(new c(w,v)),w=A.y,v=A.bottom()):v=Math.max(v,A.bottom())}null!=w&&t.push(new c(w,v));p.push(new f(n.x,t))}var x=[],B={},z=1;i=1;for(j=p.length;i<j;i+=1){b=p[i-1];n=p[i];for(k=s=0;s<b.ranges.length||k<n.ranges.length;)if(m=s<b.ranges.length?b.ranges[s]:null,q=k<n.ranges.length?n.ranges[k]:null,null==q){l=[new a.common.Point(b.x,m.end),new a.common.Point(n.x,m.end),new a.common.Point(n.x,m.start),
...
e,g));if(l>p||null==p)d=e,p=l}return d}function d(a,d,g,k,m){var n={},l,p=[],q={},r=0,s,t,w,v,A,x;if(null!=g&&null!=k&&(null==d&&(d=b(a,g)),null!=d)){k.call(a,d);n[d]=!0;r+=1;for(q[d]=null;0<r;){p=[];t=s=null;w={};for(l in n)if(n.hasOwnProperty(l)){v=c[l];d=!1;for(A in v)if(v.hasOwnProperty(A)&&!q.hasOwnProperty(A))switch(x=g.call(a,v[A],l,A),d=!0,m){case f:null==w[A]&&(w[A]=0);w[A]+=x;if(!t||w[A]>t)s=A,t=w[A];break;case e:if(w[A]=null==w[A]?x:Math.min(w[A],x),!t||w[A]<t)s=A,t=w[A]}d||p.push(l)}if(null==
...
!0),i=a.common.cloneObject(g.children,!1),j=a.common.cloneObject(g.roots,!1),k=a.common.cloneObject(g.rootChildren,!0));return{loop:function(a,b){var c;if(null!=b)for(c in e)if(e.hasOwnProperty(c)&&b.call(a,c,e[c]))break},loopLevels:function(a,b,c){var d=0,f=[],g,h,j,w,v;switch(arguments.length){case 2:h=b;break;case 3:g=b,h=c}if(null!=h){if(null==g)for(j in k)k.hasOwnProperty(j)&&(f=f.concat(k[j]));else null!=i[g]&&(f=f.concat(i[g]));for(;0<f.length;){j=[];w=0;for(v=f.length;w<v;w+=1)switch(g=f[w],
