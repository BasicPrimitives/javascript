/*
 Basic Primitives Diagrams v5.4.0
...
Background:1,Foreground:2};a.common.RenderEventArgs=function(){this.renderingMode=this.templateName=this.context=this.element=this.id=null;this.isSelected=this.isCursor=!1};a.common.BaseShape=function(){};a.common.BaseShape.prototype._getLabelPosition=function(g,b,d,c,f,e,h,i){var j=null;switch(i){case 1:j=new a.common.Rect(g+d/2-f/2,b-h-e,f,e);break;case 2:j=new a.common.Rect(g+d-f,b-h-e,f,e);break;case 8:j=new a.common.Rect(g,b-h-e,f,e);break;case 3:j=new a.common.Rect(g+d+h,b+c/2-e/2,f,e);break;
case 11:j=new a.common.Rect(g+d+h,b,f,e);break;case 12:j=new a.common.Rect(g+d+h,b+c-e,f,e);break;case 4:j=new a.common.Rect(g+d-f,b+c+h,f,e);break;case 6:j=new a.common.Rect(g,b+c+h,f,e);break;case 7:j=new a.common.Rect(g-f-h,b+c/2-e/2,f,e);break;case 9:j=new a.common.Rect(g-f-h,b,f,e);break;case 10:j=new a.common.Rect(g-f-h,b+c-e,f,e);break;default:j=new a.common.Rect(g+d/2-f/2,b+c+h,f,e)}return j};a.common.BaseShape.prototype._betweenPoint=function(g,b){return new a.common.Point((g.x+b.x)/2,(g.y+
b.y)/2)};a.common.BaseShape.prototype._offsetPoint=function(g,b,d){var c=null,c=g.distanceTo(b);return c=0===c||0===d?new a.common.Point(g):new a.common.Point(g.x+(b.x-g.x)/c*d,g.y+(b.y-g.y)/c*d)};a.common.Callout=function(a){this.m_graphics=a;this.pointerPlacement=0;this.cornerRadius="10%";this.offset=0;this.lineWidth=this.opacity=1;this.pointerWidth="10%";this.borderColor="#000000";this.lineType=0;this.fillColor="#d3d3d3";this.m_map=[[8,7,6],[1,null,5],[2,3,4]]};a.common.Callout.prototype=new a.common.BaseShape;
a.common.Callout.prototype.draw=function(g,b){var b=(new a.common.Rect(b)).offset(this.offset),d=new a.common.Point(b.x,b.y),c=new a.common.Point(b.right(),b.y),f=new a.common.Point(b.right(),b.bottom()),e=new a.common.Point(b.left(),b.bottom()),h=[null,null,null,null,null,null,null,null],e=[d,c,f,e],c=this.m_graphics.getPxSize(this.cornerRadius,Math.min(d.distanceTo(c),c.distanceTo(f))),i,j;i={};null!==this.fillColor&&(i.fillColor=this.fillColor,i.opacity=this.opacity);null!==this.lineColor&&(i.lineColor=
this.borderColor);i.lineWidth=this.lineWidth;i.lineType=this.lineType;j=new a.common.PaletteItem(i);i=new a.common.PolylinesBuffer;j=i.getPolyline(j);null!==g&&(d=0===this.pointerPlacement?this._getPlacement(g,d,f):this.pointerPlacement,null!==d&&(h[d]=g));for(f=0;f<e.length;f+=1)this._drawSegment(j,e[0],e[1],e[2],this.pointerWidth,c,h[1],h[2]),d=e.shift(),e.push(d),d=h.shift(),h.push(d),d=h.shift(),h.push(d);this.m_graphics.polylinesBuffer(i)};a.common.Callout.prototype._getPlacement=function(a,
b,d){var c=null,f=null,c=a.x<b.x?0:a.x>d.x?2:1,f=a.y<b.y?0:a.y>d.y?2:1;return this.m_map[c][f]};a.common.Callout.prototype._drawSegment=function(g,b,d,c,f,e,h,i){var j=this._offsetPoint(b,d,e),k=this._offsetPoint(d,b,e),c=this._offsetPoint(d,c,e),f=this.m_graphics.getPxSize(f,b.distanceTo(d)/2);0===g.length()&&g.addSegment(new a.common.MoveSegment(j));null!==h&&(j=this._betweenPoint(b,d),b=this._offsetPoint(j,b,f),f=this._offsetPoint(j,d,f),g.addSegment(new a.common.LineSegment(b)),g.addSegment(new a.common.LineSegment(h)),
g.addSegment(new a.common.LineSegment(f)));g.addSegment(new a.common.LineSegment(k));null!==i?(g.addSegment(new a.common.LineSegment(i)),g.addSegment(new a.common.LineSegment(c))):g.addSegment(new a.common.QuadraticArcSegment(d,c))};a.common.ConnectorOffbeat=function(){};a.common.ConnectorOffbeat.prototype=new a.common.BaseShape;a.common.ConnectorOffbeat.prototype.draw=function(g,b,d,c,f,e,h,i,j,k,m,n,l,p,q){var r,s,t,w,u,A,x,B,l=e=0,z=null,y,v;y=g.getPolyline(b);u=[];switch(j){case 1:u=[-f/2,f/2];
v=!1;break;case 0:u=[0];v=!1;break;case 2:u=[0],v=!0}r=Math.max(n?h.width:0,5*f);if(d.right()+r<c.left()||d.left()>c.right()+r)if(d.left()>c.right()?(t=new a.common.Point(d.left(),d.verticalCenter()),w=new a.common.Point(c.right(),c.verticalCenter())):(t=new a.common.Point(d.right(),d.verticalCenter()),w=new a.common.Point(c.left(),c.verticalCenter())),n&&(d.left()>c.right()?(e=7,l=3):(e=3,l=7)),s=new a.common.Rect(t,w),B=t.y<=w.y,x=t.x<w.x,s.height<s.width){s.height<2*f&&s.offset(0,B?2*f:0,0,B?0:
2*f);i=0;for(r=u.length;i<r;i+=1)A=u[i],g.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new a.common.MoveSegment(t.x,t.y+A));c.addSegment(new a.common.QuadraticArcSegment(s.horizontalCenter(),(B?s.top():s.bottom())+A,w.x,w.y+A));v&&c.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))});n&&(j=h.width<2*(s.width/5)?a.common.QuadraticArcSegment.prototype.offsetPoint(t.x,t.y,s.horizontalCenter(),
B?s.top():s.bottom(),w.x,w.y,0.5):new a.common.Point(t.x,B?s.top():s.bottom()),z=new a.common.Rect(j.x+(x?f:-h.width-f),B?j.y-h.height-f:j.y+f,h.width,h.height))}else{i=0;for(r=u.length;i<r;i+=1)A=u[i],g.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new a.common.MoveSegment(t.x,t.y+A));c.addSegment(new a.common.QuadraticArcSegment(s.horizontalCenter()+A*(B!=x?1:-1),(B?s.top():s.bottom())+A,s.horizontalCenter()+A*(B!=x?1:-1),s.verticalCenter()+A));c.addSegment(new a.common.QuadraticArcSegment(s.horizontalCenter()+
A*(B!=x?1:-1),(B?s.bottom():s.top())+A,w.x,w.y+A));v&&c.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))});n&&(z=new a.common.Rect(s.horizontalCenter()+(B!=x?f:-(f+h.width)),s.verticalCenter()-h.height/2,h.width,h.height))}else if(d.verticalCenter()<c.top()||d.verticalCenter()>c.bottom()){x=d.x<i.width/2;t=new a.common.Point(x?d.right():d.left(),d.verticalCenter());w=new a.common.Point(x?
c.right():c.left(),c.verticalCenter());s=new a.common.Rect(t,w);s.offset(10*f,0,10*f,0);B=t.y<=w.y;i=0;for(r=u.length;i<r;i+=1)A=u[i],g.addInverted(function(d){d=d.getPolyline(b);d.addSegment(new a.common.MoveSegment(t.x,t.y+A));d.addSegment(new a.common.QuadraticArcSegment(x?s.right()+A*(B?-1:1):s.left()-A*(B?-1:1),s.verticalCenter(),x?c.right():c.left(),c.verticalCenter()-A));v&&d.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))})},i||0==j),y.addArrow(b.lineWidth,function(a){a.mergeTo(g.getPolyline(a.paletteItem))});
...
a.orgdiagram.ButtonConfig=function(g,b,d){this.name=g;this.icon=b;this.text=!1;this.label=null;this.tooltip=d;this.size=new a.common.Size(16,16)};a.orgdiagram.Config=function(g){this.name=void 0!==g?g:"OrgDiagram";this.classPrefix="orgdiagram";this.graphicsType=this.navigationMode=0;this.pageFitMode=3;this.minimalVisibility=2;this.horizontalAlignment=this.orientationType=0;this.verticalAlignment=1;this.arrowsDirection=0;this.showExtraArrows=!1;this.extraArrowsMinimumSpace=30;this.showHorizontalArrows=
!1;this.connectorType=0;this.bevelSize=4;this.elbowType=0;this.elbowDotSize=4;this.emptyDiagramMessage="Diagram is empty.";this.items=[];this.annotations=[];this.highlightItem=this.cursorItem=null;this.highlightGravityRadius=40;this.selectedItems=[];this.hasSelectorCheckbox=0;this.selectCheckBoxLabel="Selected";this.selectionPathMode=1;this.templates=[];this.defaultTemplateName=null;this.hasButtons=0;this.buttons=[];this.onCursorRender=this.onHighlightRender=this.onItemRender=this.onMouseDblClick=
this.onMouseClick=this.onButtonClick=this.onSelectionChanged=this.onSelectionChanging=this.onCursorChanged=this.onCursorChanging=this.onHighlightChanged=this.onHighlightChanging=this.onButtonsRender=null;this.dotLevelShift=this.normalLevelShift=20;this.normalItemsInterval=this.lineLevelShift=10;this.dotItemsInterval=1;this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#000080";this.minimizedItemShapeType=6;this.linesColor=
"#c0c0c0";this.linesWidth=1;this.linesType=0;this.highlightLinesColor="#ff0000";this.highlightLinesWidth=1;this.highlightLinesType=0;this.calloutMaximumVisibility=2;this.showCallout=!0;this.calloutPlacementOffset=100;this.defaultCalloutTemplateName=null;this.calloutfillColor="#000000";this.calloutBorderColor=null;this.calloutCornerRadius=this.calloutOffset=4;this.calloutPointerWidth="10%";this.calloutLineWidth=1;this.calloutOpacity=0.2;this.leavesPlacementType=this.childrenPlacementType=2;this.maximumColumnsInMatrix=
6;this.buttonsPanelSize=28;this.checkBoxPanelSize=this.groupTitlePanelSize=24;this.groupTitleOrientation=this.groupTitlePlacementType=2;this.groupTitleVerticalAlignment=1;this.groupTitleHorizontalAlignment=0;this.groupTitleFontSize="12px";this.groupTitleFontFamily="Arial";this.groupTitleColor="#4169e1";this.groupTitleFontStyle=this.groupTitleFontWeight="normal";this.distance=3;this.scale=1;this.minimumScale=0.5;this.maximumScale=2;this.showLabels=0;this.labelSize=new a.common.Size(80,24);this.labelOffset=
1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight="normal";this.enablePanning=!0;this.autoSizeMinimum=new a.common.Size(800,600);this.autoSizeMaximum=new a.common.Size(1024,768)};a.orgdiagram.ConnectorAnnotationConfig=function(g,b){var d;this.annotationType=0;this.zOrderType=2;this.toItem=this.fromItem=null;this.connectorPlacementType=this.connectorShapeType=0;this.labelPlacementType=
...
this.selectItems=!1;switch(arguments.length){case 1:if(null!==a)if(a instanceof Array)this.items=a;else if("object"==typeof a)for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};a.orgdiagram.ItemConfig=function(a,b,d,c,f){var e;this.context=this.image=this.description=this.title=this.parent=this.id=null;this.itemTitleColor="#4169e1";this.groupTitle=this.minimizedItemShapeType=null;this.groupTitleColor="#4169e1";this.isActive=this.isVisible=!0;this.childrenPlacementType=this.adviserPlacementType=this.itemType=
this.hasButtons=this.hasSelectorCheckbox=0;this.templateName=null;this.showCallout=0;this.label=this.calloutTemplateName=null;this.showLabel=0;this.labelSize=null;this.labelOrientation=3;this.labelPlacement=0;switch(arguments.length){case 1:for(e in a)a.hasOwnProperty(e)&&(this[e]=a[e]);break;case 5:this.id=a,this.parent=b,this.title=d,this.description=c,this.image=f}};a.orgdiagram.ShapeAnnotationConfig=function(g){var b;this.annotationType=1;this.zOrderType=0;this.items=[];this.shapeType=0;this.offset=
new a.common.Thickness(0,0,0,0);this.lineWidth=2;this.cornerRadius="10%";this.opacity=1;this.fillColor=this.borderColor=null;this.lineType=0;this.selectItems=!1;this.label=null;this.labelSize=new a.common.Size(60,30);this.labelPlacement=0;this.labelOffset=4;switch(arguments.length){case 1:if(null!==g)if(g instanceof Array)this.items=g;else if("object"==typeof g)for(b in g)g.hasOwnProperty(b)&&(this[b]=g[b])}};a.orgdiagram.EventArgs=function(){this.name=this.position=this.parentItem=this.context=this.oldContext=
null;this.cancel=!1};a.common.BaseConnectorBundle=function(){this.NORMAL_ITEM_WEIGHT=10010;this.LINE_ITEM_WEIGHT=1E4};a.common.BaseConnectorBundle.prototype.trace=function(){};a.common.BaseConnectorBundle.prototype.getId=function(a){var b="_"+a.nodeid;a.nodeid+=1;return b};a.common.BaseConnectorBundle.prototype.ConnectorEdge=function(a,b,d,c,f,e,h,i,j,k){this.polyline=d;this.from=a;this.to=b;this.weight=h||0;this.fromOffset=i||0;this.parentsArrowId=c;this.childrenArrowId=f;this.dotId=e;this.hasMiddle=
j;this.middleParent=k};a.common.BaseConnectorBundle.prototype.ConnectorDestination=function(a){this.bundleid=this.y=this.x=this.id=null;this.hasElbow=!1;this.visibility=this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])};a.common.BaseConnectorBundle.prototype.traceFork=function(g,b,d,c,f,e,h,i,j){var k,m,n,l=[],p,q,r;if(e){l=[];e=0;for(m=f.length;e<m;e+=1)if(n=f[e],n.x<c.x&&!n.isSquared)l.push(n);else break;m=l.length;0<m&&(n=l[m-1],n=n.x==
c.x?c:new this.ConnectorDestination({id:n.bundleid,x:n.x,y:c.y}),this.traceAngularSegments(g,b,d,n,l,!1));l=[];for(k=f.length-1;k>=e;k-=1)if(n=f[k],n.x>c.x&&!n.isSquared)l.push(n);else break;m=l.length;0<m&&(n=l[m-1],n=n.x==c.x?c:new this.ConnectorDestination({id:n.bundleid,x:n.x,y:c.y}),this.traceAngularSegments(g,b,d,n,l,!1));for(l=e;l<=k;l+=1){n=f[l];m=d.bevelSize;2>m&&(m=0);if(b.hasGraphics)switch(d.elbowType){case 2:case 3:0<m&&(Math.abs(c.x-n.x)>m&&Math.abs(c.y-n.y)>m)&&(n.hasElbow=!0,n.elbowPoint1=
new a.common.Point(n.x,c.y+(c.y>n.y?-m:m)),n.elbowPoint2=new a.common.Point(n.x+(c.x>n.x?m:-m),c.y))}p=new a.common.Polyline;n.hasElbow?(b.transform.transform3Points(n.elbowPoint2.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint1.y,!0,this,function(b,c,e,g,f,h){switch(d.elbowType){case 2:p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(f,h));break;case 3:p.addSegment(new a.common.MoveSegment(b,c)),p.addSegment(new a.common.CubicArcSegment(b,
c,e,g,f,h))}}),b.transform.transformPoints(n.elbowPoint1.x,n.elbowPoint1.y,n.x,n.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.LineSegment(d,e))})):b.transform.transformPoints(n.x,c.y,n.x,n.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(d,e))});m=n.x==c.x?c.id:n.bundleid;q=4!==n.visibility;g.graph.addEdge(m,n.id,new this.ConnectorEdge(m,n.id,p,h&&q?n.id:null,!h&&q?n.id:null,null,q?this.NORMAL_ITEM_WEIGHT:this.LINE_ITEM_WEIGHT,
i))}e=Math.max(e-1,0);k=Math.min(k+1,f.length-1);n=c;m=c.id;for(l=e;l<=k;l+=1)q=f[l],r=q.bundleid,q.x>n.x&&(p=new a.common.Polyline,b.transform.transformPoints(n.x,c.y,null!=q.elbowPoint2?q.elbowPoint2.x:q.x,c.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(d,e))}),g.graph.addEdge(m,r,new this.ConnectorEdge(m,r,p,null,null,m,Math.abs(q.x-n.x)/1E4,i,j,h?r:m)),n=q.elbowPoint2||q,m=r);n=c;m=c.id;for(l=k;l>=e;l-=1)q=f[l],r=q.bundleid,q.x<n.x&&
(p=new a.common.Polyline,b.transform.transformPoints(n.x,c.y,null!=q.elbowPoint2?q.elbowPoint2.x:q.x,c.y,!0,this,function(b,c,d,e){p.addSegment(new a.common.MoveSegment(b,c));p.addSegment(new a.common.LineSegment(d,e))}),g.graph.addEdge(m,r,new this.ConnectorEdge(m,r,p,null,null,m,Math.abs(q.x-n.x)/1E4,i,j,h?r:m)),n=q.elbowPoint2||q,m=r)}else this.traceAngularSegments(g,b,d,c,f,!0)};a.common.BaseConnectorBundle.prototype.traceAngularSegments=function(g,b,d,c,f,e){var h,i,j,k,m;h=0;for(i=f.length;h<
i;h+=1){k=f[h];m=new a.common.Polyline;b.transform.transformPoint(c.x,c.y,!0,this,function(b,c){m.addSegment(new a.common.MoveSegment(b,c))});switch(d.connectorType){case 1:b.transform.transformPoint(k.x,k.y,!0,this,function(b,c){m.addSegment(new a.common.LineSegment(b,c))});break;case 2:j=new a.common.Rect(c,k),e?c.x>j.x?b.transform.transform3Points(j.right(),j.verticalCenter(),j.x,j.verticalCenter(),j.x,j.bottom(),!0,this,function(b,c,d,e,g,f){m.addSegment(new a.common.CubicArcSegment(b,c,d,e,g,
f))}):b.transform.transform3Points(j.x,j.verticalCenter(),j.right(),j.verticalCenter(),j.right(),j.bottom(),!0,this,function(b,c,d,e,g,f){m.addSegment(new a.common.CubicArcSegment(b,c,d,e,g,f))}):c.x>j.x?b.transform.transformPoints(j.x,j.y,j.x,j.bottom(),!0,this,function(b,c,d,e){m.addSegment(new a.common.QuadraticArcSegment(b,c,d,e))}):b.transform.transformPoints(j.right(),j.y,j.right(),j.bottom(),!0,this,function(b,c,d,e){m.addSegment(new a.common.QuadraticArcSegment(b,c,d,e))})}j=4!==k.visibility;
...
c,d,e){var f=new a.common.Polyline;f.addSegment(new a.common.MoveSegment(b,c));f.addSegment(new a.common.LineSegment(d,e));g.graph.addEdge(p.id,q.id,new this.ConnectorEdge(p.id,q.id,f,null,null,null,0))})};a.orgdiagram.LevelVisibility=function(a,b){this.level=a;this.currentvisibility=b};a.orgdiagram.OrgItem=function(a){var b,d,c;this.id=null;this.isActive=this.isVisible=!0;this.hasVisibleChildren=!1;this.childrenPlacementType=this.adviserPlacementType=this.itemType=0;this.level=null;this.hideChildrenConnection=
this.hideParentConnection=!1;this.childIndex=null;var f="id parent isVisible isActive itemType adviserPlacementType childrenPlacementType".split(" ");b=0;for(d=f.length;b<d;b+=1)c=f[b],a.hasOwnProperty(c)&&(this[c]=a[c])};a.orgdiagram.Template=function(a,b,d,c,f){this.templateConfig=a;this.itemTemplate=b;this.highlightTemplate=d;this.dotHighlightTemplate=c;this.cursorTemplate=f};a.orgdiagram.TemplateParams=function(){this.template=null;this.hasGroupTitle=this.hasButtons=this.hasSelectorCheckbox=this.isActive=
!1;this.buttons=[];this.onButtonsRender=null};a.orgdiagram.TreeItem=function(){this.visualAggregatorId=this.id=null;this.visualDepth=1;this.partners=[];this.visibility=1;this.actualItemType=null;this.relationDegree=this.gravity=this.connectorPlacement=0};a.orgdiagram.TreeItemPosition=function(g){this.partnerConnectorOffset=0;this.levelPosition=this.level=null;this.rightPadding=this.leftPadding=this.offset=0;this.actualVisibility=1;this.topConnectorShift=this.horizontalConnectorsShift=this.contentPosition=
this.actualPosition=this.actualSize=null;this.topConnectorInterval=0;this.bottomConnectorShift=null;this.bottomConnectorInterval=0;this.rightMedianOffset=this.leftMedianOffset=null;if(null!=g)for(var b in g)if(g.hasOwnProperty(b))switch(b){case "actualPosition":this.actualPosition=new a.common.Rect(g.actualPosition);break;default:this[b]=g[b]}};a.orgdiagram.TreeLevelConnectorStackSize=function(){this.parentsStackSize=0};a.orgdiagram.TreeLevelPosition=function(a){this.actualVisibility=this.currentvisibility=
1;this.currentOffset=this.levelSpace=this.connectorShift=this.topConnectorShift=this.horizontalConnectorsDepth=this.nextLevelShift=this.depth=this.shift=0;this.labels=[];this.labelsRect=null;this.showLabels=!0;this.hasFixedLabels=!1;if(null!=a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])};a.orgdiagram.TreeLevelPosition.prototype.setShift=function(a,b,d,c,f){this.shift=a;this.levelSpace=b;this.topConnectorShift=-b/2-d;this.connectorShift=this.depth+c+(f+1)*(b/2);return this.nextLevelShift=d+
this.depth+c+b+f*b/2};a.orgdiagram.TreeLevelPosition.prototype.shiftDown=function(a){this.shift+=a};a.orgdiagram.TreeLevelPosition.prototype.toString=function(){return this.currentvisibility};a.orgdiagram.AlignDiagramTask=function(g,b,d,c,f,e,h,i){function j(){var a=[],b={},c;for(c in k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(c)){var d=k.treeItemsPositions[c];switch(d.actualVisibility){case 1:case 2:case 3:d=d.actualPosition,d=Math.max(d.width,d.height),b.hasOwnProperty(d)||(b[d]=
!0,a.push(d))}}return a}var k={treeItemsPositions:{},panelSize:null},m,n,l,p,q,r,s,t;return{process:function(){var j=new a.common.Size(h.getContentSize()),u=new a.common.Size(f.getOptimalPanelSize());t=s=null;m=null!=e?e.getActiveItems():{};n=h.getItemsPositions();l=b.getOptions();p=g.getOptions();q=d.getOptions();r=c.getOptions();switch(p.orientationType){case 2:case 3:u.invert()}u.scale(1/r.scale);k.panelSize=u;k.treeItemsPositions=n;switch(l.pageFitMode){case 5:k.panelSize=new a.common.Size(j);
break;default:k.panelSize=new a.common.Size(j);if(j.width<u.width){k.treeItemsPositions={};var A=j.width,x=u.width,B;if(i)B=(x-A)/2;else switch(q.horizontalAlignment){case 1:B=0;break;case 2:B=x-A;break;case 0:B=(x-A)/2}var A=k.treeItemsPositions,z;for(z in n)n.hasOwnProperty(z)&&(x=new a.orgdiagram.TreeItemPosition(n[z]),x.actualPosition.translate(B,0),A[z]=x);k.panelSize.width=u.width}j.height<u.height&&(k.panelSize.height=u.height)}switch(p.orientationType){case 2:case 3:k.panelSize.invert()}return!0},
getItemPosition:function(a){return k.treeItemsPositions[a]},getItemsPositions:function(){return k.treeItemsPositions},getContentSize:function(){return k.panelSize},getTreeItemForMousePosition:function(b,c,d){var e=null,f=null,g=r.scale,h;if(null==s)for(h in s=a.common.SpatialIndex(j()),k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(h)){var i=k.treeItemsPositions[h];if(m.hasOwnProperty(h))switch(i.actualVisibility){case 1:case 2:case 3:i=new a.common.Rect(i.actualPosition),i.context=h,
s.addRect(i)}}h=s;var n,b=b/g,c=c/g,g=new a.common.Rect(b,c,0,0);n=new a.common.Point(b,c);g.offset(d,d,d,d);h.loopArea(this,g,function(a){var d=a.context;if(a.contains(b,c))return e=d,!0;switch(k.treeItemsPositions[d].actualVisibility){case 2:case 3:if(a=n.distanceTo(a.horizontalCenter(),a.verticalCenter()),null==f||a<f)f=a,e=d}});return e},getNextItem:function(b,c){var d;if(null==t)for(d in t=a.common.KeyboardNavigationManager(),k.treeItemsPositions)if(k.treeItemsPositions.hasOwnProperty(d)){var e=
...
d.templateName=t.name;n.transformRect(h.x,h.y,h.width,h.height,!0,this,function(b,c,e,f){var h=new a.common.Rect(0,0,Math.round(e),Math.round(f));h.offset(w.left,w.top,w.right,w.bottom);1==g.actualVisibility?m.template(b,c,e,f,h.x,h.y,h.width,h.height,k.highlightTemplate.template(),k.highlightTemplate.getHashCode(),k.highlightTemplate.render,d,null):m.template(b,c,e,f,h.x,h.y,h.width-1,h.height-1,k.dotHighlightTemplate.template(),k.dotHighlightTemplate.getHashCode(),k.dotHighlightTemplate.render,
d,null)})}var m,n;return{process:function(){var a=h.getHighlightTreeItem();m=g();m.reset("placeholder",8);null!=a&&(n=b.getTransform(),k(a));return!1}}};a.orgdiagram.DrawItemLabelsTask=function(g,b,d,c,f){function e(b,c){var d=[];if(0==c.showLabels||1==c.showLabels)for(var e in b.treeItemsPositions)if(b.treeItemsPositions.hasOwnProperty(e)){var f=c.itemsOptions[e],g=b.treeItemsPositions[e],l=g.actualPosition;null!=f&&b.transform.transformRect(l.x,l.y,l.width,l.height,!0,this,function(b,e,h,k){var l;
switch(g.actualVisibility){case 1:0==c.showLabels&&(p=new a.common.Label(b,e,h,k),p.weight=1E4,p.labelType=1,d.push(p));break;case 2:case 3:var p;p=f;var q=g,B=null,z,y,v,F;if(!a.common.isNullOrEmpty(p.label)){var E;E=3;switch(p.showLabel){case 0:switch(c.showLabels){case 0:switch(q.actualVisibility){case 3:case 2:E=0}break;case 1:E=2}break;case 1:E=2}switch(E){case 0:F=q.leftPadding+q.rightPadding;break;case 2:F=1E4;break;case 3:F=0}if(3!=E){v=null!=p.labelSize?p.labelSize:c.labelSize;q=3!=p.labelOrientation?
p.labelOrientation:3!=c.labelOrientation?c.labelOrientation:0;B=0!=p.labelPlacement?p.labelPlacement:0!=c.labelPlacement?c.labelPlacement:1;switch(q){case 0:z=v.width;y=v.height;break;case 1:case 2:y=v.width,z=v.height}v=c.labelOffset;var G,D;switch(B){case 0:case 1:G=new a.common.Rect(b+h/2-z/2,e-v-y,z,y);switch(q){case 0:D=0;l=2;break;case 1:l=D=1;break;case 2:D=2,l=1}break;case 2:case 11:G=new a.common.Rect(b+h+v,e-v-y,z,y);switch(q){case 0:D=1;l=2;break;case 1:D=1;l=0;break;case 2:l=D=2}break;
case 3:G=new a.common.Rect(b+h+v,e+k/2-y/2,z,y);switch(q){case 0:l=D=1;break;case 1:l=D=0;break;case 2:D=0,l=2}break;case 4:case 12:G=new a.common.Rect(b+h+v,e+k+v,z,y);switch(q){case 0:D=1;l=0;break;case 1:D=2;l=0;break;case 2:D=1,l=2}break;case 5:G=new a.common.Rect(b+h/2-z/2,e+k+v,z,y);switch(q){case 0:l=D=0;break;case 1:D=2;l=1;break;case 2:l=D=1}break;case 6:case 10:G=new a.common.Rect(b-z-v,e+k+v,z,y);switch(q){case 0:D=2;l=0;break;case 1:l=D=2;break;case 2:D=1,l=0}break;case 7:G=new a.common.Rect(b-
z-v,e+k/2-y/2,z,y);switch(q){case 0:D=2;l=1;break;case 1:D=0;l=2;break;case 2:l=D=0}break;case 8:case 9:switch(G=new a.common.Rect(b-z-v,e-v-y,z,y),q){case 0:l=D=2;break;case 1:D=1;l=2;break;case 2:D=2,l=0}}b=D;B=new a.common.Label(G);B.labelType=E;B.weight=F;B.text=p.label;B.labelOrientation=q;B.horizontalAlignmentType=b;B.verticalAlignmentType=l}}p=B;null!=p&&d.push(p)}})}0==c.showLabels&&a.common.getCrossingRectangles(this,d,function(a,b){if(a.isActive&&b.isActive)switch(a.labelType){case 1:switch(b.labelType){case 0:b.isActive=
!1;break;case 2:b.isActive=!1}break;case 2:switch(b.labelType){case 1:a.isActive=!1;break;case 0:b.isActive=!1}break;case 0:switch(b.labelType){case 1:a.isActive=!1;break;case 0:a.weight<=b.weight?a.isActive=!1:b.isActive=!1;break;case 2:a.isActive=!1}}});b.graphics.activate("placeholder",10);e={fontSize:c.labelFontSize,fontFamily:c.labelFontFamily,fontStyle:c.labelFontStyle,fontWeight:c.labelFontWeight,fontColor:c.labelColor};for(var l=0,p=d.length;l<p;l+=1){var q=d[l];if(q.isActive)switch(q.labelType){case 0:case 2:b.graphics.text(q.x,
q.y,q.width,q.height,q.text,q.labelOrientation,q.horizontalAlignmentType,q.verticalAlignmentType,e)}}}return{process:function(){var a=c.getOptions(),d={graphics:g(),transform:b.getTransform(),treeItemsPositions:f.getItemsPositions()},a={showLabels:a.showLabels,labelFontSize:a.labelFontSize,labelFontFamily:a.labelFontFamily,labelFontStyle:a.labelFontStyle,labelFontWeight:a.labelFontWeight,labelColor:a.labelColor,itemsOptions:c.getItemsOptions(),labelSize:a.labelSize,labelOrientation:a.labelOrientation,
labelPlacement:a.labelPlacement,labelOffset:a.labelOffset};d.graphics.reset("placeholder",10);e(d,a);return!1}}};a.orgdiagram.DrawMinimizedItemsTask=function(g,b,d,c,f,e){function h(){var b=new a.common.PolylinesBuffer,d={},e,g=new a.common.Marker,h,t,w,u,A,x,B,z,y,v;for(v in n)n.hasOwnProperty(v)&&(A=n[v],x=A.actualPosition,B=c.getItemOptions(v),j.transformRect(x.x,x.y,x.width,x.height,!0,this,function(c,i,n,j){switch(A.actualVisibility){case 2:z=f.getTemplateParams(v);y=z.template.templateConfig;
w=t=h=null;u=0;null!=B&&(t=h=B.itemTitleColor,w=B.minimizedItemShapeType);h=h||y.minimizedItemBorderColor||"#000080";t=t||y.minimizedItemFillColor||"#000080";null==w&&(w=null!==y.minimizedItemShapeType?y.minimizedItemShapeType:m.minimizedItemShapeType);u=null===y.minimizedItemCornerRadius?y.minimizedItemSize.width/2:y.minimizedItemCornerRadius;null==w||6==w?(e=b.getPolyline(new a.common.PaletteItem({lineColor:h,lineWidth:y.minimizedItemLineWidth,lineType:y.minimizedItemLineType,fillColor:t,opacity:y.minimizedItemOpacity})),
e.addSegment(new a.common.DotSegment(c,i,n,j,u))):g.draw(b,w,new a.common.Rect(c,i,n,j),new a.common.PaletteItem({lineColor:h,lineWidth:y.minimizedItemLineWidth,lineType:y.minimizedItemLineType,fillColor:t,opacity:y.minimizedItemOpacity}));break;default:k&&(h="#ff0000",d.hasOwnProperty(h)||(d[h]=new a.common.PaletteItem({lineColor:h,lineWidth:1,lineType:0,fillColor:h,opacity:1})),e=b.getPolyline(d[h]),e.addSegment(new a.common.DotSegment(c-1,i-1,2,2,1)))}}));i.activate("placeholder",9);i.polylinesBuffer(b)}
var i,j,k=!1,m,n;return{process:function(){i=g();j=b.getTransform();m=c.getOptions();n=e.getItemsPositions();i.reset("placeholder",9);h();return!1}}};a.orgdiagram.DrawShapeAnnotationTask=function(g,b,d,c,f,e,h,i){function j(b,c){var d,e,f,g,h,j,x,B,z,y,v,F;switch(i){case 1:d=k.activate("placeholder",3);break;case 2:d=k.activate("placeholder",13)}e=0;for(f=b.length;e<f;e+=1)if(v=b[e],null!=v.items&&0<v.items.length){B=new a.common.Rect;g=0;for(h=v.items.length;g<h;g+=1)x=c(v.items[g]),null!=x&&B.addRect(x.actualPosition);
if(!B.isEmpty()){j=new a.common.Shape(k);x=new a.orgdiagram.ShapeAnnotationConfig;z="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");g=0;for(h=z.length;g<h;g+=1)y=z[g],j[y]=v.hasOwnProperty(y)?v[y]:x[y];j.position=B;j.orientationType=n.orientationType;j.panelSize=d.size;j.labelTemplate=l;j.hasLabel=null!=v.templateName||null!=v.label;F=new a.common.RenderEventArgs;F.context=v;F.templateName=j.labelTemplate;
m.transformRect(B.x,B.y,B.width,B.height,!0,this,function(b,c,d,e){b=new a.common.Rect(b,c,d,e);j.draw(b,F)})}}}var k,m,n,l;return{process:function(){k=g();m=b.getTransform();n=c.getOptions();l=h.getTemplate();switch(i){case 1:k.reset("placeholder",3);break;case 2:k.reset("placeholder",13)}j(f.getAnnotations(),e.getItemPosition);return!1}}};a.orgdiagram.DrawTreeItemsTask=function(g,b,d,c,f,e,h,i,j,k,m,n,l,p){function q(){var b,g=k.getCursorTreeItem(),f,n,l;n=null;if(null!=i){n=c.getOptions().scale;
var p=new a.common.Point(i.getPlaceholderOffset()),q=new a.common.Rect(h.getContentSize()),D=new a.common.Size(d.getOptimalPanelSize());p.scale(1/n);D.scale(1/n);n=new a.common.Rect(p.x,p.y,Math.min(D.width,q.width),Math.min(D.height,q.height))}l=n;for(var C in r)r.hasOwnProperty(C)&&(f=r[C],n=f.actualPosition,1==f.actualVisibility&&t.transformRect(n.x,n.y,n.width,n.height,!0,this,function(c,d,h,i){var n=new a.common.Rect(c,d,h,i);if(null==l||l.overlaps(n)){var k=j.getTemplateParams(C),n=k.template;
b=new a.common.RenderEventArgs;b.id=C;b.context=e.getConfig(C);b.isCursor=C==g;b.isSelected=m.isSelected(C);b.templateName=n.templateConfig.name;b.template=k.template;b.isActive=k.isActive;b.hasSelectorCheckbox=k.hasSelectorCheckbox;b.hasButtons=k.hasButtons;b.hasGroupTitle=k.hasGroupTitle;b.buttons=k.buttons;b.onButtonsRender=k.onButtonsRender;s.activate("placeholder",12);s.template(c,d,h,i,f.contentPosition.x,f.contentPosition.y,f.contentPosition.width,f.contentPosition.height,n.itemTemplate.template(),
n.itemTemplate.getHashCode(),n.itemTemplate.render,b,{borderWidth:n.templateConfig.itemBorderWidth});if(k.hasGroupTitle){var p=0;switch(w.groupTitlePlacementType){case 2:case 0:p=2;break;case 3:p=h-(w.groupTitlePanelSize-4)}s.template(c,d,h,i,p,f.contentPosition.y,w.groupTitlePanelSize-4,f.contentPosition.height+2,x.template(),x.getHashCode(),x.render,b,null)}k.hasSelectorCheckbox&&(s.activate("placeholder",16),s.template(c,d,h,i,f.contentPosition.x,i-(w.checkBoxPanelSize-4),f.contentPosition.width,
w.checkBoxPanelSize-4,A.template(),A.getHashCode(),A.render,b,null));if(k.hasButtons){s.activate("placeholder",16);k=0;switch(w.groupTitlePlacementType){case 2:case 0:k=h-(w.buttonsPanelSize-4);break;case 3:k=2}s.template(c,d,h,i,k,f.contentPosition.y,w.buttonsPanelSize-4,Math.max(f.contentPosition.height,i-f.contentPosition.y),u.template(),n.templateConfig.name+u.getHashCode(),u.render,b,null)}}}))}var r,s,t,w,u,A,x;return{process:function(){s=g();w=f.getOptions();r=h.getItemsPositions();t=b.getTransform();
u=p.getTemplate();A=l.getTemplate();x=n.getTemplate();s.reset("placeholder",12);s.reset("placeholder",16);q();return!1}}};a.orgdiagram.ActiveItemsTask=function(g,b){function d(a,c){var d=[],e,f;e=0;for(f=c.length;e<f;e+=1){var g=c[e],l=b.getTemplate(g.templateName,a.defaultTemplateName,b.DefaultWidgetTemplateName).templateConfig;g.isActive&&l.isActive&&d.push(g.id)}return d}var c=[],f={},e=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a=
{isChanged:!1,hash:f},b=g.getOptions();c=e.read(c,d(b,b.items),"items",a);return a.isChanged},getActiveItems:function(){return f.items}}};a.orgdiagram.AnnotationLabelTemplateTask=function(a,b){var d=null;return{process:function(){return!1},getTemplate:function(){null==d&&(d=new b.AnnotationLabelTemplate);return d}}};a.orgdiagram.ButtonsTemplateTask=function(a,b){var d=null;return{process:function(){return!1},getTemplate:function(){null==d&&(d=new b.ButtonsTemplate);return d}}};a.orgdiagram.CheckBoxTemplateTask=
function(a,b){var d=null;return{process:function(){d=null;return!0},getTemplate:function(){var c;null==d&&(c=a.getOptions(),d=new b.CheckBoxTemplate(c.selectCheckBoxLabel));return d}}};a.orgdiagram.GroupTitleTemplateTask=function(a,b){var d=null;return{process:function(){d=null;return!0},getTemplate:function(){var c;null==d&&(c=a.getOptions(),d=new b.GroupTitleTemplate(c));return d}}};a.orgdiagram.ItemTemplateParamsTask=function(g,b,d){function c(a,b,c){var d=!1;switch(b){case 0:switch(c){case 0:d=
a;break;case 1:d=!0;break;case 2:d=!1}break;case 1:d=!0;break;case 2:d=!1}return d}var f={};return{process:function(){var e=g.getOptions(),h=0<e.buttons.length||null!=e.onButtonsRender,i=b.getCursorItem(),j=e.items,k,m;f={};k=0;for(m=j.length;k<m;k+=1){var n=j[k],l=new a.orgdiagram.TemplateParams,p=i==n.id,q=d.getTemplate(n.templateName,e.defaultTemplateName,d.DefaultWidgetTemplateName),r=q.templateConfig,s=null!=r.buttons&&0<r.buttons.length,s=s||null!=r.onButtonsRender;l.template=q;l.isActive=n.isActive&&
r.isActive;l.isActive&&(l.hasSelectorCheckbox=c(p,n.hasSelectorCheckbox,e.hasSelectorCheckbox),l.hasButtons=(h||s)&&c(p,n.hasButtons,e.hasButtons),l.hasButtons&&(l.buttons=s?r.buttons:e.buttons,l.onButtonsRender=r.onButtonsRender||e.onButtonsRender));l.hasGroupTitle=!a.common.isNullOrEmpty(n.groupTitle);f[n.id]=l}return!0},getTemplateParams:function(a){return f[a]}}};a.common.LabelAnnotationTemplate=function(){var a=["div",{"class":["bp-item","bp-label-annotation"]}];return{template:function(){return a},
getHashCode:function(){return"defaultLabelAnnotationTemplate"},render:function(a,d){d.element.innerHTML=d.context.title}}};a.orgdiagram.ReadTemplatesTask=function(g,b){var d={};return{process:function(){var c,f,e,h=g.getOptions(),i=h.templates;d={};e=new a.orgdiagram.TemplateConfig;d.DefaultWidgetTemplate=new a.orgdiagram.Template(e,new b.ItemTemplate(h,e),new b.HighlightTemplate(h,e),new b.DotHighlightTemplate(h,e),new b.CursorTemplate(h,e));c=new a.orgdiagram.TemplateConfig;c.name="DefaultWidgetLabelAnnotationTemplate";
c.isActive=!1;c.itemSize=new a.common.Size(100,20);c.minimizedItemSize=new a.common.Size(0,0);c.minimizedItemCornerRadius=c.minimizedItemSize.width/2;e=c;d.DefaultWidgetLabelAnnotationTemplate=new a.orgdiagram.Template(e,new b.LabelAnnotationTemplate,null,new b.DotHighlightTemplate(h,e),null);c=0;for(f=i.length;c<f;c+=1)e=i[c],d[e.name]=new a.orgdiagram.Template(e,a.common.isNullOrEmpty(e.itemTemplate)?new b.ItemTemplate(h,e):new b.UserTemplate(h,e.itemTemplate,h.onItemRender),a.common.isNullOrEmpty(e.highlightTemplate)?
new b.HighlightTemplate(h,e):new b.UserTemplate(h,e.highlightTemplate,h.onHighlightRender),new b.DotHighlightTemplate(h,e),a.common.isNullOrEmpty(e.cursorTemplate)?new b.CursorTemplate(h,e):new b.UserTemplate(h,e.cursorTemplate,h.onCursorRender));return!0},getTemplate:function(a,b,e){return d[a]||d[b]||d[e]},DefaultWidgetTemplateName:"DefaultWidgetTemplate",DefaultWidgetLabelAnnotationTemplateName:"DefaultWidgetLabelAnnotationTemplate"}};a.orgdiagram.CombinedNormalVisibilityItemsTask=function(g,b,
d,c,f,e,h,i,j,k,m,n){function l(a){var b=[],c,d,e,f,g,h,i={};c=0;for(d=a.length;c<d;c+=1){e=a[c];g=e.getItems();e=0;for(f=g.length;e<f;e+=1)h=g[e],i.hasOwnProperty(h)||(b.push(h),i[h]=!0)}return b}var p=[],q={},r=[b,d,c,f,e,h,i,j,k,m,n],s=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:q},b=g.getOptions();p=s.read(p,l(r),"items",a);if(0==b.pageFitMode||1==b.minimalVisibility)a.isChanged=!1;return a.isChanged},isItemSelected:function(a){return q.items.hasOwnProperty(a)}}};
a.orgdiagram.CursorItemTask=function(a,b){var d=null;return{process:function(){var c=a.getCursorItem(),f=null!=b?b.getActiveItems():{};d=null!=c&&f.hasOwnProperty(c)?c:null;return!0},getCursorTreeItem:function(){return d},getItems:function(){return null!=d?[d]:[]}}};a.orgdiagram.CursorNeighboursTask=function(a,b){function d(a,b){var c=[];null!==a&&b.loopNeighbours(this,a,function(a,b){0===b.visibility&&c.push(a);return!0});return c}var c=[];return{process:function(){var f=b.getNavigationFamily(),
e=a.getCursorTreeItem();c=d(e,f);return!0},getItems:function(){return c}}};a.orgdiagram.HighlightItemTask=function(a,b){var d=null;return{process:function(){var c=a.getHighlightItem(),f=null!=b?b.getActiveItems():{};d=null!=c&&f.hasOwnProperty(c)?c:null;return!0},getHighlightTreeItem:function(){return d}}};a.orgdiagram.NormalVisibilityItemsByAnnotationTask=function(g){function b(a){var b=[],c={},d,f,g,n,l,p;d=0;for(f=a.length;d<f;d+=1)if(g=a[d],g.selectItems){l=g.items;g=0;for(n=l.length;g<n;g+=1)p=
l[g],null!=p&&!c.hasOwnProperty(p)&&(b.push(p),c[p]=!0)}return b}var d=[],c={},f=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:c},h=g.getAnnotations();d=f.read(d,b(h),"items",a);return a.isChanged},getItems:function(){return d}}};a.orgdiagram.NormalVisibilityItemsByConnectorAnnotationTask=function(g){function b(a){var b=[],c={},d,f,g;d=0;for(f=a.length;d<f;d+=1)g=a[d],g.selectItems&&(null!=g.fromItem&&!c.hasOwnProperty(g.fromItem)&&
(b.push(g.fromItem),c[g.fromItem]=!0),null!=g.toItem&&!c.hasOwnProperty(g.toItem)&&(b.push(g.toItem),c[g.toItem]=!0));return b}var d=[],c={},f=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:c},h=g.getAnnotations();d=f.read(d,b(h),"items",a);return a.isChanged},getItems:function(){return d}}};a.orgdiagram.SelectedItemsTask=function(g){function b(a){var b=[],c={},d,f,g;d=0;for(f=a.length;d<f;d+=1)g=a[d],null!=g&&!c.hasOwnProperty(g)&&
(b.push(g),c[g]=!0);return b}var d=[],c={},f=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:c},h=g.getSelectedItems();d=f.read(d,b(h),"items",a);return a.isChanged},getItems:function(){return d},isSelected:function(a){return c.items.hasOwnProperty(a)}}};a.orgdiagram.SelectionPathItemsTask=function(a,b,d,c){function f(a,b,c){var d=[],e={},f,g,p;g=0;for(p=a.length;g<p;g+=1)switch(f=a[g],c){case 1:b.loopParents(this,f,
function(a,c){if(null!=e[a])return b.SKIP;4!=c.visibility&&d.push(a);e[a]=!0})}return d}var e=[];return{process:function(){var h=c.getSelectionPathMode(),i=a.getNavigationFamily(),j=b.getCursorTreeItem(),k=d.getItems().slice(0);k.push(j);e=f(k,i,h);return!0},getItems:function(){return e}}};a.orgdiagram.CombinedContextsTask=function(a,b){return{process:function(){return!0},getConfig:function(d){return a.getConfig(d)||null!=b&&b.getConfig(d)}}};a.orgdiagram.ConnectionsGraphTask=function(g,b,d,c,f){var e=
{graph:null,nodeid:0};return{process:function(){for(var h=g().activate("placeholder",6),i=c.getBundles(),j=c.getNestedLayoutBottomConnectorIds(),k=d.getOptions(),m={graph:a.common.graph(),nodeid:0},h={treeItemsPositions:f.getItemsPositions(),nestedLayoutBottomConnectorIds:j,transform:b.getTransform(),hasGraphics:h.hasGraphics},k={connectorType:k.connectorType,showExtraArrows:k.showExtraArrows,bevelSize:k.bevelSize,elbowType:k.elbowType},j=0,n=i.length;j<n;j+=1)i[j].trace(m,h,k);e=m;return!0},getGraph:function(){return e.graph}}};
a.orgdiagram.ItemsPositionsTask=function(g,b,d,c,f,e,h,i,j,k,m){var n,l;function p(b){var c=new a.common.Rect(0,0,0,0),d,e,f,g,h;switch(J.orientationType){case 2:case 3:b.invert()}if(!F.isEmpty())switch(I.pageFitMode){case 0:case 5:d=[new a.orgdiagram.LevelVisibility(0,1)];c=q(d,0);break;default:d=[new a.orgdiagram.LevelVisibility(0,1)];e=[];switch(I.minimalVisibility){case 2:e.push(2);break;case 0:case 3:case 4:e.push(2),e.push(3)}F.loopLevelsReversed(this,function(b){var c;for(c=0;c<e.length;c+=
1)d.push(new a.orgdiagram.LevelVisibility(b,e[c]))});f=q(d,d.length-1);f.addRect(b);f.offset(0,0,5,5);h=g=b=null;c=q(d,0);if(!r(c,f)&&(b=0,c=q(d,d.length-1),r(c,f))){for(h=g=d.length-1;1<g-b;)h=Math.floor((g+b)/2),c=q(d,h),r(c,f)?g=h:b=h;g!==h&&(c=q(d,g))}}return c}function q(b,c){var d,e;E=[];F.loopLevels(this,function(){var b=new a.orgdiagram.TreeLevelPosition;b.currentvisibility=1;E.push(b)});for(d=0;d<=c;d+=1)e=b[d],E[e.level].currentvisibility=e.currentvisibility;w();x();u();d=I.lineLevelShift;
var f,g,h,m,n=e=0;f=8*H.linesWidth;switch(H.arrowsDirection){case 1:e=f;n=0;break;case 2:e=0,n=f}f=0;for(g=E.length;f<g;f+=1)h=E[f],m=i.getConnectorsStacksSizes(f),d+=h.setShift(d,A(h.actualVisibility),n,e,m.parentsStackSize);return new a.common.Rect(0,0,Math.round(t()),Math.round(s()))}function r(a,b){var c=!1;switch(I.pageFitMode){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function s(){var a=E[E.length-
1];return a.shift+a.nextLevelShift}function t(){var a=0,b,c;b=0;for(c=E.length;b<c;b+=1)a=Math.max(a,E[b].currentOffset);return a+=I.normalItemsInterval}function w(){var b=k.getCursorTreeItem();n={};F.loopLevels(this,function(c){var d=E[c];F.loopLevelItems(this,c,function(c,e){var f=new a.orgdiagram.TreeItemPosition,g=m.isItemSelected(c)?1:e.visibility,h=j.getTemplateParams(c),g=0===g?d.currentvisibility:g,i=b==c,k=I,l=J.orientationType,p,q,r;switch(g){case 1:p=h.template.templateConfig;q=new a.common.Size(p.itemSize);
r=new a.common.Rect(0,0,q.width,q.height);i&&(q.height+=p.cursorPadding.top+p.cursorPadding.bottom,q.width+=p.cursorPadding.left+p.cursorPadding.right,r.x=p.cursorPadding.left,r.y=p.cursorPadding.top);h.hasSelectorCheckbox&&(q.height+=k.checkBoxPanelSize);if(h.hasButtons)switch(q.width+=k.buttonsPanelSize,k.groupTitlePlacementType){case 3:r.x+=k.buttonsPanelSize}if(h.hasGroupTitle)switch(q.width+=k.groupTitlePanelSize,k.groupTitlePlacementType){case 3:break;default:r.x+=k.groupTitlePanelSize}break;
case 2:p=h.template.templateConfig;q=new a.common.Size(p.minimizedItemSize);break;case 3:case 4:q=new a.common.Size}switch(l){case 2:case 3:q.invert()}f.actualVisibility=g;f.actualSize=q;f.contentPosition=r;n[c]=f})})}function u(){var a,b;F.loopLevels(this,function(c){var d=E[c];d.shift=0;d.depth=0;d.actualVisibility=4;b=a=null;F.loopLevelItems(this,c,function(c){c=n[c];d.depth=Math.max(d.depth,c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:b=!b?c.actualSize.height:Math.min(b,
c.actualSize.height);break;default:a=!a?c.actualSize.height:Math.min(a,c.actualSize.height)}d.actualVisibility=Math.min(d.actualVisibility,c.actualVisibility)});null==a&&(a=d.depth);null!=b&&b>a&&(a=b);switch(I.verticalAlignment){case 0:d.horizontalConnectorsDepth=a/2;break;case 1:d.horizontalConnectorsDepth=d.depth/2;break;case 2:d.horizontalConnectorsDepth=d.depth-a/2}})}function A(a){var b=0;switch(a){case 1:b=I.normalLevelShift;break;case 2:b=I.dotLevelShift;break;case 3:case 4:b=I.lineLevelShift}return b}
function x(){var a,b;a=0;for(b=E.length;a<b;a+=1)E[a].currentOffset=0;G.loopPostOrder(this,function(a,b){var c=n[a],d=c.actualVisibility,e=F.getLevelIndex(a),e=E[e],d=N[0===d?e.currentvisibility:d]/2,f,g,h,i,m,j,k,l;f=8*H.linesWidth;c.leftPadding=d+(0<e.currentOffset?d*b.relationDegree*I.cousinsIntervalMultiplier:0);c.rightPadding=d;0!=H.arrowsDirection&&(b.connectorPlacement&8&&(c.leftPadding+=f),b.connectorPlacement&2&&(c.rightPadding+=f));c.offset=e.currentOffset+c.leftPadding;e.currentOffset=
c.offset+c.actualSize.width+c.rightPadding;if(G.hasChildren(a))if(c=B(b),0<c)y(b,c);else if(0>c&&(c=-c,z(b,c),g=null,h={},m=null,e=G.parent(b.id),null!==e&&(G.loopChildrenReversed(this,e.id,function(a,c){if(c===b)g=[];else if(null!==g){var d=null,e=[],f,j,k,l;f=C[c.id];void 0===f&&(f=[]);f=f.slice();f.splice(0,0,c.id);j=0;for(k=f.length;j<k;j+=1)l=n[f[j]],e[j]=l.offset+l.actualSize.width+l.rightPadding;f=[];var p;j=D[b.id];void 0===j&&(j=[]);j=j.slice();j.splice(0,0,b.id);k=0;for(l=j.length;k<l;k+=
1)p=n[j[k]],f[k]=p.offset-p.leftPadding;j=Math.min(e.length,f.length);for(k=0;k<j&&!(l=f[k]-e[k],d=null!==d?Math.min(d,l):l,0>=l);k+=1);i=Math.floor(d);h[c.id]=i;if(0<i)g.splice(0,0,c);else return m=c,!0}}),0<g.length))){d=null;if(null!==m){j=[m];j=j.concat(g);j.push(b);d=[[m]];e=1;for(f=j.length;e<f;e+=1)k=j[e-1],l=j[e],2==k.gravity||1==l.gravity?d[d.length-1].push(l):d.push([l])}else d=[g.slice(0)],d[d.length-1].push(b);if(0<d.length){g=d[d.length-1];for(e=g.length-2;0<=e;e-=1)l=g[e],i=h[l.id],
c=Math.min(i,c),z(l,c),y(l,c)}j=c/(d.length-1);for(f=d.length-2;0<f;f-=1){k=d[f];for(e=k.length-1;0<=e;e-=1)l=k[e],i=h[l.id],c=Math.min(f*j,Math.min(i,c)),z(l,c),y(l,c)}}})}function B(a){var b=n[a.id],b=b.offset+b.actualSize.width/2,c=null,d,e,f;if(null===a.visualAggregatorId)switch(d=null,G.loopChildren(this,a.id,function(a,b){d=b;if(d.connectorPlacement&1)return!0}),e=n[d.id],f=null,G.loopChildrenReversed(this,a.id,function(a,b){f=b;if(f.connectorPlacement&1)return!0}),a=n[f.id],L.horizontalAlignment){case 1:c=
e.offset+e.actualSize.width/2;break;case 2:c=a.offset+a.actualSize.width/2;break;case 0:c=(e.offset+a.offset+a.actualSize.width)/2}else a=n[a.visualAggregatorId],c=a.offset+a.actualSize.width/2;return b-c}function z(a,b){var c=n[a.id];c.offset+=b;var d=E[F.getLevelIndex(a.id)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width+c.rightPadding)}function y(a,b){var c,d;G.loopLevels(this,a.id,function(a){c=n[a];c.offset+=b;d=E[F.getLevelIndex(a)];d.currentOffset=Math.max(d.currentOffset,
c.offset+c.actualSize.width);return!0})}function v(){var b=null;F.loopLevels(this,function(c){var d=E[c];F.loopLevelItems(this,c,function(c){var e,f,g,h,i,m,c=n[c];e=c.actualSize;h=b;f=0;switch(c.actualVisibility){case 1:switch(I.verticalAlignment){case 0:f=0;break;case 1:f=(d.depth-e.height)/2;break;case 2:f=d.depth-e.height}break;case 2:case 3:case 4:f=d.horizontalConnectorsDepth-e.height/2}e=new a.common.Rect(c.offset,d.shift+f,e.width,e.height);f=d.shift+d.horizontalConnectorsDepth;g=null!=h?
h.shift+h.connectorShift:null;h=null!=h?h.levelSpace/2:null;i=d.shift+d.connectorShift;m=d.levelSpace/2;c.actualPosition=e;c.horizontalConnectorsShift=f;c.topConnectorShift=g;c.topConnectorInterval=h;c.bottomConnectorShift=i;c.bottomConnectorInterval=m});b=d})}n={};l=null;var F,E,G,D,C,J,H,L,I,Q,N;return{process:function(){var m;m=I=c.getOptions();var j=[];j[1]=m.normalItemsInterval;j[2]=m.dotItemsInterval;j[3]=m.lineItemsInterval;j[4]=m.lineItemsInterval;N=j;J=d.getOptions();H=f.getOptions();L=e.getOptions();
F=i.getTreeLevels();G=h.getVisualTree();D=h.getLeftMargins();C=h.getRightMargins();E=[];n={};m=g.getOptimalPanelSize();Q=b.getOptions();m.scale(1/Q.scale);m=new a.common.Rect(0,0,m.width,m.height);l=p(m);v();return!0},getItemsPositions:function(){return n},getItemPosition:function(a){return n[a]},getContentSize:function(){return l}}};a.orgdiagram.OrgTreeTask=function(g){var b,d;function c(c){var g,i,j,k,m,n=0,l,p=a.common.tree();k=0;for(m=c.length;k<m;k+=1)j=c[k],null!=j.id&&(g=new a.orgdiagram.OrgItem(j),
l=parseInt(j.id,10),n=Math.max(isNaN(l)?0:l,n),p.add(j.parent,g.id,g));n+=1;c=new a.orgdiagram.ItemConfig;c.id=n;c.title="internal root";c.isVisible=!1;c.isActive=!1;i=new a.orgdiagram.OrgItem(c);i.hideParentConnection=!0;i.hideChildrenConnection=!0;p.add(null,i.id,i);p.loopLevels(this,function(a,b,c){if(0<c)return p.BREAK;i.id!=a&&(p.adopt(i.id,a),b.itemType=0)});f(p);b=p;d=n;return!0}function f(a){a.loopLevels(this,function(b,c){var d=!0;if(c.isVisible)return a.SKIP;a.loopChildren(this,b,function(a,
b){if(0!=b.itemType)return d=!1,!0});if(d)c.hideChildrenConnection=!0,a.loopChildren(this,b,function(a,b){b.hideParentConnection=!0});else return a.SKIP})}d=b=null;return{process:function(){c(g.getItems());return!0},getOrgTree:function(){return b},getMaximumId:function(){return d}}};a.orgdiagram.PaletteManagerTask=function(g,b){var d;return{process:function(){var c=[];null!=b&&(c=b.getOptions().linesPalette);d=new a.common.PaletteManager(g.getOptions(),c);return!0},getPaletteManager:function(){return d}}};
a.orgdiagram.VisualTreeLevelsTask=function(g){function b(b,c,d,e){var f,g,l,p,q,r,s,t={},w,u,A;d.loopLevels(this,function(x){var B=new a.orgdiagram.TreeLevelConnectorStackSize;c[x]=B;s=[];d.loopLevelItems(this,x,function(c,f){var g=[];if(!t.hasOwnProperty(c)&&(f.connectorPlacement&4&&g.push(c),g=g.concat(f.partners),0<g.length)){r=new a.common.VerticalConnectorBundle(g,[]);for(var i=0,m=g.length;i<m;i+=1)t[g[i]]=r;e.loopChildren(this,c,function(a,b){b.connectorPlacement&1&&r.toItems.push(a)});1<g.length&&
s.push(r);(1<r.fromItems.length||0<r.toItems.length)&&b.push(r)}f.connectorPlacement&8&&(r=new a.common.HorizontalConnectorBundle(c,d.getPrevItem(c)),b.push(r));f.connectorPlacement&2&&(r=new a.common.HorizontalConnectorBundle(c,d.getNextItem(c)),b.push(r))});if(0<s.length){A=a.common.pile();f=0;for(g=s.length;f<g;f+=1){r=s[f];u=w=null;l=0;for(p=r.fromItems.length;l<p;l+=1)q=d.getItemPosition(r.fromItems[l]),w=null!=w?Math.min(w,q):q,u=null!=u?Math.max(u,q):q;A.add(w,u,r)}B.parentsStackSize=A.resolve(this,
function(a,b,c,d,e){c.fromOffset=d+1;c.fromStackSize=e})}})}var d=null,c=null,f=null,e=new a.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var e=g.getVisualTree();d=a.common.TreeLevels();e.loopLevels(this,function(a,b,c){d.addItem(c,a,b)});c=[];f=[];b(c,f,d,e);return!0},getTreeLevels:function(){return d},getBundles:function(){return c},getConnectorsStacksSizes:function(a){return f[a]||e},getNestedLayoutBottomConnectorIds:function(){return{}}}};a.orgdiagram.VisualTreeTask=function(g,
b,d,c){function f(a,b,d){var f,g,h,s,w,u,D,C,J,H,L,I,Q={},N,ca={},P,T,U,da={},V;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(e,h){var i,j,v;if(!c&&!h.hasVisibleChildren)return a.SKIP;i=d.node(e);i||(i=q({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},h),d.add(null,e,i));U=T=0;if(null!=(u=d.indexOf(e)))T=u,U=d.countSiblings(e)-u-
1;j=[];a.loopChildren(this,e,function(a,b){if(c||b.hasVisibleChildren){f=q({parentId:e,actualItemType:b.itemType},b);switch(i.actualItemType){case 7:case 8:case 6:switch(f.actualItemType){case 7:case 8:case 6:f.actualItemType=2;break;case 0:f.actualItemType=1}}switch(f.actualItemType){case 5:r(i,f),f.connectorPlacement=5,v=q({visibility:4}),d.add(v.id,f.id,f),f=v;case 8:case 2:g=d.parent(e);if(i.connectorPlacement&2)s=n(d,t.navigationFamily,i),d.add(g.id,f.id,f,s+1),f.connectorPlacement=6,f.gravity=
2;else if(i.connectorPlacement&8)w=l(d,t.navigationFamily,i),d.add(g.id,f.id,f,w),f.connectorPlacement=12,f.gravity=1;else switch(b.adviserPlacementType){case 2:s=n(d,t.navigationFamily,i);d.add(g.id,f.id,f,s+1);f.connectorPlacement=6;f.gravity=2;break;default:w=l(d,t.navigationFamily,i),d.add(g.id,f.id,f,w),f.connectorPlacement=12,f.gravity=1}switch(f.actualItemType){case 8:null!=i.parentId?r(d.node(i.parentId),f):r(i,f,!0);break;case 2:r(i,f)}break;case 4:r(i,f),f.connectorPlacement=5,v=q({visibility:4}),
d.add(v.id,f.id,f),f=v;case 1:null===i.visualAggregatorId&&p(d,i,!1);switch(b.adviserPlacementType){case 2:d.add(e,f.id,f,0);f.connectorPlacement=6;f.gravity=2;break;default:d.add(e,f.id,f),f.connectorPlacement=12,f.gravity=1}1==f.actualItemType&&r(i,f);break;case 0:j.push(f);r(i,f);break;case 7:case 6:g=d.parent(e);if(i.connectorPlacement&2)d.add(g.id,f.id,f,T),f.connectorPlacement=6,f.gravity=2;else if(i.connectorPlacement&8)d.add(g.id,f.id,f,d.countChildren(g.id)-U),f.connectorPlacement=12,f.gravity=
1;else{switch(b.adviserPlacementType){case 2:d.add(g.id,f.id,f,T);f.gravity=2;break;default:d.add(g.id,f.id,f,d.countChildren(g.id)-U),f.gravity=1}switch(f.actualItemType){case 6:f.connectorPlacement=5;break;case 7:f.connectorPlacement=4}}null!=i.parentId?r(d.node(i.parentId),f):r(i,f,!0)}}});switch(i.actualItemType){case 7:case 8:case 6:break;default:V=[],null!=(g=d.parent(e))&&d.loopChildrenRange(this,g.id,T,d.countChildren(g.id)-U,function(b,c){if(c.id==e)V.push(c);else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==
...
d=["div",{style:{borderWidth:b.highlightBorderWidth+"px",MozBorderRadius:c+"px",WebkitBorderRadius:c+"px","-khtml-border-radius":c+"px",borderRadius:c+"px"},"class":["bp-item","bp-highlight-dot-frame"]}];return{template:function(){return d},getHashCode:function(){return"defaultDotHighlightTemplate"},render:function(){}}};a.common.GroupTitleTemplate=function(g){var b={style:{fontSize:g.groupTitleFontSize,fontFamily:g.groupTitleFontFamily,fontWeight:g.groupTitleFontWeight,fontStyle:g.groupTitleFontStyle},
"class":["bp-item","bp-corner-all","bp-grouptitle-frame"]},d=g.groupTitleVerticalAlignment,c="";switch(g.groupTitleOrientation){case 1:c="rotate(-90deg)";break;case 2:c="rotate(90deg)"}var f=g.groupTitleFontSize,e=g.groupTitleFontFamily,h=g.groupTitleFontWeight,i=g.groupTitleFontStyle,j=null;switch(g.groupTitleHorizontalAlignment){case 0:j="center";break;case 1:j="left";break;case 2:j="right"}c={fontSize:f,fontFamily:e,fontWeight:h,fontStyle:i,position:"absolute",padding:0,margin:0,textAlign:j,lineHeight:1,
"-webkit-transform-origin":"center center","-moz-transform-origin":"center center","-o-transform-origin":"center center","-ms-transform-origin":"center center","-webkit-transform":c,"-moz-transform":c,"-o-transform":c,"-ms-transform":c,transform:c};switch(d){case 0:d=["div",{style:c,"class":["bp-title-content","bp-item","bp-corner-all"]}];break;default:c.borderCollapse="collapse";c={style:c};f=null;switch(d){case 1:f="middle";break;case 0:f="top";break;case 2:f="bottom"}d=["table",c,["tbody",["tr",
["td",{style:{verticalAlign:f,padding:0},"class":"bp-title-content"}]]]]}var k=["div",b,d];return{template:function(){return k},getHashCode:function(){return"defaultGroupTitleTemplate"},render:function(b,c){var d=c.context,e=d.groupTitleColor||g.groupTitleColor,f={},h=c.width,i=c.height;f.left=Math.round(h/2-i/2)+"px";f.top=Math.round(i/2-h/2)+"px";f.width=i+"px";f.height=h+"px";f.maxWidth=f.width;f.maxHeight=f.height;a.common.JsonML.applyStyles(c.element.firstChild,f);d=d.groupTitle||"";d=d.replace(RegExp("\n",
...
return{template:function(){return d},getHashCode:function(){return"defaultHighlightTemplate"},render:function(){}}};a.common.ItemTemplate=function(g,b){var d,c=new a.common.Size(b.itemSize);c.width-=2*b.itemBorderWidth;c.height-=2*b.itemBorderWidth;d=["div",{style:{borderWidth:b.itemBorderWidth+"px"},"class":["bp-item","bp-corner-all","bt-item-frame"]},["div",{name:"titleBackground",style:{top:"2px",left:"2px",width:c.width-4+"px",height:"18px"},"class":["bp-item","bp-corner-all","bp-title-frame"]},
...
render:function(b,c){var d=c.context,i=null!=d.itemTitleColor?d.itemTitleColor:"#4169e1",j=a.common.highestContrast(i,g.itemTitleSecondFontColor,g.itemTitleFirstFontColor),k=c.element,m=k.firstChild,n=k.childNodes[1].firstChild,l=m.firstChild,k=k.childNodes[2];a.common.JsonML.applyStyles(m,{backgroundColor:i});n.src=d.image;n.alt=d.title;a.common.JsonML.applyStyles(l,{color:j});l.textContent=d.title;k.textContent=d.description}}};a.common.UserTemplate=function(g,b,d){var c=a.common.hashCode(JSON.stringify(b));
...
c.element,"title",function(b){a.common.JsonML.applyStyles(b,{color:j});b.textContent=h.title});a.common.getElementsByName(this,c.element,"description",function(a){a.textContent=h.description})}}}};a.orgdiagram.BaseControl=function(g,b,d,c,f){function e(b,c){null==c&&(c=!0);switch(b){case 1:h(c,J);break;case 2:var e=J;v.layout.forceCenterOnCursor=!1;v.tasks.process("HighlightItemOptionTask",null,e);v.graphics.end();break;default:p(v.layout);l(v.layout);var C=v.layout,e=v.name,H=a.common.getInnerSize(C.element),
H=new a.common.Rect(0,0,H.width,H.height),y=new a.common.Rect(H),z=a.common.getFixOfPixelALignment(g);a.common.JsonML.appendDOM(C.element,a.common.JsonML.toHTML(["div",{tabindex:0,style:{position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:H.width+"px",height:H.height+"px",padding:"0px",marginBottom:"0px",marginRight:"0px",marginLeft:z.width+"px",marginTop:z.height+"px"},"class":e,$:function(a){C.scrollPanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",
overflow:"hidden"},y.getCSS()),"class":e,$:function(a){C.mousePanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"hidden"},y.getCSS()),"class":["placeholder",e],$:function(a){C.placeholder=a}},["div",{style:{position:"absolute",overflow:"visible",top:"0px",left:"0px",width:"0px",height:"0px"},"class":["calloutplaceholder",e],$:function(a){C.calloutPlaceholder=a}}]]]]));e=v.layout;e.mousePanel.addEventListener("mousemove",q);e.mousePanel.addEventListener("click",s);e.mousePanel.addEventListener("dblclick",
t);e.mousePanel.addEventListener("change",r);e.scrollPanel.addEventListener("keydown",w);e.scrollPanel.addEventListener("scroll",i);v.options.enablePanning&&a.common.isChrome()&&(e.scrollPanel.draggable=!0,e.scrollPanel.addEventListener("dragstart",u),e.scrollPanel.addEventListener("drag",x),e.scrollPanel.addEventListener("dragend",x),e.scrollPanel.addEventListener("dragover",A));v.tasks=d(j,k,m,n,f);v.graphics=a.common.createGraphics(v.options.graphicsType,v.layout.element);v.graphics.debug=J;h(!0,
J)}}function h(b,c){var d;v.layout.forceCenterOnCursor=b;v.tasks.process("OptionsTask",null,c);v.graphics.end();b&&(d=v.tasks.getTask("CenterOnCursorTask"),d=d.getPlaceholderOffset(),v.layout.scrollPanel.scrollLeft=d.x,v.layout.scrollPanel.scrollTop=d.y);d=a.common.getFixOfPixelALignment(v.layout.element);a.common.JsonML.applyStyles(v.layout.scrollPanel,{top:"0px",left:"0px",marginBottom:"0px",marginRight:"0px",marginLeft:d.width+"px",marginTop:d.height+"px"})}function i(){null==H&&(H=window.setTimeout(function(){var a=
J;v.layout.forceCenterOnCursor=!1;v.tasks.process("LayoutOptionsTask",null,a);v.graphics.end();window.clearTimeout(H);H=null},200))}function j(){return v.options}function k(){return v.graphics}function m(){var b=v.layout,c=a.common.getInnerSize(b.element),d=new a.common.Point(b.scrollPanel.scrollLeft,b.scrollPanel.scrollTop);return{forceCenterOnCursor:b.forceCenterOnCursor,scrollPanelSize:c,placeholderOffset:d}}function n(b){var c=v.layout,d=new a.common.Size(b.contentSize);d.scale(1*b.scale);a.common.JsonML.applyStyles(c.mousePanel,
d.getCSS());a.common.JsonML.applyStyles(c.placeholder,b.contentSize.getCSS());var e="scale("+b.scale+","+b.scale+")";a.common.JsonML.applyStyles(c.placeholder,{"transform-origin":"0 0",transform:e,"-ms-transform":e,"-webkit-transform":e,"-o-transform":e,"-moz-transform":e});e=new a.common.Size(b.scrollPanelSize);b.autoSize&&(e=new a.common.Size(d.width+25,d.height+25),e.cropBySize(b.autoSizeMaximum),e.addSize(b.autoSizeMinimum),a.common.JsonML.applyStyles(c.element,e.getCSS()));a.common.JsonML.applyStyles(c.scrollPanel,
e.getCSS());return e}function l(){if(null!=v.layout.scrollPanel){var a=v.layout.scrollPanel.parentNode;null!=a&&a.removeChild(v.layout.scrollPanel)}}function p(a){null!=a.mousePanel&&(a.mousePanel.removeEventListener("mousemove",q),a.mousePanel.removeEventListener("click",s),a.mousePanel.removeEventListener("dblclick",t),a.mousePanel.removeEventListener("change",r));null!=a.scrollPanel&&(a.scrollPanel.removeEventListener("keydown",w),a.scrollPanel.removeEventListener("scroll",i),a.scrollPanel.removeEventListener("dragstart",
u),a.scrollPanel.removeEventListener("drag",x),a.scrollPanel.removeEventListener("dragend",x),a.scrollPanel.removeEventListener("dragover",A))}function q(b){var c=a.common.getElementOffset(v.layout.mousePanel),d=b.pageX-c.left,c=b.pageY-c.top,e=v.tasks.getTask("CreateTransformTask"),f=v.tasks.getTask("HighlightItemOptionTask");f.hasHighlightEnabled()&&(d=e.getTreeItemForMousePosition(d,c,f.getGravityRadius()),B(b,d))}function r(b){var d=b.target,e=d.getAttribute("data-id");if(null!=e){var f=(v.options.selectedItems||
[]).slice(),g=c(v,null,e,void 0),h=a.common.indexOf(f,e);y("onSelectionChanging",b,g);g.cancel||(0<=h?f.splice(h,1):f.push(e),v.options.selectedItems=f,0>h?d.setAttribute("checked","checked"):d.removeAttribute("checked"),y("onSelectionChanged",b,g))}}function s(b){var d=a.common.getElementOffset(v.layout.mousePanel),e=b.pageX-d.left,f=b.pageY-d.top,g=v.tasks.getTask("CreateTransformTask"),d=v.tasks.getTask("CursorItemOptionTask"),h=v.tasks.getTask("HighlightItemOptionTask"),e=g.getTreeItemForMousePosition(e,
f,h.getGravityRadius()),f=b.target;null!==e&&(a.common.hasClass(f,v.name+"button")||a.common.hasClass(f.parentNode,v.name+"button")?(d=a.common.hasClass(f,v.name+"button")?f:f.parentNode,d=d.getAttribute("data-buttonname"),f=c(v,null,e,d),y("onButtonClick",b,f)):"checkbox"===f.getAttribute("name")||"selectiontext"===f.getAttribute("name")||(f=c(v,null,e,void 0),y("onMouseClick",b,f),!f.cancel&&d.hasCursorEnabled()&&(z(b,e),v.layout.scrollPanel.focus())))}function t(a){var b;b=v.tasks.getTask("HighlightItemTask").getHighlightTreeItem();
null!==b&&(b=c(v,null,b,void 0),y("onMouseDblClick",a,b))}function w(a){var b=v.tasks.getTask("HighlightItemTask"),c=v.tasks.getTask("HighlightItemOptionTask"),d=v.tasks.getTask("CursorItemTask"),e=v.tasks.getTask("CursorItemOptionTask"),f=v.tasks.getTask("AlignDiagramTask"),g=v.tasks.getTask("CreateTransformTask").getTransform(),h=null,i=null,m=v.layout;c.hasHighlightEnabled()&&e.hasCursorEnabled()?(h=b.getHighlightTreeItem(),null===h&&(h=d.getCursorTreeItem())):c.hasHighlightEnabled()?h=b.getHighlightTreeItem():
e.hasCursorEnabled()&&(h=d.getCursorTreeItem());if(null!=h){switch(a.which){case 13:e.hasCursorEnabled()&&(z(a,h),a.preventDefault(),m.scrollPanel.focus());break;case 40:i=1;break;case 38:i=0;break;case 37:i=2;break;case 39:i=3}if(null!=i){for(d=!1;!d;)d=!0,i=g.getOrientation(i),b=f.getNextItem(h,i),null!=b&&(a.preventDefault(),c.hasHighlightEnabled()?B(a,b):e.hasCursorEnabled()&&z(a,b));m.scrollPanel.focus()}}}function u(b){var c=v.layout.scrollPanel;F=new a.common.Point(b.clientX,b.clientY);E=new a.common.Point(c.scrollLeft,
c.scrollTop);D=D||new Image;b.dataTransfer.setDragImage(D,0,0)}function A(a){a.preventDefault();a.dataTransfer.dropEffect="move"}function x(b){G=new a.common.Point(E.x-(b.clientX-F.x),E.y-(b.clientY-F.y));null==C&&(C=window.setTimeout(function(){var a=v.layout.scrollPanel;a.scrollLeft=G.x;a.scrollTop=G.y;window.clearTimeout(C);C=null},50))}function B(a,b){var d=!0,e;null!==b?b!==v.options.highlightItem&&(e=c(v,v.options.highlightItem,b,void 0),v.options.highlightItem=b,y("onHighlightChanging",a,e),
e.cancel?d=!1:(h(!1,!1),y("onHighlightChanged",a,e))):null!==v.options.highlightItem&&(e=c(v,v.options.highlightItem,null,void 0),v.options.highlightItem=null,y("onHighlightChanging",a,e),e.cancel?d=!1:(h(!1,!1),y("onHighlightChanged",a,e)));return d}function z(a,b){var d;b!==v.options.cursorItem&&(d=c(v,v.options.cursorItem,b,void 0),v.options.cursorItem=b,y("onCursorChanging",a,d),d.cancel||(h(!0,J),y("onCursorChanged",a,d)))}function y(a,b,c){a=v.options[a];null!=a&&a(b,c)}var v={name:"orgdiagram",
options:b,tasks:null,graphics:null,mouse:null,layout:{element:g,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,forceCenterOnCursor:!0}},F,E,G,D,C,J=!1,H=null;e();return{destroy:function(){p(v.layout);l(v.layout);v.tasks=null;v.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(v.options[b]=a[b])},getOptions:j,setOption:function(a,b){return v.options[a]=b},getOption:function(a){return v.options[a]},update:e}};a.orgdiagram.Control=function(g,b){return a.orgdiagram.BaseControl(g,
...
a.orgdiagram.EventArgsFactory=function(g,b,d,c){var f=new a.orgdiagram.EventArgs,e=g.tasks.getTask("CombinedContextsTask"),h=g.tasks.getTask("AlignDiagramTask"),b=e.getConfig(b),i=e.getConfig(d);b&&null!=b.id&&(f.oldContext=b);i&&null!=i.id&&(f.context=i,null!==i.parent&&(f.parentItem=e.getConfig(i.parent)),e=a.common.getElementOffset(g.layout.mousePanel),g=a.common.getElementOffset(g.layout.element),d=h.getItemPosition(d),f.position=(new a.common.Rect(d.actualPosition)).translate(e.left,e.top).translate(-g.left,
-g.top));null!=c&&(f.name=c);return f};a.orgdiagram.getProcessDiagramConfig=function(){var g=function(){};return a.orgdiagram.TaskManagerFactory(g,g,g).getProcessDiagramConfig()};a.orgdiagram.TaskManagerFactory=function(g,b,d,c,f){var e=new a.common.TaskManager;e.addDependency("options",g);e.addDependency("graphics",b);e.addDependency("getLayout",d);e.addDependency("setLayout",c);e.addDependency("templates",f);e.addDependency("defaultConfig",new a.orgdiagram.Config);e.addDependency("defaultItemConfig",
new a.orgdiagram.ItemConfig);e.addDependency("defaultTemplateConfig",new a.orgdiagram.TemplateConfig);e.addDependency("defaultButtonConfig",new a.orgdiagram.ButtonConfig);e.addDependency("defaultBackgroundAnnotationConfig",new a.orgdiagram.BackgroundAnnotationConfig);e.addDependency("defaultConnectorAnnotationConfig",new a.orgdiagram.ConnectorAnnotationConfig);e.addDependency("defaultHighlightPathAnnotationConfig",new a.orgdiagram.HighlightPathAnnotationConfig);e.addDependency("defaultShapeAnnotationConfig",
new a.orgdiagram.ShapeAnnotationConfig);e.addDependency("isFamilyChartMode",!1);e.addDependency("showElbowDots",!1);e.addDependency("null",null);e.addDependency("foreground",2);e.addDependency("background",1);e.addTask("OptionsTask",["options"],a.orgdiagram.OptionsTask,"#000000");e.addTask("LayoutOptionsTask",["getLayout","OptionsTask"],a.orgdiagram.LayoutOptionsTask,"#000000");e.addTask("CurrentControlSizeTask",["LayoutOptionsTask","ItemsSizesOptionTask"],a.orgdiagram.CurrentControlSizeTask,"#000000");
e.addTask("CurrentScrollPositionTask",["LayoutOptionsTask"],a.orgdiagram.CurrentScrollPositionTask,"#000000");e.addTask("CalloutOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.CalloutOptionTask,"#000080");e.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ConnectorsOptionTask,"#000080");e.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],a.orgdiagram.ItemsOptionTask,"#000080");e.addTask("ItemsContentOptionTask",["OptionsTask","defaultItemConfig"],
a.orgdiagram.ItemsContentOptionTask,"#000080");e.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],a.orgdiagram.ItemsSizesOptionTask,"#000080");e.addTask("LabelsOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.LabelsOptionTask,"#000080");e.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],a.orgdiagram.TemplatesOptionTask,"#000080");e.addTask("OrientationOptionTask",
["OptionsTask","defaultConfig"],a.orgdiagram.OrientationOptionTask,"#000080");e.addTask("VisualTreeOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.VisualTreeOptionTask,"#000080");e.addTask("MinimizedItemsOptionTask",["OptionsTask"],a.orgdiagram.MinimizedItemsOptionTask,"#000080");e.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.CursorItemOptionTask,"#000080");e.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.HighlightItemOptionTask,
"#000080");e.addTask("SelectedItemsOptionTask",["OptionsTask"],a.orgdiagram.SelectedItemsOptionTask,"#000080");e.addTask("CursorSelectionPathModeOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.CursorSelectionPathModeOptionTask,"#000080");e.addTask("SplitAnnotationsOptionTask",["OptionsTask"],a.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");e.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],a.orgdiagram.ShapeAnnotationOptionTask,
"#000080");e.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");e.addTask("ForegroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");e.addTask("BackgroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig",
"background"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");e.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");e.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");e.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask",
"defaultBackgroundAnnotationConfig"],a.orgdiagram.BackgroundAnnotationOptionTask,"#000080");e.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ScaleOptionTask,"#000080");e.addTask("CombinedContextsTask",["ItemsContentOptionTask"],a.orgdiagram.CombinedContextsTask,"#00ffff");e.addTask("OrgTreeTask",["ItemsOptionTask"],a.orgdiagram.OrgTreeTask,"#ff0000");e.addTask("ReadTemplatesTask",["TemplatesOptionTask","templates"],a.orgdiagram.ReadTemplatesTask,"#00ffff");e.addTask("ActiveItemsTask",
["ItemsSizesOptionTask","ReadTemplatesTask"],a.orgdiagram.ActiveItemsTask,"#00ffff");e.addTask("ItemTemplateParamsTask",["ItemsSizesOptionTask","CursorItemOptionTask","ReadTemplatesTask"],a.orgdiagram.ItemTemplateParamsTask,"#00ffff");e.addTask("GroupTitleTemplateTask",["TemplatesOptionTask","templates"],a.orgdiagram.GroupTitleTemplateTask,"#00ffff");e.addTask("CheckBoxTemplateTask",["ItemsSizesOptionTask","templates"],a.orgdiagram.CheckBoxTemplateTask,"#00ffff");e.addTask("ButtonsTemplateTask",["ItemsSizesOptionTask",
"templates"],a.orgdiagram.ButtonsTemplateTask,"#00ffff");e.addTask("AnnotationLabelTemplateTask",["ItemsOptionTask","templates"],a.orgdiagram.AnnotationLabelTemplateTask,"#00ffff");e.addTask("VisualTreeTask",["OrgTreeTask","ActiveItemsTask","VisualTreeOptionTask","isFamilyChartMode"],a.orgdiagram.VisualTreeTask,"#ff0000");e.addTask("VisualTreeLevelsTask",["VisualTreeTask","ItemTemplateParamsTask"],a.orgdiagram.VisualTreeLevelsTask,"#ff0000");e.addTask("ConnectionsGraphTask",["graphics","CreateTransformTask",
...
1],l[t]));m.endHead.attach(m.startHead);s+=1}else q.endHead=h(!0),q.endHead.add(new a.common.Vector(new a.common.Point(n.x,q.start),new a.common.Point(n.x,q.end))),q.startHead=q.endHead.getTail(),k+=1}if(null!=d)for(i=0;i<x.length;i+=1)B.hasOwnProperty(i)&&(j=x[i],l=[],j.iterate(function(a){0==l.length&&l.push(a.from);l.push(a.to)}),d.call(g,l))};a.common.getMinimumCrossingRows=function(a,b,d){var c=a=null;if(null!=d){b.sort(function(a,b){return a.y-b.y});for(var f=0;f<b.length;f+=1){var e=b[f],h=
e.bottom();null===a?(a=e.y,c=h):e.y>=c?(d.call(this.Arg,a),a=e.y,c=h):(e.y>a&&(a=e.y),h<c&&(c=h))}null!==a&&d.call(this.Arg,a)}};a.common.graph=function(){function g(a,b,d,e){var f=[],g,l,p,q;f.push(b);d[b]=!0;if(null!=e)for(;0<f.length;){b=[];l=0;for(p=f.length;l<p;l+=1)for(q in g=f[l],e.call(a,g),g=c[g],g)g.hasOwnProperty(q)&&!d.hasOwnProperty(q)&&(d[q]=!0,b.push(q));f=b}}function b(a,b){var d=null,e,f,g,l=0,p=null;for(e in c)if(c.hasOwnProperty(e)){f=c[e];l=0;for(g in f)f.hasOwnProperty(g)&&(l+=
b.call(a,f[g],e,g));if(l>p||null==p)d=e,p=l}return d}function d(a,d,g,k,m){var n={},l,p=[],q={},r=0,s,t,w,u,A,x;if(null!=g&&null!=k&&(null==d&&(d=b(a,g)),null!=d)){k.call(a,d);n[d]=!0;r+=1;for(q[d]=null;0<r;){p=[];t=s=null;w={};for(l in n)if(n.hasOwnProperty(l)){u=c[l];d=!1;for(A in u)if(u.hasOwnProperty(A)&&!q.hasOwnProperty(A))switch(x=g.call(a,u[A],l,A),d=!0,m){case f:null==w[A]&&(w[A]=0);w[A]+=x;if(!t||w[A]>t)s=A,t=w[A];break;case e:if(w[A]=null==w[A]?x:Math.min(w[A],x),!t||w[A]<t)s=A,t=w[A]}d||
p.push(l)}if(null==s)break;else n[s]=!0,r+=1,q[s]=!0,k.call(a,s);d=0;for(s=p.length;d<s;d+=1)delete n[p[d]],r-=1}}}var c={},f=1,e=2;return{addEdge:function(a,b,d){if((null==c[a]||null==c[a][b])&&null!=d)null==c[a]&&(c[a]={}),c[a][b]=d,null==c[b]&&(c[b]={}),c[b][a]=d},edge:function(a,b){var d=null;null!=c[a]&&c[a][b]&&(d=c[a][b]);return d},hasNode:function(a){return c.hasOwnProperty(a)},loopNodes:function(a,b,d){a={};if(null==b)for(b in c)c.hasOwnProperty(b)&&(a.hasOwnProperty[b]||g(this,b,a,d));else g(this,
b,a,d)},loopNodeEdges:function(a,b,d){var e;if(null!=d&&(b=c[b],null!=b))for(e in b)b.hasOwnProperty(e)&&d.call(a,e,b[e])},getSpanningTree:function(b,d){var e=a.common.tree(),f=a.common.FibonacciHeap(!0),g,n={},l,p,q,r;f.add(b,0,null);for(n[b]=null;null!=(g=f.extractRoot());){l=c[g.key];for(p in l)l.hasOwnProperty(p)&&!e.node(p)&&(q=null!=d?d(l[p]):l[p],r=f.getPriority(p),null==r?(f.add(p,q,null),n[p]=g.key.toString()):r<=q&&(f.setPriority(p,q),n[p]=g.key.toString()));e.add(n[g.key],g.key.toString(),
{})}return e},getTotalWeightGrowthSequence:function(a,c,e){var g=b(a,c);d(a,g,c,e,f)},getMinimumWeightGrowthSequence:function(a,b,c,f){d(a,b,c,f,e)},getShortestPath:function(b,d,e,f,g){var n=a.common.FibonacciHeap(!1),l={},p={},q,r,s={},t=0,w=0,l=0;for(r=e.length;l<r;l+=1)q=e[l],s.hasOwnProperty(q)||(t+=1,s[q]=!0);n.add(d,0,null);for(p[d]=null;null!=(d=n.extractRoot());){e=c[d.key];for(q in e)e.hasOwnProperty(q)&&(r=d.priority+(null!=f?f.call(b,e[q],d,q):1),l=n.getPriority(q),null!=l?l>r&&(n.setPriority(q,
r),p[q]=d.key):p.hasOwnProperty(q)||(n.add(q,r,null),p[q]=d.key));if(s.hasOwnProperty(d.key)){l=[];for(e=d.key;null!=e;)l.push(e),e=p[e];g.call(b,l,d.key);w+=1;if(w>=t)break}}}}};a.common.LCA=function(g){var b=[],d=[],c={},f;(function(){var e=0;g.loopEulerWalk(this,function(a,f,g){b.push(a);d.push(g);c.hasOwnProperty(a)||(c[a]=e);e+=1});f=a.common.RMQ(d)})();return{getLowestCommonAncestor:function(a,d){var g=c[a],j=c[d],g=g<j?f.getRangeMinimumIndex(g,j):f.getRangeMinimumIndex(j,g);return b[g]}}};
a.common.LinkedHashItems=function(){function a(b,c){if(e.hasOwnProperty(b))throw"Duplicate segments are not supported!";e[b]=c;h[b]=null;null==k?(j=b,i[b]=null):(h[k]=b,i[b]=k);k=b}function b(a,b){if(e.hasOwnProperty(a))throw"Duplicate segments are not supported!";e[a]=b;i[a]=null;null==j?(k=a,h[a]=null):(i[j]=a,h[a]=j);j=a}function d(c,d,f){if(e.hasOwnProperty(d))throw"Duplicate segments are not supported!";if(null==c)b(d,f);else{var j=h[c];null==j?a(d,f):(e[d]=f,h[c]=d,h[d]=j,i[j]=d,i[d]=c)}}function c(a,
