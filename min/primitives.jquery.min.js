/*
 jQuery Widgets for Basic Primitives Diagram v5.1.1
...
!1,this,function(a,c,b,d){g=new primitives.common.Rect(a,c,b,d)});d.transformRect(f.x,f.y,f.width,f.height,!1,this,function(a,c,b,d){f=new primitives.common.Rect(a,c,b,d)});switch(a.connectorPlacementType){case primitives.common.ConnectorPlacementType.Offbeat:b=new primitives.common.ConnectorOffbeat;break;case primitives.common.ConnectorPlacementType.Straight:b=new primitives.common.ConnectorStraight}var i;d.transformRect(0,0,a.labelSize.width,a.labelSize.height,!1,this,function(a,c,b,d){i=new primitives.common.Size(b,
d)});var j=null;d.transformRect(0,0,k.size.width,k.size.height,!1,this,function(a,c,b,d){j=new primitives.common.Size(b,d)});var k=new primitives.common.PaletteItem({lineColor:a.color,lineWidth:a.lineWidth,lineType:a.lineType}),m=!primitives.common.isNullOrEmpty(a.label),g=(new primitives.common.Rect(g)).offset(a.offset),f=(new primitives.common.Rect(f)).offset(a.offset);b.draw(l,k,g,f,6*a.lineWidth,0,i,j,a.connectorShapeType,4,a.labelPlacementType,m,e,function(b){m&&null!=b&&(d.transformRect(b.x,
b.y,b.width,b.height,!0,h,function(a,c,d,e){b=new primitives.common.Rect(a,c,d,e)}),c=new primitives.common.RenderEventArgs,c.context=a,h._graphics.template(b.x,b.y,0,0,0,0,b.width,b.height,h._labelTemplate.template(),h._labelTemplate.getHashCode(),h._labelTemplate.render,c,null))});e.resolve()}l.transform(d,!0);this._graphics.polylinesBuffer(l)};
