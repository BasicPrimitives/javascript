/*
 Basic Primitives Diagram v5.3.0
...
f=!0),c.unshift(b),1<c.length&&(c[1].invert(c[0].getEndPoint()),j.push(c[1]),c.length=1))}):b.mergeTo(k)},addArrow:function(b,f){var d,e,h,i;e=j.length;i=3*b;var g=2*b;switch(b){case 1:i=8;g=6;break;case 2:i=12;g=8;break;case 3:i=16,g=10}null!=f&&1<e&&(d=j[e-2].getEndPoint(),h=j[e-1],null!=h.trim&&(e=new a.common.Point(h.getEndPoint()),d=h.trim(d,g),i=c(d.x,d.y,e.x,e.y,i,g),f(i,d)))},addOffsetArrow:function(b,f,d,e,h){var i,g,l;i=j.length;l=3*f;var k=2*f,z;switch(f){case 1:l=8;k=6;break;case 2:l=
12;k=8;break;case 3:l=16,k=10}null!=h&&1<i&&(f=j[i-2].getEndPoint(),g=j[i-1],null!=g.offsetPoint&&(i=new a.common.Point(g.getEndPoint()),z=f.distanceTo(i),z>e&&(d*=z,b?(b=g.offsetPoint(f,i,d),l=c(f.x,f.y,b.x,b.y,l,k)):(b=g.offsetPoint(i,f,d),l=c(i.x,i.y,b.x,b.y,l,k)),h(l))))},optimizeMoveSegments:function(){var a,b,f,c,d;f={};var e=[],i=[];a=0;for(b=j.length;a<b-1;a+=1)switch(c=j[a],d=j[a+1],c.segmentType){case 0:case 2:case 3:switch(d.segmentType){case 1:case 4:c=c.x+"&"+c.y,f.hasOwnProperty(c)||
