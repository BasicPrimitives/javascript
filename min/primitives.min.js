/*
 Basic Primitives Diagrams v5.9.1
...
a.common.mergeObjects(d,b.framePlaceholderSize.getCSS()));a.common.JsonML.applyStyles(c.frameMousePanel,b.controlSize.getCSS());a.common.JsonML.applyStyles(c.scrollPanel,a.common.mergeObjects({left:b.frameThickness.left+"px",top:b.frameThickness.top+"px"},b.viewportSize.getCSS()))}function p(b,d){var e=a.common.getInnerSize(b.element);e=new a.common.Rect(0,0,e.width,e.height);var f=a.common.getFixOfPixelALignment(c);a.common.JsonML.appendDOM(b.element,a.common.JsonML.toHTML(["div",{tabindex:0,style:{position:"relative",
overflow:"hidden",top:"0px",left:"0px",width:"100%",height:"100%",padding:"0px",marginBottom:"0px",marginRight:"0px",marginLeft:f.width+"px",marginTop:f.height+"px"},name:"controlPanel","class":d,$:function(a){b.controlPanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"hidden"},e.getCSS()),name:"frameMousePanel","class":d,$:function(a){b.frameMousePanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"hidden"},e.getCSS()),name:"framePlaceholder","class":["frameplaceholder",
d],$:function(a){b.framePlaceholder=a}}]],["div",{style:a.common.mergeObjects({position:"absolute",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:e.width+"px",height:e.height+"px"},e.getCSS()),name:"scrollPanel","class":["bp-scrollpanel",d],$:function(a){b.scrollPanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"visible"},e.getCSS()),name:"mousePanel","class":d,$:function(a){b.mousePanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",
overflow:"hidden"},e.getCSS()),name:"placeholder","class":["placeholder",d],$:function(a){b.placeholder=a}},["div",{style:{position:"absolute",overflow:"visible",top:"0px",left:"0px",width:"0px",height:"0px"},name:"calloutPlaceholder","class":["calloutplaceholder",d],$:function(a){b.calloutPlaceholder=a}}]]]]]))}function r(){var a=z.layout.controlPanel;if(null!=a){var b=a.parentNode;null!=b&&b.removeChild(a)}}function t(a){null!=a.mousePanel&&(a.mousePanel.removeEventListener("mousemove",v),a.mousePanel.removeEventListener("click",
E),a.mousePanel.removeEventListener("dblclick",A),a.mousePanel.removeEventListener("change",x));null!=a.element&&a.element.removeEventListener("keydown",F);null!=a.scrollPanel&&(a.scrollPanel.removeEventListener("scroll",k),a.scrollPanel.removeEventListener("dragstart",y),a.scrollPanel.removeEventListener("drag",C),a.scrollPanel.removeEventListener("dragend",C),a.scrollPanel.removeEventListener("dragover",B));null!=a.frameMousePanel&&(a.frameMousePanel.removeEventListener("mousemove",u),a.frameMousePanel.removeEventListener("click",
w))}function u(b){var c=a.common.getElementOffset(z.layout.frameMousePanel),d=b.pageX-c.left;c=b.pageY-c.top;var e=z.tasks.getTask("ProjectItemsToFrameTask"),f=z.tasks.getTask("HighlightItemOptionTask");f.hasHighlightEnabled()&&(d=e.getTreeItemForMousePosition(d,c,f.getGravityRadius()),D(b,d))}function w(b){var c=a.common.getElementOffset(z.layout.frameMousePanel),d=b.pageX-c.left,f=b.pageY-c.top,h=z.tasks.getTask("ProjectItemsToFrameTask");c=z.tasks.getTask("CursorItemOptionTask");var g=z.tasks.getTask("HighlightItemOptionTask");
d=h.getTreeItemForMousePosition(d,f,g.getGravityRadius());null!==d&&(f=e(z,null,d,void 0),G("onMouseClick",b,f),!f.cancel&&c.hasCursorEnabled()&&(K(b,d),z.layout.element.focus()))}function v(b){var c=a.common.getElementOffset(z.layout.mousePanel),d=b.pageX-c.left;c=b.pageY-c.top;var e=z.tasks.getTask("CreateTransformTask"),f=z.tasks.getTask("HighlightItemOptionTask");f.hasHighlightEnabled()&&(d=e.getTreeItemForMousePosition(d,c,f.getGravityRadius()),D(b,d))}function x(b){var c=b.target,d=c.getAttribute("data-id");
if(null!=d){var f=(z.options.selectedItems||[]).slice(),h=e(z,null,d,void 0),g=a.common.indexOf(f,d);G("onSelectionChanging",b,h);h.cancel||(0<=g?f.splice(g,1):f.push(d),z.options.selectedItems=f,0>g?c.setAttribute("checked","checked"):c.removeAttribute("checked"),G("onSelectionChanged",b,h))}}function E(b){var c=a.common.getElementOffset(z.layout.mousePanel),d=b.pageX-c.left,f=b.pageY-c.top,h=z.tasks.getTask("CreateTransformTask");c=z.tasks.getTask("CursorItemOptionTask");var g=z.tasks.getTask("HighlightItemOptionTask");
d=h.getTreeItemForMousePosition(d,f,g.getGravityRadius());f=b.target;null!==d&&(a.common.hasClass(f,z.name+"button")||a.common.hasClass(f.parentNode,z.name+"button")?(c=a.common.hasClass(f,z.name+"button")?f:f.parentNode,c=c.getAttribute("data-buttonname"),f=e(z,null,d,c),G("onButtonClick",b,f)):"checkbox"!==f.getAttribute("name")&&"selectiontext"!==f.getAttribute("name")&&(f=e(z,null,d,void 0),G("onMouseClick",b,f),!f.cancel&&c.hasCursorEnabled()&&(K(b,d),z.layout.element.focus())))}function A(a){var b=
z.tasks.getTask("HighlightItemTask").getHighlightTreeItem();null!==b&&(b=e(z,null,b,void 0),G("onMouseDblClick",a,b))}function F(a){var b=z.tasks.getTask("HighlightItemTask"),c=z.tasks.getTask("HighlightItemOptionTask"),d=z.tasks.getTask("CursorItemTask"),e=z.tasks.getTask("CursorItemOptionTask"),f=z.tasks.getTask("AlignDiagramTask"),h=z.tasks.getTask("CreateTransformTask").getTransform(),g=null,m=null,k=z.layout;c.hasHighlightEnabled()&&e.hasCursorEnabled()?(g=b.getHighlightTreeItem(),null===g&&
(g=d.getCursorTreeItem())):c.hasHighlightEnabled()?g=b.getHighlightTreeItem():e.hasCursorEnabled()&&(g=d.getCursorTreeItem());if(null!=g){switch(a.which){case 13:e.hasCursorEnabled()&&(K(a,g),a.preventDefault(),k.element.focus());break;case 40:m=1;break;case 38:m=0;break;case 37:m=2;break;case 39:m=3}if(null!=m){for(d=!1;!d;)d=!0,m=h.getOrientation(m),b=f.getNextItem(g,m),null!=b&&(a.preventDefault(),c.hasHighlightEnabled()?D(a,b):e.hasCursorEnabled()&&K(a,b));k.element.focus()}}}function y(b){var c=
z.layout.scrollPanel;H=new a.common.Point(b.clientX,b.clientY);L=new a.common.Point(c.scrollLeft,c.scrollTop);N=N||new Image;b.dataTransfer.setDragImage(N,0,0)}function B(a){a.preventDefault();a.dataTransfer.dropEffect="move"}function C(b){J=new a.common.Point(L.x-(b.clientX-H.x),L.y-(b.clientY-H.y));null==M&&(M=window.setTimeout(function(){var a=z.layout.scrollPanel;a.scrollLeft=J.x;a.scrollTop=J.y;window.clearTimeout(M);M=null},50))}function D(a,b){var c=!0;if(null!==b){if(b!==z.options.highlightItem){var d=
e(z,z.options.highlightItem,b,void 0);z.options.highlightItem=b;G("onHighlightChanging",a,d);d.cancel?c=!1:(h(!1,!1),G("onHighlightChanged",a,d))}}else null!==z.options.highlightItem&&(d=e(z,z.options.highlightItem,null,void 0),z.options.highlightItem=null,G("onHighlightChanging",a,d),d.cancel?c=!1:(h(!1,!1),G("onHighlightChanged",a,d)));return c}function K(a,b){if(b!==z.options.cursorItem){var c=e(z,z.options.cursorItem,b,void 0);z.options.cursorItem=b;G("onCursorChanging",a,c);c.cancel||(h(!0,!1),
G("onCursorChanged",a,c))}}function G(a,b,c){a=z.options[a];null!=a&&a(b,c)}var z={name:"orgdiagram",options:b,tasks:null,graphics:null,mouse:null,layout:{element:c,controlPanel:null,frameMousePanel:null,framePlaceholder:null,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,forceCenterOnCursor:!0}},H,L,J,N,M,P=null;d();return{destroy:function(){t(z.layout);r(z.layout);z.tasks=null;z.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(z.options[b]=a[b])},
getOptions:l,setOption:function(a,b){return z.options[a]=b},getOption:function(a){return z.options[a]},update:d}};a.orgdiagram.Control=function(c,b){return a.orgdiagram.BaseControl(c,b,a.orgdiagram.TaskManagerFactory,a.orgdiagram.EventArgsFactory,{AnnotationLabelTemplate:a.common.AnnotationLabelTemplate,ButtonsTemplate:a.common.ButtonsTemplate,CheckBoxTemplate:a.common.CheckBoxTemplate,CursorTemplate:a.common.CursorTemplate,DotHighlightTemplate:a.common.DotHighlightTemplate,GroupTitleTemplate:a.common.GroupTitleTemplate,
HighlightTemplate:a.common.HighlightTemplate,ItemTemplate:a.common.ItemTemplate,UserTemplate:a.common.UserTemplate,LabelAnnotationTemplate:a.common.LabelAnnotationTemplate})};a.orgdiagram.EventArgsFactory=function(c,b,f,e){var g=new a.orgdiagram.EventArgs,d=c.tasks.getTask("CombinedContextsTask"),h=c.tasks.getTask("AlignDiagramTask");b=d.getConfig(b);var k=d.getConfig(f);b&&null!=b.id&&(g.oldContext=b);k&&null!=k.id&&(g.context=k,null!==k.parent&&(g.parentItem=d.getConfig(k.parent)),d=a.common.getElementOffset(c.layout.mousePanel),
c=a.common.getElementOffset(c.layout.element),f=h.getItemPosition(f),g.position=(new a.common.Rect(f.actualPosition)).translate(d.left,d.top).translate(-c.left,-c.top));null!=e&&(g.name=e);return g};a.orgdiagram.getProcessDiagramConfig=function(){var c=function(){};return a.orgdiagram.TaskManagerFactory(c,c,c).getProcessDiagramConfig()};a.orgdiagram.TaskManagerFactory=function(c,b,f,e,g){var d=new a.common.TaskManager;d.addDependency("options",c);d.addDependency("graphics",b);d.addDependency("getLayout",
f);d.addDependency("setLayout",e);d.addDependency("templates",g);d.addDependency("defaultConfig",new a.orgdiagram.Config);d.addDependency("defaultItemConfig",new a.orgdiagram.ItemConfig);d.addDependency("defaultTemplateConfig",new a.orgdiagram.TemplateConfig);d.addDependency("defaultButtonConfig",new a.orgdiagram.ButtonConfig);d.addDependency("defaultBackgroundAnnotationConfig",new a.orgdiagram.BackgroundAnnotationConfig);d.addDependency("defaultConnectorAnnotationConfig",new a.orgdiagram.ConnectorAnnotationConfig);
d.addDependency("defaultHighlightPathAnnotationConfig",new a.orgdiagram.HighlightPathAnnotationConfig);d.addDependency("defaultShapeAnnotationConfig",new a.orgdiagram.ShapeAnnotationConfig);d.addDependency("isFamilyChartMode",!1);d.addDependency("showElbowDots",!1);d.addDependency("null",null);d.addDependency("foreground",2);d.addDependency("background",1);d.addTask("OptionsTask",["options"],a.orgdiagram.OptionsTask,"#000000");d.addTask("CalloutOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],
a.orgdiagram.CalloutOptionTask,"#000080");d.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ConnectorsOptionTask,"#000080");d.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],a.orgdiagram.ItemsOptionTask,"#000080");d.addTask("ItemsContentOptionTask",["OptionsTask","defaultItemConfig"],a.orgdiagram.ItemsContentOptionTask,"#000080");d.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],a.orgdiagram.ItemsSizesOptionTask,
"#000080");d.addTask("LabelsOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.LabelsOptionTask,"#000080");d.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],a.orgdiagram.TemplatesOptionTask,"#000080");d.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.OrientationOptionTask,"#000080");d.addTask("VisualTreeOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.VisualTreeOptionTask,"#000080");
d.addTask("MinimizedItemsOptionTask",["OptionsTask"],a.orgdiagram.MinimizedItemsOptionTask,"#000080");d.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.CursorItemOptionTask,"#000080");d.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.HighlightItemOptionTask,"#000080");d.addTask("SelectedItemsOptionTask",["OptionsTask"],a.orgdiagram.SelectedItemsOptionTask,"#000080");d.addTask("CursorSelectionPathModeOptionTask",["OptionsTask","defaultConfig"],
a.orgdiagram.CursorSelectionPathModeOptionTask,"#000080");d.addTask("SplitAnnotationsOptionTask",["OptionsTask"],a.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");d.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");d.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");
d.addTask("ForegroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");d.addTask("BackgroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","background"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");d.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig",
"foreground"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");d.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");d.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],a.orgdiagram.BackgroundAnnotationOptionTask,"#000080");d.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ScaleOptionTask,
"#000080");d.addTask("FrameOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.FrameOptionTask,"#000080");d.addTask("CombinedContextsTask",["ItemsContentOptionTask"],a.orgdiagram.CombinedContextsTask,"#00ffff");d.addTask("OrgTreeTask",["ItemsOptionTask"],a.orgdiagram.OrgTreeTask,"#ff0000");d.addTask("ReadTemplatesTask",["TemplatesOptionTask","templates"],a.orgdiagram.ReadTemplatesTask,"#00ffff");d.addTask("ActiveItemsTask",["ItemsSizesOptionTask","ReadTemplatesTask"],a.orgdiagram.ActiveItemsTask,
"#00ffff");d.addTask("ItemTemplateParamsTask",["ItemsSizesOptionTask","CursorItemOptionTask","ReadTemplatesTask"],a.orgdiagram.ItemTemplateParamsTask,"#00ffff");d.addTask("GroupTitleTemplateTask",["TemplatesOptionTask","templates"],a.orgdiagram.GroupTitleTemplateTask,"#00ffff");d.addTask("CheckBoxTemplateTask",["ItemsSizesOptionTask","templates"],a.orgdiagram.CheckBoxTemplateTask,"#00ffff");d.addTask("ButtonsTemplateTask",["ItemsSizesOptionTask","templates"],a.orgdiagram.ButtonsTemplateTask,"#00ffff");
d.addTask("AnnotationLabelTemplateTask",["ItemsOptionTask","templates"],a.orgdiagram.AnnotationLabelTemplateTask,"#00ffff");d.addTask("VisualTreeTask",["OrgTreeTask","ActiveItemsTask","VisualTreeOptionTask","isFamilyChartMode"],a.orgdiagram.VisualTreeTask,"#ff0000");d.addTask("VisualTreeLevelsTask",["VisualTreeTask","ItemTemplateParamsTask"],a.orgdiagram.VisualTreeLevelsTask,"#ff0000");d.addTask("ConnectionsGraphTask",["graphics","CreateTransformTask","ConnectorsOptionTask","VisualTreeLevelsTask",
"AlignDiagramTask"],a.orgdiagram.ConnectionsGraphTask,"#00ffff");d.addTask("HighlightItemTask",["HighlightItemOptionTask","ActiveItemsTask"],a.orgdiagram.HighlightItemTask,"#00ffff");d.addTask("CursorItemTask",["CursorItemOptionTask","ActiveItemsTask"],a.orgdiagram.CursorItemTask,"#00ffff");d.addTask("CursorNeighboursTask",["CursorItemTask","VisualTreeTask"],a.orgdiagram.CursorNeighboursTask,"#00ffff");d.addTask("SelectedItemsTask",["SelectedItemsOptionTask","ItemsOptionTask"],a.orgdiagram.SelectedItemsTask,
"#00ffff");d.addTask("SelectionPathItemsTask",["VisualTreeTask","CursorItemTask","SelectedItemsTask","CursorSelectionPathModeOptionTask"],a.orgdiagram.SelectionPathItemsTask,"#00ffff");d.addTask("NormalVisibilityItemsByForegroundShapeAnnotationTask",["ForegroundShapeAnnotationOptionTask"],a.orgdiagram.NormalVisibilityItemsByAnnotationTask,"#00ffff");d.addTask("NormalVisibilityItemsByBackgroundShapeAnnotationTask",["BackgroundShapeAnnotationOptionTask"],a.orgdiagram.NormalVisibilityItemsByAnnotationTask,
