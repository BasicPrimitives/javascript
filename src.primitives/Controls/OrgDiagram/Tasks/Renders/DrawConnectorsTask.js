		...
		graph.loopNodes(this, null, function (itemid) {
			graph.loopNodeEdges(this, itemid, function (to, connectorEdge) {
				if (!processed.hasOwnProperty(to)) {
					...
					var arrowId = null;
					if (connectorEdge.parentsArrowId != null && connectorsOptions.arrowsDirection == primitives.common.GroupByType.Parents) {
						arrowId = connectorEdge.parentsArrowId;
					} else if(connectorEdge.childrenArrowId != null && connectorsOptions.arrowsDirection == primitives.common.GroupByType.Children) {
