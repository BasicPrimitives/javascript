...
Archive contains implementations of JavaScript Controls and PDFkit plugins. PDFkit is NodeJS and in browser PDF rendering library.
...
Go to [http://www.basicprimitives.com](https://www.basicprimitives.com) to see on-line examples and samples.
* [NPM](https://www.npmjs.com/package/basicprimitives) package.
* [GITHUB](https://github.com/BasicPrimitives) repos.
