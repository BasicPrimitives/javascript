primitives.famdiagram.FamilyItem = function (arg0) {
  ...
  this.level = null;
  this.levelGravity = primitives.common.GroupByType.None; // If item can be moved between its parent and children levels in diagram, this option defines preference
