/*
 Basic Primitives Diagrams v5.7.0
...
else if("object"===e&&c.tagName&&"param"===c.tagName.toLowerCase()){try{a.appendChild(c)}catch(J){}try{a.object&&(a.object[c.name]=c.value)}catch(J){}}}},w=function(a){return!!a&&3===a.nodeType&&(!a.nodeValue||!/\S/.exec(a.nodeValue))},y=function(a,c){a&&3===a.nodeType&&c.exec(a.nodeValue)&&(a.nodeValue=a.nodeValue.replace(c,""))},C=function(a){if(a){for(;w(a.firstChild);)a.removeChild(a.firstChild);for(y(a.firstChild,n);w(a.lastChild);)a.removeChild(a.lastChild);y(a.lastChild,m)}},E=function(a){var c=
r("div");c.innerHTML=""+a;C(c);if(1===c.childNodes.length)return c.firstChild;for(a=r("");c.firstChild;)a.appendChild(c.firstChild);return a},F=function(a){return b.createTextNode("["+a+"]")};a.onerror=null;var x=a.patch=function(a,c,e){for(var d=1;d<c.length;d+=1)if(p(c[d])||"string"===typeof c[d])v(a,A(c[d],e));else if(q(c[d]))v(a,E(c[d].value));else if("object"===typeof c[d]&&null!==c[d]&&1===a.nodeType){var m=void 0,n=c[d];if(n.name&&b.attachEvent&&!a.parentNode)try{var w=r("<"+a.tagName+' name="'+
n.name+'">');a.tagName===w.tagName&&(a=w)}catch(K){}for(m in n)if(n.hasOwnProperty(m)){var D=n[m],z=g(D);if(m)if(0===z&&(D="",z=4),m=f[m.toLowerCase()]||m,"$"===m)D(a);else if("className"==m)if(p(D))for(z=0;z<D.length;z+=1)a.className+=" "+D[z];else a.className+=" "+D;else"style"===m?0!==g(a.style.cssText)?"string"==typeof D?a.style.cssText=D:u(a,D):a.style=D:"on"===m.substr(0,2)?(t(a,m,D),(m=h[m])&&t(a,m,D)):k[m.toLowerCase()]||4===z&&"$"!==m.charAt(0)&&0===g(a[m])&&0===g(a[h[m]])?l[m.toLowerCase()]?
D&&(a.setAttribute(m,m),(m=h[m])&&a.setAttribute(m,m)):(a.setAttribute(m,D),(m=h[m])&&a.setAttribute(m,D)):(a[m]=D,(m=h[m])&&(a[m]=D))}}return a},A=a.toHTML=function(c,e){try{if(!c)return null;if("string"===typeof c)return b.createTextNode(c);if(q(c))return E(c.value);if(!p(c)||"string"!==typeof c[0])throw new SyntaxError("invalid JsonML");var f=c[0];if(!f){var h=r("");for(f=1;f<c.length;f+=1)v(h,A(c[f],e));C(h);return 1===h.childNodes.length?h.firstChild:h}if("style"===f.toLowerCase()&&b.createStyleSheet)return x(b.createStyleSheet(),
c,e),null;var g=x(r(f),c,e);C(g);return g&&d(e)?e(g):g}catch(H){try{return(d(a.onerror)?a.onerror:F)(H,c,e)}catch(I){return b.createTextNode("["+I+"]")}}};a.toHTMLText=function(a,c){a=A(a,c);if(a.outerHTML)return a.outerHTML;c=r("div");c.appendChild(a);var b=c.innerHTML;c.removeChild(a);return b}}(a.common.JsonML,document);a.common.AdviserPlacementType={Auto:0,Left:2,Right:3};a.orgdiagram.AdviserPlacementType=a.common.AdviserPlacementType;a.common.AnnotationType={Connector:0,Shape:1,HighlightPath:2,
...
c.addSegment(new a.common.LineSegment(d))):c.addSegment(new a.common.QuadraticArcSegment(e,d))};a.common.ConnectorOffbeat=function(){};a.common.ConnectorOffbeat.prototype=new a.common.BaseShape;a.common.ConnectorOffbeat.prototype.draw=function(c,b,e,d,g,f,h,k,l,n,m,q,p,r,t){p=f=0;var u=null;var v=c.getPolyline(b);var w=[];switch(l){case 1:w=[-g/2,g/2];var y=!1;break;case 0:w=[0];y=!1;break;case 2:w=[0],y=!0}var C=Math.max(q?h.width:0,5*g);if(e.right()+C<d.left()||e.left()>d.right()+C){if(e.left()>
d.right()){var E=new a.common.Point(e.left(),e.verticalCenter());var F=new a.common.Point(d.right(),d.verticalCenter())}else E=new a.common.Point(e.right(),e.verticalCenter()),F=new a.common.Point(d.left(),d.verticalCenter());q&&(e.left()>d.right()?(f=7,p=3):(f=3,p=7));var x=new a.common.Rect(E,F);var A=E.y<=F.y;var D=E.x<F.x;if(x.height<x.width){x.height<2*g&&x.offset(0,A?2*g:0,0,A?0:2*g);k=0;for(C=w.length;k<C;k+=1){var B=w[k];c.addInverted(function(e){e=e.getPolyline(b);e.addSegment(new a.common.MoveSegment(E.x,
E.y+B));e.addSegment(new a.common.QuadraticArcSegment(x.horizontalCenter(),(A?x.top():x.bottom())+B,F.x,F.y+B));y&&e.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))})},k||0==l);v.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))})}q&&(l=h.width<x.width/5*2?a.common.QuadraticArcSegment.prototype.offsetPoint(E.x,E.y,x.horizontalCenter(),A?x.top():x.bottom(),F.x,F.y,.5):new a.common.Point(E.x,A?x.top():x.bottom()),u=new a.common.Rect(l.x+(D?g:-h.width-
g),A?l.y-h.height-g:l.y+g,h.width,h.height))}else{k=0;for(C=w.length;k<C;k+=1)B=w[k],c.addInverted(function(e){e=e.getPolyline(b);e.addSegment(new a.common.MoveSegment(E.x,E.y+B));e.addSegment(new a.common.QuadraticArcSegment(x.horizontalCenter()+B*(A!=D?1:-1),(A?x.top():x.bottom())+B,x.horizontalCenter()+B*(A!=D?1:-1),x.verticalCenter()+B));e.addSegment(new a.common.QuadraticArcSegment(x.horizontalCenter()+B*(A!=D?1:-1),(A?x.bottom():x.top())+B,F.x,F.y+B));y&&e.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))})},
k||0==l),v.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))});q&&(u=new a.common.Rect(x.horizontalCenter()+(A!=D?g:-(g+h.width)),x.verticalCenter()-h.height/2,h.width,h.height))}}else if(e.verticalCenter()<d.top()||e.verticalCenter()>d.bottom()){D=e.x<k.width/2;E=new a.common.Point(D?e.right():e.left(),e.verticalCenter());F=new a.common.Point(D?d.right():d.left(),d.verticalCenter());x=new a.common.Rect(E,F);x.offset(10*g,0,10*g,0);A=E.y<=F.y;k=0;for(C=w.length;k<C;k+=1)B=w[k],
c.addInverted(function(e){e=e.getPolyline(b);e.addSegment(new a.common.MoveSegment(E.x,E.y+B));e.addSegment(new a.common.QuadraticArcSegment(D?x.right()+B*(A?-1:1):x.left()-B*(A?-1:1),x.verticalCenter(),D?d.right():d.left(),d.verticalCenter()-B));y&&e.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))})},k||0==l),v.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))});q&&(p=f=D?3:7,l=a.common.QuadraticArcSegment.prototype.offsetPoint(E.x,E.y,D?x.right():
x.left(),x.verticalCenter(),F.x,F.y,.5),u=new a.common.Rect(l.x+(D?g/2:-g/2-h.width),l.y-h.height/2,h.width,h.height))}else{E=new a.common.Point(e.horizontalCenter(),e.top());F=new a.common.Point(d.horizontalCenter(),d.top());x=new a.common.Rect(E,F);x.offset(0,7*g,0,0);D=E.x<F.x;k=0;for(C=w.length;k<C;k+=1)B=w[k],c.addInverted(function(e){e=e.getPolyline(b);e.addSegment(new a.common.MoveSegment(E.x+B,E.y));e.addSegment(new a.common.QuadraticArcSegment(x.horizontalCenter(),x.top()-B*(D?-1:1),d.horizontalCenter()-
B,d.top()));y&&e.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))})},k||0==l),v.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))});q&&(p=f=1,l=a.common.QuadraticArcSegment.prototype.offsetPoint(E.x,E.y,x.horizontalCenter(),x.top(),F.x,F.y,.5),u=new a.common.Rect(l.x-h.width/2,l.y-(n+h.height),h.width,h.height))}if(q)switch(m){case 0:u=this._getLabelPosition(e.x,e.y,e.width,e.height,u.width,u.height,n,f);break;case 2:u=this._getLabelPosition(d.x,d.y,
d.width,d.height,u.width,u.height,n,p)}null!=r&&r(u,t)};a.common.ConnectorStraight=function(){};a.common.ConnectorStraight.prototype=new a.common.BaseShape;a.common.ConnectorStraight.prototype.draw=function(c,b,e,d,g,f,h,k,l,n,m,q,p,r,t){var u,v,w,y,C=g/2,E=null,F=0,x=0,A=this;var D=new a.common.Vector(e.centerPoint(),d.centerPoint());e.loopEdges(function(a,c){u=a.getIntersectionPoint(D,!0,1);F=c;return null!=u});d.loopEdges(function(a,c){v=a.getIntersectionPoint(D,!0,1);x=c;return null!=v});if(null!=
u&&null!=v){var B=new a.common.Vector(u,v);p.getOffset(B,function(e,d,g){B.offset((e*f-(d-1)*f/2)*g);u=B.from;v=B.to;switch(l){case 1:y=new a.common.Vector(v.clone(),u.clone());y.offset(C);A._drawLine(c,b,y.from,y.to,!1);y=new a.common.Vector(u.clone(),v.clone());y.offset(C);A._drawLine(c,b,y.from,y.to,!1);break;case 0:A._drawLine(c,b,u,v,!1);break;case 2:A._drawLine(c,b,u,v,!0)}if(q){switch(m){case 0:E=A._getLabelPositionBySnapPoint(u.x,u.y,h.width,h.height,n,F);break;case 1:w=A._betweenPoint(u,
v);E=A._getLabelPositionBySnapPoint(w.x,w.y,h.width,h.height,n,3);break;case 2:E=A._getLabelPositionBySnapPoint(v.x,v.y,h.width,h.height,n,x)}null!=r&&r.call(this,E,t)}})}};a.common.ConnectorStraight.prototype._drawLine=function(c,b,e,d,g){c.addInverted(function(h){f=h.getPolyline(b);f.addSegment(new a.common.MoveSegment(e));f.addSegment(new a.common.LineSegment(d));f.addArrow(b.lineWidth,function(a){a.mergeTo(c.getPolyline(a.paletteItem))})},!1);if(g){var f=c.getPolyline(b);f.addArrow(b.lineWidth,
...
null;this.tooltip=e;this.size=new a.common.Size(16,16)};a.famdiagram.Config=function(c){this.name=void 0!==c?c:"FamDiagram";this.classPrefix="famdiagram";this.graphicsType=this.navigationMode=0;this.pageFitMode=3;this.minimalVisibility=2;this.orientationType=0;this.verticalAlignment=1;this.arrowsDirection=0;this.showExtraArrows=!0;this.extraArrowsMinimumSpace=30;this.groupByType=2;this.alignBylevels=!0;this.enableMatrixLayout=!1;this.minimumMatrixSize=4;this.maximumColumnsInMatrix=6;this.hideGrandParentsConnectors=
!1;this.elbowType=3;this.elbowDotSize=this.bevelSize=4;this.emptyDiagramMessage="Diagram is empty.";this.items=[];this.annotations=[];this.highlightItem=this.cursorItem=null;this.highlightGravityRadius=40;this.selectedItems=[];this.hasSelectorCheckbox=0;this.selectCheckBoxLabel="Selected";this.neighboursSelectionMode=this.selectionPathMode=0;this.templates=[];this.defaultLabelAnnotationTemplate=this.defaultTemplateName=null;this.hasButtons=0;this.buttons=[];this.onCursorRender=this.onHighlightRender=
...
function(a,b,e,d){this.values=[b,d];this[a]=0;this[e]=1};a.famdiagram.EdgeItem.prototype.getNear=function(a){return this.values[this[a]]};a.famdiagram.EdgeItem.prototype.getFar=function(a){return this.values[Math.abs(this[a]-1)]};a.famdiagram.EdgeItem.prototype.setNear=function(a,b){this.values[this[a]]=b};a.famdiagram.EdgeItem.prototype.setFar=function(a,b){this.values[Math.abs(this[a]-1)]=b};a.famdiagram.EdgeItem.prototype.toString=function(){return this.parent+","+this.child};a.famdiagram.FamilyItem=
function(a){var b;this.itemConfig=this.familyId=this.id=null;this.isActive=this.isVisible=!0;this.isLevelNeutral=!1;this.level=null;this.levelGravity=0;this.hideChildrenConnection=this.hideParentConnection=!1;switch(arguments.length){case 1:for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};a.famdiagram.Slot=function(a){this.itemId=a;this.position=null;this.balance=0;this.left={};this.right={};this.crossings={}};a.famdiagram.Slot.prototype.clone=function(c){var b=new a.famdiagram.Slot(c),e;for(e in this.left)this.left.hasOwnProperty(e)&&
(b.left[e]=this.left[e]);for(e in this.right)this.right.hasOwnProperty(e)&&(b.right[e]=this.right[e]);for(e in this.crossings)this.crossings.hasOwnProperty(e)&&(b.crossings[e]=this.crossings[e]);b.itemid=c;return b};a.famdiagram.LabelAnnotationOptionTask=function(c,b,e){var d=[],g={},f=null,h={},k=new a.common.ArrayReader(new a.common.ObjectReader({zOrderType:new a.common.EnumerationReader(a.common.ZOrderType,!1,e.zOrderType),fromItem:new a.common.ValueReader(["string","number"],!0),toItems:new a.common.ArrayReader(new a.common.ValueReader(["string",
"number"],!0),!0),title:new a.common.ValueReader(["string"],!0),itemTitleColor:new a.common.ValueReader(["string"],!1,e.itemTitleColor),templateName:new a.common.ValueReader(["string"],!0)},!1),!1,null,!0);return{process:function(){var a={isChanged:!1,hash:h,sourceHash:{}},e=b.getMaximumId(),m;d=k.read(d,c.getAnnotations(3),"annotations",a);g={};var q=a.sourceHash.annotations;var p=0;for(m=d.length;p<m;p+=1){var r=d[p];e+=1;r.id=e;g[r.id]=q[p]}f=e;return a.isChanged},getAnnotations:function(){return d},
getMaximumId:function(){return f},getConfig:function(a){return g[a]}}};a.famdiagram.LabelAnnotationPlacementOptionTask=function(c,b){var e=[],d={},g=new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["number"],!0),fromItem:new a.common.ValueReader(["string","number"],!0),toItems:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0)}),!0,"id");return{process:function(){var a={isChanged:!1,hash:d};e=g.read(e,c.getAnnotations(),"annotations",a);return a.isChanged},
getAnnotations:function(){return e},getMaximumId:function(){return c.getMaximumId()}}};a.famdiagram.LabelAnnotationTemplateOptionTask=function(c,b){var e=[],d={},g=new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["number"],!0),title:new a.common.ValueReader(["string"],!0),itemTitleColor:new a.common.ValueReader(["string"],!1,b.itemTitleColor),templateName:new a.common.ValueReader(["string"],!0)}),!0,"id");return{process:function(){var a={isChanged:!1,hash:d};e=g.read(e,
c.getAnnotations(),"annotations",a);return a.isChanged},getAnnotations:function(){return e}}};a.famdiagram.NeighboursSelectionModeOptionTask=function(c,b){var e={},d=new a.common.ObjectReader({neighboursSelectionMode:new a.common.EnumerationReader(a.common.NeighboursSelectionMode,!1,b.neighboursSelectionMode)});return{process:function(){var a={isChanged:!1};e=d.read(e,c.getOptions(),"options",a);return a.isChanged},getNeighboursSelectionMode:function(){return e.neighboursSelectionMode}}};a.famdiagram.HideGrandParentsConnectorsOptionTask=
function(c,b){var e={},d={},g=new a.common.ObjectReader({hideGrandParentsConnectors:new a.common.ValueReader(["boolean"],!1,b.hideGrandParentsConnectors)});return{process:function(){var a={isChanged:!1,hash:d};e=g.read(e,c.getOptions(),"options",a);return a.isChanged},getOptions:function(){return e}}};a.famdiagram.ItemsOptionTask=function(c,b){var e={},d={},g={},f=new a.common.ObjectReader({items:new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["string","number"],!0),
parents:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0),isActive:new a.common.ValueReader(["boolean"],!1,b.isActive)}),!0,"id",!0)});return{process:function(){var a={isChanged:!1,hash:d,sourceHash:g};e=f.read(e,c.getOptions(),"options",a);return a.isChanged},getItems:function(){return e.items},getConfig:function(a){return g["options-items"][a]}}};a.famdiagram.LinePaletteOptionTask=function(c,b){var e={},d={},g=new a.common.ObjectReader({linesPalette:new a.common.ArrayReader(new a.common.ObjectReader({lineColor:new a.common.ValueReader(["string"],
!1,b.lineColor),lineWidth:new a.common.ValueReader(["number"],!1,b.lineWidth),lineType:new a.common.EnumerationReader(a.common.LineType,!1,b.lineType)}),!1)});return{process:function(){var a={isChanged:!1,hash:d};e=g.read(e,c.getOptions(),"options",a);return a.isChanged},getOptions:function(){return e}}};a.famdiagram.NormalizeOptionTask=function(c,b){var e={},d={},g=new a.common.ObjectReader({groupByType:new a.common.EnumerationReader(a.common.GroupByType,!1,b.groupByType),alignBylevels:new a.common.ValueReader(["boolean"],
!1,b.alignBylevels)});return{process:function(){var a={isChanged:!1,hash:d};e=g.read(e,c.getOptions(),"options",a);return a.isChanged},getOptions:function(){return e}}};a.famdiagram.OptionsTask=function(a){return{process:function(){return!0},getOptions:a,description:"Raw options."}};a.famdiagram.OrderFamilyNodesOptionTask=function(c,b,e){var d={},g={},f=new a.common.ObjectReader({enableMatrixLayout:new a.common.ValueReader(["boolean"],!1,b.enableMatrixLayout),minimumMatrixSize:new a.common.ValueReader(["number"],
!1,b.minimumMatrixSize),maximumColumnsInMatrix:new a.common.ValueReader(["number"],!1,b.maximumColumnsInMatrix),items:new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["string","number"],!0),position:new a.common.ValueReader(["number"],!0),relativeItem:new a.common.ValueReader(["string","number"],!0),placementType:new a.common.EnumerationReader(a.common.AdviserPlacementType,!1,e.placementType),primaryParent:new a.common.ValueReader(["string","number"],!0)}),!0,"id")});
return{process:function(){var a={isChanged:!1,hash:g};d=f.read(d,c.getOptions(),"options",a);return a.isChanged},getOptions:function(){return d}}};a.famdiagram.SpousesOptionTask=function(c,b){var e={},d={},g=new a.common.ObjectReader({items:new a.common.ArrayReader(new a.common.ObjectReader({id:new a.common.ValueReader(["string","number"],!0),spouses:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0)}),!0,"id")});return{process:function(){var a={isChanged:!1,hash:d};e=g.read(e,
...
a.famdiagram.FamilyBalance.prototype.balance=function(c){var b={maximumId:null,treeLevels:a.common.TreeLevels(),bundles:[],connectorStacks:[]},e={orgTree:a.common.tree(),maximumId:c.maximumId,orgPartners:{},itemByChildrenKey:{},minimumLevel:null,maximumLevel:null};this.createOrgTree(c,e);e.orgTree.loopLevels(this,function(a,c,f){b.treeLevels.addItem(f,a,c)});this.recalcLevelsDepth(b.bundles,b.connectorStacks,b.treeLevels,e.orgTree,e.orgPartners);b.maximumId=e.maximumId;return b};a.famdiagram.FamilyBalance.prototype.Family=
function(a){this.id=null;this.familyPriority=1;this.childFamilies=[];this.items=[];this.links=[];this.backLinks=[];1==arguments.length&&(this.id=a)};a.famdiagram.FamilyBalance.prototype.FamLink=function(a,b){this.fromItem=a;this.toItem=b};a.famdiagram.FamilyBalance.prototype.createOrgTree=function(c,b){var e,d,g=[],f=[];if(0<c.logicalFamily.hasNodes()){var h={};var k=0;var l=[];c.logicalFamily.loopRoots(this,function(a,d){p=new this.Family(k);this.extractOrgChart(a,c.logicalFamily,c.primaryParents,
c.defaultItemConfig,b.orgTree,b.orgPartners,b.itemByChildrenKey,h,p);f.push(p);l.push(p);k+=1});l.sort(function(a,b){var c=a.items[0].level,f=b.items[0].level;return c!=f?c-f:b.items.length-a.items.length});g=[];var n={};if(0<f.length){var m=a.common.graph();var q=0;for(e=f.length;q<e;q+=1){var p=f[q];var r=0;for(d=p.links.length;r<d;r+=1){var t=p.links[r];var u=c.logicalFamily.node(t.fromItem).familyId;var v=c.logicalFamily.node(t.toItem).familyId;u!=v&&(m.addEdge(u,v,{weight:0}),m.edge(u,v).weight+=
1);f[v].backLinks.push(new this.FamLink(t.toItem,t.fromItem))}}for(;g.length<f.length;)for(q=0,e=l.length;q<e;q+=1)if(p=l[q],!n.hasOwnProperty(p.id)){var w=m.getSpanningTree(p.id,function(a){return-a.weight});null!=w.node(p.id)?(w.loopPostOrder(this,function(a,b,c,d){b=f[a];d=f[c];var e=[];null!=c&&(d.familyPriority+=b.familyPriority);e=[];w.loopChildren(this,a,function(a,b,c){e.push(a)});e.sort(function(a,b){return f[a].familyPriority-f[b].familyPriority});w.arrangeChildren(a,e)}),w.loopPreOrder(this,
function(a,b){g.push(a);n[a]=!0})):(g.push(p.id),n[p.id]=!0)}}b.maximumId+=1;var y=this.createOrgItem(b.orgTree,c.defaultItemConfig,b.maximumId,null,null,b.minimumLevel-1,null);y.hideParentConnection=!0;y.hideChildrenConnection=!0;y.title="internal root";y.isVisible=!1;y.isActive=!1;y.childIndex=0;m={};q=0;for(e=g.length;q<e;q+=1){p=f[g[q]];v={};var C=y;var E=0;d=p.links.concat(p.backLinks);for(r=0;r<d.length;r+=1)if(t=d[r],u=b.orgTree.node(t.toItem),b.orgTree.node(t.fromItem),!0===m[u.familyId]){var F=
p.items[0];var x=u;x.level>=F.level&&b.orgTree.loopParents(this,x.id,function(a,b){x=b;if(b.level<F.level)return!0});v.hasOwnProperty(x.id)?v[x.id]+=1:v[x.id]=1;E<v[x.id]&&(C=x,E=v[x.id])}this.attachFamilyToOrgChart(b,c.defaultItemConfig,C,p);m[p.id]=!0}q=this.getExtraGravity(b);e=this.getGrandChildren(b);this.balanceOrgTree(b.orgTree,q,e,c.itemsPositions,c.itemsGroups)}};a.famdiagram.FamilyBalance.prototype.getGrandChildren=function(a){var b={};a.orgTree.loopPostOrder(this,function(c,d,g,f){a.minimumLevel=
null!=a.minimumLevel?Math.min(a.minimumLevel,d.level):d.level;a.maximumLevel=null!=a.maximumLevel?Math.max(a.maximumLevel,d.level):d.level;if(null!=g&&(b[g]||(b[g]={}),d=d.level-1,b[g][d]=b[g][d]?b[g][d]+1:1,null!=b[c]))for(d in b[c])b[c].hasOwnProperty(d)&&(b[g][d]=b[g][d]?b[g][d]+b[c][d]:b[c][d])});return b};a.famdiagram.FamilyBalance.prototype.balanceOrgTree=function(c,b,e,d,g){var f,h,k,l,n,m,q,p,r,t,u;c.loopLevels(this,function(v,w,y){var C=a.common.graph(),E={},F=null,x;q=[];c.loopChildren(this,
w.id,function(a,d,e){var g;null==F&&(F=d);E[d.id]={};if(b.hasOwnProperty(d.id))for(g in m=b[d.id],m)if(m.hasOwnProperty(g))for(t=m[g],E[d.id][g]={},f=0,h=t.length;f<h;f+=1)n=t[f],x=n.commonParent==w.id?n.toParent:c.node(n.fromParent).childIndex<c.node(n.toParent).childIndex?"__right__":"__left__",d.id!=x&&(C.addEdge(d.id,x,{weight:0}),C.edge(d.id,x).weight+=1,null==E[d.id][g][x]&&(E[d.id][g][x]=0),E[d.id][g][x]+=1);0<e&&C.addEdge(d.id,F.id,{weight:0})});if(null!=F)for(u=[],C.getTotalWeightGrowthSequence(this,
function(a){return a.weight},function(a){u.push(a)}),0===u.length&&(u=[F.id]),p=this.balanceItems(u,"__left__","__right__",E,e,d,g),k=0,l=p.length;k<l;k+=1)r=c.node(p[k]),r.childIndex=k,q.push(r.id);c.arrangeChildren(w.id,q)})};a.famdiagram.FamilyBalance.prototype.balanceItems=function(c,b,e,d,g,f,h){var k=[],l,n=a.common.LinkedHashItems(),m=0,q={},p={},r,t,u,v,w,y,C,E,F,x,A,D,B;var z=[b,null,e];for(l=0;l<z.length;l+=1){var G=z[l];var J=m++;var H=new a.famdiagram.Slot(G);H.position=l;n.add(J,H);null!==
G&&(p[G]=J)}for(l=0;l<c.length;l+=1)if(G=c[l],G!=b&&G!=e){z=J=y=w=v=u=t=r=null;h.hasOwnProperty(G)&&(H=h[G],q.hasOwnProperty(H)&&(z=f[G],H=q[H],J=H.previousContext(z),z=H.nextContext(z)));n.iterate(function(a,b){var c,f;if(null==a.itemId){A=g[G];x=F=E=C=0;for(c in a.crossings)a.crossings.hasOwnProperty(c)&&(A&&null!=A[c]&&(C+=a.crossings[c]*A[c]),x+=a.crossings[c]);for(c in d[G])if(d[G].hasOwnProperty(c)){var e=d[G][c];for(f in e)if(e.hasOwnProperty(f)&&p.hasOwnProperty(f)){var h=n.item(p[f]);null!=
h&&(h.position<a.position?(C+=(a.left[c]||0)-(h.left[c]||0),F+=Math.abs(h.balance+1)):(C+=(a.right[c]||0)-(h.right[c]||0),F+=Math.abs(h.balance-1)),E+=Math.abs(h.position-a.position))}}if(null==u||u>C||u==C&&(v>E||v==E&&(w>F||w==F&&y>x)))r=b,u=C,t=a,v=E,w=F,y=x}},J,z);n.insertBefore(r,m++,t.clone(null));var I=p[G]=m;J=t.clone(G);f.hasOwnProperty(G)&&(H=h[G],q.hasOwnProperty(H)||(q[H]=a.common.SortedList()),H=q[H],H.add(f[G],m));n.insertBefore(r,m++,J);var L=J.position=0;n.iterate(function(a,b){var c;
if(b!=I){b=g[G];for(c in b)b.hasOwnProperty(c)&&(a.left[c]=a.left[c]?a.left[c]+b[c]:b[c]);L+=1;a.position=L}},I);L=0;n.iterateBack(function(a,b){var c;if(b!=I){b=g[G];for(c in g[G])g[G].hasOwnProperty(c)&&(a.right[c]=a.right[c]?a.right[c]+b[c]:b[c]);--L;a.position=L}},I);for(D in d[G])if(d[G].hasOwnProperty(D)){var O=d[G][D];for(B in O)if(O.hasOwnProperty(B)&&p.hasOwnProperty(B)){var K=p[B];H=n.item(K);null!=H&&(0>H.position?(H.balance+=1,--J.balance,n.iterateBack(function(a,b){b!=I&&b!=K&&(a.crossings[D]=
a.crossings[D]?a.crossings[D]+O[B]:O[B])},I,K)):(--H.balance,J.balance+=1,n.iterate(function(a,b){b!=I&&b!=K&&(a.crossings[D]=a.crossings[D]?a.crossings[D]+O[B]:O[B])},I,K)))}}}n.iterate(function(a){a=a.itemId;null!=a&&a!=b&&a!=e&&k.push(a)});return k};a.famdiagram.FamilyBalance.prototype.ExtraGravity=function(a){this.toParent=this.fromParent=this.commonParent=null;this.level=a};a.famdiagram.FamilyBalance.prototype.getExtraGravity=function(a){var b,c={},d;for(b in a.orgPartners)if(a.orgPartners.hasOwnProperty(b)){var g=
a.orgTree.node(b);var f=a.orgPartners[b];var h=0;for(d=f.length;h<d;h+=1){var k=a.orgTree.node(f[h]);this.addExtraGravitiesForConnection(a.orgTree,c,k,g)}}return c};a.famdiagram.FamilyBalance.prototype.addExtraGravitiesForConnection=function(a,b,e,d){var c=new this.ExtraGravity(e.level),f=new this.ExtraGravity(d.level);a.zipUp(this,e.id,d.id,function(a,d,e,g){this.addExtraGravityForItem(b,a,c);this.addExtraGravityForItem(b,e,f);if(d==g)return c.commonParent=d,c.fromParent=a,c.toParent=e,f.commonParent=
d,f.fromParent=e,f.toParent=a,!0})};a.famdiagram.FamilyBalance.prototype.addExtraGravityForItem=function(a,b,e){a.hasOwnProperty(b)||(a[b]={});null==a[b][e.level]&&(a[b][e.level]=[]);a[b][e.level].push(e)};a.famdiagram.FamilyBalance.prototype.attachFamilyToOrgChart=function(a,b,e,d){var c=d.items[0];var f=e;for(e=e.level+1;e<c.level;e+=1)a.maximumId+=1,f=this.createOrgItem(a.orgTree,b,a.maximumId,f.id,null,e,null),f.title="shift",f.isVisible=!1,f.isActive=!1,f.hideParentConnection=!0,f.hideChildrenConnection=
!0,d.items.push(f);c.hideParentConnection=!0;a.orgTree.adopt(f.id,c.id,c)};a.famdiagram.FamilyBalance.prototype.extractOrgChart=function(a,b,e,d,g,f,h,k,l){var c;var m=b.node(a);a=this.createOrgItem(g,d,m.id,null,l.id,m.level,m.itemConfig);a.hideParentConnection=!0;a.isVisible=m.isVisible;a.isActive=m.isActive;a.hideParentConnection=m.hideParentConnection;a.hideChildrenConnection=m.hideChildrenConnection;l.items.push(a);k[m.id]=m;m.familyId=l.id;for(c=this.extractChildren(m,b,e,d,g,f,h,k,l);0<c.length;){var q=
[];a=0;for(m=c.length;a<m;a+=1){var p=c[a];q=q.concat(this.extractChildren(p,b,e,d,g,f,h,k,l))}c=q}};a.famdiagram.FamilyBalance.prototype.extractChildren=function(a,b,e,d,g,f,h,k,l){var c=[],m=null,q=null,p;1==b.countChildren(a.id)&&(m=b.firstChild(a.id));if(null!=h[m])q=h[m],null==f[q.id]&&(f[q.id]=[]),f[q.id].push(a.id),l.links.push(new this.FamLink(a.id,m));else{if(null!=m){if(e.hasOwnProperty(m)&&(e=e[m],e!=a.id))return null==f[e]&&(f[e]=[]),f[e].push(a.id),l.links.push(new this.FamLink(a.id,
m)),c;h[m]=a}b.loopChildren(this,a.id,function(f,e,h){if(k[e.id])throw"Many to many relations should not exist at this stage";c.push(e);p=this.createOrgItem(g,d,e.id,a.id,l.id,e.level,e.itemConfig);p.hideParentConnection=e.hideParentConnection;p.hideChildrenConnection=e.hideChildrenConnection;p.isVisible=e.isVisible;p.isActive=e.isActive;l.items.push(p);k[e.id]=!0;e.familyId=l.id;return b.SKIP})}return c};a.famdiagram.FamilyBalance.prototype.createOrgItem=function(c,b,e,d,g,f,h){var k=new a.orgdiagram.OrgItem({});
k.id=e;k.familyId=g;k.level=f;e=0;for(g=this.properties.length;e<g;e+=1)f=this.properties[e],k[f]=null!=h&&void 0!==h[f]?h[f]:b[f];c.add(d,k.id,k);return k};a.famdiagram.FamilyBalance.prototype.recalcLevelsDepth=function(c,b,e,d,g){var f,h,k,l,n,m,q,p,r,t={},u,v,w;e.loopLevels(this,function(y,C){C=new a.orgdiagram.TreeLevelConnectorStackSize;b[y]=C;r=[];e.loopLevelItems(this,y,function(b,e,m){m=[];var k=[];if(!t.hasOwnProperty(b)){t[b]=!0;e.hideChildrenConnection||m.push(b);e=g[b];if(null!=e)for(f=
0,h=e.length;f<h;f+=1){var q=e[f];t[q]=!0;m.push(q)}d.loopChildren(this,b,function(a,b,c){b.hideParentConnection||k.push(a)});if(1<m.length||0<k.length)p=new a.common.VerticalConnectorBundle(m,k),c.push(p),1<m.length&&r.push(p)}});if(0<r.length){w=a.common.pile();k=0;for(l=r.length;k<l;k+=1){p=r[k];v=u=null;n=0;for(m=p.fromItems.length;n<m;n+=1)q=e.getItemPosition(p.fromItems[n]),u=null!=u?Math.min(u,q):q,v=null!=v?Math.max(v,q):q;w.add(u,v,p)}C.parentsStackSize=w.resolve(this,function(a,b,c,f,d){c.fromOffset=
f+1;c.fromStackSize=d})}})};a.famdiagram.FamilyMatrixesExtractor=function(c){this.parent=a.famdiagram.BaseTransformer.prototype;this.parent.constructor.apply(this,arguments)};a.famdiagram.FamilyMatrixesExtractor.prototype=new a.famdiagram.BaseTransformer;a.famdiagram.FamilyMatrixesExtractor.prototype.extract=function(c,b,e,d,g,f){0<b.hasNodes()&&c.enableMatrixLayout&&b.groupBy(this,Math.max(2,c.minimumMatrixSize),function(h,k,l,n){var m=f+=1,q=f+=1,p=b.node(l[0]);p=new a.famdiagram.FamilyItem({id:m,
...
l,m,q,this.getMatrixWidth(c.maximumColumnsInMatrix,l.length))));e[m]=n});return f};a.famdiagram.FamilyMatrixesExtractor.prototype.getMatrixWidth=function(a,b){return Math.min(a,Math.ceil(Math.sqrt(b)))};a.famdiagram.FamilyNormalizer=function(c){this.parent=a.famdiagram.BaseTransformer.prototype;this.parent.constructor.apply(this,arguments)};a.famdiagram.FamilyNormalizer.prototype=new a.famdiagram.BaseTransformer;a.famdiagram.FamilyNormalizer.prototype.normalize=function(c,b,e){if(0<b.hasNodes()){b.loopLevels(this,
1==c.groupByType,function(a,b,c){b.level=c});b.optimizeReferences(function(){e+=1;return new a.famdiagram.FamilyItem({id:e,isVisible:!1,isActive:!1,itemConfig:{title:"bundle #"+e,description:" This item was created by references optimizer."},levelGravity:2})});if(this.debug&&!b.validate())throw"References are broken in family structure!";if(this.debug&&b.hasLoops())throw"Structure has loops!";b.eliminateManyToMany(function(){e+=1;return new a.famdiagram.FamilyItem({id:e,isVisible:!1,isActive:!1,itemConfig:{title:"dummy #"+
e,description:"This is item used to eliminate M:M relations."},levelGravity:2,hideParentConnection:!1,hideChildrenConnection:!1})});if(this.debug&&!b.validate())throw"References are broken in family structure!";c.alignBylevels?this.resortItemsBylevels(b):b.loopLevels(this,1==c.groupByType,function(a,b,c){b.level=c});this.debug&&this.validate(b,!1);this.fillInItems(b,function(){e+=1;return new a.famdiagram.FamilyItem({id:e,levelGravity:2,isVisible:!1,isActive:!1,itemConfig:{title:"extension #"+e,description:"This is item used to fill gaps in levels."}})});
this.debug&&this.validate(b,!0)}return e};a.famdiagram.FamilyNormalizer.prototype.resortItemsBylevels=function(a){var b=[],c=null,d=null,g;a.loop(this,function(a,f){f.originalLevel=f.level;f.level=null;null!=f.originalLevel&&(b[f.originalLevel]||(b[f.originalLevel]={}),b[f.originalLevel][a]=f,c=null!=c?Math.min(f.originalLevel,c):f.originalLevel,d=null!=d?Math.max(f.originalLevel,d):f.originalLevel)});for(g=c;g<=d;g+=1){var f=b[g];this.setLevelsForItems(f,a)}a.loopTopo(this,function(b,c,f){if(1==
c.levelGravity){var d=null;a.loopParents(this,b,function(b,c,f){d=null==d?c.level+1:Math.max(c.level+1,d);return a.SKIP});c.level=d?d:c.level}})};a.famdiagram.FamilyNormalizer.prototype.setLevelsForItems=function(c,b){var e=0,d;for(d in c)c.hasOwnProperty(d)&&b.loopParents(this,d,function(a,c,f){e=Math.max(c.level+1,e);return b.SKIP});for(d in c)if(c.hasOwnProperty(d)){var g=c[d];g.level=e}for(;!a.common.isEmptyObject(c);){var f={};for(d in c)c.hasOwnProperty(d)&&(g=c[d],b.loopChildren(this,d,function(a,
c,d){if(null==c.originalLevel||c.isLevelNeutral)c.level=null==c.level?g.level+1:Math.max(c.level,g.level+1),f[a]=c;return b.SKIP}));c=f}};a.famdiagram.FamilyNormalizer.prototype.fillInItems=function(a,b){var c;a.loop(this,function(d,e){for(var f=!0,h;f;)f=!1,h=[],a.loopParents(this,d,function(b,c,f){e.level-1>c.level&&h.push(b);return a.SKIP}),1<h.length&&(c=b(e),c.level=e.level-1,c.hideParentConnection=!1,c.hideChildrenConnection=!1,a.bundleParents(d,h,c.id,c),f=!0,d=c.id,e=c)});a.loop(this,function(d,
e){for(var f=!0,h,g=!0;f;)f=!1,h=[],a.loopChildren(this,d,function(b,c,f){e.level+1<c.level?h.push(b):g=!1;return a.SKIP}),1<h.length&&(c=b(e),c.level=e.level+1,g&&(c.hideParentConnection=!1,c.hideChildrenConnection=!1),a.bundleChildren(d,h,c.id,c),f=!0,d=c.id,e=c)});a.loop(this,function(d,e){for(var f=!0,h;f;)f=!1,h=[],a.loopParents(this,d,function(b,c,f){e.level-1>c.level&&h.push(b);return a.SKIP}),0<h.length&&(c=b(e),c.level=e.level-1,c.hideParentConnection=!1,c.hideChildrenConnection=!1,a.bundleParents(d,
h,c.id,c),f=!0,d=c.id,e=c)})};a.famdiagram.UserDefinedNodesOrder=function(){};a.famdiagram.UserDefinedNodesOrder.prototype.getUserDefinedPositions=function(c){function b(a,b){this.position=a;this.items=b}var e,d=a.common.tree(),g={};var f=0;for(e=c.length;f<e;f+=1){var h=c[f];null!=h.relativeItem&&(g[h.relativeItem]=!0);null!=h.id&&(g[h.id]=!0)}f=0;for(e=c.length;f<e;f+=1)h=c[f],g.hasOwnProperty(h.id)&&d.add(h.relativeItem||null,h.id,h);var k={},l={},n={};d.loopPostOrder(this,function(a,c,f,d){d=
[];var e=l[a],h=n[a],g;if(null!=e)for(e.sort(function(a,b){return b.position-a.position}),g=0;g<e.length;g+=1)d=d.concat(e[g].items);d.push(a);if(null!=h)for(h.sort(function(a,b){return a.position-b.position}),g=0;g<h.length;g+=1)d=d.concat(h[g].items);null!=f?2==c.placementType?(l.hasOwnProperty(f)||(l[f]=[]),l[f].push(new b(c.position,d))):(n.hasOwnProperty(f)||(n[f]=[]),n[f].push(new b(c.position,d))):k[a]=d});h={};e={};for(var m in k)if(k.hasOwnProperty(m))for(c=k[m],f=0;f<c.length;f+=1)d=c[f],
h[d]=f,e[d]=m;return{position:h,group:e}};a.famdiagram.UserDefinedPrimaryParents=function(){};a.famdiagram.UserDefinedPrimaryParents.prototype.getUserDefinedPrimaryParents=function(a,b){for(var c={},d={},g=0;g<a.length;g+=1){var f=a[g];null!=f.primaryParent&&(d[f.id]=f.primaryParent)}for(var h in d){var k=d[h],l={};for(a=[h];0<a.length;){var n=[];for(g=0;g<a.length;g+=1)h=a[g],b.loopParents(this,h,function(a,f){l[a]=h;if(a==k){for(;null!=l[a];)c[l[a]]=a,a=l[a];n=[];return b.BREAK}0==f.isVisible&&
n.push(a);return b.SKIP});a=n}}return c};a.common.BaseLayout=function(a,b){this._children={};if(null!=this.params)for(var c in this.params)this.params.hasOwnProperty(c)&&a.hasOwnProperty(c)&&(this.params[c]=a[c]);if(null!=this.options){for(c in this.options)this.options.hasOwnProperty(c)&&b.hasOwnProperty(c)&&(this.options[c]=b[c]);this.options.shifts=this.getShifts(this.options);this.options.intervals=this.getIntervals(this.options)}};a.common.BaseLayout.prototype.add=function(a,b){this._children[a]=
b};a.common.BaseLayout.prototype.getLayout=function(a){return this._children[a]||null};a.common.BaseLayout.prototype.getShifts=function(a){var b=[];b[1]=a.normalLevelShift;b[2]=a.dotLevelShift;b[3]=a.lineLevelShift;b[4]=a.lineLevelShift;return b};a.common.BaseLayout.prototype.getIntervals=function(a){var b=[];b[1]=a.normalItemsInterval;b[2]=a.dotItemsInterval;b[3]=a.lineItemsInterval;b[4]=a.lineItemsInterval;return b};a.common.BaseLayout.prototype.getItemSize=function(c,b,e,d){switch(c){case 1:c=
e.template.templateConfig;var g=new a.common.Size(c.itemSize);var f=new a.common.Rect(0,0,g.width,g.height);b&&(g.height+=c.cursorPadding.top+c.cursorPadding.bottom,g.width+=c.cursorPadding.left+c.cursorPadding.right,f.x=c.cursorPadding.left,f.y=c.cursorPadding.top);e.hasSelectorCheckbox&&(g.height+=d.checkBoxPanelSize);if(e.hasButtons)switch(g.width+=d.buttonsPanelSize,d.groupTitlePlacementType){case 3:f.x+=d.buttonsPanelSize}if(e.hasGroupTitle)switch(g.width+=d.groupTitlePanelSize,d.groupTitlePlacementType){case 3:break;
default:f.x+=d.groupTitlePanelSize}break;case 2:c=e.template.templateConfig;g=new a.common.Size(c.minimizedItemSize);break;case 3:case 4:g=new a.common.Size}switch(d.orientationType){case 2:case 3:g.invert()}return{actualSize:g,contentPosition:f}};a.famdiagram.FamilyLayout=function(c,b){this.params={logicalFamily:null,treeLevels:null,getConnectorsStacksSizes:null,isItemSelected:null,cursorItemId:null,getTemplateParams:null};this.options={verticalAlignment:1,pageFitMode:0,minimalVisibility:2,orientationType:0,
arrowsDirection:0,linesWidth:1,checkBoxPanelSize:24,buttonsPanelSize:28,groupTitlePanelSize:24,groupTitlePlacementType:2,normalLevelShift:20,dotLevelShift:20,lineLevelShift:20,normalItemsInterval:10,dotItemsInterval:1,lineItemsInterval:2};this.data={treeItemsPositions:{},treeLevelsPositions:[]};this.parent=a.common.BaseLayout.prototype;this.parent.constructor.apply(this,arguments)};a.famdiagram.FamilyLayout.prototype=new a.common.BaseLayout;a.famdiagram.FamilyLayout.prototype.measure=function(c){var b=
new a.common.Rect(0,0,0,0),e={treeItemsPositions:{},treeLevelsPositions:[]};switch(this.options.orientationType){case 2:case 3:c.invert()}if(!this.params.treeLevels.isEmpty())switch(this.options.pageFitMode){case 0:case a.common.PageFitMode.PrintPreview:case 5:var d=[new a.orgdiagram.LevelVisibility(0,1)];b=this.setTreeLevelsVisibilityAndPositionTreeItems(e,this.params,this.options,d,0);break;default:d=this.getLevelVisibilities(this.params.treeLevels,this.options.minimalVisibility);var g=this.setTreeLevelsVisibilityAndPositionTreeItems(e,
this.params,this.options,d,d.length-1);this.checkDiagramSize(g,c,this.options.pageFitMode)?(g.addRect(c),g.offset(0,0,5,5),this.findOptimalSize(this,d.length-1,function(a){b=this.setTreeLevelsVisibilityAndPositionTreeItems(e,this.params,this.options,d,a);return this.checkDiagramSize(b,g,this.options.pageFitMode)})):b=g}this.data=e;return b};a.famdiagram.FamilyLayout.prototype.getLevelVisibilities=function(c,b){var e=[new a.orgdiagram.LevelVisibility(0,1)],d=[];switch(b){case 2:d.push(2);break;case 0:case 3:case 4:d.push(2),
d.push(3)}c.loopLevelsReversed(this,function(b,c){for(c=0;c<d.length;c+=1)e.push(new a.orgdiagram.LevelVisibility(b,d[c]))});return e};a.famdiagram.FamilyLayout.prototype.findOptimalSize=function(a,b,e){var c=0,g;if(!e.call(a,c)){for(g=b;1<b-c;)g=Math.floor((b+c)/2),e.call(a,g)?b=g:c=g;b!==g&&e.call(a,b)}};a.famdiagram.FamilyLayout.prototype.setTreeLevelsVisibilityAndPositionTreeItems=function(c,b,e,d,g){var f;c.treeLevelsPositions=[];b.treeLevels.loopLevels(this,function(b,f){b=new a.orgdiagram.TreeLevelPosition;
b.currentvisibility=1;c.treeLevelsPositions.push(b)});for(f=0;f<=g;f+=1){var h=d[f];c.treeLevelsPositions[h.level].currentvisibility=h.currentvisibility}c.treeItemsPositions={};this.recalcItemsSize(b.treeLevels,c.treeItemsPositions,c.treeLevelsPositions,b.isItemSelected,b.cursorItemId,b.getTemplateParams,e);this.setOffsets(b.treeLevels,c.treeItemsPositions,c.treeLevelsPositions,b.logicalFamily,e.intervals);this.recalcLevelsDepth(b.treeLevels,c.treeItemsPositions,c.treeLevelsPositions,e.verticalAlignment);
this.shiftLevels(c.treeLevelsPositions,e.shifts[3],e.shifts,e.arrowsDirection,e.linesWidth,b.getConnectorsStacksSizes);return this.getLayoutSize(b.treeLevels,c.treeItemsPositions,c.treeLevelsPositions)};a.famdiagram.FamilyLayout.prototype.checkDiagramSize=function(a,b,e){var c=!1;switch(e){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c};a.famdiagram.FamilyLayout.prototype.getLayoutSize=function(c,b,e){return new a.common.Rect(0,
0,Math.round(this.getLayoutWidth(c,b)),Math.round(this.getLayoutHeight(e)))};a.famdiagram.FamilyLayout.prototype.getLayoutWidth=function(a,b){var c=0;a.loopLevels(this,function(d,e){e=a.getLevelLength(d);0<e&&(d=a.getItemAtPosition(d,e-1),d=b[d],c=Math.max(c,d.offset+d.actualSize.width+d.rightPadding))});return c};a.famdiagram.FamilyLayout.prototype.getLayoutHeight=function(a){a=a[a.length-1];return a.shift+a.nextLevelShift};a.famdiagram.FamilyLayout.prototype.recalcItemsSize=function(c,b,e,d,g,f,
h){c.loopLevels(this,function(k,l){var n=e[k];c.loopLevelItems(this,k,function(c,e,k){k=new a.orgdiagram.TreeItemPosition;var m=this.getLayout(c);null==m?(m=d(c)?1:e.isVisible?0:4,e=f(c),m=0===m?n.currentvisibility:m,e=this.getItemSize(m,g==c,e,h),k.actualVisibility=m,k.actualSize=e.actualSize,k.contentPosition=e.contentPosition):(e=m.measure(n.currentvisibility),k.actualVisibility=4,k.actualSize=e);b[c]=k})})};a.famdiagram.FamilyLayout.prototype.recalcLevelsDepth=function(a,b,e,d){var c,f;a.loopLevels(this,
function(h,g){var k=e[h];k.shift=0;k.depth=0;k.actualVisibility=4;f=c=null;a.loopLevelItems(this,h,function(a,d,e){a=b[a];k.depth=Math.max(k.depth,a.actualSize.height);switch(a.actualVisibility){case 2:case 3:case 4:f=f?Math.min(f,a.actualSize.height):a.actualSize.height;break;default:c=c?Math.min(c,a.actualSize.height):a.actualSize.height}k.actualVisibility=Math.min(k.actualVisibility,a.actualVisibility)});null==c&&(c=k.depth);null!=f&&f>c&&(c=f);switch(d){case 0:k.horizontalConnectorsDepth=c/2;
break;case 1:k.horizontalConnectorsDepth=k.depth/2;break;case 2:k.horizontalConnectorsDepth=k.depth-c/2}})};a.famdiagram.FamilyLayout.prototype.shiftLevels=function(a,b,e,d,g,f){var c=0,k=0;g*=8;switch(d){case 1:c=g;k=0;break;case 2:c=0,k=g}d=0;for(g=a.length;d<g;d+=1){var l=a[d];var n=f(d);b+=l.setShift(b,e[l.actualVisibility],k,c,n.parentsStackSize)}};a.famdiagram.FamilyLayout.prototype.setOffsets=function(c,b,e,d,g){var f;var h=0;for(f=e.length;h<f;h+=1)e[h].currentOffset=0;e=d.getPlanarFamily(c);
var k=new a.common.FamilyAlignment(this,e,c,function(a,c){a=b[a];c=g[a.actualVisibility]/2;a.leftPadding=c;a.rightPadding=c;return a.leftPadding+a.actualSize.width+a.rightPadding}),l=null;c.loopLevels(this,function(a,f){a=c.getItemAtPosition(a,0);null!=a&&(f=b[a],a=k.getOffset(a)-f.leftPadding-f.actualSize.width/2,l=null==l?a:Math.min(l,a))});c.loopLevels(this,function(a,f){c.loopLevelItems(this,a,function(a,c,f){c=b[a];a=k.getOffset(a);c.offset=a-c.actualSize.width/2;c.offset-=l})})};a.famdiagram.FamilyLayout.prototype.arrange=
function(a,b){var c=null;null!=b&&this.params.treeLevels.loopLevels(this,function(d,e){var f=this.data.treeLevelsPositions[d];this.params.treeLevels.loopLevelItems(this,d,function(d,e,g){g=this.data.treeItemsPositions[d];e=this.getItemPosition(g.actualVisibility,g.offset,g.actualSize,c,f,this.options.verticalAlignment);g.actualPosition=e.position;g.horizontalConnectorsShift=e.horizontalConnectorsShift;g.topConnectorShift=e.topConnectorShift;g.topConnectorInterval=e.topConnectorInterval;g.bottomConnectorShift=
e.bottomConnectorShift;g.bottomConnectorInterval=e.bottomConnectorInterval;b.call(a,d,g);d=this.getLayout(d);null!=d&&d.arrange(a,e.position,b)});c=f})};a.famdiagram.FamilyLayout.prototype.getItemPosition=function(c,b,e,d,g,f){var h=0;switch(c){case 1:switch(f){case 0:h=0;break;case 1:h=(g.depth-e.height)/2;break;case 2:h=g.depth-e.height}break;case 2:case 3:case 4:h=g.horizontalConnectorsDepth-e.height/2}return{position:new a.common.Rect(b,g.shift+h,e.width,e.height),horizontalConnectorsShift:g.shift+
g.horizontalConnectorsDepth,topConnectorShift:null!=d?d.shift+d.connectorShift:null,topConnectorInterval:null!=d?d.levelSpace/2:null,bottomConnectorShift:g.shift+g.connectorShift,bottomConnectorInterval:g.levelSpace/2}};a.famdiagram.MatrixLayout=function(c,b){this.params={items:[],isItemSelected:null,cursorItemId:null,getTemplateParams:null,hideParentConnection:!1,hideChildrenConnection:!1};this.options={verticalAlignment:1,orientationType:0,arrowsDirection:0,linesWidth:1,checkBoxPanelSize:24,buttonsPanelSize:28,
...
this.data=b;return this.getLayoutSize(b)};a.famdiagram.MatrixLayout.prototype.measureItems=function(c,b,e,d){for(var g=0,f=b.items.length;g<f;g+=1){var h=b.items[g],k=h.id,l=new a.orgdiagram.TreeItemPosition,n=b.isItemSelected(k)?1:h.isVisible?0:4;h=b.getTemplateParams(k);n=0===n?d:n;h=this.getItemSize(n,b.cursorItemId==k,h,e);l.actualVisibility=n;l.actualSize=h.actualSize;l.contentPosition=h.contentPosition;c.treeItemsPositions[k]=l}};a.famdiagram.MatrixLayout.prototype.measureColumns=function(a,
b,e){var c,g=this.getMatrixWidth(e.maximumColumnsInMatrix,b.items.length);var f=0;for(c=b.items.length;f<c;f+=1){var h=a.treeItemsPositions[b.items[f].id];var k=e.intervals[h.actualVisibility]/2;h.leftPadding=k;h.rightPadding=k;var l=f%g;k=a.columns[l];null==k&&(k=new this.Column,a.columns[l]=k);k.depth=Math.max(k.depth,h.leftPadding+h.actualSize.width+h.rightPadding)}g=8*e.linesWidth;f=h=0;for(c=a.columns.length;f<c;f+=1){k=a.columns[f];if(0==f%2)switch(e.arrowsDirection){case 1:k.leftPadding=b.hideChildrenConnection?
...
1){var h=a.treeItemsPositions[b.items[f].id],k=Math.floor(f/g),l=e.shifts[h.actualVisibility]/2;var n=a.rows[k];null==n&&(n=new this.Row,a.rows[k]=n);n.depth=Math.max(n.depth,l+h.actualSize.height+l);switch(h.actualVisibility){case 2:case 3:case 4:n.dotsDepth=n.dotsDepth?Math.min(n.dotsDepth,h.actualSize.height):h.actualSize.height;break;default:n.minimalDepth=n.minimalDepth?Math.min(n.minimalDepth,h.actualSize.height):h.actualSize.height}}f=b=0;for(c=a.rows.length;f<c;f+=1)switch(n=a.rows[f],n.offset=
b+n.depth/2,b=n.offset+n.depth/2,null==n.minimalDepth&&(n.minimalDepth=n.depth),null!=n.dotsDepth&&n.dotsDepth>n.minimalDepth&&(n.minimalDepth=n.dotsDepth),e.verticalAlignment){case 0:n.horizontalConnectorsDepth=n.minimalDepth/2;break;case 1:n.horizontalConnectorsDepth=n.depth/2;break;case 2:n.horizontalConnectorsDepth=n.depth-n.minimalDepth/2}};a.famdiagram.MatrixLayout.prototype.getLayoutSize=function(c){return new a.common.Rect(0,0,Math.round(this.getLayoutWidth(c)),Math.round(this.getLayoutHeight(c)))};
a.famdiagram.MatrixLayout.prototype.getLayoutWidth=function(a){var b=0,c=a.columns.length;0<c&&(a=a.columns[c-1],b=a.offset+a.depth/2+a.rightPadding);return b};a.famdiagram.MatrixLayout.prototype.getLayoutHeight=function(a){var b=0,c=a.rows.length;0<c&&(a=a.rows[c-1],b=a.offset+a.depth/2);return b};a.famdiagram.MatrixLayout.prototype.arrange=function(a,b,e){if(null!=e)for(var c=this.getMatrixWidth(this.options.maximumColumnsInMatrix,this.params.items.length),g=0,f=this.params.items.length;g<f;g+=
1){var h=this.params.items[g].id,k=this.data.columns[g%c],l=this.data.rows[Math.floor(g/c)],n=this.data.treeItemsPositions[h],m=this.getItemPosition(n.actualVisibility,k,l,n.actualSize,this.options);m.translate(b.x,b.y);n.actualPosition=m;n.horizontalConnectorsShift=b.y+l.offset-l.depth/2+l.horizontalConnectorsDepth;n.leftMedianOffset=k.depth/2+k.leftPadding;n.rightMedianOffset=k.depth/2+k.rightPadding;n.topConnectorShift=l.depth/2;n.bottomConnectorShift=l.depth/2;e.call(a,h,n)}};a.famdiagram.MatrixLayout.prototype.getItemPosition=
function(c,b,e,d,g){var f=0;switch(c){case 1:switch(g.verticalAlignment){case 0:f=0;break;case 1:f=(e.depth-d.height)/2;break;case 2:f=e.depth-d.height}break;case 2:case 3:case 4:f=e.horizontalConnectorsDepth-d.height/2}return new a.common.Rect(b.offset-d.width/2,e.offset-e.depth/2+f,d.width,d.height)};a.famdiagram.CursorNeighboursTask=function(c,b,e,d){function g(a,b,c,f){var d=[],e={};if(null!==a)switch(b){case 0:c.loopParents(this,a,function(a,b){e.hasOwnProperty(a)||(e[a]=!0,d.push(a));if(f.hasOwnProperty(a))return c.SKIP});
c.loopChildren(this,a,function(a,b){e.hasOwnProperty(a)||(e[a]=!0,d.push(a));if(f.hasOwnProperty(a))return c.SKIP});break;case 1:c.loopNeighbours(this,a,function(a,b){e.hasOwnProperty(a)||(e[a]=!0,d.push(a));if(f.hasOwnProperty(a))return!0})}return d}var f=[],h={},k=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:h},n=c.getCursorTreeItem(),m=e.getNavigationFamily(),q=b.getNeighboursSelectionMode(),p=d.getActiveItems();
f=k.read(f,g(n,q,m,p),"items",a);return a.isChanged},getItems:function(){return f}}};a.famdiagram.AddLabelAnnotationsTask=function(c,b){function e(b,c){var f=a.common.graph(),e={},h,g;if(0<c.length){var k=0;for(g=c.length;k<g;k+=1){var r=c[k];e.hasOwnProperty(r.fromItem)?e[r.fromItem].push(r):(e[r.fromItem]=[r],b.loopChildren(this,r.fromItem,function(c,d,e){f.addEdge(r.fromItem,c,new a.famdiagram.EdgeItem(r.fromItem,r.fromItem,c,c));return b.SKIP}),b.loopParents(this,r.fromItem,function(c,d,e){f.addEdge(c,
r.fromItem,new a.famdiagram.EdgeItem(c,c,r.fromItem,r.fromItem));return b.SKIP}))}for(h in e)if(e.hasOwnProperty(h))for(c=e[h],c.sort(function(a,b){return b.toItems.length-a.toItems.length}),k=0;k<c.length;k+=1)r=c[k],d(b,f,r.fromItem,r.toItems,function(){return new a.famdiagram.FamilyItem({id:r.id,isVisible:!0,isLevelNeutral:!0,isActive:!1,itemConfig:r})})}}function d(a,b,c,f,d){var e=!0,h=null,g,m=[];var k=0;for(g=f.length;k<g;k+=1){var l=f[k];var n=b.edge(c,l);if(null!=n){if(null==h)h=n.getFar(l);
else if(h!=n.getFar(l)){e=!1;break}m.push(n.getNear(l))}else{e=!1;break}}if(e&&(d=d(),a.bundleParents(h,m,d.id,d)?(d.levelGravity=2,e=!0):a.bundleChildren(h,m,d.id,d)?(d.levelGravity=1,e=!0):a.bundleParents(h,f,d.id,d)?(d.levelGravity=2,e=!0):a.bundleParents(h,f,d.id,d)&&(d.levelGravity=1,e=!0),e))for(k=0,g=f.length;k<g;k+=1)l=f[k],n=b.edge(c,l),n.setFar(l,d.id)}var g=null,f=null;return{process:function(a){var d=b.getLogicalFamily(),h=c.getAnnotations();d=d.clone();e(d,h);g=d;f=c.getMaximumId();if(a&&
!d.validate())throw"References are broken in family structure!";return!0},getNavigationFamily:function(){return g},getMaximumId:function(){return f}}};a.famdiagram.AddSpousesTask=function(c,b){var e=null,d=null;return{process:function(g){var f=b.getLogicalFamily(),h=b.getMaximumId(),k=c.getItems(),l=f=f.clone(),n,m;var q=0;for(n=k.length;q<n;q+=1){var p=k[q];var r=p.spouses.slice(0);var t=0;for(m=r.length;t<m;t+=1){var u=[p.id,r[t]];if(!l.hasCommonChild(u)){h+=1;var v=new a.famdiagram.FamilyItem({id:h,
isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+h,description:"This is fake child keeps spouses together."},levelGravity:1});l.add(u,v.id,v)}}}e=f;d=h;if(g&&!f.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return e},getMaximumId:function(){return d}}};a.famdiagram.HideGrandParentsConnectorsTask=function(a,b){var c=null,d=null;return{process:function(e){e=b.getLogicalFamily();
var f=b.getMaximumId();d=e=1==a.getOptions().hideGrandParentsConnectors?e.getFamilyWithoutGrandParentsRelations():e.clone();c=f;return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return c}}};a.famdiagram.ItemsPositionsTask=function(c,b,e,d,g,f,h,k,l,n){var m={},q=null;return{process:function(){var p=d.getOptions(),r=g.getOptions(),t=f.getOptions(),u={logicalFamily:h.getLogicalFamily(),treeLevels:h.getTreeLevels(),getConnectorsStacksSizes:h.getConnectorsStacksSizes,isItemSelected:n.isItemSelected,
cursorItemId:l.getCursorTreeItem(),getTemplateParams:k.getTemplateParams};p={verticalAlignment:p.verticalAlignment,pageFitMode:p.pageFitMode,minimalVisibility:p.minimalVisibility,normalLevelShift:p.normalLevelShift,dotLevelShift:p.dotLevelShift,lineLevelShift:p.lineLevelShift,normalItemsInterval:p.normalItemsInterval,dotItemsInterval:p.dotItemsInterval,lineItemsInterval:p.lineItemsInterval,orientationType:e.getOptions().orientationType,arrowsDirection:r.arrowsDirection,linesWidth:r.linesWidth,checkBoxPanelSize:p.checkBoxPanelSize,
buttonsPanelSize:p.buttonsPanelSize,groupTitlePanelSize:p.groupTitlePanelSize,groupTitlePlacementType:p.groupTitlePlacementType,maximumColumnsInMatrix:t.maximumColumnsInMatrix};r=c.getOptimalPanelSize();t=b.getOptions().scale;r.scale(1/t);r=new a.common.Rect(0,0,r.width,r.height);t=new a.famdiagram.FamilyLayout(u,p);var v=h.getMatrixes(),w;for(w in v)if(v.hasOwnProperty(w)){var y=u.logicalFamily.node(w);t.add(w,new a.famdiagram.MatrixLayout({items:v[w],isItemSelected:u.isItemSelected,cursorItemId:u.cursorItemId,
getTemplateParams:u.getTemplateParams,hideParentConnection:y.hideParentConnection,hideChildrenConnection:y.hideChildrenConnection},p))}q=t.measure(r);m={};t.arrange(this,function(a,b){m[a]=b});return!0},getItemsPositions:function(){return m},getItemPosition:function(a){return m[a]},getContentSize:function(){return q}}};a.famdiagram.LogicalFamilyTask=function(c){var b=null,e=null;return{process:function(d){var g,f=c.getItems(),h=a.common.family(),k=0;if(0<f.length){var l=0;for(g=f.length;l<g;l+=1){var n=
f[l];if(null!=n){var m=new a.famdiagram.FamilyItem({id:n.id,itemConfig:n,isActive:n.isActive});h.add(n.parents,m.id,m);n=parseInt(n.id,10);k=Math.max(isNaN(n)?0:n,k)}}}b=h;e=k;if(d&&!h.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return b},getMaximumId:function(){return e}}};a.famdiagram.NormalizeLogicalFamilyTask=function(c,b){var e=null,d=null,g=new a.famdiagram.FamilyNormalizer(!1);return{process:function(a){a=b.getLogicalFamily();var f=b.getMaximumId(),
k=c.getOptions();k={groupByType:k.groupByType,alignBylevels:k.alignBylevels};a=a.clone();f=g.normalize(k,a,f);d=a;e=f;return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return e}}};a.famdiagram.OrderFamilyNodesTask=function(c,b,e,d){var g=null,f=null,h={},k={},l=null,n=null,m=null,q=new a.famdiagram.FamilyBalance,p=new a.famdiagram.FamilyMatrixesExtractor(!1),r=new a.famdiagram.UserDefinedPrimaryParents,t=new a.orgdiagram.TreeLevelConnectorStackSize;return{process:function(a){a=
e.getLogicalFamily();var t=e.getMaximumId(),u={},y={},C=[],E=c.getOptions(),F={enableMatrixLayout:E.enableMatrixLayout,minimumMatrixSize:E.minimumMatrixSize,maximumColumnsInMatrix:E.maximumColumnsInMatrix};a=a.clone();t=p.extract(F,a,u,y,C,t);f=a;h=u;k=y;n=C;a={logicalFamily:a,maximumId:t,defaultItemConfig:d,itemsPositions:b.getPositions(),itemsGroups:b.getGroups(),primaryParents:r.getUserDefinedPrimaryParents(E.items,a)};a=q.balance(a);g=a.maximumId;l=a.treeLevels;n=n.concat(a.bundles);m=a.connectorStacks;
return!0},getLogicalFamily:function(){return f},getMatrixes:function(){return h},getNestedLayoutBottomConnectorIds:function(){return k},getMaximumId:function(){return g},getTreeLevels:function(){return l},getBundles:function(){return n},getConnectorsStacksSizes:function(a){return m[a]||t}}};a.famdiagram.RemoveLoopsTask=function(c,b){function e(b,c,d,e){var f,h;var g=c.clone();c.loopTopo(this,function(a,b,c){g.removeNode(a)});if(g.hasNodes()){var k=0;for(f=b.length;k<f;k+=1){var l=b[k];if(null!=g.node(l.id)){var t=
[];g.loopParents(this,l.id,function(a,b,c){t.push(a);return g.SKIP});var u=0;for(h=t.length;u<h;u+=1)g.removeRelation(t[u],l.id),c.removeRelation(t[u],l.id);d+=1;e=new a.famdiagram.FamilyItem({id:d,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake parent #"+d,description:"This is fake parent item was created by loops reversal."}});c.add([],e.id,e);c.adopt([e.id],l.id);u=0;for(h=t.length;u<h;u+=1)d+=1,l=new a.famdiagram.FamilyItem({id:d,
isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+d,description:"This is fake child item was created by loops reversal."}}),c.add([e.id,t[u]],l.id,l);var v=[];g.loopTopo(this,function(a,b,c){v.push(a)});u=0;for(h=v.length;u<h;u+=1)g.removeNode(v[u])}}}return d}var d=null,g=null;return{process:function(a){var f=b.getNavigationFamily(),k=b.getMaximumId(),l=c.getItems();f=f.clone();k=e(l,f,k,a);d=f;g=k;if(a&&!f.validate())throw"References are broken in family structure!";
return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return g}}};a.famdiagram.UserDefinedNodesOrderTask=function(c){var b=null,e=null,d=new a.famdiagram.UserDefinedNodesOrder;return{process:function(){var a=c.getOptions();a=d.getUserDefinedPositions(a.items);b=a.position;e=a.group;return!0},getPositions:function(){return b},getGroups:function(){return e}}};a.famdiagram.Control=function(c,b){return a.orgdiagram.BaseControl(c,b,a.famdiagram.TaskManagerFactory,a.famdiagram.EventArgsFactory,
{AnnotationLabelTemplate:a.common.AnnotationLabelTemplate,ButtonsTemplate:a.common.ButtonsTemplate,CheckBoxTemplate:a.common.CheckBoxTemplate,CursorTemplate:a.common.CursorTemplate,DotHighlightTemplate:a.common.DotHighlightTemplate,GroupTitleTemplate:a.common.GroupTitleTemplate,HighlightTemplate:a.common.HighlightTemplate,ItemTemplate:a.common.ItemTemplate,UserTemplate:a.common.UserTemplate,LabelAnnotationTemplate:a.common.LabelAnnotationTemplate})};a.famdiagram.EventArgsFactory=function(c,b,e,d){var g=
new a.famdiagram.EventArgs,f=c.tasks.getTask("CombinedContextsTask"),h=c.tasks.getTask("AlignDiagramTask"),k=c.tasks.getTask("LogicalFamilyTask");b=f.getConfig(b);var l=f.getConfig(e),n=k.getLogicalFamily();b&&null!=b.id&&(g.oldContext=b);l&&null!=l.id&&(g.context=l,n.loopParents(this,l.id,function(a,b,c){if(0<c)return n.BREAK;g.parentItems.push(f.getConfig(a))}),n.loopChildren(this,l.id,function(a,b,c){if(0<c)return n.BREAK;g.childrenItems.push(f.getConfig(a))}),k=a.common.getElementOffset(c.layout.mousePanel),
c=a.common.getElementOffset(c.layout.element),e=h.getItemPosition(e),g.position=(new a.common.Rect(e.actualPosition)).translate(k.left,k.top).translate(-c.left,-c.top));null!=d&&(g.name=d);return g};a.famdiagram.getProcessDiagramConfig=function(){var c=function(){};return a.famdiagram.TaskManagerFactory(c,c,c).getProcessDiagramConfig()};a.famdiagram.TaskManagerFactory=function(c,b,e,d,g){var f=new a.common.TaskManager;f.addDependency("options",c);f.addDependency("graphics",b);f.addDependency("getLayout",
e);f.addDependency("setLayout",d);f.addDependency("templates",g);f.addDependency("defaultConfig",new a.famdiagram.Config);f.addDependency("defaultItemConfig",new a.famdiagram.ItemConfig);f.addDependency("defaultTemplateConfig",new a.famdiagram.TemplateConfig);f.addDependency("defaultButtonConfig",new a.famdiagram.ButtonConfig);f.addDependency("defaultPaletteItemConfig",new a.famdiagram.PaletteItemConfig);f.addDependency("defaultBackgroundAnnotationConfig",new a.famdiagram.BackgroundAnnotationConfig);
f.addDependency("defaultConnectorAnnotationConfig",new a.famdiagram.ConnectorAnnotationConfig);f.addDependency("defaultHighlightPathAnnotationConfig",new a.famdiagram.HighlightPathAnnotationConfig);f.addDependency("defaultShapeAnnotationConfig",new a.famdiagram.ShapeAnnotationConfig);f.addDependency("defaultLabelAnnotationConfig",new a.famdiagram.LabelAnnotationConfig);f.addDependency("isFamilyChartMode",!0);f.addDependency("showElbowDots",!0);f.addDependency("null",null);f.addDependency("foreground",
2);f.addDependency("background",1);f.addTask("OptionsTask",["options"],a.famdiagram.OptionsTask,"#000000");f.addTask("LayoutOptionsTask",["getLayout","OptionsTask"],a.orgdiagram.LayoutOptionsTask,"#000000");f.addTask("CurrentControlSizeTask",["LayoutOptionsTask","ItemsSizesOptionTask"],a.orgdiagram.CurrentControlSizeTask,"#000000");f.addTask("CurrentScrollPositionTask",["LayoutOptionsTask"],a.orgdiagram.CurrentScrollPositionTask,"#000000");f.addTask("CalloutOptionTask",["OptionsTask","defaultConfig",
"defaultItemConfig"],a.orgdiagram.CalloutOptionTask,"#000080");f.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ConnectorsOptionTask,"#000080");f.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.ItemsOptionTask,"#000080");f.addTask("ItemsContentOptionTask",["OptionsTask","defaultItemConfig"],a.orgdiagram.ItemsContentOptionTask,"#000080");f.addTask("SpousesOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.SpousesOptionTask,"#000080");
f.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],a.orgdiagram.ItemsSizesOptionTask,"#000080");f.addTask("LabelsOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.LabelsOptionTask,"#000080");f.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],a.orgdiagram.TemplatesOptionTask,"#000080");f.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.OrientationOptionTask,
"#000080");f.addTask("VisualTreeOptionTask",["OptionsTask"],a.famdiagram.VisualTreeOptionTask,"#000080");f.addTask("MinimizedItemsOptionTask",["OptionsTask"],a.orgdiagram.MinimizedItemsOptionTask,"#000080");f.addTask("HideGrandParentsConnectorsOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.HideGrandParentsConnectorsOptionTask,"#000080");f.addTask("NormalizeOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.NormalizeOptionTask,"#000080");f.addTask("OrderFamilyNodesOptionTask",["OptionsTask",
...
"#000080");f.addTask("CursorSelectionPathModeOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.CursorSelectionPathModeOptionTask,"#000080");f.addTask("NeighboursSelectionModeOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.NeighboursSelectionModeOptionTask,"#000080");f.addTask("SplitAnnotationsOptionTask",["OptionsTask"],a.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");f.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],
a.orgdiagram.ShapeAnnotationOptionTask,"#000080");f.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");f.addTask("ForegroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");f.addTask("BackgroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask",
"defaultHighlightPathAnnotationConfig","background"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");f.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");f.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");f.addTask("BackgroundAnnotationOptionTask",
["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],a.orgdiagram.BackgroundAnnotationOptionTask,"#000080");f.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ScaleOptionTask,"#000080");f.addTask("UserDefinedNodesOrderTask",["OrderFamilyNodesOptionTask","defaultItemConfig"],a.famdiagram.UserDefinedNodesOrderTask,"#ff0000");f.addTask("LogicalFamilyTask",["ItemsOptionTask"],a.famdiagram.LogicalFamilyTask,"#00ffff");f.addTask("LabelAnnotationOptionTask",["SplitAnnotationsOptionTask",
"LogicalFamilyTask","defaultLabelAnnotationConfig"],a.famdiagram.LabelAnnotationOptionTask,"#000080");f.addTask("LabelAnnotationTemplateOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],a.famdiagram.LabelAnnotationTemplateOptionTask,"#000080");f.addTask("LabelAnnotationPlacementOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],a.famdiagram.LabelAnnotationPlacementOptionTask,"#000080");f.addTask("CombinedContextsTask",["ItemsContentOptionTask","LabelAnnotationOptionTask"],
a.orgdiagram.CombinedContextsTask,"#00ffff");f.addTask("AddLabelAnnotationsTask",["LabelAnnotationPlacementOptionTask","LogicalFamilyTask"],a.famdiagram.AddLabelAnnotationsTask,"#ff0000");f.addTask("RemoveLoopsTask",["ItemsOptionTask","AddLabelAnnotationsTask"],a.famdiagram.RemoveLoopsTask,"#ff0000");f.addTask("AddSpousesTask",["SpousesOptionTask","RemoveLoopsTask"],a.famdiagram.AddSpousesTask,"#ff0000");f.addTask("HideGrandParentsConnectorsTask",["HideGrandParentsConnectorsOptionTask","AddSpousesTask"],
a.famdiagram.HideGrandParentsConnectorsTask,"#ff0000");f.addTask("NormalizeLogicalFamilyTask",["NormalizeOptionTask","HideGrandParentsConnectorsTask"],a.famdiagram.NormalizeLogicalFamilyTask,"#ff0000");f.addTask("OrderFamilyNodesTask",["OrderFamilyNodesOptionTask","UserDefinedNodesOrderTask","NormalizeLogicalFamilyTask","defaultItemConfig"],a.famdiagram.OrderFamilyNodesTask,"#ff0000");f.addTask("ReadTemplatesTask",["TemplatesOptionTask","templates"],a.orgdiagram.ReadTemplatesTask,"#00ffff");f.addTask("ActiveItemsTask",
["ItemsSizesOptionTask","ReadTemplatesTask"],a.orgdiagram.ActiveItemsTask,"#00ffff");f.addTask("ItemTemplateParamsTask",["ItemsSizesOptionTask","CursorItemOptionTask","ReadTemplatesTask"],a.orgdiagram.ItemTemplateParamsTask,"#00ffff");f.addTask("LabelAnnotationTemplateParamsTask",["ItemsSizesOptionTask","LabelAnnotationTemplateOptionTask","ReadTemplatesTask"],a.famdiagram.LabelAnnotationTemplateParamsTask,"#00ffff");f.addTask("CombinedTemplateParamsTask",["ItemTemplateParamsTask","LabelAnnotationTemplateParamsTask"],
a.famdiagram.CombinedTemplateParamsTask,"#00ffff");f.addTask("GroupTitleTemplateTask",["TemplatesOptionTask","templates"],a.orgdiagram.GroupTitleTemplateTask,"#00ffff");f.addTask("CheckBoxTemplateTask",["ItemsSizesOptionTask","templates"],a.orgdiagram.CheckBoxTemplateTask,"#00ffff");f.addTask("ButtonsTemplateTask",["ItemsSizesOptionTask","templates"],a.orgdiagram.ButtonsTemplateTask,"#00ffff");f.addTask("AnnotationLabelTemplateTask",["ItemsOptionTask","templates"],a.orgdiagram.AnnotationLabelTemplateTask,
"#00ffff");f.addTask("ConnectionsGraphTask",["graphics","CreateTransformTask","ConnectorsOptionTask","OrderFamilyNodesTask","AlignDiagramTask"],a.orgdiagram.ConnectionsGraphTask,"#00ffff");f.addTask("HighlightItemTask",["HighlightItemOptionTask","ActiveItemsTask"],a.orgdiagram.HighlightItemTask,"#00ffff");f.addTask("CursorItemTask",["CursorItemOptionTask","ActiveItemsTask"],a.orgdiagram.CursorItemTask,"#00ffff");f.addTask("CursorNeighboursTask",["CursorItemTask","NeighboursSelectionModeOptionTask",
"AddLabelAnnotationsTask","ActiveItemsTask"],a.famdiagram.CursorNeighboursTask,"#00ffff");f.addTask("SelectedItemsTask",["SelectedItemsOptionTask"],a.orgdiagram.SelectedItemsTask,"#00ffff");f.addTask("SelectionPathItemsTask",["AddLabelAnnotationsTask","CursorItemTask","SelectedItemsTask","CursorSelectionPathModeOptionTask"],a.orgdiagram.SelectionPathItemsTask,"#00ffff");f.addTask("NormalVisibilityItemsByForegroundShapeAnnotationTask",["ForegroundShapeAnnotationOptionTask"],a.orgdiagram.NormalVisibilityItemsByAnnotationTask,
...
c[b])}};a.orgdiagram.EventArgs=function(){this.name=this.position=this.parentItem=this.context=this.oldContext=null;this.cancel=!1};a.common.BaseConnectorBundle=function(){this.NORMAL_ITEM_WEIGHT=10010;this.LINE_ITEM_WEIGHT=1E4};a.common.BaseConnectorBundle.prototype.trace=function(a,b,e){};a.common.BaseConnectorBundle.prototype.getId=function(a){var b="_"+a.nodeid;a.nodeid+=1;return b};a.common.BaseConnectorBundle.prototype.ConnectorEdge=function(a,b,e,d,g,f,h,k,l,n){this.polyline=e;this.from=a;
this.to=b;this.weight=h||0;this.fromOffset=k||0;this.parentsArrowId=d;this.childrenArrowId=g;this.dotId=f;this.hasMiddle=l;this.middleParent=n};a.common.BaseConnectorBundle.prototype.ConnectorDestination=function(a){this.bundleid=this.y=this.x=this.id=null;this.hasElbow=!1;this.visibility=this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])};a.common.BaseConnectorBundle.prototype.traceFork=function(c,b,e,d,g,f,h,k,l){var n,m,q=[];if(f){q=[];f=
0;for(m=g.length;f<m;f+=1){var p=g[f];if(p.x<d.x&&!p.isSquared)q.push(p);else break}m=q.length;0<m&&(p=q[m-1],p=p.x==d.x?d:new this.ConnectorDestination({id:p.bundleid,x:p.x,y:d.y}),this.traceAngularSegments(c,b,e,p,q,!1));q=[];for(n=g.length-1;n>=f;--n)if(p=g[n],p.x>d.x&&!p.isSquared)q.push(p);else break;m=q.length;0<m&&(p=q[m-1],p=p.x==d.x?d:new this.ConnectorDestination({id:p.bundleid,x:p.x,y:d.y}),this.traceAngularSegments(c,b,e,p,q,!1));for(q=f;q<=n;q+=1){p=g[q];m=e.bevelSize;2>m&&(m=0);if(b.hasGraphics)switch(e.elbowType){case 2:case 3:0<
m&&Math.abs(d.x-p.x)>m&&Math.abs(d.y-p.y)>m&&(p.hasElbow=!0,p.elbowPoint1=new a.common.Point(p.x,d.y+(d.y>p.y?-m:m)),p.elbowPoint2=new a.common.Point(p.x+(d.x>p.x?m:-m),d.y))}var r=new a.common.Polyline;p.hasElbow?(b.transform.transform3Points(p.elbowPoint2.x,p.elbowPoint2.y,p.elbowPoint1.x,p.elbowPoint2.y,p.elbowPoint1.x,p.elbowPoint1.y,!0,this,function(b,c,f,d,h,g){switch(e.elbowType){case 2:r.addSegment(new a.common.MoveSegment(b,c));r.addSegment(new a.common.LineSegment(h,g));break;case 3:r.addSegment(new a.common.MoveSegment(b,
c)),r.addSegment(new a.common.CubicArcSegment(b,c,f,d,h,g))}}),b.transform.transformPoints(p.elbowPoint1.x,p.elbowPoint1.y,p.x,p.y,!0,this,function(b,c,f,d){r.addSegment(new a.common.LineSegment(f,d))})):b.transform.transformPoints(p.x,d.y,p.x,p.y,!0,this,function(b,c,f,d){r.addSegment(new a.common.MoveSegment(b,c));r.addSegment(new a.common.LineSegment(f,d))});m=p.x==d.x?d.id:p.bundleid;var t=4!==p.visibility;c.graph.addEdge(m,p.id,new this.ConnectorEdge(m,p.id,r,h&&t?p.id:null,!h&&t?p.id:null,null,
t?this.NORMAL_ITEM_WEIGHT:this.LINE_ITEM_WEIGHT,k))}f=Math.max(f-1,0);n=Math.min(n+1,g.length-1);p=d;m=d.id;for(q=f;q<=n;q+=1){t=g[q];var u=t.bundleid;t.x>p.x&&(r=new a.common.Polyline,b.transform.transformPoints(p.x,d.y,null!=t.elbowPoint2?t.elbowPoint2.x:t.x,d.y,!0,this,function(b,c,f,d){r.addSegment(new a.common.MoveSegment(b,c));r.addSegment(new a.common.LineSegment(f,d))}),c.graph.addEdge(m,u,new this.ConnectorEdge(m,u,r,null,null,m,Math.abs(t.x-p.x)/1E4,k,l,h?u:m)),p=t.elbowPoint2||t,m=u)}p=
d;m=d.id;for(q=n;q>=f;--q)t=g[q],u=t.bundleid,t.x<p.x&&(r=new a.common.Polyline,b.transform.transformPoints(p.x,d.y,null!=t.elbowPoint2?t.elbowPoint2.x:t.x,d.y,!0,this,function(b,c,f,d){r.addSegment(new a.common.MoveSegment(b,c));r.addSegment(new a.common.LineSegment(f,d))}),c.graph.addEdge(m,u,new this.ConnectorEdge(m,u,r,null,null,m,Math.abs(t.x-p.x)/1E4,k,l,h?u:m)),p=t.elbowPoint2||t,m=u)}else this.traceAngularSegments(c,b,e,d,g,!0)};a.common.BaseConnectorBundle.prototype.traceAngularSegments=
function(c,b,e,d,g,f){var h;var k=0;for(h=g.length;k<h;k+=1){var l=g[k];var n=new a.common.Polyline;b.transform.transformPoint(d.x,d.y,!0,this,function(b,c){n.addSegment(new a.common.MoveSegment(b,c))});switch(e.connectorType){case 1:b.transform.transformPoint(l.x,l.y,!0,this,function(b,c){n.addSegment(new a.common.LineSegment(b,c))});break;case 2:var m=new a.common.Rect(d,l);f?d.x>m.x?b.transform.transform3Points(m.right(),m.verticalCenter(),m.x,m.verticalCenter(),m.x,m.bottom(),!0,this,function(b,
c,f,d,e,h){n.addSegment(new a.common.CubicArcSegment(b,c,f,d,e,h))}):b.transform.transform3Points(m.x,m.verticalCenter(),m.right(),m.verticalCenter(),m.right(),m.bottom(),!0,this,function(b,c,f,d,e,h){n.addSegment(new a.common.CubicArcSegment(b,c,f,d,e,h))}):d.x>m.x?b.transform.transformPoints(m.x,m.y,m.x,m.bottom(),!0,this,function(b,c,f,d){n.addSegment(new a.common.QuadraticArcSegment(b,c,f,d))}):b.transform.transformPoints(m.right(),m.y,m.right(),m.bottom(),!0,this,function(b,c,f,d){n.addSegment(new a.common.QuadraticArcSegment(b,
c,f,d))})}m=4!==l.visibility;c.graph.addEdge(d.id,l.id,new this.ConnectorEdge(d.id,l.id,n,null,m?l.id:null,m?this.NORMAL_ITEM_WEIGHT:this.LINE_ITEM_WEIGHT))}};a.common.HorizontalConnectorBundle=function(a,b){this.fromItem=a;this.toItem=b};a.common.HorizontalConnectorBundle.prototype=new a.common.BaseConnectorBundle;a.common.HorizontalConnectorBundle.prototype.trace=function(c,b,e){e=this.fromItem;var d=this.toItem,g=b.treeItemsPositions[e],f=b.treeItemsPositions[d],h=new a.common.Polyline;g.actualPosition.x<
f.actualPosition.x?b.transform.transformPoints(g.actualPosition.right(),g.horizontalConnectorsShift,f.actualPosition.x,f.horizontalConnectorsShift,!0,this,function(b,c,f,d){h.addSegment(new a.common.MoveSegment(b,c));h.addSegment(new a.common.LineSegment(f,d))}):b.transform.transformPoints(g.actualPosition.x,g.horizontalConnectorsShift,f.actualPosition.right(),g.horizontalConnectorsShift,!0,this,function(b,c,f,d){h.addSegment(new a.common.MoveSegment(b,c));h.addSegment(new a.common.LineSegment(f,
d))});b=4!==f.actualVisibility;g=4!==g.actualVisibility;c.graph.addEdge(e,d,new this.ConnectorEdge(e,d,h,b?d:null,g?e:null,b||g?this.NORMAL_ITEM_WEIGHT:this.LINE_ITEM_WEIGHT))};a.common.MatrixConnectorBundle=function(a,b,e,d,g){this.isChildren=a;this.items=b;this.len=b.length;this.matrixNodeId=e;this.connectionId=d;this.matrixWidth=g;this.blocksCount=Math.ceil(this.matrixWidth/2);this.rowsCount=Math.ceil(this.len/this.matrixWidth)};a.common.MatrixConnectorBundle.prototype=new a.common.BaseConnectorBundle;
a.common.MatrixConnectorBundle.prototype.trace=function(a,b,e){this.isChildren?this.traceChildrenLayout(a,b,e):this.traceParentsLayout(a,b,e)};a.common.MatrixConnectorBundle.prototype.traceChildrenLayout=function(c,b,e){for(var d,g=[],f=0;f<this.blocksCount;f+=1){for(var h=null,k=this.rowsCount-1;0<=k;--k){var l=this.getNodeIndex(f,k,!0,!0),n=null;d=null;l<this.len&&(n=this.items[l],d=b.treeItemsPositions[n]);var m=this.getNodeIndex(f,k,!1,!0),q=null;l=null;m<this.len&&(q=this.items[m],l=b.treeItemsPositions[q]);
var p=null;null==p&&null!=d&&(p=new this.ConnectorDestination({id:this.getId(c),x:d.actualPosition.horizontalCenter()+d.rightMedianOffset,y:d.horizontalConnectorsShift}));null==p&&null!=l&&(p=new this.ConnectorDestination({id:this.getId(c),x:l.actualPosition.horizontalCenter()-l.leftMedianOffset,y:l.horizontalConnectorsShift}));null!=d&&(d=d.actualPosition,b.transform.transformPoints(d.right(),d.verticalCenter(),p.x,p.y,!0,this,function(b,f,d,e){var h=new a.common.Polyline;h.addSegment(new a.common.MoveSegment(b,
f));h.addSegment(new a.common.LineSegment(d,e));c.graph.addEdge(n,p.id,new this.ConnectorEdge(n,p.id,h,null,n,null,10))}));null!=l&&(d=l.actualPosition,b.transform.transformPoints(d.left(),d.verticalCenter(),p.x,p.y,!0,this,function(b,f,d,e){var h=new a.common.Polyline;h.addSegment(new a.common.MoveSegment(b,f));h.addSegment(new a.common.LineSegment(d,e));c.graph.addEdge(q,p.id,new this.ConnectorEdge(q,p.id,h,null,q,null,10))}));null!=h&&null!=p&&b.transform.transformPoints(h.x,h.y,p.x,p.y,!0,this,
function(b,f,d,e){var g=new a.common.Polyline;g.addSegment(new a.common.MoveSegment(b,f));g.addSegment(new a.common.LineSegment(d,e));c.graph.addEdge(h.id,p.id,new this.ConnectorEdge(h.id,p.id,g,null,null,null,0))});null!=p&&(h=p)}null!=h&&g.push(new this.ConnectorDestination({id:h.id,bundleid:this.getId(c),x:h.x,y:h.y,isSquared:!0,visibility:4}))}d=b.treeItemsPositions[this.matrixNodeId].actualPosition;f=new this.ConnectorDestination({id:this.matrixNodeId,x:d.horizontalCenter(),y:d.top()});this.traceFork(c,
b,e,f,g,!0,!1,0,e.showExtraArrows)};a.common.MatrixConnectorBundle.prototype.traceParentsLayout=function(c,b,e){for(var d,g=[],f=0;f<=this.blocksCount;f+=1){for(var h=null,k=0;k<this.rowsCount;k+=1){var l=this.getNodeIndex(f,k,!0,!1),n=null;d=null;l<this.len&&(n=this.items[l],d=b.treeItemsPositions[n]);var m=this.getNodeIndex(f,k,!1,!1),q=null;l=null;m<this.len&&(q=this.items[m],l=b.treeItemsPositions[q]);var p=null;null==p&&null!=d&&(p=new this.ConnectorDestination({id:this.getId(c),x:d.actualPosition.horizontalCenter()+
d.rightMedianOffset,y:d.horizontalConnectorsShift}));null==p&&null!=l&&(p=new this.ConnectorDestination({id:this.getId(c),x:l.actualPosition.horizontalCenter()-l.leftMedianOffset,y:l.horizontalConnectorsShift}));null!=d&&(d=d.actualPosition,b.transform.transformPoints(d.right(),d.verticalCenter(),p.x,p.y,!0,this,function(b,f,d,e){var h=new a.common.Polyline;h.addSegment(new a.common.MoveSegment(b,f));h.addSegment(new a.common.LineSegment(d,e));c.graph.addEdge(n,p.id,new this.ConnectorEdge(n,p.id,
h,n,null,null,10))}));null!=l&&(d=l.actualPosition,b.transform.transformPoints(d.left(),d.verticalCenter(),p.x,p.y,!0,this,function(b,f,d,e){var h=new a.common.Polyline;h.addSegment(new a.common.MoveSegment(b,f));h.addSegment(new a.common.LineSegment(d,e));c.graph.addEdge(q,p.id,new this.ConnectorEdge(q,p.id,h,q,null,null,10))}));null!=h&&null!=p&&b.transform.transformPoints(h.x,h.y,p.x,p.y,!0,this,function(b,f,d,e){var g=new a.common.Polyline;g.addSegment(new a.common.MoveSegment(b,f));g.addSegment(new a.common.LineSegment(d,
e));c.graph.addEdge(h.id,p.id,new this.ConnectorEdge(h.id,p.id,g,null,null,null,0))});null!=p&&(h=p)}null!=h&&g.push(new this.ConnectorDestination({id:h.id,bundleid:this.getId(c),x:h.x,y:h.y,isSquared:!0,visibility:4}))}d=b.treeItemsPositions[this.matrixNodeId].actualPosition;f=new this.ConnectorDestination({id:this.connectionId,x:d.horizontalCenter(),y:d.bottom()});this.traceFork(c,b,e,f,g,!0,!0,0,e.showExtraArrows)};a.common.MatrixConnectorBundle.prototype.getNodeIndex=function(a,b,e,d){var c=null;
d?(a=2*a+(e?0:1),this.matrixWidth>a&&(c=b*this.matrixWidth+a)):(a=2*a+(e?-1:0),0<=a&&a<this.matrixWidth&&(c=b*this.matrixWidth+a));return c};a.common.VerticalConnectorBundle=function(a,b){this.fromItems=a;this.toItems=b;this.childConnectorId={};this.fromStackSize=this.fromOffset=0};a.common.VerticalConnectorBundle.prototype=new a.common.BaseConnectorBundle;a.common.VerticalConnectorBundle.prototype.trace=function(c,b,e){var d,g=0===e.connectorType;var f=[];if(0<this.fromItems.length){var h=this.fromItems;
var k=0;for(d=h.length;k<d;k+=1){var l=h[k];var n=b.treeItemsPositions[l];l=new this.ConnectorDestination({id:b.nestedLayoutBottomConnectorIds.hasOwnProperty(l)?b.nestedLayoutBottomConnectorIds[l]:l,bundleid:this.getId(c),x:n.actualPosition.horizontalCenter(),y:n.actualPosition.bottom(),isSquared:!0,visibility:n.actualVisibility});f.push(l)}f.sort(function(a,b){return a.x-b.x});var m=n.bottomConnectorShift-n.bottomConnectorInterval*(this.fromStackSize-this.fromOffset+1)}d=[];if(0<this.toItems.length){var q=
!1;h=this.toItems;for(k=0;k<h.length;k+=1){l=h[k];n=b.treeItemsPositions[l];var p=!0;if(b.hasGraphics)switch(n.actualVisibility){case 2:case 3:p=g}l=new this.ConnectorDestination({id:l,bundleid:this.getId(c),x:n.actualPosition.horizontalCenter()+0,y:n.actualPosition.top(),isSquared:p,visibility:n.actualVisibility});d.push(l);q=q||l.isSquared}d.sort(function(a,b){return a.x-b.x});p=n.topConnectorShift}h=1==d.length?d[0].x:1==f.length?f[0].x:0<d.length&&0<f.length?(f[0].x+f[f.length-1].x+d[0].x+d[d.length-
1].x)/4:0<d.length?(d[0].x+d[d.length-1].x)/2:(f[0].x+f[f.length-1].x)/2;var r=null;0<f.length&&(r=new this.ConnectorDestination({id:this.getId(c),x:h,y:m}),this.traceFork(c,b,e,r,f,!0,!0,this.fromOffset,e.showExtraArrows&&0<d.length));var t=null;0<d.length&&(t=new this.ConnectorDestination({id:this.getId(c),x:h,y:p}),null!=r&&t.y==r.y&&(t=r),this.traceFork(c,b,e,t,d,q,!1,0,e.showExtraArrows&&0<f.length));null!=r&&null!=t&&r.id!=t.id&&b.transform.transformPoints(r.x,r.y,t.x,t.y,!0,this,function(b,
f,d,e){var h=new a.common.Polyline;h.addSegment(new a.common.MoveSegment(b,f));h.addSegment(new a.common.LineSegment(d,e));c.graph.addEdge(r.id,t.id,new this.ConnectorEdge(r.id,t.id,h,null,null,null,0))})};a.orgdiagram.LevelVisibility=function(a,b){this.level=a;this.currentvisibility=b};a.orgdiagram.OrgItem=function(a){var b;this.id=null;this.isActive=this.isVisible=!0;this.hasVisibleChildren=!1;this.placeAssistantsAboveChildren=this.placeAdvisersAboveChildren=this.childrenPlacementType=this.adviserPlacementType=
this.itemType=0;this.level=this.levelOffset=null;this.hideChildrenConnection=this.hideParentConnection=!1;this.childIndex=null;var c="id parent isVisible isActive itemType adviserPlacementType childrenPlacementType placeAdvisersAboveChildren placeAssistantsAboveChildren levelOffset".split(" ");var d=0;for(b=c.length;d<b;d+=1){var g=c[d];a.hasOwnProperty(g)&&(this[g]=a[g])}};a.orgdiagram.Template=function(a,b,e,d,g){this.templateConfig=a;this.itemTemplate=b;this.highlightTemplate=e;this.dotHighlightTemplate=
d;this.cursorTemplate=g};a.orgdiagram.TemplateParams=function(){this.template=null;this.hasGroupTitle=this.hasButtons=this.hasSelectorCheckbox=this.isActive=!1;this.buttons=[];this.onButtonsRender=null};a.orgdiagram.TreeItem=function(){this.visualAggregatorId=this.id=null;this.visualDepth=1;this.partners=[];this.visibility=1;this.actualItemType=null;this.relationDegree=this.gravity=this.connectorPlacement=0};a.orgdiagram.TreeItemPosition=function(c){this.partnerConnectorOffset=0;this.levelPosition=
this.level=null;this.rightPadding=this.leftPadding=this.offset=0;this.actualVisibility=1;this.topConnectorShift=this.horizontalConnectorsShift=this.contentPosition=this.actualPosition=this.actualSize=null;this.topConnectorInterval=0;this.bottomConnectorShift=null;this.bottomConnectorInterval=0;this.rightMedianOffset=this.leftMedianOffset=null;if(null!=c)for(var b in c)if(c.hasOwnProperty(b))switch(b){case "actualPosition":this.actualPosition=new a.common.Rect(c.actualPosition);break;default:this[b]=
c[b]}};a.orgdiagram.TreeLevelConnectorStackSize=function(){this.parentsStackSize=0};a.orgdiagram.TreeLevelPosition=function(a){this.actualVisibility=this.currentvisibility=1;this.currentOffset=this.levelSpace=this.connectorShift=this.topConnectorShift=this.horizontalConnectorsDepth=this.nextLevelShift=this.depth=this.shift=0;this.labels=[];this.labelsRect=null;this.showLabels=!0;this.hasFixedLabels=!1;if(null!=a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])};a.orgdiagram.TreeLevelPosition.prototype.setShift=
function(a,b,e,d,g){this.shift=a;this.levelSpace=b;this.topConnectorShift=-b/2-e;this.connectorShift=this.depth+d+b/2*(g+1);return this.nextLevelShift=e+this.depth+d+b+g*b/2};a.orgdiagram.TreeLevelPosition.prototype.shiftDown=function(a){this.shift+=a};a.orgdiagram.TreeLevelPosition.prototype.toString=function(){return this.currentvisibility};a.orgdiagram.AlignDiagramTask=function(c,b,e,d,g,f,h,k){function l(){var a=[],b={},c;for(c in m.treeItemsPositions)if(m.treeItemsPositions.hasOwnProperty(c)){var f=
m.treeItemsPositions[c];switch(f.actualVisibility){case 1:case 2:case 3:f=f.actualPosition,f=Math.max(f.width,f.height),b.hasOwnProperty(f)||(b[f]=!0,a.push(f))}}return a}function n(){if(null==w){w=a.common.SpatialIndex(l());for(var b in m.treeItemsPositions)if(m.treeItemsPositions.hasOwnProperty(b)){var c=m.treeItemsPositions[b];if(q.hasOwnProperty(b))switch(c.actualVisibility){case 1:case 2:case 3:c=new a.common.Rect(c.actualPosition),c.context=b,w.addRect(c)}}}return w}var m={treeItemsPositions:{},
panelSize:null},q,p,r,t,u,v,w,y;return{process:function(){var l=new a.common.Size(h.getContentSize()),n=new a.common.Size(g.getOptimalPanelSize());y=w=null;q=null!=f?f.getActiveItems():{};p=h.getItemsPositions();r=b.getOptions();t=c.getOptions();u=e.getOptions();v=d.getOptions();switch(t.orientationType){case 2:case 3:n.invert()}n.scale(1/v.scale);m.panelSize=n;m.treeItemsPositions=p;switch(r.pageFitMode){case 5:m.panelSize=new a.common.Size(l);break;default:m.panelSize=new a.common.Size(l);if(l.width<
n.width){m.treeItemsPositions={};var F=l.width,x=n.width;if(k)var A=(x-F)/2;else switch(u.horizontalAlignment){case 1:A=0;break;case 2:A=x-F;break;case 0:A=(x-F)/2}F=m.treeItemsPositions;for(var D in p)p.hasOwnProperty(D)&&(x=new a.orgdiagram.TreeItemPosition(p[D]),x.actualPosition.translate(A,0),F[D]=x);m.panelSize.width=n.width}l.height<n.height&&(m.panelSize.height=n.height)}switch(t.orientationType){case 2:case 3:m.panelSize.invert()}return!0},getItemPosition:function(a){return m.treeItemsPositions[a]},
getItemsPositions:function(){return m.treeItemsPositions},getContentSize:function(){return m.panelSize},getTreeItemForMousePosition:function(b,c,f){var d=null,e=null,h=v.scale,g=n();b/=h;c/=h;h=new a.common.Rect(b,c,0,0);var k=new a.common.Point(b,c);h.offset(f,f,f,f);g.loopArea(this,h,function(a){var f=a.context;if(a.contains(b,c))return d=f,!0;switch(m.treeItemsPositions[f].actualVisibility){case 2:case 3:if(a=k.distanceTo(a.horizontalCenter(),a.verticalCenter()),null==e||a<e)e=a,d=f}});return d},
getNextItem:function(b,c){if(null==y)for(d in y=a.common.KeyboardNavigationManager(),m.treeItemsPositions)if(m.treeItemsPositions.hasOwnProperty(d)){var f=m.treeItemsPositions[d];if(q.hasOwnProperty(d))switch(f.actualVisibility){case 1:f=new a.common.Rect(f.actualPosition),y.addRect(f,d)}}var d=y;switch(c){case 0:var e=d.getItemAbove(b);break;case 1:e=d.getItemBelow(b);break;case 2:e=d.getItemOnLeft(b);break;case 3:e=d.getItemOnRight(b)}return e}}};a.orgdiagram.ApplyLayoutChangesTask=function(c,b,
e,d,g,f){var h=null;return{process:function(){var a=c(),l=g.getOptions(),n=e.getOptions(),m=f.getContentSize(),q=d.getScrollPanelSize();a.resize("placeholder",m.width,m.height);h=b({scale:l.scale,contentSize:m,scrollPanelSize:q,autoSize:5==n.pageFitMode,autoSizeMaximum:n.autoSizeMaximum,autoSizeMinimum:n.autoSizeMinimum});return!0},getOptimalPanelSize:function(){return new a.common.Size(h.width-25,h.height-25)}}};a.orgdiagram.CenterOnCursorTask=function(c,b,e,d,g,f,h){function k(b){var c=!1;n.transformRect(b.x,
b.y,b.width,b.height,!0,this,function(b,f,d,e){c=new a.common.Rect(b,f,d,e)});return c}var l=null,n;return{process:function(){var m=c.getOptions();var q=d.getCursorTreeItem(),p=g.getItemPosition(q);q=new a.common.Size(g.getContentSize());var r=h.getOptions().scale;l=e.getPlaceholderOffset();m.forceCenterOnCursor&&(n=f.getTransform(),null!=p&&(m=k(p.actualPosition),m.scale(r),q.scale(r),r=b.getScrollPanelSize(),l=new a.common.Point(Math.max(Math.min(m.horizontalCenter()-r.width/2,q.width-r.width),
0),Math.max(Math.min(m.verticalCenter()-r.height/2,q.height-r.height),0))));return!0},getPlaceholderOffset:function(){return l}}};a.orgdiagram.CreateTransformTask=function(c,b){var e=null;return{process:function(){var d=c.getOptions(),g=new a.common.Size(b.getContentSize());e=new a.common.Transform;e.setOrientation(d.orientationType);e.size=new a.common.Size(g);return!0},getTransform:function(){return e},getTreeItemForMousePosition:function(a,c,f){var d=null;e.transformPoint(a,c,!1,this,function(a,
c){d=b.getTreeItemForMousePosition(a,c,f)});return d},description:"Create oordiante system tranfromation object."}};a.orgdiagram.CurrentControlSizeTask=function(c,b){var e={scrollPanelSize:null},d={},g=new a.common.ObjectReader({scrollPanelSize:new a.common.ObjectReader({width:new a.common.ValueReader(["number"],!0),height:new a.common.ValueReader(["number"],!0)},!0)});return{process:function(){var a={isChanged:!1,hash:d},h=c.getOptions(),k=!1,l=b.getOptions();e=g.read(e,h,"layout",a);switch(l.pageFitMode){case 1:case 2:case 3:case 0:k=
a.isChanged}return k},getScrollPanelSize:function(){return e.scrollPanelSize},getOptimalPanelSize:function(){return new a.common.Size(e.scrollPanelSize.width-25,e.scrollPanelSize.height-25)}}};a.orgdiagram.CurrentScrollPositionTask=function(c){var b={placeholderOffset:null},e={},d=new a.common.ObjectReader({placeholderOffset:new a.common.ObjectReader({x:new a.common.ValueReader(["number"],!0),y:new a.common.ValueReader(["number"],!0)},!0)});return{process:function(){var a={isChanged:!1,hash:e},f=
c.getOptions();b=d.read(b,f,"layout",a);return a.isChanged},getPlaceholderOffset:function(){return b.placeholderOffset}}};a.orgdiagram.BackgroundAnnotationOptionTask=function(c,b){var e=[],d={},g=new a.common.ArrayReader(new a.common.ObjectReader({items:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0),includeChildren:new a.common.ValueReader(["boolean"],!1,b.includeChildren),zOrderType:new a.common.EnumerationReader(a.common.ZOrderType,!1,b.zOrderType),offset:new a.common.ObjectReader({left:new a.common.ValueReader(["number"],
!1,b.offset.left),top:new a.common.ValueReader(["number"],!1,b.offset.top),right:new a.common.ValueReader(["number"],!1,b.offset.right),bottom:new a.common.ValueReader(["number"],!1,b.offset.bottom)},!1,b.offset),lineWidth:new a.common.ValueReader(["number"],!1,b.lineWidth),opacity:new a.common.ValueReader(["number"],!1,b.opacity),borderColor:new a.common.ValueReader(["string"],!1,b.borderColor),fillColor:new a.common.ValueReader(["string"],!1,b.fillColor),lineType:new a.common.EnumerationReader(a.common.LineType,
!1,b.lineType),selectItems:new a.common.ValueReader(["boolean"],!1,b.selectItems)}),!1);return{process:function(){var a={isChanged:!1,hash:d};e=g.read(e,c.getAnnotations(4,null),"annotations",a);return a.isChanged},getAnnotations:function(){return e}}};a.orgdiagram.ConnectorAnnotationOptionTask=function(c,b,e){var d=[],g={},f=new a.common.ArrayReader(new a.common.ObjectReader({zOrderType:new a.common.EnumerationReader(a.common.ZOrderType,!1,b.zOrderType),fromItem:new a.common.ValueReader(["string",
"number"],!0),toItem:new a.common.ValueReader(["string","number"],!0),connectorShapeType:new a.common.EnumerationReader(a.common.ShapeType,!1,b.connectorShapeType),connectorPlacementType:new a.common.EnumerationReader(a.common.ConnectorPlacementType,!1,b.connectorPlacementType),labelPlacementType:new a.common.EnumerationReader(a.common.ConnectorLabelPlacementType,!1,b.labelPlacementType),offset:new a.common.ObjectReader({left:new a.common.ValueReader(["number"],!1,b.offset.left),top:new a.common.ValueReader(["number"],
!1,b.offset.top),right:new a.common.ValueReader(["number"],!1,b.offset.right),bottom:new a.common.ValueReader(["number"],!1,b.offset.bottom)},!1,b.offset),lineWidth:new a.common.ValueReader(["number"],!1,b.lineWidth),color:new a.common.ValueReader(["string"],!1,b.color),lineType:new a.common.EnumerationReader(a.common.LineType,!1,b.lineType),selectItems:new a.common.ValueReader(["boolean"],!1,b.selectItems),label:new a.common.ValueReader(["string","object"],!1,b.label),labelSize:new a.common.ObjectReader({width:new a.common.ValueReader(["number"],
!1,b.labelSize.width),height:new a.common.ValueReader(["number"],!1,b.labelSize.height)},!1,b.labelSize)}),!1);return{process:function(){var a={isChanged:!1,hash:g};d=f.read(d,c.getAnnotations(0,e),"annotations",a);return a.isChanged},getAnnotations:function(){return d}}};a.orgdiagram.HighlightPathAnnotationOptionTask=function(c,b,e){var d=[],g={},f=new a.common.ArrayReader(new a.common.ObjectReader({zOrderType:new a.common.EnumerationReader(a.common.ZOrderType,!1,b.zOrderType),lineWidth:new a.common.ValueReader(["number"],
!1,b.lineWidth),opacity:new a.common.ValueReader(["number"],!1,b.opacity),color:new a.common.ValueReader(["string"],!1,b.color),lineType:new a.common.EnumerationReader(a.common.LineType,!1,b.lineType),items:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!1),selectItems:new a.common.ValueReader(["boolean"],!1,b.selectItems),showArrows:new a.common.ValueReader(["boolean"],!1,b.showArrows)},!1));return{process:function(){var a={isChanged:!1,hash:g};d=f.read(d,c.getAnnotations(2,
e),"annotations",a);return a.isChanged},getAnnotations:function(){return d}}};a.orgdiagram.ShapeAnnotationOptionTask=function(c,b,e){var d=[],g={},f=new a.common.ArrayReader(new a.common.ObjectReader({zOrderType:new a.common.EnumerationReader(a.common.ZOrderType,!1,b.zOrderType),items:new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0),shapeType:new a.common.EnumerationReader(a.common.ShapeType,!1,b.shapeType),offset:new a.common.ObjectReader({left:new a.common.ValueReader(["number"],
...
n;var q=new a.orgdiagram.BackgroundAnnotationConfig;var l=["opacity","lineWidth","borderColor","fillColor","lineType"];var p=0;for(h=l.length;p<h;p+=1){var E=l[p];m[E]=g.hasOwnProperty(E)?g[E]:q[E]}k.activate("placeholder",2);var F=[];var x={};p=0;for(h=g.items.length;p<h;p+=1){q=g.items[p];var A=f.getItemPosition(q);if(null!=A){x[q]=!0;var D=new a.common.Rect(A.actualPosition);D.offset(g.offset);F.push(D);g.includeChildren&&d.loopChildren(this,q,function(b,c){x[b]||(x[b]=!0,A=f.getItemPosition(b),
D=new a.common.Rect(A.actualPosition),D.offset(g.offset),F.push(D))})}}m.draw(F)}}}var k,l,n;return{process:function(){var a=d.getAnnotations();k=c();k.reset("placeholder",2);if(0<a.length){l=f.getItemsPositions();n=b.getTransform();var e=g.getNavigationFamily();h(a,l,e)}return!1}}};a.orgdiagram.DrawConnectorAnnotationTask=function(c,b,e,d,g,f,h,k){function l(b,c){var d,f,e=new a.common.PolylinesBuffer,h=a.orgdiagram.ConnectorAnnotationOffsetResolver(),g=0;switch(k){case 1:n.activate("placeholder",
4);break;case 2:n.activate("placeholder",14)}var l=0;for(d=b.length;l<d;l+=1){var t=b[l];g=Math.max(g,t.lineWidth)}l=0;for(d=b.length;l<d;l+=1)if(t=b[l],null!=t.fromItem&&null!=t.toItem){var r=c(t.fromItem);var A=c(t.toItem);if(null!=r&&null!=A){var D=r.actualPosition;var B=A.actualPosition;switch(t.connectorPlacementType){case 0:var z=new a.common.ConnectorOffbeat;break;case 1:z=new a.common.ConnectorStraight}var G;m.transformRect(0,0,t.labelSize.width,t.labelSize.height,!1,this,function(b,c,d,f){G=
new a.common.Size(d,f)});var J=null;m.transformRect(0,0,p.width,p.height,!1,this,function(b,c,d,f){J=new a.common.Size(d,f)});A=new a.common.PaletteItem({lineColor:t.color,lineWidth:t.lineWidth,lineType:t.lineType});r=!a.common.isNullOrEmpty(t.label);D=(new a.common.Rect(D)).offset(t.offset);B=(new a.common.Rect(B)).offset(t.offset);z.draw(e,A,D,B,3*t.lineWidth,6*g,G,J,t.connectorShapeType,4,t.labelPlacementType,r,h,function(b,c){a.common.isNullOrEmpty(c.label)||null==b||(m.transformRect(b.x,b.y,
b.width,b.height,!0,this,function(c,d,f,e){b=new a.common.Rect(c,d,f,e)}),f=new a.common.RenderEventArgs,f.context=c,n.template(b.x,b.y,0,0,0,0,b.width,b.height,q.template(),q.getHashCode(),q.render,f,null))},t)}}h.resolve();e.transform(m,!0);n.polylinesBuffer(e)}var n,m,q,p;return{process:function(){n=c();m=b.getTransform();d.getOptions();q=h.getTemplate();p=new a.common.Size(f.getContentSize());switch(k){case 1:n.reset("placeholder",4);break;case 2:n.reset("placeholder",14)}l(g.getAnnotations(),
...
if(d&&null!=f.dotId&&0!=k.elbowType&&!p.hasOwnProperty(f.dotId)){c=n.getPolyline(e.arrowPaletteItem);var h=f.dotId==f.from?f.polyline.getStartPoint():f.polyline.getEndPoint();c.addSegment(new a.common.DotSegment(h.x-m,h.y-m,2*m,2*m,m));p[f.dotId]=!0}c=null;null!=f.parentsArrowId&&1==k.arrowsDirection?c=f.parentsArrowId:null!=f.childrenArrowId&&2==k.arrowsDirection&&(c=f.childrenArrowId);null==c?(c=f.polyline.clone(),f.hasMiddle&&0!=k.arrowsDirection&&(h=!0,h=f.from==f.middleParent?2==k.arrowsDirection:
1==k.arrowsDirection,c.addOffsetArrow(h,k.linesWidth,.4,k.extraArrowsMinimumSpace,function(a){a.mergeTo(n.getPolyline(e.arrowPaletteItem))})),f.from==b?c.mergeTo(e):e.addInverted(c)):(c==f.to?f.polyline.clone().mergeTo(e):e.addInverted(f.polyline.clone()),e.addArrow(k.linesWidth,function(a){a.mergeTo(n.getPolyline(a.paletteItem))}))}});q[b]=!0});f.polylinesBuffer(n);return!1}}};a.orgdiagram.DrawCursorTask=function(c,b,e,d,g,f,h,k){function l(b){n.activate("placeholder",11);var c=g.getItemPosition(b);
if(null!=c){var e=c.actualPosition,h=new a.common.Rect(c.contentPosition),l=f.getTemplateParams(b).template,q=l.templateConfig;c=q.cursorPadding;h.offset(c.left,c.top,c.right,c.bottom);var w=new a.common.RenderEventArgs;w.context=d.getConfig(b);w.isCursor=!0;w.isSelected=k.isSelected(b);w.templateName=q.name;m.transformRect(e.x,e.y,e.width,e.height,!0,this,function(a,b,c,f){n.template(a,b,c,f,h.x,h.y,h.width,h.height,l.cursorTemplate.template(),l.cursorTemplate.getHashCode(),l.cursorTemplate.render,
w,{borderWidth:q.cursorBorderWidth})})}}var n,m;return{process:function(){var a=h.getCursorTreeItem();n=c();n.reset("placeholder",11);null!=a&&(m=b.getTransform(),l(a));return!1}}};a.orgdiagram.DrawHighlightAnnotationTask=function(c,b,e,d,g,f,h,k,l,n,m,q){function p(b){var c,p,n,w,x,A=!0,D=k.getItemPosition(b),B=D.actualPosition;switch(D.actualVisibility){case 2:case 3:case 1:var z=f.getItemOptions(b);switch(z.showCallout){case 2:A=!1;break;case 1:A=!1;break;default:A=v.showCallout}A?(r.activate("placeholder",
12),t.transformRect(B.x,B.y,B.width,B.height,!0,this,function(f,t,A,I){t=new a.common.Rect(f,t,A,I);f=new a.common.Point(t.horizontalCenter(),t.verticalCenter());A=d.getOptions().scale;I=new a.common.Point(l.getPlaceholderOffset());var L=new a.common.Rect(k.getContentSize()),B=new a.common.Size(e.getOptimalPanelSize());I.scale(1/A);B.scale(1/A);A=new a.common.Rect(I.x,I.y,Math.min(B.width,L.width),Math.min(B.height,L.height));if(D.actualVisibility>=v.calloutMaximumVisibility&&4!=D.actualVisibility||
!A.overlaps(t)){w=a.common.isNullOrEmpty(z.calloutTemplateName)?a.common.isNullOrEmpty(z.templateName)?a.common.isNullOrEmpty(v.defaultCalloutTemplateName)?v.defaultTemplateName:v.defaultCalloutTemplateName:z.templateName:z.calloutTemplateName;x=h.getTemplate(w,h.DefaultWidgetTemplateName);t=x.templateConfig.itemSize;I=new a.common.Rect(f.x,f.y,t.width,t.height);switch(v.orientationType){case 0:case 1:I.y-=t.height/4;f.x<A.horizontalCenter()?I.x+=v.calloutPlacementOffset:I.x-=v.calloutPlacementOffset+
t.width;break;default:I.x-=t.width/4,f.y<A.verticalCenter()?I.y+=v.calloutPlacementOffset:I.y-=v.calloutPlacementOffset+t.height}I.x<A.x?I.x=A.x+5:I.right()>A.right()&&(I.x-=I.right()-A.right()+5);I.y<A.y?I.y=A.y+5:I.bottom()>A.bottom()&&(I.y-=I.bottom()-A.bottom()+5);p=I;c=new a.common.Rect(p);c.addRect(f.x,f.y);c.offset(50);f.x-=c.x;f.y-=c.y;p.x-=c.x;p.y-=c.y;n=new a.common.RenderEventArgs;n.context=g.getConfig(b);n.isCursor=m.getCursorTreeItem()==b;n.isSelected=q.isSelected(b);n.templateName=x.templateConfig.name;
r.show("calloutplaceholder");r.activate("calloutplaceholder",15);r.position("calloutplaceholder",c.x,c.y,c.width,c.height);r.template(p.x,p.y,p.width,p.height,0,0,p.width,p.height,x.itemTemplate.template(),x.itemTemplate.getHashCode(),x.itemTemplate.render,n,null);u.pointerPlacement=0;u.cornerRadius=v.calloutCornerRadius;u.offset=v.calloutOffset;u.opacity=v.calloutOpacity;u.lineWidth=v.calloutLineWidth;u.pointerWidth=v.calloutPointerWidth;u.borderColor=v.calloutBorderColor;u.fillColor=v.calloutfillColor;
u.draw(f,p)}else r.hide("calloutplaceholder")})):r.hide("calloutplaceholder");break;case 4:r.hide("calloutplaceholder")}}var r,t,u=new a.common.Callout(c()),v;return{process:function(){var a=n.getHighlightTreeItem();r=c();r.reset("calloutplaceholder",15);null!==a&&(t=b.getTransform(),v=f.getOptions(),p(a));return!1}}};a.orgdiagram.DrawHighlightPathAnnotationTask=function(c,b,e,d,g){function f(b,c,f,d){var e,h;if(0<f.length){var k=new a.common.PolylinesBuffer;switch(g){case 1:b.activate("placeholder",
5);break;case 2:b.activate("placeholder",7)}var l={};var n=0;for(e=f.length;n<e;n+=1){var u=f[n];if(null!=u.items&&0<u.items.length){var v=u.items.slice(0);var w=v[0];if(d.hasNode(w)){var y=1;for(h=v.length;y<h;y+=1){var C=v[y];d.hasNode(C)&&(l.hasOwnProperty(w)?l[w].push(C):l[w]=[C],w=C)}}}}var E={};for(x in l)E[x]={},l.hasOwnProperty(x)&&d.getShortestPath(this,x,l[x],function(a,b,c){return a.weight},function(a,b){E[x][b]=a});n=0;for(e=f.length;n<e;n+=1)if(u=f[n],y=new a.common.PaletteItem({lineColor:null!=
u.color?u.color:c.highlightLinesColor,lineWidth:null!=u.lineWidth?u.lineWidth:c.highlightLinesWidth,lineType:null!=u.lineType?u.lineType:c.highlightLinesType,fillColor:null,opacity:u.opacity}),l=k.getPolyline(y),null!=u.items&&0<u.items.length&&(v=u.items.slice(0),w=v[0],d.hasNode(w)))for(y=1,h=v.length;y<h;y+=1)if(C=v[y],d.hasNode(C)){var F=E[w][C]||[];for(w=F.length-2;0<=w;--w){var x=F[w+1];var A=F[w];var D=d.edge(x,A);D.from==x?D.polyline.clone().mergeTo(l):l.addInverted(D.polyline.clone());u.showArrows&&
(A==D.parentsArrowId||A==D.childrenArrowId)&&l.addArrow(u.lineWidth,function(a){a.mergeTo(k.getPolyline(a.paletteItem))})}w=C}b.polylinesBuffer(k)}}return{process:function(){var a=d.getGraph(),k=b.getOptions(),l=e.getAnnotations(),n=c();switch(g){case 1:n.reset("placeholder",5);break;case 2:n.reset("placeholder",7)}f(n,k,l,a);return!1}}};a.orgdiagram.DrawHighlightTask=function(c,b,e,d,g,f,h,k,l){function n(b){m.activate("placeholder",8);var c=g.getItemPosition(b),e=c.actualPosition,h=f.getTemplateParams(b).template,
...
3;switch(k.showLabel){case 0:switch(c.showLabels){case 0:switch(l.actualVisibility){case 3:case 2:n=0}break;case 1:n=2}break;case 1:n=2}switch(n){case 0:var p=l.leftPadding+l.rightPadding;break;case 2:p=1E4;break;case 3:p=0}if(3!=n){var t=null!=k.labelSize?k.labelSize:c.labelSize;l=3!=k.labelOrientation?k.labelOrientation:3!=c.labelOrientation?c.labelOrientation:0;q=0!=k.labelPlacement?k.labelPlacement:0!=c.labelPlacement?c.labelPlacement:1;switch(l){case 0:var r=t.width;var u=t.height;break;case 1:case 2:u=
t.width,r=t.height}t=c.labelOffset;switch(q){case 0:case 1:var v=new a.common.Rect(b+g/2-r/2,d-t-u,r,u);switch(l){case 0:var w=0;var y=2;break;case 1:y=w=1;break;case 2:w=2,y=1}break;case 2:case 11:v=new a.common.Rect(b+g+t,d-t-u,r,u);switch(l){case 0:w=1;y=2;break;case 1:w=1;y=0;break;case 2:y=w=2}break;case 3:v=new a.common.Rect(b+g+t,d+m/2-u/2,r,u);switch(l){case 0:y=w=1;break;case 1:y=w=0;break;case 2:w=0,y=2}break;case 4:case 12:v=new a.common.Rect(b+g+t,d+m+t,r,u);switch(l){case 0:w=1;y=0;break;
case 1:w=2;y=0;break;case 2:w=1,y=2}break;case 5:v=new a.common.Rect(b+g/2-r/2,d+m+t,r,u);switch(l){case 0:y=w=0;break;case 1:w=2;y=1;break;case 2:y=w=1}break;case 6:case 10:v=new a.common.Rect(b-r-t,d+m+t,r,u);switch(l){case 0:w=2;y=0;break;case 1:y=w=2;break;case 2:w=1,y=0}break;case 7:v=new a.common.Rect(b-r-t,d+m/2-u/2,r,u);switch(l){case 0:w=2;y=1;break;case 1:w=0;y=2;break;case 2:y=w=0}break;case 8:case 9:switch(v=new a.common.Rect(b-r-t,d-t-u,r,u),l){case 0:y=w=2;break;case 1:w=1;y=2;break;
...
function(c,b,e,d,g,f){function h(){var b=new a.common.PolylinesBuffer,c,f=new a.common.Marker,e,h,v,w,y,C,E;for(E in m)if(m.hasOwnProperty(E)){var F=m[E];var x=F.actualPosition;var A=d.getItemOptions(E);l.transformRect(x.x,x.y,x.width,x.height,!0,this,function(d,m,k,l){switch(F.actualVisibility){case 2:y=g.getTemplateParams(E),C=y.template.templateConfig,v=h=e=null,w=0,null!=A&&(h=e=A.itemTitleColor,v=A.minimizedItemShapeType),e=e||C.minimizedItemBorderColor||"#000080",h=h||C.minimizedItemFillColor||
"#000080",null==v&&(v=null!==C.minimizedItemShapeType?C.minimizedItemShapeType:n.minimizedItemShapeType),w=null===C.minimizedItemCornerRadius?C.minimizedItemSize.width:C.minimizedItemCornerRadius,null==v||6==v?(c=b.getPolyline(new a.common.PaletteItem({lineColor:e,lineWidth:C.minimizedItemLineWidth,lineType:C.minimizedItemLineType,fillColor:h,opacity:C.minimizedItemOpacity})),c.addSegment(new a.common.DotSegment(d,m,k,l,w))):f.draw(b,v,new a.common.Rect(d,m,k,l),new a.common.PaletteItem({lineColor:e,
lineWidth:C.minimizedItemLineWidth,lineType:C.minimizedItemLineType,fillColor:h,opacity:C.minimizedItemOpacity}))}})}k.activate("placeholder",9);k.polylinesBuffer(b)}var k,l,n,m;return{process:function(){k=c();l=b.getTransform();n=d.getOptions();m=f.getItemsPositions();k.reset("placeholder",9);h();return!1}}};a.orgdiagram.DrawShapeAnnotationTask=function(c,b,e,d,g,f,h,k){function l(b,c){var f,d;switch(k){case 1:var e=n.activate("placeholder",3);break;case 2:e=n.activate("placeholder",13)}var h=0;
for(f=b.length;h<f;h+=1){var g=b[h];if(null!=g.items&&0<g.items.length){var l=new a.common.Rect;var t=0;for(d=g.items.length;t<d;t+=1){var r=c(g.items[t]);null!=r&&l.addRect(r.actualPosition)}if(!l.isEmpty()){var A=new a.common.Shape(n);r=new a.orgdiagram.ShapeAnnotationConfig;var D="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");t=0;for(d=D.length;t<d;t+=1){var B=D[t];A[B]=g.hasOwnProperty(B)?g[B]:r[B]}A.position=
...
f.getItemPosition);return!1}}};a.orgdiagram.DrawTreeItemsTask=function(c,b,e,d,g,f,h,k,l,n,m,q,p,r){function t(){var b,c=n.getCursorTreeItem(),d=u(),e;for(e in v)if(v.hasOwnProperty(e)){var h=v[e];var g=h.actualPosition;1==h.actualVisibility&&y.transformRect(g.x,g.y,g.width,g.height,!0,this,function(g,k,q,n){var p=new a.common.Rect(g,k,q,n);if(null==d||d.overlaps(p)){var t=l.getTemplateParams(e);p=t.template;b=new a.common.RenderEventArgs;b.id=e;b.context=f.getConfig(e);b.isCursor=e==c;b.isSelected=
m.isSelected(e);b.templateName=p.templateConfig.name;b.template=t.template;b.isActive=t.isActive;b.hasSelectorCheckbox=t.hasSelectorCheckbox;b.hasButtons=t.hasButtons;b.hasGroupTitle=t.hasGroupTitle;b.buttons=t.buttons;b.onButtonsRender=t.onButtonsRender;w.activate("placeholder",12);w.template(g,k,q,n,h.contentPosition.x,h.contentPosition.y,h.contentPosition.width,h.contentPosition.height,p.itemTemplate.template(),p.itemTemplate.getHashCode(),p.itemTemplate.render,b,{borderWidth:p.templateConfig.itemBorderWidth});
if(t.hasGroupTitle){var r=0;switch(C.groupTitlePlacementType){case 2:case 0:r=2;break;case 3:r=q-(C.groupTitlePanelSize-4)}w.template(g,k,q,n,r,h.contentPosition.y,C.groupTitlePanelSize-4,h.contentPosition.height+2,x.template(),x.getHashCode(),x.render,b,null)}t.hasSelectorCheckbox&&(w.activate("placeholder",16),w.template(g,k,q,n,h.contentPosition.x,n-(C.checkBoxPanelSize-4),h.contentPosition.width,C.checkBoxPanelSize-4,F.template(),F.getHashCode(),F.render,b,null));if(t.hasButtons){w.activate("placeholder",
16);t=0;switch(C.groupTitlePlacementType){case 2:case 0:t=q-(C.buttonsPanelSize-4);break;case 3:t=2}w.template(g,k,q,n,t,h.contentPosition.y,C.buttonsPanelSize-4,Math.max(h.contentPosition.height,n-h.contentPosition.y),E.template(),p.templateConfig.name+E.getHashCode(),E.render,b,null)}}})}}function u(){var b=null;if(null!=k){b=d.getOptions().scale;var c=new a.common.Point(k.getPlaceholderOffset()),f=new a.common.Rect(h.getContentSize()),g=new a.common.Size(e.getOptimalPanelSize());c.scale(1/b);g.scale(1/
b);b=new a.common.Rect(c.x,c.y,Math.min(g.width,f.width),Math.min(g.height,f.height))}return b}var v,w,y,C,E,F,x;return{process:function(){w=c();C=g.getOptions();v=h.getItemsPositions();y=b.getTransform();E=r.getTemplate();F=p.getTemplate();x=q.getTemplate();w.reset("placeholder",12);w.reset("placeholder",16);t();return!1}}};a.orgdiagram.ActiveItemsTask=function(c,b){function e(a,c){var f=[],d;var e=0;for(d=c.length;e<d;e+=1){var h=c[e],g=b.getTemplate(h.templateName,a.defaultTemplateName,b.DefaultWidgetTemplateName).templateConfig;
...
e=g.read(e,b(h),"items",a);return a.isChanged},getItems:function(){return e}}};a.orgdiagram.SelectedItemsTask=function(c){function b(a){var b=[],c={},d;var f=0;for(d=a.length;f<d;f+=1){var e=a[f];null==e||c.hasOwnProperty(e)||(b.push(e),c[e]=!0)}return b}var e=[],d={},g=new a.common.ArrayReader(new a.common.ValueReader(["string","number"],!0),!0);return{process:function(){var a={isChanged:!1,hash:d},h=c.getSelectedItems();e=g.read(e,b(h),"items",a);return a.isChanged},getItems:function(){return e},
isSelected:function(a){return d.items.hasOwnProperty(a)}}};a.orgdiagram.SelectionPathItemsTask=function(a,b,e,d){function c(a,b,c){var d=[],f={},e;var h=0;for(e=a.length;h<e;h+=1){var g=a[h];switch(c){case 1:b.loopParents(this,g,function(a,c){if(null!=f[a])return b.SKIP;4!=c.visibility&&d.push(a);f[a]=!0})}}return d}var f=[];return{process:function(){var h=d.getSelectionPathMode(),g=a.getNavigationFamily(),l=b.getCursorTreeItem(),n=e.getItems().slice(0);n.push(l);f=c(n,g,h);return!0},getItems:function(){return f}}};
a.orgdiagram.CombinedContextsTask=function(a,b){return{process:function(){return!0},getConfig:function(c){return a.getConfig(c)||null!=b&&b.getConfig(c)}}};a.orgdiagram.ConnectionsGraphTask=function(c,b,e,d,g){var f={graph:null,nodeid:0};return{process:function(){var h=c().activate("placeholder",6),k=d.getBundles(),l=d.getNestedLayoutBottomConnectorIds(),n=e.getOptions(),m={graph:a.common.graph(),nodeid:0};h={treeItemsPositions:g.getItemsPositions(),nestedLayoutBottomConnectorIds:l,transform:b.getTransform(),
hasGraphics:h.hasGraphics};n={connectorType:n.connectorType,showExtraArrows:n.showExtraArrows,bevelSize:n.bevelSize,elbowType:n.elbowType};l=0;for(var q=k.length;l<q;l+=1)k[l].trace(m,h,n);f=m;return!0},getGraph:function(){return f.graph}}};a.orgdiagram.ItemsPositionsTask=function(c,b,e,d,g,f,h,k,l,n,m){function q(b){var c=new a.common.Rect(0,0,0,0),d;switch(O.orientationType){case 2:case 3:b.invert()}if(!G.isEmpty())switch(N.pageFitMode){case 0:case 5:var f=[new a.orgdiagram.LevelVisibility(0,1)];
c=p(f,0);break;default:f=[new a.orgdiagram.LevelVisibility(0,1)];var e=[];switch(N.minimalVisibility){case 2:e.push(2);break;case 0:case 3:case 4:e.push(2),e.push(3)}G.loopLevelsReversed(this,function(b,c){for(c=0;c<e.length;c+=1)f.push(new a.orgdiagram.LevelVisibility(b,e[c]))});var h=p(f,f.length-1);h.addRect(b);h.offset(0,0,5,5);var g=d=b=null;c=p(f,0);if(!r(c,h)&&(b=0,c=p(f,f.length-1),r(c,h))){for(g=d=f.length-1;1<d-b;)g=Math.floor((d+b)/2),c=p(f,g),r(c,h)?d=g:b=g;d!==g&&(c=p(f,d))}}return c}
function p(b,c){var d;J=[];G.loopLevels(this,function(b,c){b=new a.orgdiagram.TreeLevelPosition;b.currentvisibility=1;J.push(b)});for(d=0;d<=c;d+=1){var f=b[d];J[f.level].currentvisibility=f.currentvisibility}v();E();w();y();return new a.common.Rect(0,0,Math.round(u()),Math.round(t()))}function r(a,b){var c=!1;switch(N.pageFitMode){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function t(){var a=J[J.length-
1];return a.shift+a.nextLevelShift}function u(){var a=0,b;var c=0;for(b=J.length;c<b;c+=1)a=Math.max(a,J[c].currentOffset);return a+=N.normalItemsInterval}function v(){var b=n.getCursorTreeItem();B={};G.loopLevels(this,function(c,d){var f=J[c];G.loopLevelItems(this,c,function(c,d,e){e=new a.orgdiagram.TreeItemPosition;var h=m.isItemSelected(c)?1:d.visibility;d=l.getTemplateParams(c);h=0===h?f.currentvisibility:h;var g=b==c,k=N,q=O.orientationType;switch(h){case 1:var n=d.template.templateConfig;var p=
new a.common.Size(n.itemSize);var t=new a.common.Rect(0,0,p.width,p.height);g&&(p.height+=n.cursorPadding.top+n.cursorPadding.bottom,p.width+=n.cursorPadding.left+n.cursorPadding.right,t.x=n.cursorPadding.left,t.y=n.cursorPadding.top);d.hasSelectorCheckbox&&(p.height+=k.checkBoxPanelSize);if(d.hasButtons)switch(p.width+=k.buttonsPanelSize,k.groupTitlePlacementType){case 3:t.x+=k.buttonsPanelSize}if(d.hasGroupTitle)switch(p.width+=k.groupTitlePanelSize,k.groupTitlePlacementType){case 3:break;default:t.x+=
k.groupTitlePanelSize}break;case 2:n=d.template.templateConfig;p=new a.common.Size(n.minimizedItemSize);break;case 3:case 4:p=new a.common.Size}switch(q){case 2:case 3:p.invert()}e.actualVisibility=h;e.actualSize=p;e.contentPosition=t;B[c]=e})})}function w(){var a,b;G.loopLevels(this,function(c,d){var f=J[c];f.shift=0;f.depth=0;f.actualVisibility=4;b=a=null;G.loopLevelItems(this,c,function(c,d,e){c=B[c];f.depth=Math.max(f.depth,c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:b=
b?Math.min(b,c.actualSize.height):c.actualSize.height;break;default:a=a?Math.min(a,c.actualSize.height):c.actualSize.height}f.actualVisibility=Math.min(f.actualVisibility,c.actualVisibility)});null==a&&(a=f.depth);null!=b&&b>a&&(a=b);switch(N.verticalAlignment){case 0:f.horizontalConnectorsDepth=a/2;break;case 1:f.horizontalConnectorsDepth=f.depth/2;break;case 2:f.horizontalConnectorsDepth=f.depth-a/2}})}function y(){var a=N.lineLevelShift,b,c=0,d=0;var f=8*K.linesWidth;switch(K.arrowsDirection){case 1:c=
f;d=0;break;case 2:c=0,d=f}f=0;for(b=J.length;f<b;f+=1){var e=J[f];var h=k.getConnectorsStacksSizes(f);a+=e.setShift(a,C(e.actualVisibility),d,c,h.parentsStackSize)}}function C(a){var b=0;switch(a){case 1:b=N.normalLevelShift;break;case 2:b=N.dotLevelShift;break;case 3:case 4:b=N.lineLevelShift}return b}function E(){var a;var b=0;for(a=J.length;b<a;b+=1)J[b].currentOffset=0;H.loopPostOrder(this,function(a,b,c,f){c=B[a];var d=c.actualVisibility;f=G.getLevelIndex(a);f=J[f];d=W[0===d?f.currentvisibility:
d]/2;var e=8*K.linesWidth;c.leftPadding=d+(0<f.currentOffset?d*b.relationDegree*N.cousinsIntervalMultiplier:0);c.rightPadding=d;0!=K.arrowsDirection&&(b.connectorPlacement&8&&(c.leftPadding+=e),b.connectorPlacement&2&&(c.rightPadding+=e));c.offset=f.currentOffset+c.leftPadding;f.currentOffset=c.offset+c.actualSize.width+c.rightPadding;if(H.hasChildren(a))if(a=F(b),0<a)A(b,a);else if(0>a){a=-a;x(b,a);var h=null;var g={};var m=null;c=H.parent(b.id);if(null!==c&&(H.loopChildrenReversed(this,c.id,function(a,
c,f){if(c===b)h=[];else if(null!==h){a=null;f=[];var d;var e=L[c.id];void 0===e&&(e=[]);e=e.slice();e.splice(0,0,c.id);var k=0;for(d=e.length;k<d;k+=1){var l=B[e[k]];f[k]=l.offset+l.actualSize.width+l.rightPadding}e=[];k=I[b.id];void 0===k&&(k=[]);k=k.slice();k.splice(0,0,b.id);d=0;for(l=k.length;d<l;d+=1){var p=B[k[d]];e[d]=p.offset-p.leftPadding}k=Math.min(f.length,e.length);for(d=0;d<k&&!(l=e[d]-f[d],a=null!==a?Math.min(a,l):l,0>=l);d+=1);q=Math.floor(a);g[c.id]=q;if(0<q)h.splice(0,0,c);else return m=
c,!0}}),0<h.length)){f=null;if(null!==m)for(e=[m],e=e.concat(h),e.push(b),f=[[m]],c=1,d=e.length;c<d;c+=1){var k=e[c-1];var l=e[c];2==k.gravity||1==l.gravity?f[f.length-1].push(l):f.push([l])}else f=[h.slice(0)],f[f.length-1].push(b);if(0<f.length)for(h=f[f.length-1],c=h.length-2;0<=c;--c){l=h[c];var q=g[l.id];a=Math.min(q,a);x(l,a);A(l,a)}e=a/(f.length-1);for(d=f.length-2;0<d;--d)for(k=f[d],c=k.length-1;0<=c;--c)l=k[c],q=g[l.id],a=Math.min(d*e,Math.min(q,a)),x(l,a),A(l,a)}}})}function F(a){var b=
B[a.id];b=b.offset+b.actualSize.width/2;var c=null;if(null===a.visualAggregatorId){var f=null;H.loopChildren(this,a.id,function(a,b,c){f=b;if(f.connectorPlacement&1)return!0});var d=B[f.id];var e=null;H.loopChildrenReversed(this,a.id,function(a,b,c){e=b;if(e.connectorPlacement&1)return!0});a=B[e.id];switch(M.horizontalAlignment){case 1:c=d.offset+d.actualSize.width/2;break;case 2:c=a.offset+a.actualSize.width/2;break;case 0:c=(d.offset+a.offset+a.actualSize.width)/2}}else a=B[a.visualAggregatorId],
c=a.offset+a.actualSize.width/2;return b-c}function x(a,b){var c=B[a.id];c.offset+=b;a=J[G.getLevelIndex(a.id)];a.currentOffset=Math.max(a.currentOffset,c.offset+c.actualSize.width+c.rightPadding)}function A(a,b){var c,f;H.loopLevels(this,a.id,function(a,d,e){c=B[a];c.offset+=b;f=J[G.getLevelIndex(a)];f.currentOffset=Math.max(f.currentOffset,c.offset+c.actualSize.width);return!0})}function D(){var b=null;G.loopLevels(this,function(c,f){var d=J[c];G.loopLevelItems(this,c,function(c,f,e){c=B[c];f=c.actualSize;
var h=b;e=0;switch(c.actualVisibility){case 1:switch(N.verticalAlignment){case 0:e=0;break;case 1:e=(d.depth-f.height)/2;break;case 2:e=d.depth-f.height}break;case 2:case 3:case 4:e=d.horizontalConnectorsDepth-f.height/2}f=new a.common.Rect(c.offset,d.shift+e,f.width,f.height);e=d.shift+d.horizontalConnectorsDepth;var g=null!=h?h.shift+h.connectorShift:null;h=null!=h?h.levelSpace/2:null;var m=d.shift+d.connectorShift;var k=d.levelSpace/2;c.actualPosition=f;c.horizontalConnectorsShift=e;c.topConnectorShift=
g;c.topConnectorInterval=h;c.bottomConnectorShift=m;c.bottomConnectorInterval=k});b=d})}var B={};var z=null;var G,J,H,I,L,O,K,M,N,V,W;return{process:function(){var m=N=d.getOptions();var l=[];l[1]=m.normalItemsInterval;l[2]=m.dotItemsInterval;l[3]=m.lineItemsInterval;l[4]=m.lineItemsInterval;W=l;O=e.getOptions();K=g.getOptions();M=f.getOptions();G=k.getTreeLevels();H=h.getVisualTree();I=h.getLeftMargins();L=h.getRightMargins();J=[];B={};m=c.getOptimalPanelSize();V=b.getOptions();m.scale(1/V.scale);
m=new a.common.Rect(0,0,m.width,m.height);z=q(m);D();return!0},getItemsPositions:function(){return B},getItemPosition:function(a){return B[a]},getContentSize:function(){return z}}};a.orgdiagram.OrgTreeTask=function(c){var b;function e(c){var f,e=0,l=a.common.tree();var n=0;for(f=c.length;n<f;n+=1){var m=c[n];if(null!=m.id){var q=new a.orgdiagram.OrgItem(m);var p=parseInt(m.id,10);e=Math.max(isNaN(p)?0:p,e);l.add(m.parent,q.id,q)}}e+=1;c=new a.orgdiagram.ItemConfig;c.id=e;c.title="internal root";c.isVisible=
!1;c.isActive=!1;var r=new a.orgdiagram.OrgItem(c);r.hideParentConnection=!0;r.hideChildrenConnection=!0;l.add(null,r.id,r);l.loopLevels(this,function(a,b,c){if(0<c)return l.BREAK;r.id!=a&&(l.adopt(r.id,a),b.itemType=0)});d(l);b=l;g=e;return!0}function d(a){a.loopLevels(this,function(b,c,d){var f=!0;if(c.isVisible)return a.SKIP;a.loopChildren(this,b,function(a,b,c){if(0!=b.itemType)return f=!1,!0});if(f)c.hideChildrenConnection=!0,a.loopChildren(this,b,function(a,b,c){b.hideParentConnection=!0});
else return a.SKIP})}var g=b=null;return{process:function(){e(c.getItems());return!0},getOrgTree:function(){return b},getMaximumId:function(){return g}}};a.orgdiagram.PaletteManagerTask=function(c,b){var e;return{process:function(){var d=[];null!=b&&(d=b.getOptions().linesPalette);e=new a.common.PaletteManager(c.getOptions(),d);return!0},getPaletteManager:function(){return e}}};a.orgdiagram.VisualTreeLevelsTask=function(c,b){function e(b,c,d,f,e){var h,g,m,k,l,q,n,C={},E,F,x;d.loopLevels(this,function(e,
p){p=new a.orgdiagram.TreeLevelConnectorStackSize;c[e]=p;n=[];d.loopLevelItems(this,e,function(c,e,h){h=[];if(!C.hasOwnProperty(c)&&(e.connectorPlacement&4&&h.push(c),h=h.concat(e.partners),0<h.length)){q=new a.common.VerticalConnectorBundle(h,[]);for(var g=0,m=h.length;g<m;g+=1)C[h[g]]=q;f.loopChildren(this,c,function(a,b,c){b.connectorPlacement&1&&q.toItems.push(a)});1<h.length&&n.push(q);(1<q.fromItems.length||0<q.toItems.length)&&b.push(q)}e.connectorPlacement&8&&(q=new a.common.HorizontalConnectorBundle(c,
d.getPrevItem(c)),b.push(q));e.connectorPlacement&2&&(q=new a.common.HorizontalConnectorBundle(c,d.getNextItem(c)),b.push(q))});if(0<n.length){x=a.common.pile();h=0;for(g=n.length;h<g;h+=1){q=n[h];F=E=null;m=0;for(k=q.fromItems.length;m<k;m+=1)l=d.getItemPosition(q.fromItems[m]),E=null!=E?Math.min(E,l):l,F=null!=F?Math.max(F,l):l;x.add(E,F,q)}p.parentsStackSize=x.resolve(this,function(a,b,c,d,f){c.fromOffset=d+1;c.fromStackSize=f})}})}var d=null,g=null,f=null,h=new a.orgdiagram.TreeLevelConnectorStackSize;
return{process:function(){var b=c.getVisualTree();d=a.common.TreeLevels();b.loopLevels(this,function(a,b,c){d.addItem(c,a,b)});g=[];f=[];e(g,f,d,b);return!0},getTreeLevels:function(){return d},getBundles:function(){return g},getConnectorsStacksSizes:function(a){return f[a]||h},getNestedLayoutBottomConnectorIds:function(){return{}}}};a.orgdiagram.VisualTreeTask=function(c,b,e,d){function g(a,b,c){var e,g,m,q,w,x,I,L,A,K,M,N,F,C={},E,P={},U,Q,R,T={},S;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=
b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,m,k){var l;if(!d&&!m.hasVisibleChildren)return a.SKIP;var K=c.node(f);K||(K=u({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},m),c.add(null,f,K));R=Q=0;null!=(x=c.indexOf(f))&&(Q=x,R=c.countSiblings(f)-x-1);var I=[];a.loopChildren(this,f,function(a,b,h){if(d||b.hasVisibleChildren){e=u({parentId:f,actualItemType:b.itemType},b);switch(K.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=
2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:v(K,e),e.connectorPlacement=5,l=u({visibility:4}),c.add(l.id,e.id,e),e=l;case 8:case 2:g=c.parent(f);if(K.connectorPlacement&2)q=p(c,y.navigationFamily,K),c.add(g.id,e.id,e,q+1),e.connectorPlacement=6,e.gravity=2;else if(K.connectorPlacement&8)w=r(c,y.navigationFamily,K),c.add(g.id,e.id,e,w),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:q=p(c,y.navigationFamily,K);c.add(g.id,e.id,e,q+1);e.connectorPlacement=
6;e.gravity=2;break;default:w=r(c,y.navigationFamily,K),c.add(g.id,e.id,e,w),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=K.parentId?v(c.node(K.parentId),e):v(K,e,!0);break;case 2:v(K,e)}break;case 4:v(K,e),e.connectorPlacement=5,l=u({visibility:4}),c.add(l.id,e.id,e),e=l;case 1:a=K;var m=b.levelOffset||0,k=null;h=!1;for(var n=0;n<=m;){k=null==k?a:c.node(k.visualAggregatorId);if(null==k.visualAggregatorId){var t=u({visibility:4,visualAggregatorId:null,connectorPlacement:h?
0:5});c.insert(k.id,t.id,t);k.visualAggregatorId=t.id}n+=1}a=k;switch(b.adviserPlacementType){case 2:c.add(a.id,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:c.add(a.id,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&v(K,e);break;case 0:b=b.levelOffset||0;null==I[b]?I[b]=[e]:I[b].push(e);v(K,e);break;case 7:case 6:g=c.parent(f);if(K.connectorPlacement&2)c.add(g.id,e.id,e,Q),e.connectorPlacement=6,e.gravity=2;else if(K.connectorPlacement&8)c.add(g.id,e.id,e,c.countChildren(g.id)-
R),e.connectorPlacement=12,e.gravity=1;else{switch(b.adviserPlacementType){case 2:c.add(g.id,e.id,e,Q);e.gravity=2;break;default:c.add(g.id,e.id,e,c.countChildren(g.id)-R),e.gravity=1}switch(e.actualItemType){case 6:e.connectorPlacement=5;break;case 7:e.connectorPlacement=4}}null!=K.parentId?v(c.node(K.parentId),e):v(K,e,!0)}}});switch(K.actualItemType){case 7:case 8:case 6:break;default:S=[],null!=(g=c.parent(f))&&c.loopChildrenRange(this,g.id,Q,c.countChildren(g.id)-R,function(b,c,d){if(c.id==f)S.push(c);
else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==f&&S.push(c)}}),1<S.length&&(T[f]=S)}C[f]=[];P[f]=[];k=[];if(0<I.length){g=h(c,K);for(var A=0;A<I.length-1;A+=1){var M=I[A];if(null!=M){var z=t(c,g,4==K.visibility&&0===K.connectorPlacement);k.push([z]);var D=0;switch(b.horizontalAlignment){case 0:D=Math.ceil(M.length/2)-1;break;case 1:D=-1;break;case 2:D=M.length-1}for(x=D;0<=x;--x)L=M[x],c.add(g.id,L.id,L,0),L.connectorPlacement=5,L.gravity=2;for(x=D+1;x<M.length;x+=1)L=M[x],c.add(g.id,
L.id,L),L.connectorPlacement=5,L.gravity=1;g=z}}n(a,c,b,K,I[I.length-1],m.childrenPlacementType,C[f],P[f]);C[f]=C[f].concat(k);P[f]=P[f].concat(I.slice(0,I.length-1))}});a.loopPostOrder(this,function(a,d,e,h){d=c.node(a);var g=null!=T[e];if(null!=d){e=P[a];var q=C[a];if(null!=h){var p=g;switch(h.placeAssistantsAboveChildren){case 0:b.placeAssistantsAboveChildren&&(p=!0);break;case 1:p=!0}if(p&&(M=k(c,d),0<M&&(d.visualDepth=M+1,null!==d.visualAggregatorId)))for(m=c.node(d.visualAggregatorId),p=c.hasChildren(m.id),
x=0;x<M-1;x+=1)m=t(c,m,!p)}if(null!=h){p=g;switch(h.placeAdvisersAboveChildren){case 0:b.placeAdvisersAboveChildren&&(p=!0);break;case 1:p=!0}if(p){h=0;g=c.parent(d.id);var n,r;if(null!==g){p=c.indexOf(d.id);for(n=1;null!=(r=c.getChild(g.id,p+n));)if(r.connectorPlacement&8)h=Math.max(h,l(c,r)),n+=1;else break;for(n=1;null!=(r=c.getChild(g.id,p-n));)if(r.connectorPlacement&2)h=Math.max(h,l(c,r)),n+=1;else break}M=h;if(1<M)for(d.visualDepth+=M-1,p=c.hasChildren(a),m=d,x=0;x<M-1;x+=1)m=t(c,m,!p)}}N=
[];x=0;for(I=e.length;x<I;x+=1)for(U=e[x],A=N[x]=0,K=U.length;A<K;A+=1)N[x]=Math.max(N[x],l(c,U[A]));x=0;for(I=N.length;x<I;x+=1)if(F=N[x],1<F)for(A=0,K=q[x].length;A<K;A+=1)if(E=q[x][A],c.hasChildren(E.id))for(M=F;1<M;)E=t(c,E,!1),--M;null!=T[a]&&f(c,d,T[a])}})}function f(a,b,c){var d,f=0,e=[],g;var m=0;for(d=c.length;m<d;m+=1){var k=c[m];f=Math.max(f,k.visualDepth)}m=0;for(d=c.length;m<d;m+=1){k=c[m];var l=h(a,k);var q=1;for(g=k;null!=g.visualAggregatorId;)g=a.node(g.visualAggregatorId),g.connectorPlacement=
5,q+=1;for(;q<f;)l=t(a,l,!1),q+=1;e.push(h(a,l).id)}g=h(a,b);if(a.hasChildren(g.id)){l=c[Math.floor(c.length/2)];if(1<c.length&&0===c.length%2)for(m=a.parent(l.id),d=p(a,y.navigationFamily,l),q=a.getChild(m.id,d).gravity||a.getChild(m.id,d+1).gravity,l=u({visibility:4,connectorPlacement:l.connectorPlacement&10,gravity:q}),a.add(m.id,l.id,l,d+1),q=1;q<f;)l=t(a,l,!1),l.connectorPlacement=0,q+=1;m=0;for(d=c.length;m<d;m+=1)k=c[m],y.navigationFamily.loopChildren(this,b.id,function(a,c,d){switch(c.actualItemType){case 5:case 2:case 4:case 1:break;
default:b.id!=k.id&&v(k,c)}return y.navigationFamily.SKIP});l=h(a,l);a.moveChildren(g.id,l.id)}l.partners=e}function h(a,b){for(;null!=b.visualAggregatorId;)b=a.node(b.visualAggregatorId);return b}function k(a,b){var c=0;null!=b.visualAggregatorId&&a.loopLevels(this,b.id,function(d,f,e){if(b.visualAggregatorId==d)return a.SKIP;c=e+1});return c}function l(a,b){var c=0;a.loopLevels(this,b.id,function(a,b,d){c=d+1});return c+1}function n(a,b,c,d,f,e,g,k){var l,p,n,t=4==d.visibility&&0===d.connectorPlacement;
switch(c.horizontalAlignment){case 0:case 1:var r=3;break;case 2:r=2}0===e&&(e=q(a,d)?0===c.leavesPlacementType?3:c.leavesPlacementType:0===c.childrenPlacementType?2:c.childrenPlacementType);d=h(b,d);3==e&&3>f.length&&(e=2);switch(e){case 2:e=0;for(l=f.length;e<l;e+=1)c=f[e],g=a.node(c.id),b.add(d.id,c.id,c),c.connectorPlacement=(g.hideParentConnection?0:1)|(g.hideChildrenConnection?0:4),0===e&&(c.relationDegree=1);break;case 3:e=Math.min(c.maximumColumnsInMatrix,Math.ceil(Math.sqrt(f.length)));l=
Math.ceil(f.length/e);var v=Math.ceil(e/2);for(p=0;p<v;p+=1)for(a=d,n=0;n<l;n+=1){r=m(f,2*p,n,e);c=m(f,2*p+1,n,e);void 0===g[n]&&(g[n]=[],k[n]=[]);null!==r&&(0===p&&(r.relationDegree=1),b.add(a.id,r.id,r),r.connectorPlacement=(t?0:2)|4,r.gravity=2,k[n].push(r));if(null!==r||null!==c){var w=u({visibility:4,connectorPlacement:t?0:5});b.add(a.id,w.id,w);g[n].push(w)}null!==c&&(b.add(a.id,c.id,c),c.connectorPlacement=(t?0:8)|4,c.gravity=1,k[n].push(c));a=w}2<e&&(d.visualAggregatorId=null);break;case 1:e=
0;for(l=f.length;e<l;e+=1){c=f[e];w=u({visibility:4,connectorPlacement:t?0:5});switch(r){case 2:b.add(d.id,c.id,c);b.add(d.id,w.id,w);c.connectorPlacement=(t?0:2)|4;c.gravity=2;break;case 3:b.add(d.id,w.id,w),b.add(d.id,c.id,c),c.connectorPlacement=(t?0:8)|4,c.gravity=1}g[e]=[w];k[e]=[c];d=w}break;default:throw"Children placement is undefined!";}}function m(a,b,c,d){0<d%2&&(b===d-1?b=a.length:b===d&&(b=d-1));b=c*d+b;return b>a.length-1?null:a[b]}function q(a,b){var c=!1,d=!0;a.loopChildren(this,b.id,
function(b,f,e){c=!0;if(0===f.itemType&&a.hasChildren(b))return d=!1,!0});return c&&d}function p(a,b,c){var d=null,f={},e=a.parent(c.id);a.loopChildrenReversed(this,e.id,function(a,e,g){if(null===d)a==c.id&&(d=-1,f[c.id]=!0,b.loopChildren(this,c.id,function(a,c,d){if(0<d)return b.BREAK;f[a]=!0}));else if(f.hasOwnProperty(a))b.loopChildren(this,e.id,function(a,c,d){if(0<d)return b.BREAK;f[a]=!0});else return d=g,!0});return d}function r(a,b,c){var d=null,f={},e=a.parent(c.id);a.loopChildren(this,e.id,
function(a,e,g,h){if(null===d)a==c.id&&(d=h+1,f[c.id]=!0,b.loopChildren(this,c.id,function(a,c,d){if(0<d)return b.BREAK;f[a]=!0}));else if(f.hasOwnProperty(a))b.loopChildren(this,a,function(a,c,d){if(0<d)return b.BREAK;f[a]=!0});else return d=g,!0});return d}function t(a,b,c){c=u({visibility:4,visualAggregatorId:b.visualAggregatorId,connectorPlacement:4==b.visibility&&0===b.connectorPlacement||c?0:5});a.insert(b.id,c.id,c);b.visualAggregatorId=c.id;return c}function u(b,c){var d=new a.orgdiagram.TreeItem,
f;for(f in b)b.hasOwnProperty(f)&&(d[f]=b[f]);null!=c?(d.id=c.id,d.visibility=c.isVisible?0:4):(C+=1,d.id=C);return d}function v(a,b,c){var d=[];c||4==a.visibility||!E.hasOwnProperty(a.id)?(c||d.push(a.id),y.navigationFamily.loopParents(this,a.id,function(a,b,c){if(4!=b.visibility&&(d.push(a),E.hasOwnProperty(a)))return y.navigationFamily.SKIP})):d.push(a.id);null!=y.navigationFamily.node(b.id)?y.navigationFamily.adopt(d,b.id):y.navigationFamily.add(d,b.id,b)}function w(a,b,c){a.loop(this,function(a,
d){b[a]=[];c[a]=[]});a.loopPostOrder(this,function(a,d,f,e){d=b[f];e=c[f];var g=b[a],h=c[a],m;if(null!=f){d[0]||(d[0]=a);f=0;for(m=g.length;f<m;f+=1)d[f+1]||(d[f+1]=g[f]);e[0]=a;f=0;for(m=h.length;f<m;f+=1)e[f+1]=h[f]}})}var y={visualTree:null,leftMargins:{},rightMargins:{},navigationFamily:null},C,E;return{process:function(){var d=c.getOrgTree(),f=e.getOptions();E=null!=b?b.getActiveItems():{};y.visualTree=a.common.tree();y.navigationFamily=a.common.family();C=c.getMaximumId();d.hasNodes()&&g(d,
f,y.visualTree);y.leftMargins={};y.rightMargins={};w(y.visualTree,y.leftMargins,y.rightMargins);return!0},getVisualTree:function(){return y.visualTree},getNavigationFamily:function(){return y.navigationFamily},getConnectionsFamily:function(){return y.connectionsFamily},getLeftMargins:function(){return y.leftMargins},getRightMargins:function(){return y.rightMargins}}};a.common.AnnotationLabelTemplate=function(){var c=["div",{type:"checkbox",name:"checkbox","class":["bp-item","bp-corner-all","bp-connector-label"]}];
return{template:function(){return c},getHashCode:function(){return"defaultAnnotationLabelTemplate"},render:function(b,c){b=c.context;a.common.isArray(b.label)?(c.element.innerHTML="",c.element.appendChild(a.common.JsonML.toHTML(b.label))):c.element.innerHTML=b.label}}};a.common.ButtonsTemplate=function(c){var b=["div",{style:{position:"absolute"}}];return{template:function(){return b},getHashCode:function(){return"defaultButtonsTemplate"},render:function(b,c){b=0;var d=c.buttons,f;switch(c.renderingMode){case 0:for(f=
0;f<d.length;f+=1){var e=d[f];var k=["button",{style:{position:"absolute",top:b+"px",left:"0px"},"class":["orgdiagrambutton","bp-button"],"data-buttonname":e.name},["span",{style:{width:e.size.width+"px",height:e.size.height+"px"},"class":["bp-icon",e.icon]}]];c.element.appendChild(a.common.JsonML.toHTML(k));b+=10+e.size.height}}}}};a.common.CheckBoxTemplate=function(a){var b=["div",["label",["nobr",["input",{type:"checkbox",name:"checkbox","class":"bp-selectioncheckbox"}],"\u00a0",["span",{name:"selectiontext",
"class":"bp-selectiontext"},a]]]];return{template:function(){return b},getHashCode:function(){return"defaultCheckBoxTemplate"},render:function(a,b){a=b.element.firstChild.firstChild.firstChild;a.checked=b.isSelected;a.setAttribute("data-id",b.id);b.element.firstChild.firstChild.childNodes[2].setAttribute("data-id",b.id)}}};a.common.CursorTemplate=function(a,b){var c=["div",{style:{width:b.itemSize.width+b.cursorPadding.left+b.cursorPadding.right+"px",height:b.itemSize.height+b.cursorPadding.top+b.cursorPadding.bottom+
"px",borderWidth:b.cursorBorderWidth+"px"},"class":["bp-item","bp-corner-all","bp-cursor-frame"]}];return{template:function(){return c},getHashCode:function(){return"defaultCursorTemplate"},render:function(a,b){}}};a.common.DotHighlightTemplate=function(a,b){var c=function(a){var b=a.minimizedItemCornerRadius;null==b&&(b=Math.max(a.highlightPadding.left+a.minimizedItemSize.width+a.highlightPadding.right,a.highlightPadding.top+a.minimizedItemSize.height+a.highlightPadding.bottom)+a.highlightBorderWidth);
return["div",{style:{borderWidth:a.highlightBorderWidth+"px",MozBorderRadius:b+"px",WebkitBorderRadius:b+"px","-khtml-border-radius":b+"px",borderRadius:b+"px"},"class":["bp-item","bp-highlight-dot-frame"]}]}(b);return{template:function(){return c},getHashCode:function(){return"defaultDotHighlightTemplate"},render:function(a,b){}}};a.common.GroupTitleTemplate=function(c){var b=["div",{style:{fontSize:c.groupTitleFontSize,fontFamily:c.groupTitleFontFamily,fontWeight:c.groupTitleFontWeight,fontStyle:c.groupTitleFontStyle},
"class":["bp-item","bp-corner-all","bp-grouptitle-frame"]},function(a,b,g){var d="";switch(a){case 1:d="rotate(-90deg)";break;case 2:d="rotate(90deg)"}a=c.groupTitleFontSize;var e=c.groupTitleFontFamily,k=c.groupTitleFontWeight,l=c.groupTitleFontStyle,n=null;switch(b){case 0:n="center";break;case 1:n="left";break;case 2:n="right"}b={fontSize:a,fontFamily:e,fontWeight:k,fontStyle:l,position:"absolute",padding:0,margin:0,textAlign:n,lineHeight:1,"-webkit-transform-origin":"center center","-moz-transform-origin":"center center",
"-o-transform-origin":"center center","-ms-transform-origin":"center center","-webkit-transform":d,"-moz-transform":d,"-o-transform":d,"-ms-transform":d,transform:d};switch(g){case 0:g=["div",{style:b,"class":["bp-title-content","bp-item","bp-corner-all"]}];break;default:b.borderCollapse="collapse";d=null;switch(g){case 1:d="middle";break;case 0:d="top";break;case 2:d="bottom"}g=["table",{style:b},["tbody",["tr",["td",{style:{verticalAlign:d,padding:0},"class":"bp-title-content"}]]]]}return g}(c.groupTitleOrientation,
c.groupTitleHorizontalAlignment,c.groupTitleVerticalAlignment)];return{template:function(){return b},getHashCode:function(){return"defaultGroupTitleTemplate"},render:function(b,d){var e=d.context;b=e.groupTitleColor||c.groupTitleColor;var f={},h=d.width,k=d.height;f.left=Math.round(h/2-k/2)+"px";f.top=Math.round(k/2-h/2)+"px";f.width=k+"px";f.height=h+"px";f.maxWidth=f.width;f.maxHeight=f.height;a.common.JsonML.applyStyles(d.element.firstChild,f);e=e.groupTitle||"";e=e.replace(/\n/g,"<br/>");switch(c.groupTitleVerticalAlignment){case 0:f=
d.element.firstChild;break;default:f=d.element.firstChild.firstChild.firstChild.firstChild,f.style.borderCollapse="collapse"}f.style.color=a.common.highestContrast(b,c.itemTitleSecondFontColor,c.itemTitleFirstFontColor);f.textContent=e;a.common.JsonML.applyStyles(d.element,{backgroundColor:b})}}};a.common.HighlightTemplate=function(a,b){var c=["div",{style:{borderWidth:b.highlightBorderWidth+"px"},"class":["bp-item","bp-corner-all","bp-highlight-frame"]}];return{template:function(){return c},getHashCode:function(){return"defaultHighlightTemplate"},
render:function(a,b){}}};a.common.ItemTemplate=function(c,b){var e=function(b){var c=new a.common.Size(b.itemSize);c.width-=2*b.itemBorderWidth;c.height-=2*b.itemBorderWidth;return["div",{style:{borderWidth:b.itemBorderWidth+"px"},"class":["bp-item","bp-corner-all","bt-item-frame"]},["div",{name:"titleBackground",style:{top:"2px",left:"2px",width:c.width-4+"px",height:"18px"},"class":["bp-item","bp-corner-all","bp-title-frame"]},["div",{name:"title",style:{top:"1px",left:"4px",width:c.width-4-8+"px",
height:"16px"},"class":["bp-item","bp-title"]}]],["div",{name:"photoBorder",style:{top:"24px",left:"2px",width:"50px",height:"60px"},"class":["bp-item","bp-photo-frame"]},["img",{name:"photo",alt:"",style:{width:"50px",height:"60px"}}]],["div",{name:"description",style:{top:"24px",left:"56px",width:c.width-4-56+"px",height:"74px"},"class":["bp-item","bp-description"]}]]}(b);return{template:function(){return e},getHashCode:function(){return"defaultItemTemplate"},render:function(b,e){b=e.context;var d=
null!=b.itemTitleColor?b.itemTitleColor:"#4169e1",h=a.common.highestContrast(d,c.itemTitleSecondFontColor,c.itemTitleFirstFontColor),g=e.element;e=g.firstChild;var l=g.childNodes[1].firstChild,n=e.firstChild;g=g.childNodes[2];a.common.JsonML.applyStyles(e,{backgroundColor:d});l.src=b.image;l.alt=b.title;a.common.JsonML.applyStyles(n,{color:h});n.textContent=b.title;g.textContent=b.description}}};a.common.UserTemplate=function(c,b,e){var d=a.common.hashCode(JSON.stringify(b));return{template:function(){return b},
getHashCode:function(){return d},render:function(b,d){if(null!=e)e(b,d);else{var f=d.context,g=null!=f.itemTitleColor?f.itemTitleColor:"#4169e1",l=a.common.highestContrast(g,c.itemTitleSecondFontColor,c.itemTitleFirstFontColor);a.common.getElementsByName(this,d.element,"photo",function(a){a.src=f.image;a.alt=f.title});a.common.getElementsByName(this,d.element,"titleBackground",function(b){a.common.JsonML.applyStyles(b,{background:g})});a.common.getElementsByName(this,d.element,"title",function(b){a.common.JsonML.applyStyles(b,
{color:l});b.textContent=f.title});a.common.getElementsByName(this,d.element,"description",function(a){a.textContent=f.description})}}}};a.orgdiagram.BaseControl=function(c,b,e,d,g){function f(b,c){null==c&&(c=!0);switch(b){case 1:h(c,!1);break;case 2:z.layout.forceCenterOnCursor=!1;z.tasks.process("HighlightItemOptionTask",null,!1);z.graphics.end();break;default:t(z.layout),r(z.layout),p(z.layout,z.name),b=z.layout,b.mousePanel.addEventListener("mousemove",u),b.mousePanel.addEventListener("click",
w),b.mousePanel.addEventListener("dblclick",y),b.mousePanel.addEventListener("change",v),b.scrollPanel.addEventListener("keydown",C),b.scrollPanel.addEventListener("scroll",k),z.options.enablePanning&&a.common.isChrome()&&(b.scrollPanel.draggable=!0,b.scrollPanel.addEventListener("dragstart",E),b.scrollPanel.addEventListener("drag",x),b.scrollPanel.addEventListener("dragend",x),b.scrollPanel.addEventListener("dragover",F)),z.tasks=e(l,n,m,q,g),z.graphics=a.common.createGraphics(z.options.graphicsType,
z.layout.element),z.graphics.debug=!1,h(!0,!1)}}function h(b,c){z.layout.forceCenterOnCursor=b;z.tasks.process("OptionsTask",null,c);z.graphics.end();b&&(b=z.tasks.getTask("CenterOnCursorTask"),b=b.getPlaceholderOffset(),z.layout.scrollPanel.scrollLeft=b.x,z.layout.scrollPanel.scrollTop=b.y);b=a.common.getFixOfPixelALignment(z.layout.element);a.common.JsonML.applyStyles(z.layout.scrollPanel,{top:"0px",left:"0px",marginBottom:"0px",marginRight:"0px",marginLeft:b.width+"px",marginTop:b.height+"px"})}
function k(a){null==O&&(O=window.setTimeout(function(){z.layout.forceCenterOnCursor=!1;z.tasks.process("LayoutOptionsTask",null,!1);z.graphics.end();window.clearTimeout(O);O=null},200))}function l(){return z.options}function n(){return z.graphics}function m(){var b=z.layout,c=a.common.getInnerSize(b.element),d=new a.common.Point(b.scrollPanel.scrollLeft,b.scrollPanel.scrollTop);return{forceCenterOnCursor:b.forceCenterOnCursor,scrollPanelSize:c,placeholderOffset:d}}function q(b){var c=z.layout,d=new a.common.Size(b.contentSize);
d.scale(1*b.scale);a.common.JsonML.applyStyles(c.mousePanel,d.getCSS());a.common.JsonML.applyStyles(c.placeholder,b.contentSize.getCSS());var f="scale("+b.scale+","+b.scale+")";a.common.JsonML.applyStyles(c.placeholder,{"transform-origin":"0 0",transform:f,"-ms-transform":f,"-webkit-transform":f,"-o-transform":f,"-moz-transform":f});f=new a.common.Size(b.scrollPanelSize);b.autoSize&&(f=new a.common.Size(d.width+25,d.height+25),f.cropBySize(b.autoSizeMaximum),f.addSize(b.autoSizeMinimum),a.common.JsonML.applyStyles(c.element,
f.getCSS()));a.common.JsonML.applyStyles(c.scrollPanel,f.getCSS());return f}function p(b,d){var f=a.common.getInnerSize(b.element);f=new a.common.Rect(0,0,f.width,f.height);var e=new a.common.Rect(f),g=a.common.getFixOfPixelALignment(c);a.common.JsonML.appendDOM(b.element,a.common.JsonML.toHTML(["div",{tabindex:0,style:{position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:f.width+"px",height:f.height+"px",padding:"0px",marginBottom:"0px",marginRight:"0px",
marginLeft:g.width+"px",marginTop:g.height+"px"},"class":d,$:function(a){b.scrollPanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"hidden"},e.getCSS()),"class":d,$:function(a){b.mousePanel=a}},["div",{style:a.common.mergeObjects({position:"absolute",overflow:"hidden"},e.getCSS()),"class":["placeholder",d],$:function(a){b.placeholder=a}},["div",{style:{position:"absolute",overflow:"visible",top:"0px",left:"0px",width:"0px",height:"0px"},"class":["calloutplaceholder",d],$:function(a){b.calloutPlaceholder=
a}}]]]]))}function r(a){null!=z.layout.scrollPanel&&(a=z.layout.scrollPanel.parentNode,null!=a&&a.removeChild(z.layout.scrollPanel))}function t(a){null!=a.mousePanel&&(a.mousePanel.removeEventListener("mousemove",u),a.mousePanel.removeEventListener("click",w),a.mousePanel.removeEventListener("dblclick",y),a.mousePanel.removeEventListener("change",v));null!=a.scrollPanel&&(a.scrollPanel.removeEventListener("keydown",C),a.scrollPanel.removeEventListener("scroll",k),a.scrollPanel.removeEventListener("dragstart",
E),a.scrollPanel.removeEventListener("drag",x),a.scrollPanel.removeEventListener("dragend",x),a.scrollPanel.removeEventListener("dragover",F))}function u(b){var c=a.common.getElementOffset(z.layout.mousePanel),d=b.pageX-c.left;c=b.pageY-c.top;var f=z.tasks.getTask("CreateTransformTask"),e=z.tasks.getTask("HighlightItemOptionTask");e.hasHighlightEnabled()&&(d=f.getTreeItemForMousePosition(d,c,e.getGravityRadius()),A(b,d))}function v(b){var c=b.target,f=c.getAttribute("data-id");if(null!=f){var e=(z.options.selectedItems||
[]).slice(),g=d(z,null,f,void 0),h=a.common.indexOf(e,f);B("onSelectionChanging",b,g);g.cancel||(0<=h?e.splice(h,1):e.push(f),z.options.selectedItems=e,0>h?c.setAttribute("checked","checked"):c.removeAttribute("checked"),B("onSelectionChanged",b,g))}}function w(b){var c=a.common.getElementOffset(z.layout.mousePanel),f=b.pageX-c.left,e=b.pageY-c.top,g=z.tasks.getTask("CreateTransformTask");c=z.tasks.getTask("CursorItemOptionTask");var h=z.tasks.getTask("HighlightItemOptionTask");f=g.getTreeItemForMousePosition(f,
e,h.getGravityRadius());e=b.target;null!==f&&(a.common.hasClass(e,z.name+"button")||a.common.hasClass(e.parentNode,z.name+"button")?(c=a.common.hasClass(e,z.name+"button")?e:e.parentNode,c=c.getAttribute("data-buttonname"),e=d(z,null,f,c),B("onButtonClick",b,e)):"checkbox"!==e.getAttribute("name")&&"selectiontext"!==e.getAttribute("name")&&(e=d(z,null,f,void 0),B("onMouseClick",b,e),!e.cancel&&c.hasCursorEnabled()&&(D(b,f),z.layout.scrollPanel.focus())))}function y(a){var b=z.tasks.getTask("HighlightItemTask").getHighlightTreeItem();
null!==b&&(b=d(z,null,b,void 0),B("onMouseDblClick",a,b))}function C(a){var b=z.tasks.getTask("HighlightItemTask"),c=z.tasks.getTask("HighlightItemOptionTask"),d=z.tasks.getTask("CursorItemTask"),f=z.tasks.getTask("CursorItemOptionTask"),e=z.tasks.getTask("AlignDiagramTask"),g=z.tasks.getTask("CreateTransformTask").getTransform(),h=null,m=null,k=z.layout;c.hasHighlightEnabled()&&f.hasCursorEnabled()?(h=b.getHighlightTreeItem(),null===h&&(h=d.getCursorTreeItem())):c.hasHighlightEnabled()?h=b.getHighlightTreeItem():
f.hasCursorEnabled()&&(h=d.getCursorTreeItem());if(null!=h){switch(a.which){case 13:f.hasCursorEnabled()&&(D(a,h),a.preventDefault(),k.scrollPanel.focus());break;case 40:m=1;break;case 38:m=0;break;case 37:m=2;break;case 39:m=3}if(null!=m){for(d=!1;!d;)d=!0,m=g.getOrientation(m),b=e.getNextItem(h,m),null!=b&&(a.preventDefault(),c.hasHighlightEnabled()?A(a,b):f.hasCursorEnabled()&&D(a,b));k.scrollPanel.focus()}}}function E(b){var c=z.layout.scrollPanel;G=new a.common.Point(b.clientX,b.clientY);J=new a.common.Point(c.scrollLeft,
c.scrollTop);I=I||new Image;b.dataTransfer.setDragImage(I,0,0)}function F(a){a.preventDefault();a.dataTransfer.dropEffect="move"}function x(b){H=new a.common.Point(J.x-(b.clientX-G.x),J.y-(b.clientY-G.y));null==L&&(L=window.setTimeout(function(){var a=z.layout.scrollPanel;a.scrollLeft=H.x;a.scrollTop=H.y;window.clearTimeout(L);L=null},50))}function A(a,b){var c=!0;if(null!==b){if(b!==z.options.highlightItem){var f=d(z,z.options.highlightItem,b,void 0);z.options.highlightItem=b;B("onHighlightChanging",
a,f);f.cancel?c=!1:(h(!1,!1),B("onHighlightChanged",a,f))}}else null!==z.options.highlightItem&&(f=d(z,z.options.highlightItem,null,void 0),z.options.highlightItem=null,B("onHighlightChanging",a,f),f.cancel?c=!1:(h(!1,!1),B("onHighlightChanged",a,f)));return c}function D(a,b){if(b!==z.options.cursorItem){var c=d(z,z.options.cursorItem,b,void 0);z.options.cursorItem=b;B("onCursorChanging",a,c);c.cancel||(h(!0,!1),B("onCursorChanged",a,c))}}function B(a,b,c){a=z.options[a];null!=a&&a(b,c)}var z={name:"orgdiagram",
...
c={index:e,item:h};d=b(h,e);if(0<d){var k=Math.abs(d);h=a[f];d=b(h,f);if(0<=d)c={index:f,item:h};else for(d=Math.abs(d),k>d&&(k=d,c={index:f,item:h});e+1<f;){var l=Math.round((e+f)/2);h=a[l];d=b(h,l);if(0===d){c={index:l,item:h};break}else 0<d?e=l:f=l,d=Math.abs(d),k>d&&(k=d,c={index:l,item:h})}}}return c};a.common.family=function(c){function b(a,b,c,d){var f;if(null!=d&&(b=b[c],null!=b))for(f in b)if(b.hasOwnProperty(f)&&d.call(a,f,b[f]))break}function e(a,b){var c=!1;null!=B[a]&&null!=B[a][b]&&
(delete B[a][b],--z[a],delete G[b][a],--J[b],z[a]||(delete B[a],delete z[a]),G[b]||(delete G[b],delete J[b],null==A[null]&&(A[null]={},D[null]=0),A[null][b]=!0,D[null]+=1),c=!0);return c}function d(a,b){var c;if(null!=b)for(c in H)if(H.hasOwnProperty(c)&&b.call(a,c,H[c]))break}function g(a,c,d,f){for(var e,h,g={},m=0,k=!0;k;){e={};k=!1;for(h in d)if(d.hasOwnProperty(h)&&!g[h])switch(g[h]=!0,f.call(a,h,H[h],m)){case 1:e={};k=!1;break;case 2:break;default:b(this,c,h,function(a){g[a]||(k=e[a]=!0)})}d=
e;m+=1}}function f(a,b,c){null!=c&&null!=b&&null!=H[b]&&null!=B[b]&&g(a,B,B[b],c)}function h(a,b,c){null!=c&&null!=b&&null!=H[b]&&null!=G[b]&&g(a,G,G[b],c)}function k(a,c,d,f,e,h){var g;if(null!=h){c=[];var m={};for(l in H)H.hasOwnProperty(l)&&(m[l]=d[l]||0,m[l]||c.push(l));for(g=0;0<c.length;){var k=[];d=0;for(e=c.length;d<e;d+=1){var l=c[d];if(h.call(a,l,H[l],g)){k=[];break}g+=1;b(this,f,l,function(a){--m[a];0===m[a]&&k.push(a)})}c=k}}}function l(a,b){k(a,G,J,B,z,b)}function n(a,b){k(a,B,z,G,J,
b)}function m(a,b,c,d,f,e,h,g,m){var k=!1,l;if(null!=H[a]&&null!=h[a]){k=!0;if(m)for(m=0,l=b.length;m<l;m+=1){var q=b[m];if(null==H[q]||null==h[a][q])k=!1}if(k&&(null!=d&&(H[c]=d),null!=H[c]))for(f[c]||(f[c]={},e[c]=0),h[c]||(h[c]={},g[c]=0),f[c][a]||(f[c][a]=!0,e[c]+=1),h[a][c]||(h[a][c]=!0,g[a]+=1),m=0,l=b.length;m<l;m+=1)q=b[m],c!=q&&(null!=h[a][q]&&(delete h[a][q],--g[a]),null!=f[q][a]&&(delete f[q][a],--e[q]),f[q][c]||(f[q][c]=!0,e[q]+=1),h[c][q]||(h[c][q]=!0,g[c]+=1))}return k}function q(a,
b,c,d){return m(a,b,c,d,G,J,B,z,!0)}function p(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function r(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function t(c){var d=a.common.graph(),f,e,h,g,m,k,l,q,p={};for(f in c)c.hasOwnProperty(f)&&b(this,B,f,function(a){if(!p.hasOwnProperty(a))for(p[a]=!0,e=[],b(this,G,a,function(a){e.push(a)}),h=0,m=e.length;h<m-1;h+=1)if(k=e[h],c.hasOwnProperty(k))for(g=h+1;g<m;g+=1)if(l=e[g],c.hasOwnProperty(l)){q=
Math.abs(c[k].children.length-c[l].children.length);var f=d.edge(k,l);null==f&&(f=new r(q),d.addEdge(k,l,f));f.items.push(a);f.weight+=1}});return d}function u(a,b){this.parentid=a;this.childid=b;this.key=a+","+b}function v(a,b,c){this.from=a;this.to=b;this.distance=0}function w(a){return z[a]||0}function y(a){return J[a]||0}function C(a){var b=null;a=B[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null}function E(a){var b=null;a=G[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null}
function F(a,b){this.parentid=a;this.childid=b;this.ids=[];this.nodes=[]}function x(){return a.common.family({roots:A,rootsCount:D,children:B,childrenCount:z,parents:G,parentsCount:J,nodes:H})}var A={},D={},B={},z={},G={},J={},H={};(function(b){a.common.isObject(b)&&(A=a.common.cloneObject(b.roots,!1),D=a.common.cloneObject(b.rootsCount,!0),B=a.common.cloneObject(b.children,!1),z=a.common.cloneObject(b.childrenCount,!0),G=a.common.cloneObject(b.parents,!1),J=a.common.cloneObject(b.parentsCount,!0),
H=a.common.cloneObject(b.nodes,!0))})(c);return{add:function(a,c,d){var f,e={};a&&0!==a.length||(a=[null]);if(null==H[c]&&null!=d){H[c]=d;d=0;for(f=a.length;d<f;d+=1){var h=a[d];null==e[h]&&h!=c&&(e[h]=!0,null!=H[h]?(null==G[c]&&(G[c]={},J[c]=0),G[c][h]||(G[c][h]=!0,J[c]+=1),null==B[h]&&(B[h]={},z[h]=0),B[h][c]||(B[h][c]=!0,z[h]+=1)):(null==A[h]&&(A[h]={},D[h]=0),A[h][c]||(A[h][c]=!0,D[h]+=1)))}null!=A[c]&&(B[c]=A[c],z[c]=D[c],delete A[c],delete D[c],b(this,B,c,function(a){null==G[a]&&(G[a]={},J[a]=
0);G[a][c]||(G[a][c]=!0,J[a]+=1)}))}},adopt:function(a,b){var c;if(null!=H[b]){var d=0;for(c=a.length;d<c;d+=1){var f=a[d];null==G[b]&&(G[b]={},J[b]=0);if(f!=b&&null!=H[f])G[b][f]||(G[b][f]=!0,J[b]+=1),null==B[f]&&(B[f]={},z[f]=0),B[f][b]||(B[f][b]=!0,z[f]+=1);else throw"Item cannot be parent of itself and parent should exist in the structure!";}}else throw"Child should be in hierarchy!";},bundleChildren:q,bundleParents:function(a,b,c,f){return m(a,b,c,f,B,z,G,J,!0)},optimizeReferences:function(c){var d=
{},e={},h={},g;var k=0;var l=10;if(null!=c){for(g in H)if(k+=1,H.hasOwnProperty(g)){var q=new p;b(this,B,g,function(a){q.children.push(a);q.childrenHash[a]=!0});q.children.sort();q.id=g;q.key=q.children.join(",");h[q.id]=q}for(l=Math.pow(10,k.toString().length);!a.common.isEmptyObject(h);){var n={};var r={};var u=t(h);for(g in h)if(h.hasOwnProperty(g)&&(k=h[g],!k.processed)){var v=u.getSpanningTree(g,function(a){return a.weight*l+l-a.difference});v.loopLevels(this,function(a,b,g){h[a].processed=!0;
v.loopChildren(this,a,function(g,k){var l=u.edge(a,g),q=null,t,v;h[g].processed=!0;if(1<l.weight){var w=l.items.join(",");if(d.hasOwnProperty(w))q=d[w];else{var y=c();H[y.id]=y;q=new p;q.id=y.id;q.key=w;w=0;for(t=l.items.length;w<t;w+=1){var x=l.items[w];q.children.push(x);q.childrenHash[x]=!0;r[x]=!0}q.children.sort();d[q.key]=q;e[q.id]=q;n[q.id]=q;r[q.id]=q;var C=q.children.slice(0);f(this,b.replacementItem||a,function(a,b,c){q.childrenHash[a]||null==e[a]||(v=!0,f(this,a,function(a,b,c){if(!q.childrenHash[a])return v=
!1,1;if(!r.hasOwnProperty(a))return 2}),v&&C.push(a));return 2});m(b.replacementItem||a,C,q.id,y,G,J,B,z,!1);1>=(z[a]||0)&&null==b.replacementItem&&(b.replacementItem=q.id)}q.id!=g&&(C=q.children.slice(0),f(this,k.replacementItem||g,function(a,b,c){null==e[a]||q.childrenHash[a]||(v=!0,f(this,a,function(a,b,c){return q.childrenHash[a]?(r.hasOwnProperty(a),2):(v=!1,1)}),v&&C.push(a));return 2}),m(k.replacementItem||g,C,q.id,null,G,J,B,z,!1),1>=(z[g]||0)&&null==k.replacementItem&&(k.replacementItem=
q.id))}})})}h=n}}},eliminateManyToMany:function(a){var c,d;for(c in B)B.hasOwnProperty(c)&&1<(z[c]||0)&&b(this,B,c,function(b){1<(J[b]||0)&&(d=a(),q(c,[b],d.id,d))})},groupBy:function(a,b,c){if(null!=c){var d={};for(g in H){var f=z[g]||0;if(1>=(J[g]||0)&&1>=f){f=E(g);var e=C(g),h=f+" * "+e;d.hasOwnProperty(h)||(d[h]=new F(f,e));d[h].ids.push(g);d[h].nodes.push(H[g])}}for(h in d)if(d.hasOwnProperty(h)){var g=d[h];if(g.ids.length>=b&&c.call(a,g.parentid,g.childid,g.ids,g.nodes))break}}},getPlanarFamily:function(b){var c=
new a.common.family,d,e;b.loopLevels(this,function(h,g){var m=new a.common.LinkedHashItems,k={},l={},q=[];b.loopLevelItems(this,h,function(a,c,d){f(this,a,function(c,d){var f=b.getItemPosition(c),e=new u(a,c);l[e.key]=e;var h=[];m.isEmpty()?m.add(f,[e]):(m.iterateBack(function(b,c){if(c<f)return m.insertAfter(c,f,[e]),!0;if(c==f)return b.push(e),!0;c=0;for(var d=b.length;c<d;c+=1){var g=b[c];g.parentid!=a&&h.push(g)}}),m.startKey()>f&&m.unshift(f,[e]));k[e.key]=h;c=0;for(d=h.length;c<d;c+=1)k[h[c].key].push(e);
return 2});1==w(a)&&(c=C(a),1==y(c)&&(c=new u(a,c),q.push(c.key)))});h=[];for(v in k){var p=k[v];g=p.length;null!=h[g]?h[g].push(v):h[g]=[v]}g={};h.unshift(q);for(var n=0,t=h.length;n<t;n+=1){var r=h[n];if(null!=r)for(d=0,e=r.length;d<e;d+=1){var v=r[d];if(!g.hasOwnProperty(v)){g[v]=!0;p=l[v];null==c.node(p.parentid)&&c.add(null,p.parentid,{});null==c.node(p.childid)?c.add([p.parentid],p.childid,{}):c.adopt([p.parentid],p.childid);p=k[v];v=0;for(var x=p.length;v<x;v+=1)g[p[v].key]=!0}}}});return c},
getFamilyWithoutGrandParentsRelations:function(){var c=new a.common.family,f={},e=[],h=0;for(q in G)G.hasOwnProperty(q)&&b(this,G,q,function(a){var b=f[q];null==b&&(b={},f[q]=b);b.hasOwnProperty(a)||(b=new v(q,a,h),e.push(b),f[q][a]=b)});for(;0<e.length;){var g=[];h+=1;for(var m=0,k=e.length;m<k;m+=1){var l=e[m];var q=l.to;G.hasOwnProperty(q)&&b(this,G,q,function(a){var b=f[l.from];null==b&&(b={},f[l.from]=b);if(b.hasOwnProperty(a))b[a].distance=h;else{var c=new v(q,a,h);g.push(c);b[a]=c}})}e=g}d(this,
function(a,d){var e=[];b(this,G,a,function(b){0===f[a][b].distance&&e.push(b)});c.add(e,a,d)});return c},getGraph:function(){var c=a.common.graph(),d;for(d in B)B.hasOwnProperty(d)&&b(this,B,d,function(a){var b=c.edge(d,a);null==b&&(b=new r({}),c.addEdge(d,a,b))});return c},removeNode:function(a){null!=H[a]&&(b(this,B,a,function(b){delete G[b][a];--J[b];J[b]||(delete G[b],delete J[b],null==A[null]&&(A[null]={},D[null]=0),A[null][b]||(A[null][b]=!0,D[null]+=1))}),b(this,G,a,function(b){delete B[b][a];
--z[b];z[b]||(delete B[b],delete z[b])}),null!=A[null]&&null!=A[null][a]&&(delete A[null][a],--D[null],D[null]||(delete A[null],delete D[null])),delete B[a],delete z[a],delete G[a],delete J[a],delete H[a])},removeRelation:function(a,b){var c=!1;null!=H[a]&&null!=H[b]&&(c=e(a,b)||e(b,a));return c},node:function(a){return H[a]},loop:d,loopLevels:function(a,c,d){function f(){this.items={};this.minimumLevel=null}function e(a,b,c){var d=p[b];d||(d=new f,p[b]=d);d.addItemToLevel(a,c);u=null==u?c:Math.min(u,
c);q[a]=c;m[a]=!0}var h=[],g={},m={},k=[],q={},p={},t,r,u=null;var v=c?l:n;var w,y,x;f.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){v(this,function(a,b,c){h.push(a);g[a]=c});v=0;for(w=h.length;v<w;v+=1){var C=h[v];if(null==m[C])for(k.push(C),e(C,v,0);0<k.length;){var z=x=y=null;var E=!c;var A=[];C=0;for(r=k.length;C<r;C+=1){var D=k[C];var F=q[D];var I=!1;c?(b(this,
G,D,function(a){if(!m[a]){I=!0;var b=g[a];if(null==y||!E||y<b||y==b&&z>F-1)y=b,x=a,z=F-1,E=!0}}),b(this,B,D,function(a){if(!m[a]){I=!0;var b=g[a];if(null==y||!E&&(y>b||y==b&&z<F+1))y=b,x=a,z=F+1,E=!1}})):(b(this,B,D,function(a){if(!m[a]){I=!0;var b=g[a];if(null==y||E||y<b||y==b&&z<F+1)y=b,x=a,z=F+1,E=!1}}),b(this,G,D,function(a){if(!m[a]){I=!0;var b=g[a];if(null==y||E&&(y>b||y==b&&z>F-1))y=b,x=a,z=F-1,E=!0}}));I&&A.push(D)}null!=x&&(A.push(x),e(x,v,z));k=A}}k=!0;for(c=u;k;){C={};k=!1;for(t in p)if(p.hasOwnProperty(t)&&
(v=p[t],r=v.items[v.minimumLevel-u+c],null!=r))for(C[t]=v,k=!0,v=0,w=r.length;v<w;v+=1)if(D=r[v],d.call(a,D,H[D],c-u))return k=!1,!0;p=C;c+=1}}},loopTopo:l,loopTopoReversed:n,loopChildren:f,loopParents:h,findLargestRoot:function(){var a=null,b={},c={},d;var f=null;n(this,function(e,g,m){b.hasOwnProperty(e)||(b[e]={},c[e]=0);b[e][e]=!0;c[e]+=1;d=!0;h(this,g.id,function(a,f,h){var g;d=!1;b.hasOwnProperty(a)||(b[a]={},c[a]=0);if(c[a]||1!=J[e])for(g in f=b[e],f)f.hasOwnProperty(g)&&(b[a][g]=!0,c[a]+=
1);else b[a]=b[e],c[a]=c[e];return 2});d&&(!f||c[e]>f)&&(f=c[e],a=e)});return a},loopRoots:function(a,b){var c=null,d=0,f={},e={},g,m={},k={},l,q,p;n(this,function(a,b,c){f.hasOwnProperty(a)||(f[a]={},e[a]=0);f[a][a]=!0;e[a]+=1;g=!0;h(this,b.id,function(b,c,d){var h;g=!1;f.hasOwnProperty(b)||(f[b]={},e[b]=0);if(e[b]||1!=J[a])for(h in c=f[a],c)c.hasOwnProperty(h)&&!f[b][h]&&(f[b][h]=!0,e[b]+=1);else f[b]=f[a],e[b]=e[a];return 2});g&&(m[a]=!0,d+=1)});var t={};for(u in m)if(m.hasOwnProperty(u)){var r=
f[u];for(q in r)r.hasOwnProperty(q)&&(t[q]||(t[q]=[]),t[q].push(u.toString()))}for(;0<d;){r=null;for(l in m)m.hasOwnProperty(l)&&(!r||e[l]<r)&&(r=e[l],c=l);if(null!=c){null!=b&&b.call(a,c,H[c]);r=f[c];for(q in r)if(r.hasOwnProperty(q)&&!k[q]){var u=t[q];var v=0;for(p=u.length;v<p;v+=1){var w=u[v];--e[w]}k[q]=!0}delete m[c];--d}}},hasNodes:function(){return!a.common.isEmptyObject(H)},hasCommonChild:function(a){var c=!1,d,f,e;var h={};var g=d=0;for(f=a.length;g<f;g+=1){var m=a[g];null==H[m]||h[m]||
(h[m]=!0,d+=1)}var k={};for(m in h)h.hasOwnProperty(m)&&b(this,B,m,function(a){k[a]=k[a]?k[a]+1:1});for(e in k)if(k.hasOwnProperty(e)&&null!=G[e]&&(J[e]||0)==k[e]&&k[e]==d){c=!0;break}return c},loopNeighbours:function(a,b,c){var d={};null!=c&&(f(this,b,function(b,f,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,f,1)&&(d[b]=2),h(this,b,function(b,f,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,f,2)&&(d[b]=2));return d[b]}));return d[b]}),h(this,b,function(b,e,h){d.hasOwnProperty(b)||(d[b]=null,c.call(a,
b,e,1)&&(d[b]=2),f(this,b,function(b,f,e){d.hasOwnProperty(b)||(d[b]=!0,c.call(a,b,f,2)&&(d[b]=2));return d[b]}));return d[b]}))},countChildren:w,countParents:y,firstParent:E,firstChild:C,validate:function(a){function c(a){var b=0,c;if(null!=a)for(c in a)a.hasOwnProperty(c)&&(b+=1);return b}var f,e;d(this,function(c,d){b(this,B,c,function(b){if(!G.hasOwnProperty(b)||!G[b].hasOwnProperty(c))return null!=a&&(a.message="Child #"+b+" does not reference parent #"+c),!1});b(this,G,c,function(b){if(!B.hasOwnProperty(b)||
!B[b].hasOwnProperty(c))return null!=a&&(a.message="Parent #"+b+" does not reference child #"+c),!1})});for(f in G)if(G.hasOwnProperty(f)){if((J[f]||0)!=c(G[f]))return null!=a&&(a.message="Parents count for item #"+f+" missmatch."),!1;if(G.hasOwnProperty(f)&&!H.hasOwnProperty(f))return null!=a&&(a.message="Orphant parents for item #"+f),!1}for(e in B)if(B.hasOwnProperty(e)){if((z[e]||0)!=c(B[e]))return null!=a&&(a.message="Children count for item "+e+" missmatch."),!1;if(B.hasOwnProperty(e)&&!H.hasOwnProperty(e))return null!=
a&&(a.message="Orphant children of item "+e),!1}for(e in A)if(A.hasOwnProperty(e)){if((D[e]||0)!=c(A[e]))return null!=a&&(a.message="Root children count for item @"+e+" missmatch."),!1;b(this,A,e,function(b){if(!H.hasOwnProperty(b))return null!=a&&(a.message="Child #"+b+"of root #"+e+" does not exists."),!1})}return!0},hasLoops:function(){var a=x();l(this,function(b,c,d){a.removeNode(b)});return a.hasNodes()},clone:x,BREAK:1,SKIP:2}};a.common.FamilyAlignment=function(c,b,e,d){function g(b,c){var d=
b[c];null==d&&(d=new a.common.FamilyMargins,b[c]=d);return d}function f(a,b,c,d,f,e,g,k){var m=e,l=e;c.loopSiblings(this,b,function(a){a=g.getItemPosition(a);m=Math.min(m,a);l=Math.max(l,a)});for(var q=e-1;q>=m;--q){var p=g.getItemAtPosition(d,q);if(!a.hasOwnProperty(p)){var n=g.getItemAtPosition(d,q+1);a[p]=a[n]-(h[p]/2+(k[n]||0)+h[n]/2)}}for(q=e+1;q<=l;q+=1)p=g.getItemAtPosition(d,q),a.hasOwnProperty(p)||(n=g.getItemAtPosition(d,q-1),a[p]=a[n]+(h[n]/2+(k[p]||0)+h[p]/2));p=g.getItemAtPosition(d,
m);n=a[p]-h[p]/2;p=g.getItemAtPosition(d,l);n+=a[p]+h[p]/2;n/=2;l=m=null;c.loopNonSiblings(this,b,function(a){a=g.getItemPosition(a);m=null!=m?Math.min(m,a):a;l=null!=l?Math.max(l,a):a});c=0;for(q=m;q<=l;q+=1)b=g.getItemAtPosition(f,q),c+=h[b],q>m&&(c+=k[b]||0);q=n-c/2;b=g.getItemAtPosition(f,m);a.hasOwnProperty(b)||(a[b]=q+h[b]/2);for(q=m+1;q<=l;q+=1)b=g.getItemAtPosition(f,q),a.hasOwnProperty(b)||(n=g.getItemAtPosition(f,q-1),a[b]=a[n]+(h[n]/2+(k[b]||0)+h[b]/2))}var h={};null!=d&&e.loopItems(this,
function(a,b,f,e,g){h[a]=d.call(c,a,b)});var k=function(b,c){var d={},f={},e=null;c.loopLevelsReversed(this,function(m,k){k=new a.common.FamilyMargins;null!=e&&(e.add(0,Number.MAX_VALUE),k.merge(e,0));var l=e=k;c.loopLevelItems(this,m,function(a,e,m){var k=g(f,a);k.add(h[a],m);switch(b.countParents(a)){case 0:null!=l&&(d[a]=l.attach(k));break;case 1:b.loopParents(this,a,function(c,e,h){c=g(f,c);d[a]=c.merge(k);l=c;return b.BREAK});break;default:var q=0,p=null,n=null,t={};b.loopParents(this,a,function(a,
d,f){if(0<f)return b.BREAK;q+=h[a];d=c.getItemPosition(a);p=null==p?d:Math.min(p,d);n=null==n?d:Math.max(n,d);t[d]=a});e=-q/2;for(m=p;m<=n;m+=1){var r=t[m];e+=h[r]/2;var u=g(f,r);u.attach(k,-e);l=u;e+=h[r]/2}}})});return d}(b,e);var l=function(b,c,d){var e={},g=a.common.getFamilyUnits(b),m={};c.loopLevels(this,function(a,b){c.loopLevelItems(this,a,function(b,k,l){if(!e.hasOwnProperty(b)){k=0;if(0===l)null!=d[b]&&(k+=d[b]+h[b]/2);else{var q=c.getItemAtPosition(a,l-1);k+=e[q]+h[q]/2+(d[b]||0)+h[b]/
2}e[b]=k}k=g[b];if(null!=k)for(q=0;q<k.length;q+=1){var p=k[q];m.hasOwnProperty(p.id)||(m[p.id]=!0,f(e,b,p,a,a+1,l,c,d))}})});return e}(b,e,k);return{getOffset:function(a){return l[a]}}};a.common.FamilyMargins=function(){function a(a,c,d,g){this.left=a;this.right=c;this.leftIndex=d;this.rightIndex=g}this.items=[];this.add=function(b,c,d,g){switch(arguments.length){case 2:this.items.push(new a(-b/2,b/2,c,c));break;case 4:this.items.push(new a(b,c,d,g))}};this.merge=function(b,c){for(var d=this.getDistanceTo(b),
e=0,f=0,h=this.items.length,k=b.items.length,l=Math.min(h,k),n=Math.max(h,k),m=0;m<l;m+=1){var q=this.items[h-1-m],p=b.items[k-1-m];0===m&&(f=q.right-q.left+(d||0)+(c||0)+p.right-p.left,e=f/2+q.left,f=f/2-p.right);q.left-=e;q.right=p.right+f;q.rightIndex=p.rightIndex;this.items[n-1-m]=q}for(m=l;m<n;m+=1)q=this.items[h-1-m],p=b.items[k-1-m],null==q?this.items[n-1-m]=new a(p.left+f,p.right+f,p.leftIndex,p.rightIndex):(q.left-=e,q.right-=e);return d};this.attach=function(b,c){for(var d=this.getDistanceTo(b),
e=c||0,f=this.items.length,h=b.items.length,k=Math.min(f,h),l=Math.max(f,h),n=0;n<k;n+=1){var m=this.items[f-1-n],q=b.items[h-1-n];0===n&&(e=m.right+(d||0)+(c||0)-q.left);m.right=q.right+e;m.rightIndex=q.rightIndex;this.items[l-1-n]=m}for(n=k;n<l;n+=1)m=this.items[f-1-n],null==m&&(q=b.items[h-1-n],this.items[l-1-n]=new a(q.left+e,q.right+e,q.leftIndex,q.rightIndex));return d};this.getDistanceTo=function(a){var b=null,c=0,g=this.items.length,f=a.items.length,h=Math.min(g,f);if(0<h){for(var k=0;k<h;k+=
1){var l=this.items[g-1-k],n=a.items[f-1-k];0===k?b=c=l.right-n.left:l.rightIndex<n.leftIndex&&(b=Math.max(b,l.right-n.left))}b-=c}return b};this.loop=function(a,c){if(null!=c)for(var b=0,e=this.items.length;b<e;b+=1){var f=this.items[e-1-b];if(c.call(a,b,f.left,f.right,f.leftIndex,f.rightIndex))break}};this.getLeft=function(a){var b=this.items.length-1;if(b>=a)return this.items[b-a].left}};a.common.FibonacciHeap=function(a){function b(a){this.key=a.key;this.priority=a.priority;this.item=a.item}function c(a,
b,c){this.key=a;this.priority=b;this.item=c;this.degree=0;this.marked=!1;this.right=this.left=this.child=this.parent=null}function d(a,b){var c=r[a.right];b.right=a.right;b.left=a.key;a.right=b.key;c.left=b.key}function g(a){var b=r[a.left],c=r[a.right];b.right=c.key;c.left=b.key;a.right=a.key;a.left=a.key}function f(){var a=null;null!=p&&(a=new b(r[p]));return a}function h(){var a=f();if(null!=a){var b=r[p],c=r[b.right];if(null!=b.child){var d=r[b.child],e=r[d.left];b.right=d.key;c.left=e.key;d.left=
b.key;e.right=c.key;g(b);delete r[b.key];p=null;k(d.key)}else g(b),delete r[b.key],p=null,c.key!=b.key&&k(c.key)}return a}function k(b){var c=[],d,f={};for(d=b;!f.hasOwnProperty(d);){b=r[d];var e=b.right;f[d]=!0;for(b.parent=null;null!=(d=c[b.degree]);)(a?b.priority>d.priority:b.priority<d.priority)?l(b,d):(l(d,b),b=d),c[b.degree-1]=null;c[b.degree]=b;if(null==p||null==r[p]||(a?r[p].priority<=b.priority:r[p].priority>=b.priority))p=b.key;d=e}}function l(b,c){b.degree+=1;g(c);var f=r[b.child];if(null!=
f){if(d(f,c),a?f.priority<c.priority:f.priority>c.priority)b.child=c.key}else b.child=c.key;c.parent=b.key}function n(b,c){b=r[b];if(a?b.priority>c:b.priority<c)throw"Priority increase is not supported";b.priority=c;null!=b.parent&&(c=r[b.parent],a?c.priority<b.priority:c.priority>b.priority)&&(m(c,b),q(c));if(a?r[p].priority<b.priority:r[p].priority>b.priority)p=b.key}function m(a,b){b.marked=!1;b.parent=null;b.right==b.key?a.child=null:(a.child=b.right,g(b));--a.degree;d(r[p],b)}function q(a){if(null!=
a.parent)if(a.marked){var b=r[a.parent];m(b,a);q(b)}else a.marked=!0}var p=null,r={};return{add:function(b,f,e){if(r.hasOwnProperty(b))throw"Duplicate keys are not supported!";f=new c(b,f,e);r[b]=f;if(null==p)f.left=b,p=f.right=b;else if(e=r[p],d(e,f),a?e.priority<f.priority:e.priority>f.priority)p=b},getPriority:function(a){var b=null;r.hasOwnProperty(a)&&(b=r[a].priority);return b},setPriority:n,heapRoot:f,extractRoot:h,deleteKey:function(b){n(b,a?Infinity:-1);h()},validate:function(){var a=0;for(d in r)if(r.hasOwnProperty(d)){var b=
r[d];a+=1;if(null!=b.child){if(!r.hasOwnProperty(b.child))throw"Child does not exists";var c=r[b.child];if(c.parent!=b.key)throw"Child references wrong parent";}if(null!=b.parent&&!r.hasOwnProperty(b.parent))throw"Parent does not exists";if(null!=b.left){if(!r.hasOwnProperty(b.left))throw"Left does not exists";c=r[b.left];if(c.right!=b.key)throw"Left references wrong right";}if(null!=b.right){if(!r.hasOwnProperty(b.right))throw"Right does not exists";c=r[b.right];if(c.left!=b.key)throw"Right references wrong left";
}}if(null==p&&0<a)throw"Orphans";if(null!=p){if(!r.hasOwnProperty(p))throw"Root node does not exists";b=r[p];if(null!=b.parent)throw"Root node has parent reference";var d=[p];b={};for(c=0;0<d.length;){for(var f=[],e=0,h=d.length;e<h;e+=1)for(var g=r[d[e]];!b.hasOwnProperty(g.key);)b[g.key]=!0,c+=1,null!=g.child&&f.push(g.child),g=r[g.right];d=f}if(a!=c)throw"Tree has loops or orpants";}}}};a.common.getCrossingRectangles=function(c,b,e){function d(a,b,c,d){this.isStart=a;this.index=b;this.x=c;this.rect=
d}function g(){this.count=0;this.rectangles={};this.add=function(a){this.count+=1;this.rectangles[a]=!0};this.remove=function(a){--this.count;delete this.rectangles[a];return 0==this.count}}function f(a,d,f,h,g){a.loopForward(this,d,function(a,d){if(a>f)return!0;for(var k in d.rectangles)d.rectangles.hasOwnProperty(k)&&(a=h>k?h+"-"+k:k+"-"+h,m.hasOwnProperty(a)||(m[a]=!0,e.call(c,g,b[k])))})}if(null!=e){for(var h=[],k=0;k<b.length;k+=1){var l=b[k];h.push(new d(1,k,l.x,l));h.push(new d(0,k,l.right(),
l))}h.sort(function(a,b){return a.x==b.x?b.isStart-a.isStart:a.x-b.x});l=a.common.SortedList();var n={},m={};for(k=0;k<h.length;k+=1){var q=h[k],p=[q.rect.y,q.rect.bottom()];if(1==q.isStart){f(l,p[0],p[1],q.index,q.rect);for(var r=0,t=p.length;r<t;r+=1){var u=p[r],v=n[u];null==v&&(v=new g,n[u]=v,l.add(u,v));v.add(q.index)}}else{r=0;for(t=p.length;r<t;r+=1)u=p[r],v=n[u],v.remove(q.index)&&(delete n[u],l.remove(u));f(l,p[0],p[1],q.index,q.rect)}}}};a.common.getFamilyUnits=function(a){function b(){this.toIndex=
this.fromIndex=0;this.items=[];this.hash={}}function c(a){this.id=a;this.parents=new b;this.children=new b;this.loopSiblings=function(a,b,c){this._loop(a,this.parents.hash.hasOwnProperty(b)?this.parents.items:this.children.items,c)};this.loopNonSiblings=function(a,b,c){this._loop(a,this.parents.hash.hasOwnProperty(b)?this.children.items:this.parents.items,c)};this.loop=function(a,b){this._loop(a,this.parents.items,b);this._loop(a,this.children.items,b)};this._loop=function(a,b,c){if(null!=c)for(var d=
0,f=b.length;d<f;d+=1)c.call(a,b[d])};this.addParent=function(a){this._add(a,this.parents)};this.addChild=function(a){this._add(a,this.children)};this._add=function(a,b){b.hash.hasOwnProperty(a)||(b.items.push(a),b.hash[a]=!0)}}var d=[],g={},f;var h=0;a.loop(this,function(b,f){var e=a.countChildren(b);if(0<e&&!g.hasOwnProperty(b)){var m=new c(h);h+=1;m.addParent(b);a.loopChildren(this,b,function(b,c){m.addChild(b);1==e&&a.loopParents(this,b,function(b){m.addParent(b);g[b]=m;return a.SKIP});return a.SKIP});
d.push(m);g[b]=m}});var k={};h=0;for(f=d.length;h<f;h+=1){var l=d[h];l.loop(this,function(a){k.hasOwnProperty(a)?k[a].push(l):k[a]=[l]})}return k};a.common.getLiniarBreaks=function(c){function b(b,f){var e=0,h=(d[f]-d[b]+c[b])/(f-b+1),g=a.common.binarySearch(c,function(a){return h-a},b,f);g.item<=h?(e+=h*(g.index+1-b)-(d[g.index]-d[b]+c[b]),e+=d[f]-d[g.index]-h*(f-g.index)):(e+=h*(g.index-b)-(d[g.index]-d[b]-c[g.index]+c[b]),e+=d[f]-d[g.index]+c[g.index]-h*(f-g.index+1));return e}function e(a,c){var d=
0+b(0,a);c>a+1&&(d+=b(a+1,c-1));return d+=b(c,g-1)}for(var d=[],g=c.length,f=0,h=0;h<g;h+=1)f+=c[h],d[h]=f;f=0;h=g-1;for(var k=e(f,h);f<h+1;){var l=e(f+1,h),n=e(f,h-1);if(l<n){if(l>=k)break;f+=1;k=l}else{if(n>=k)break;--h;k=n}}return[f,h-1,g-1]};a.common.getMergedRectangles=function(c,b,e){function d(a,b){this.start=a;this.startHead=null;this.end=b;this.endHead=null;this.overlap=function(a){return!(this.end<a.start||this.start>a.end)}}function g(a,b){this.x=a;this.ranges=b}function f(a,b){this.isHead=
a;this.list=b;x.hasOwnProperty(b)||(x[b]=[]);x[b].push(this);this.add=function(a){a.from.equalTo(a.to)||(this.isHead?F[this.list].add(A,a):F[this.list].unshift(A,a),A+=1)};this.getTail=function(){return new f(!this.isHead,this.list)};this.attach=function(a){if(this.list!=a.list){F[this.list].attach(F[a.list]);var b=x[a.list];delete x[a.list];if(null!=b)for(var c=0,d=b.length;c<d;c+=1){var f=b[c];f!=a&&(f.list=this.list,x[this.list].push(f))}}}}function h(b){F.push(new a.common.LinkedHashItems);return new f(b,
F.length-1)}var k;b.sort(function(a,b){return a.x==b.x?a.y-b.y:a.x-b.x});var l=[],n={};var m=0;for(k=b.length;m<k;m+=1){var q=b[m];var p=[q.x,q.right()];for(var r=0;r<p.length;r+=1){var t=p[r];var u=n[t];null==u&&(u={x:t,add:[],remove:[]},n[t]=u,l.push(u));t==q.x?u.add.push(m):u.remove.push(m)}}l.sort(function(a,b){return a.x-b.x});r={};n=[];n.push(new g(null,[]));m=0;for(k=l.length;m<k;m+=1){u=l[m];q=0;for(p=u.add.length;q<p;q+=1)r[u.add[q]]=!0;q=0;for(p=u.remove.length;q<p;q+=1)delete r[u.remove[q]];
t=[];for(var v in r)r.hasOwnProperty(v)&&t.push(b[v]);t.sort(function(a,b){return a.y-b.y});var w=[],y=null,C=null;q=0;for(p=t.length;q<p;q+=1){var E=t[q];null==y?(y=E.y,C=E.bottom()):C<E.y?(w.push(new d(y,C)),y=E.y,C=E.bottom()):C=Math.max(C,E.bottom())}null!=y&&w.push(new d(y,C));n.push(new g(u.x,w))}var F=[],x={},A=1;m=1;for(k=n.length;m<k;m+=1)for(b=n[m-1],u=n[m],q=v=0;v<b.ranges.length||q<u.ranges.length;)if(p=v<b.ranges.length?b.ranges[v]:null,r=q<u.ranges.length?u.ranges[q]:null,null==r){l=
[new a.common.Point(b.x,p.end),new a.common.Point(u.x,p.end),new a.common.Point(u.x,p.start),new a.common.Point(b.x,p.start)];for(w=1;w<l.length;w+=1)p.endHead.add(new a.common.Vector(l[w-1],l[w]));p.endHead.attach(p.startHead);v+=1}else if(null==p)r.endHead=h(!0),r.endHead.add(new a.common.Vector(new a.common.Point(u.x,r.start),new a.common.Point(u.x,r.end))),r.startHead=r.endHead.getTail(),q+=1;else if(r.overlap(p)){l=[new a.common.Point(b.x,p.start),new a.common.Point(u.x,p.start),new a.common.Point(u.x,
r.start)];for(w=1;w<l.length;w+=1)p.startHead.add(new a.common.Vector(l[w],l[w-1]));r.startHead=p.startHead;for(w=!0;w;)if(w=!1,p.end>r.end)t=q+1<u.ranges.length?u.ranges[q+1]:null,null!=t&&t.overlap(p)&&(w=new a.common.Point(u.x,t.start),y=new a.common.Point(u.x,r.end),r.endHead=h(!0),r.endHead.add(new a.common.Vector(w,y)),t.startHead=r.endHead.getTail(),q+=1,r=t,w=!0);else if(t=v+1<b.ranges.length?b.ranges[v+1]:null,null!=t&&t.overlap(r)){l=[new a.common.Point(b.x,p.end),new a.common.Point(u.x,
p.end),new a.common.Point(u.x,t.start),new a.common.Point(b.x,t.start)];for(w=1;w<l.length;w+=1)p.endHead.add(new a.common.Vector(l[w-1],l[w]));p.endHead.attach(t.startHead);v+=1;p=t;w=!0}l=[new a.common.Point(b.x,p.end),new a.common.Point(u.x,p.end),new a.common.Point(u.x,r.end)];for(w=1;w<l.length;w+=1)p.endHead.add(new a.common.Vector(l[w-1],l[w]));r.endHead=p.endHead;v+=1;q+=1}else if(p.start<r.start){l=[new a.common.Point(b.x,p.end),new a.common.Point(u.x,p.end),new a.common.Point(u.x,p.start),
new a.common.Point(b.x,p.start)];for(w=1;w<l.length;w+=1)p.endHead.add(new a.common.Vector(l[w-1],l[w]));p.endHead.attach(p.startHead);v+=1}else r.endHead=h(!0),r.endHead.add(new a.common.Vector(new a.common.Point(u.x,r.start),new a.common.Point(u.x,r.end))),r.startHead=r.endHead.getTail(),q+=1;if(null!=e)for(m=0;m<F.length;m+=1)x.hasOwnProperty(m)&&(k=F[m],l=[],k.iterate(function(a,b){0==l.length&&l.push(a.from);l.push(a.to)}),e.call(c,l))};a.common.getMinimumCrossingRows=function(a,b,e){var c=null,
g=null;if(null!=e){b.sort(function(a,b){return a.y-b.y});for(var f=0;f<b.length;f+=1){var h=b[f],k=h.bottom();null===c?(c=h.y,g=k):h.y>=g?(e.call(a,c),c=h.y,g=k):(h.y>c&&(c=h.y),k<g&&(g=k))}null!==c&&e.call(a,c)}};a.common.graph=function(){function c(a,b,c,e){var f=[],h,g;f.push(b);c[b]=!0;if(null!=e)for(;0<f.length;){b=[];var k=0;for(h=f.length;k<h;k+=1){var p=f[k];e.call(a,p);p=d[p];for(g in p)p.hasOwnProperty(g)&&!c.hasOwnProperty(g)&&(c[g]=!0,b.push(g))}f=b}}function b(a,b){var c=null,f,e,g=null;
for(f in d)if(d.hasOwnProperty(f)){var m=d[f];var q=0;for(e in m)m.hasOwnProperty(e)&&(q+=b.call(a,m[e],f,e));if(q>g||null==g)c=f,g=q}return c}function e(a,c,e,k,l){var f={},h,g={},p=0,r,t;if(null!=e&&null!=k&&(null==c&&(c=b(a,e)),null!=c))for(k.call(a,c),f[c]=!0,p+=1,g[c]=null;0<p;){c=[];var u=r=null;var v={};for(h in f)if(f.hasOwnProperty(h)){var w=d[h];var y=!1;for(t in w)if(w.hasOwnProperty(t)&&!g.hasOwnProperty(t)){var C=e.call(a,w[t],h,t);y=!0;switch(l){case 1:null==v[t]&&(v[t]=0);v[t]+=C;if(!u||
v[t]>u)r=t,u=v[t];break;case 2:if(v[t]=null==v[t]?C:Math.min(v[t],C),!u||v[t]<u)r=t,u=v[t]}}y||c.push(h)}if(null==r)break;else f[r]=!0,p+=1,g[r]=!0,k.call(a,r);y=0;for(r=c.length;y<r;y+=1)delete f[c[y]],--p}}var d={};return{addEdge:function(a,b,c){null!=d[a]&&null!=d[a][b]||null==c||(null==d[a]&&(d[a]={}),d[a][b]=c,null==d[b]&&(d[b]={}),d[b][a]=c)},edge:function(a,b){var c=null;null!=d[a]&&d[a][b]&&(c=d[a][b]);return c},hasNode:function(a){return d.hasOwnProperty(a)},loopNodes:function(a,b,e){a={};
if(null==b)for(b in d)d.hasOwnProperty(b)&&(a.hasOwnProperty[b]||c(this,b,a,e));else c(this,b,a,e)},loopNodeEdges:function(a,b,c){var f;if(null!=c&&(b=d[b],null!=b))for(f in b)b.hasOwnProperty(f)&&c.call(a,f,b[f])},getSpanningTree:function(b,c){var f=a.common.tree(),e=a.common.FibonacciHeap(!0),g={},n;e.add(b,0,null);for(g[b]=null;null!=(b=e.extractRoot());){var m=d[b.key];for(n in m)if(m.hasOwnProperty(n)&&!f.node(n)){var q=null!=c?c(m[n]):m[n];var p=e.getPriority(n);null==p?(e.add(n,q,null),g[n]=
b.key.toString()):p<=q&&(e.setPriority(n,q),g[n]=b.key.toString())}f.add(g[b.key],b.key.toString(),{})}return f},getTotalWeightGrowthSequence:function(a,c,d){var f=b(a,c);e(a,f,c,d,1)},getMinimumWeightGrowthSequence:function(a,b,c,d){e(a,b,c,d,2)},getShortestPath:function(b,c,e,k,l){var f=a.common.FibonacciHeap(!1),h={},g,p={},r=0,t=0;var u=0;for(g=e.length;u<g;u+=1){var v=e[u];p.hasOwnProperty(v)||(r+=1,p[v]=!0)}f.add(c,0,null);for(h[c]=null;null!=(c=f.extractRoot());){u=d[c.key];for(v in u)u.hasOwnProperty(v)&&
(g=c.priority+(null!=k?k.call(b,u[v],c,v):1),e=f.getPriority(v),null!=e?e>g&&(f.setPriority(v,g),h[v]=c.key):h.hasOwnProperty(v)||(f.add(v,g,null),h[v]=c.key));if(p.hasOwnProperty(c.key)){e=[];for(u=c.key;null!=u;)e.push(u),u=h[u];l.call(b,e,c.key);t+=1;if(t>=r)break}}}}};a.common.LCA=function(c){var b=[],e=[],d={},g;(function(){var f=0;c.loopEulerWalk(this,function(a,c,g){b.push(a);e.push(g);d.hasOwnProperty(a)||(d[a]=f);f+=1});g=a.common.RMQ(e)})();return{getLowestCommonAncestor:function(a,c){a=
...
n.points)for(var w=0;4>w;w+=1)g.push(n.quadrants[w]);else{w=0;for(var y=n.points.length;w<y;w+=1){var C=n.points[w];if(b.contains(C)&&c.call(a,C))return}}else f.push(n)}l=0;for(d=f.length;l<d;l+=1)if(n=f[l],null==n.points)for(w=0;4>w;w+=1)k.push(n.quadrants[w]);else for(w=0,y=n.points.length;w<y;w+=1)if(c.call(a,n.points[w]))return;e=g;f=k}},validate:function(){for(var b=[h];0<b.length;){for(var c=[],d=0,e=b.length;d<e;d+=1){var f=b[d],g=new a.common.Rect(f.x,f.y,f.size,f.size);if(null!=f.points&&
...
e;)if(null!=e.right)d.push(e),e=e.right;else{if(c.call(a,e.value,e.context))return;e=e.left}}}function l(a){var b=[],c=0;if(null!=a)for(b.push(a);0<b.length;){for(var e=[],d=0;d<b.length;d+=1)a=b[d],null!=a.left&&e.push(a.left),null!=a.right&&e.push(a.right);b=e;c+=1}return c}var n=null;return{add:function(c,e,d,f){if(null==n)n=new a(c,e);else{for(var g=[],h=null,k=n;null!=k;)if(null!=h&&g.push(h),h=k,h.value==c)if(null!=f)f.call(d,h.context);else throw"Structure does not support duplicates.";else k=
h.value>c?h.left:h.right;g.push(h);e=new a(c,e);h.value>c?h.left=e:h.right=e;for(h=e;null!=(k=g.pop());){if(h.value<k.value)if(0>k.balance){--k.balance;b(k);break}else{if(0<k.balance){--k.balance;break}--k.balance}else if(0<k.balance){k.balance+=1;b(k);break}else{if(0>k.balance){k.balance+=1;break}k.balance+=1}h=k}}},remove:function(a){for(var c=[],e=n;null!=e;)if(e.value==a){if(null!=e.right&&null!=e.left){c.push(e);for(a=e.right;null!=a.left;)c.push(a),a=a.left;var d=a;e.value=d.value;e.context=
d.context;g(a,c[c.length-1]);c.push(a)}else g(e,c[c.length-1]),c.push(e);for(a=c.length-2;0<=a;--a)if(d=c[a],e=c[a+1],d.value>e.value)if(0<d.balance){if(d.balance+=1,0===b(d))break}else{if(0===d.balance){d.balance+=1;break}d.balance+=1}else if(0>d.balance){if(--d.balance,0===b(d))break}else{if(0===d.balance){--d.balance;break}--d.balance}break}else c.push(e),e=e.value>a?e.left:e.right},loopForward:h,loopBackward:k,nextContext:function(a){var b=null;h(this,a,function(a,c){b=c;return!0});return b},
previousContext:function(a){var b=null;k(this,a,function(a,c){b=c;return!0});return b},validate:function(){if(null!=n)for(var a=[n];0<a.length;){for(var b=[],c=0;c<a.length;c+=1){var e=a[c];if(null==e.value||null!=e.left&&(b.push(e.left),e.left.value>=e.value)||null!=e.right&&(b.push(e.right),e.right.value<=e.value))return!1;if(e.balance!=l(e.right)-l(e.left))return console.log("Disbalanced node: "+e.value+" - "+JSON.stringify(n)),!1}a=b}return!0}}};a.common.SpatialIndex=function(c){function b(b,
...
return b}}};a.common.tree=function(c){function b(a,b,c){var e;if(null!=f[b]&&(b=k[b],null!=b)){var d=0;for(e=b.length;d<e;d+=1){var h=b[d];if(c.call(a,h,f[h],d,e-1))break}}}function e(a){var b=null;null!=h[a]&&(b=h[a]);return b}function d(a,b){var c,e=a.length;for(c=0;c<e;c+=1)if(a[c]==b)return a.splice(c,1),e-1;return e}function g(a,c,d){if(null!=d&&f.hasOwnProperty(c)){var h=e(c);null!=h&&d.call(a,h,f[h])||(b(a,h,function(b,e){b!=c&&d.call(a,b,e)}),b(a,c,function(b,c){d.call(a,b,c)}))}}var f={},
h={},k={},l={},n={};(function(b){a.common.isObject(b)&&(f=a.common.cloneObject(b.nodes,!0),h=a.common.cloneObject(b.parents,!0),k=a.common.cloneObject(b.children,!1),l=a.common.cloneObject(b.roots,!1),n=a.common.cloneObject(b.rootChildren,!0))})(c);return{loop:function(a,b){var c;if(null!=b)for(c in f)if(f.hasOwnProperty(c)&&b.call(a,c,f[c]))break},loopLevels:function(a,b,c){var e=0,d=[],h;switch(arguments.length){case 2:var g=b;break;case 3:var l=b;g=c}if(null!=g){if(null==l)for(m in n)n.hasOwnProperty(m)&&
(d=d.concat(n[m]));else null!=k[l]&&(d=d.concat(k[l]));for(;0<d.length;){var m=[];var q=0;for(h=d.length;q<h;q+=1)switch(l=d[q],g.call(a,l,f[l],e)){case 1:m=[];break;case 2:break;default:null!=k[l]&&(m=m.concat(k[l]))}d=m;e+=1}}},loopParents:function(a,b,c,e){if(null!=f[b]&&null!=c&&(!0!==e||!c.call(a,b,f[b])))for(;null!=(b=h[b])&&!c.call(a,b,f[b]););},loopChildren:b,loopChildrenRange:function(a,b,c,e,d){var h;if(null!=f[b]&&(b=k[b],null!=b))if(c<e)for(c=Math.max(c,0),e=Math.min(e,b.length-1),h=c;h<=
e&&(c=b[h],!d.call(a,c,f[c],h,NaN));h+=1);else for(c=Math.min(c,b.length-1),e=Math.max(0,e),h=c;h>=e&&(c=b[h],!d.call(a,c,f[c],h,NaN));--h);},loopChildrenReversed:function(a,b,c){var e;if(null!=f[b]){b=k[b];var d=b.length-1;if(null!=b)for(e=d;0<=e;--e){var h=b[e];if(c.call(a,h,f[h],e,d))break}}},loopPostOrder:function(a,b){var c=[],e;if(null!=b){for(d in n)n.hasOwnProperty(d)&&(c=c.concat(n[d]));for(;0<c.length;){var d=c[c.length-1];if(d!=g&&null!=(e=k[d]))for(d=e.length-1;0<=d;--d)c.push(e[d]);else{c.pop();
var g=h[d];if(b.call(a,d,f[d],g,f[g]))break}}}},loopPreOrder:function(a,b){var c=[],e;if(null!=b){for(d in n)n.hasOwnProperty(d)&&(c=c.concat(n[d]));for(;0<c.length;){var d=c[c.length-1];if(d!=l){var g=h[d];if(b.call(a,d,f[d],g,f[g]))break}if(d!=l&&null!=(e=k[d]))for(d=e.length-1;0<=d;--d)c.push(e[d]);else{c.pop();var l=h[d]}}}},loopEulerWalk:function(a,b){var c=[],d=[],e;if(null!=b){for(m in n)if(n.hasOwnProperty(m)){var g=n[m];var l=0;for(e=g.length;l<e;l+=1)c.push(g[l]),d.push(0)}for(;0<c.length;){l=
...
a.orgdiagram.ConnectorsOptionTask,"#000080");c.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.ItemsOptionTask,"#000080");c.addTask("SpousesOptionTask",["OptionsTask","defaultItemConfig"],a.famdiagram.SpousesOptionTask,"#000080");c.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],a.orgdiagram.ItemsSizesOptionTask,"#000080");c.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],
a.orgdiagram.TemplatesOptionTask,"#000080");c.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.OrientationOptionTask,"#000080");c.addTask("VisualTreeOptionTask",["OptionsTask"],a.famdiagram.VisualTreeOptionTask,"#000080");c.addTask("HideGrandParentsConnectorsOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.HideGrandParentsConnectorsOptionTask,"#000080");c.addTask("NormalizeOptionTask",["OptionsTask","defaultConfig"],a.famdiagram.NormalizeOptionTask,"#000080");c.addTask("OrderFamilyNodesOptionTask",
["OptionsTask","defaultConfig","defaultItemConfig"],a.famdiagram.OrderFamilyNodesOptionTask,"#000080");c.addTask("LinePaletteOptionTask",["OptionsTask","defaultPaletteItemConfig"],a.famdiagram.LinePaletteOptionTask,"#000080");c.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.CursorItemOptionTask,"#000080");c.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.HighlightItemOptionTask,"#000080");c.addTask("SelectedItemsOptionTask",["OptionsTask"],
a.orgdiagram.SelectedItemsOptionTask,"#000080");c.addTask("SplitAnnotationsOptionTask",["OptionsTask"],a.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");c.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");c.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],a.orgdiagram.ShapeAnnotationOptionTask,"#000080");c.addTask("ForegroundHighlightPathAnnotationOptionTask",
...
a.famdiagram.ItemsPositionsTask,"#ff0000");c.addTask("AlignDiagramTask","OrientationOptionTask ItemsSizesOptionTask VisualTreeOptionTask ScaleOptionTask CurrentControlSizeTask null ItemsPositionsTask isFamilyChartMode".split(" "),a.orgdiagram.AlignDiagramTask,"#ff0000");c.addTask("CreateTransformTask",["OrientationOptionTask","AlignDiagramTask"],a.orgdiagram.CreateTransformTask,"#00ffff");c.addTask("PaletteManagerTask",["ConnectorsOptionTask","LinePaletteOptionTask"],a.orgdiagram.PaletteManagerTask,
"#00ffff");c.addTask("DrawBackgroundAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask BackgroundAnnotationOptionTask AddLabelAnnotationsTask AlignDiagramTask".split(" "),a.orgdiagram.DrawBackgroundAnnotationTask,"#008000");c.addTask("DrawBackgroundShapeAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask BackgroundShapeAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask background DrawBackgroundAnnotationTask".split(" "),a.orgdiagram.DrawShapeAnnotationTask,
"#008000");c.addTask("DrawBackgroundConnectorAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask BackgroundConnectorAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask background DrawBackgroundShapeAnnotationTask".split(" "),a.orgdiagram.DrawConnectorAnnotationTask,"#008000");c.addTask("DrawBackgroundHighlightPathAnnotationTask","graphics ConnectorsOptionTask ForegroundHighlightPathAnnotationOptionTask ConnectionsGraphTask foreground DrawBackgroundConnectorAnnotationTask".split(" "),
a.orgdiagram.DrawHighlightPathAnnotationTask,"#00ffff");c.addTask("DrawConnectorsTask","graphics ConnectionsGraphTask ConnectorsOptionTask showElbowDots PaletteManagerTask DrawBackgroundHighlightPathAnnotationTask".split(" "),a.orgdiagram.DrawConnectorsTask,"#008000");c.addTask("DrawForegroundHighlightPathAnnotationTask","graphics ConnectorsOptionTask BackgroundHighlightPathAnnotationOptionTask ConnectionsGraphTask background DrawConnectorsTask".split(" "),a.orgdiagram.DrawHighlightPathAnnotationTask,
"#00ffff");c.addTask("DrawTreeItemsTask","graphics CreateTransformTask ApplyLayoutChangesTask null ItemsSizesOptionTask CombinedContextsTask AlignDiagramTask null CombinedTemplateParamsTask CursorItemTask SelectedItemsTask GroupTitleTemplateTask CheckBoxTemplateTask ButtonsTemplateTask DrawForegroundHighlightPathAnnotationTask".split(" "),a.orgdiagram.DrawTreeItemsTask,"#008000");c.addTask("DrawCursorTask","graphics CreateTransformTask ApplyLayoutChangesTask CombinedContextsTask AlignDiagramTask CombinedTemplateParamsTask CursorItemTask SelectedItemsTask DrawTreeItemsTask".split(" "),
a.orgdiagram.DrawCursorTask,"#008000");c.addTask("DrawHighlightTask","graphics CreateTransformTask ApplyLayoutChangesTask CombinedContextsTask AlignDiagramTask CombinedTemplateParamsTask HighlightItemTask CursorItemTask SelectedItemsTask DrawCursorTask".split(" "),a.orgdiagram.DrawHighlightTask,"#008000");c.addTask("DrawForegroundShapeAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask ForegroundShapeAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask foreground DrawHighlightTask".split(" "),
a.orgdiagram.DrawShapeAnnotationTask,"#008000");c.addTask("DrawForegroundConnectorAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask ForegroundConnectorAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask foreground DrawForegroundShapeAnnotationTask".split(" "),a.orgdiagram.DrawConnectorAnnotationTask,"#008000");return c}function g(){f.options.hasButtons=2;f.options.pageFitMode=5;f.options.autoSizeMaximum=new a.common.Size(1E5,1E5)}var f={name:"famdiagram",
doc:null,options:c,tasks:null,graphics:null};return{draw:function(c,k,l){f.doc=c;f.tasks=d(b,e);f.graphics=new a.pdf.graphics(f.doc);f.graphics.debug=!1;g();f.doc.save();f.doc.translate(k,l);f.tasks.process("OptionsTask",null,!1);f.doc.restore();c=f.tasks.getTask("AlignDiagramTask");return new a.common.Size(c.getContentSize())},getSize:function(){f.tasks=d(b,e);g();f.tasks.process("OptionsTask","AlignDiagramTask",!1);var c=f.tasks.getTask("AlignDiagramTask");return new a.common.Size(c.getContentSize())}}};
a.pdf.Template=function(c,b){this.cursorTemplate=this.dotHighlightTemplate=this.highlightTemplate=this.itemTemplate=this.templateConfig=null;null!=b&&(this.templateConfig=b,this.itemTemplate=a.common.isNullOrEmpty(b.itemTemplate)?new a.pdf.ItemTemplate(c,b):new a.pdf.UserTemplate(c,b,c.onItemRender),this.highlightTemplate=a.common.isNullOrEmpty(b.highlightTemplate)?new a.pdf.HighlightTemplate(c,b):new a.pdf.UserTemplate(c,b,c.onHighlightRender),this.dotHighlightTemplate=new a.pdf.DummyTemplate(c,
b),this.cursorTemplate=a.common.isNullOrEmpty(b.cursorTemplate)?new a.pdf.CursorTemplate(c,b):new a.pdf.UserTemplate(c,b,c.onCursorRender))};a.pdf.orgdiagram.DummyCurrentControlSizeTask=function(c){return{process:function(){return!0},getScrollPanelSize:function(){return new a.common.Size(800,600)},getOptimalPanelSize:function(){return new a.common.Size(775,575)}}};a.pdf.orgdiagram.AnnotationLabelTemplateTask=function(c){var b=null;return{process:function(){return!1},getTemplate:function(){null==b&&
(b=new a.pdf.AnnotationLabelTemplate);return b}}};a.pdf.orgdiagram.ButtonsTemplateTask=function(c){var b=null;return{process:function(){return!1},getTemplate:function(){null==b&&(b=new a.pdf.DummyTemplate);return b}}};a.pdf.orgdiagram.CheckBoxTemplateTask=function(c){var b=null;return{process:function(){b=null;return!0},getTemplate:function(){if(null==b){var e=c.getOptions();b=new a.pdf.CheckBoxTemplate(e.selectCheckBoxLabel)}return b}}};a.pdf.orgdiagram.GroupTitleTemplateTask=function(c){var b=null;
return{process:function(){b=null;return!0},getTemplate:function(){if(null==b){var e=c.getOptions();b=new a.pdf.GroupTitleTemplate(e.itemTitleFirstFontColor,e.itemTitleSecondFontColor)}return b}}};a.pdf.orgdiagram.ReadTemplatesTask=function(c){var b={};return{process:function(){var e=c.getOptions(),d=e.templates;b={};b.DefaultWidgetTemplate=new a.pdf.Template(e,new a.orgdiagram.TemplateConfig);var g=new a.orgdiagram.TemplateConfig;g.name="DefaultWidgetLabelAnnotationTemplate";g.isActive=!1;g.itemSize=
new a.common.Size(100,20);g.minimizedItemSize=new a.common.Size(0,0);var f=new a.pdf.Template;f.templateConfig=g;f.minimizedItemCornerRadius=g.minimizedItemSize.width/2;f.itemTemplate=new a.pdf.LabelAnnotationTemplate;f.dotHighlightTemplate=new a.pdf.DummyTemplate;b.DefaultWidgetLabelAnnotationTemplate=f;g=0;for(f=d.length;g<f;g+=1){var h=d[g];b[h.name]=new a.pdf.Template(e,h)}return!0},getTemplate:function(a,c,g){return b[a]||b[c]||b[g]},DefaultWidgetTemplateName:"DefaultWidgetTemplate",DefaultWidgetLabelAnnotationTemplateName:"DefaultWidgetLabelAnnotationTemplate"}};
a.pdf.orgdiagram.DummyCombinedNormalVisibilityItemsTask=function(a){return{process:function(){return!0},isItemSelected:function(a){return!1}}};a.pdf.orgdiagram.Plugin=function(c){function b(){return f.options}function e(){return f.graphics}function d(){var c=new a.common.TaskManager;c.addDependency("options",b);c.addDependency("graphics",e);c.addDependency("defaultConfig",new a.orgdiagram.Config);c.addDependency("defaultItemConfig",new a.orgdiagram.ItemConfig);c.addDependency("defaultTemplateConfig",
new a.orgdiagram.TemplateConfig);c.addDependency("defaultButtonConfig",new a.orgdiagram.ButtonConfig);c.addDependency("defaultBackgroundAnnotationConfig",new a.orgdiagram.BackgroundAnnotationConfig);c.addDependency("defaultConnectorAnnotationConfig",new a.orgdiagram.ConnectorAnnotationConfig);c.addDependency("defaultHighlightPathAnnotationConfig",new a.orgdiagram.HighlightPathAnnotationConfig);c.addDependency("defaultShapeAnnotationConfig",new a.orgdiagram.ShapeAnnotationConfig);c.addDependency("isFamilyChartMode",
!1);c.addDependency("showElbowDots",!1);c.addDependency("null",null);c.addDependency("foreground",2);c.addDependency("background",1);c.addTask("OptionsTask",["options"],a.orgdiagram.OptionsTask,"#000000");c.addTask("CalloutOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],a.orgdiagram.CalloutOptionTask,"#000080");c.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ConnectorsOptionTask,"#000080");c.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],
a.orgdiagram.ItemsOptionTask,"#000080");c.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],a.orgdiagram.ItemsSizesOptionTask,"#000080");c.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],a.orgdiagram.TemplatesOptionTask,"#000080");c.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.OrientationOptionTask,"#000080");c.addTask("VisualTreeOptionTask",["OptionsTask",
"defaultConfig"],a.orgdiagram.VisualTreeOptionTask,"#000080");c.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.CursorItemOptionTask,"#000080");c.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.HighlightItemOptionTask,"#000080");c.addTask("SelectedItemsOptionTask",["OptionsTask"],a.orgdiagram.SelectedItemsOptionTask,"#000080");c.addTask("SplitAnnotationsOptionTask",["OptionsTask"],a.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");c.addTask("ForegroundShapeAnnotationOptionTask",
...
["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","background"],a.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");c.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");c.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],a.orgdiagram.ConnectorAnnotationOptionTask,"#000080");
c.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],a.orgdiagram.BackgroundAnnotationOptionTask,"#000080");c.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],a.orgdiagram.ScaleOptionTask,"#000080");c.addTask("CombinedContextsTask",["ItemsOptionTask"],a.orgdiagram.CombinedContextsTask,"#00ffff");c.addTask("OrgTreeTask",["ItemsOptionTask"],a.orgdiagram.OrgTreeTask,"#ff0000");c.addTask("ReadTemplatesTask",["TemplatesOptionTask"],a.pdf.orgdiagram.ReadTemplatesTask,
"#00ffff");c.addTask("ItemTemplateParamsTask",["ItemsSizesOptionTask","CursorItemOptionTask","ReadTemplatesTask"],a.orgdiagram.ItemTemplateParamsTask,"#00ffff");c.addTask("GroupTitleTemplateTask",["TemplatesOptionTask"],a.pdf.orgdiagram.GroupTitleTemplateTask,"#00ffff");c.addTask("CheckBoxTemplateTask",["ItemsSizesOptionTask"],a.pdf.orgdiagram.CheckBoxTemplateTask,"#00ffff");c.addTask("ButtonsTemplateTask",["ItemsSizesOptionTask"],a.pdf.orgdiagram.ButtonsTemplateTask,"#00ffff");c.addTask("AnnotationLabelTemplateTask",
["ItemsOptionTask"],a.pdf.orgdiagram.AnnotationLabelTemplateTask,"#00ffff");c.addTask("VisualTreeTask",["OrgTreeTask","null","VisualTreeOptionTask","isFamilyChartMode"],a.orgdiagram.VisualTreeTask,"#ff0000");c.addTask("VisualTreeLevelsTask",["VisualTreeTask","ItemTemplateParamsTask"],a.orgdiagram.VisualTreeLevelsTask,"#ff0000");c.addTask("ConnectionsGraphTask",["graphics","CreateTransformTask","ConnectorsOptionTask","VisualTreeLevelsTask","AlignDiagramTask"],a.orgdiagram.ConnectionsGraphTask,"#00ffff");
c.addTask("HighlightItemTask",["HighlightItemOptionTask","null"],a.orgdiagram.HighlightItemTask,"#00ffff");c.addTask("CursorItemTask",["CursorItemOptionTask","null"],a.orgdiagram.CursorItemTask,"#00ffff");c.addTask("SelectedItemsTask",["SelectedItemsOptionTask"],a.orgdiagram.SelectedItemsTask,"#00ffff");c.addTask("CombinedNormalVisibilityItemsTask",["OptionsTask"],a.pdf.orgdiagram.DummyCombinedNormalVisibilityItemsTask,"#00ffff");c.addTask("CurrentControlSizeTask",["OptionsTask"],a.pdf.orgdiagram.DummyCurrentControlSizeTask,
"#00ffff");c.addTask("ItemsPositionsTask","CurrentControlSizeTask ScaleOptionTask OrientationOptionTask ItemsSizesOptionTask ConnectorsOptionTask VisualTreeOptionTask VisualTreeTask VisualTreeLevelsTask ItemTemplateParamsTask CursorItemTask CombinedNormalVisibilityItemsTask".split(" "),a.orgdiagram.ItemsPositionsTask,"#ff0000");c.addTask("AlignDiagramTask","OrientationOptionTask ItemsSizesOptionTask VisualTreeOptionTask ScaleOptionTask CurrentControlSizeTask null ItemsPositionsTask isFamilyChartMode".split(" "),
a.orgdiagram.AlignDiagramTask,"#ff0000");c.addTask("CreateTransformTask",["OrientationOptionTask","AlignDiagramTask"],a.orgdiagram.CreateTransformTask,"#00ffff");c.addTask("PaletteManagerTask",["ConnectorsOptionTask","null"],a.orgdiagram.PaletteManagerTask,"#00ffff");c.addTask("DrawBackgroundAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask BackgroundAnnotationOptionTask VisualTreeTask AlignDiagramTask".split(" "),a.orgdiagram.DrawBackgroundAnnotationTask,"#008000");c.addTask("DrawBackgroundShapeAnnotationTask",
...
a.orgdiagram.DrawConnectorAnnotationTask,"#008000");c.addTask("DrawTreeItemsTask","graphics CreateTransformTask ApplyLayoutChangesTask null ItemsSizesOptionTask CombinedContextsTask AlignDiagramTask null ItemTemplateParamsTask CursorItemTask SelectedItemsTask GroupTitleTemplateTask CheckBoxTemplateTask ButtonsTemplateTask DrawBackgroundConnectorAnnotationTask".split(" "),a.orgdiagram.DrawTreeItemsTask,"#008000");c.addTask("DrawBackgroundHighlightPathAnnotationTask","graphics ConnectorsOptionTask ForegroundHighlightPathAnnotationOptionTask ConnectionsGraphTask foreground DrawTreeItemsTask".split(" "),
a.orgdiagram.DrawHighlightPathAnnotationTask,"#00ffff");c.addTask("DrawConnectorsTask","graphics ConnectionsGraphTask ConnectorsOptionTask showElbowDots PaletteManagerTask DrawBackgroundHighlightPathAnnotationTask".split(" "),a.orgdiagram.DrawConnectorsTask,"#008000");c.addTask("DrawForegroundHighlightPathAnnotationTask","graphics ConnectorsOptionTask BackgroundHighlightPathAnnotationOptionTask ConnectionsGraphTask background DrawConnectorsTask".split(" "),a.orgdiagram.DrawHighlightPathAnnotationTask,
"#00ffff");c.addTask("DrawForegroundShapeAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask ForegroundShapeAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask foreground DrawForegroundHighlightPathAnnotationTask".split(" "),a.orgdiagram.DrawShapeAnnotationTask,"#008000");c.addTask("DrawForegroundConnectorAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask ForegroundConnectorAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask foreground DrawForegroundShapeAnnotationTask".split(" "),
a.orgdiagram.DrawConnectorAnnotationTask,"#008000");c.addTask("DrawCursorTask","graphics CreateTransformTask ApplyLayoutChangesTask CombinedContextsTask AlignDiagramTask ItemTemplateParamsTask CursorItemTask SelectedItemsTask DrawForegroundConnectorAnnotationTask".split(" "),a.orgdiagram.DrawCursorTask,"#008000");c.addTask("DrawHighlightTask","graphics CreateTransformTask ApplyLayoutChangesTask CombinedContextsTask AlignDiagramTask ItemTemplateParamsTask HighlightItemTask CursorItemTask SelectedItemsTask DrawCursorTask".split(" "),
a.orgdiagram.DrawHighlightTask,"#008000");return c}function g(){f.options.hasButtons=2;f.options.pageFitMode=5;f.options.autoSizeMaximum=new a.common.Size(1E5,1E5)}var f={name:"orgdiagram",doc:null,options:c,tasks:null,graphics:null};return{draw:function(c,k,l){f.doc=c;f.tasks=d(b,e);f.graphics=new a.pdf.graphics(f.doc);f.graphics.debug=!1;g();f.doc.save();f.doc.translate(k,l);f.tasks.process("OptionsTask",null,!1);f.doc.restore();c=f.tasks.getTask("AlignDiagramTask");return new a.common.Size(c.getContentSize())},
getSize:function(){f.tasks=d(b,e);g();f.tasks.process("OptionsTask","AlignDiagramTask",!1);var c=f.tasks.getTask("AlignDiagramTask");return new a.common.Size(c.getContentSize())}}};a.pdf.AnnotationLabelTemplate=function(){return{template:function(){return{}},getHashCode:function(){return 0},render:function(a,b,e){e=e.context;a.save();a.font("Helvetica",12).text(e.label,b.x,b.y,{width:b.width,height:b.height,align:"center"});a.restore()}}};a.pdf.CheckBoxTemplate=function(a){return{template:function(){return{}},
